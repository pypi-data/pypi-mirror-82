...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'okta', '2.5.0-alpha.1602522568+304cf8b6'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource okta 2.5.0-alpha.1602522568+304cf8b6`
                """)
            else:
                raise
