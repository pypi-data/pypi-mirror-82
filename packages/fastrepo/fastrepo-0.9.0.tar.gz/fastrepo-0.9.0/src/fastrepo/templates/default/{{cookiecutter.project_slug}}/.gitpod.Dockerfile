...
ADD --chown=gitpod:gitpod https://raw.githubusercontent.com/RDIL/better-wsfull/master/nvm-lazy.sh  /home/gitpod/.nvm/nvm-lazy.sh

ENV PATH=/home/gitpod/.nvm/versions/node/v${NODE_VERSION}/bin:home/gitpod/.local/bin:$PATH

USER gitpod

RUN sudo python3 -m pip install --upgrade --no-cache-dir setuptools wheel pip
