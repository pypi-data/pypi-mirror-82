...
class Model():
    ...
    def create_deployment(self, name=None, description=None, deployment_config=None, calls_per_second=None):
        return self.client.create_deployment(self.model_id, name, description, deployment_config, calls_per_second)
