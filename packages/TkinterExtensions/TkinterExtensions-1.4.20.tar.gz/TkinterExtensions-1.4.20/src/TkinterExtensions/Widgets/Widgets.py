...
class Canvas(tk.Canvas, BaseTkinterWidget):
    def __init__(self, master, *args, **kwargs):
        ...
        self.bind(Bindings.Button, func=self.HandleRelease)
        self.bind(Bindings.ButtonRelease, func=self.HandlePress)

        self.bind(Bindings.FocusIn, func=self.HandleFocusIn)
        self.bind(Bindings.FocusOut, func=self.HandleFocusOut)
