...
with io.open(os.path.join(here, 'vision-ui', '__about__.py'), encoding='utf-8') as f:
    exec(f.read(), about)
...
class UploadCommand(Command):
    ...
    def run(self):
        try:
            ...
            rmtree(os.path.join(here, 'vision-ui/dist'))
        except OSError:
            pass
...
setup(
    ...
    package_data={
        '': ["README.md"],
        'vision-ui': ['dbnet_crnn/model/det/model', 'dbnet_crnn/model/det/params', 'dbnet_crnn/model/rec/model',
