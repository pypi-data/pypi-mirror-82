...
def bootstrap(request):
    ...
    cls.data /= 10
    cls.data[:100] *= 10
    cls.data_part_1 = cls.data[:100].ravel()
    cls.data_part_2 = cls.data[100:].ravel()
...
class TestPartialHistogram:
    ...
    def test_fixed_nbins(self):
        ...
        hist1 = partial_hist.compute_histogram(self.data_part_1)
        hist2 = partial_hist.compute_histogram(self.data_part_2)
