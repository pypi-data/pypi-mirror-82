...
#Default ATAC-Seq File
DEFAULT_ATAC_SEQ_OCCUPANCY_FILE = 'ENCFF035ICJ_breast-epithelium_Normal_ATAC-seq.wig'

#Default CTCF File
DEFAULT_CTCF_OCCUPANCY_FILE = 'ENCFF782GCQ_breast-epithelium_Normal_CTCF-human.bed'
