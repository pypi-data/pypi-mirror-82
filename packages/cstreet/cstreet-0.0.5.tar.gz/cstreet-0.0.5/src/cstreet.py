...
class CStreetData(object):
    ...
    def __get_inner_cgKNN(self,adata):
        ...
        if knn_graph.shape[0]!=0:
            ...
            knn_graph_egde['Node2_cluster_cell_num']=knn_graph_egde['Node2_cluster'].map(adata.obs['scdata_cluster'].value_counts().to_dict())
            knn_graph_egde["edge_num_per_cell"]=knn_graph_egde["edge_num"]/knn_graph_egde["Node2_cluster_cell_num"]

            tmp_dict=knn_graph_egde.groupby(['Node2_cluster'],as_index=False)['edge_num_per_cell'].sum()
            tmp_dict.index=tmp_dict["Node2_cluster"]
            knn_graph_egde['incoming_edge_num']=knn_graph_egde['Node2_cluster'].map(tmp_dict['edge_num_per_cell'].to_dict())
            knn_graph_egde["score"]=knn_graph_egde["edge_num_per_cell"]/knn_graph_egde["incoming_edge_num"]
        else:
    ...
    def __get_link_cgKNN(self,knn_graph,node_cluster,node_cluster_cell_num):
        ...
        knn_graph["edge_num"]=1
        knn_graph_egde=knn_graph.groupby(['Node1_cluster','Node2_cluster'],as_index=False)['edge_num'].count()
        knn_graph_egde['Node2_cluster_cell_num']=knn_graph_egde['Node2_cluster'].map(node_cluster_cell_num)
        knn_graph_egde["edge_num_per_cell"]=knn_graph_egde["edge_num"]/knn_graph_egde["Node2_cluster_cell_num"]
