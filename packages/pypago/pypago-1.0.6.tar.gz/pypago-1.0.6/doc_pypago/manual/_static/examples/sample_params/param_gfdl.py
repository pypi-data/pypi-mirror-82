...
dictvname = {}
dictvname["lon_varname"] = "geolon_t"
dictvname["lat_varname"] = "geolat_t"
dictvname["bathy_varname"] = "ht"
dictvname["tmask_varname"] = "wet"

dictvname["dxt_varname"] = "dxt"
dictvname["dyt_varname"] = "dyt"
dictvname["dye_varname"] = "dyte"
dictvname["dxn_varname"] = "dxtn"
dictvname["dzt_varname"] = "dz_t" 
dictvname["dzc_varname"] = "dz_c"
#default configuration for GFDL defines ' +
#      "Corner points at the north west corner of cell")
#cf http://data1.gfdl.noaa.gov:9192/' +
#      'opendap/gfdl_cm2_0/ocean_grid_doc.html')
#warning: CMIP5 GFDL-CM3 defines Corner ' +
#      'points at the north east corner of cell !')
# use default configuration of GFDL which is Corner point at 
# point at north west corner of cell? True or False
gfdl_default = True
