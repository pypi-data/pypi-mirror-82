...
class Ui_DeviceButton(object):
    def setupUi(self, DeviceButton):
        ...
        DeviceButton.resize(180, 180)
        DeviceButton.setMinimumSize(QtCore.QSize(180, 180))
        DeviceButton.setMaximumSize(QtCore.QSize(180, 180))
        font = QtGui.QFont()
...
"}")
        ...
        spacerItem = QtWidgets.QSpacerItem(18, 28, QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Expanding)
        self.verticalLayout_2.addItem(spacerItem)
        self.horizontalLayout = QtWidgets.QHBoxLayout()
        self.horizontalLayout.setObjectName("horizontalLayout")
        spacerItem1 = QtWidgets.QSpacerItem(35, 30, QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Minimum)
        self.horizontalLayout.addItem(spacerItem1)
        self.label_icon = IconLabel(self.widget)
        self.label_icon.setMinimumSize(QtCore.QSize(76, 76))
        self.label_icon.setMaximumSize(QtCore.QSize(76, 76))
        ...
        spacerItem2 = QtWidgets.QSpacerItem(35, 28, QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Minimum)
        ...
        spacerItem3 = QtWidgets.QSpacerItem(18, 35, QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Expanding)
