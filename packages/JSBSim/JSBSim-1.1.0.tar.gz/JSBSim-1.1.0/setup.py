...
if 'sdist' not in dist.commands and compiler.find_library_file([library_path],
    ...
    # the sources.
    if compiler.compiler_type == 'msvc':
        compile_flags = [('/D'+flag).replace('"', '\\"') for flag in ['JSBSIM_VERSION="1.1.0 [GitHub build 102/commit fb5a11ee1450ddbc9ae8612c65331fa42431f786]"','HAVE_EXPAT_CONFIG_H',]]
    else:
        compile_flags = ['-D'+flag for flag in ['JSBSIM_VERSION="1.1.0 [GitHub build 102/commit fb5a11ee1450ddbc9ae8612c65331fa42431f786]"','HAVE_EXPAT_CONFIG_H',]]
