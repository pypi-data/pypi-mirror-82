...
USER_AGENT = f"python-faest/{__version__}"
...
class BaseClient:
    ...
    def stream(
        ...
        *,
        ...
        """
        Alternative to `faest.request()` that streams the response body
        instead of loading it into memory at once.

        **Parameters**: See `faest.request`.
    ...
    def _redirect_url(self, request: Request, response: Response) -> URL:
        ...
        # See: https://git.sr.ht/~wsmith/faest/issues/771
    ...
    * **trust_env** - *(optional)* Enables or disables usage of environment
        ...
        if http2:
            try:
                ...
                raise ImportError(
                    ...
                    "Make sure to install faest using `pip install faest[http2]`."
                ) from None
    ...
    def send(
        ...
        *,
        ...
        but passing an explicit `faest.Request()` is supported as well.
        ...
        validate_origin(request, response)
    ...
    * **trust_env** - *(optional)* Enables or disables usage of environment
    ...
    def __del__(self) -> None:
        if not self.is_closed:
            warnings.warn(
                f"Unclosed {self!r}. "
                "See https://www.python-faest.org/async/#opening-and-closing-clients "
                "for details."
            )
