    ...
    def __init__(
        ...
        *,
        ...
        if not isinstance(connect_timeout, UnsetType):
            warn_deprecated(
                "faest.Timeout(..., connect_timeout=...) is deprecated and will "
                "raise errors in a future version. "
                "Use faest.Timeout(..., connect=...) instead."
            )
            connect = connect_timeout

        if not isinstance(read_timeout, UnsetType):
            warn_deprecated(
                "faest.Timeout(..., read_timeout=...) is deprecated and will "
                "raise errors in a future version. "
                "Use faest.Timeout(..., write=...) instead."
            )
            read = read_timeout

        if not isinstance(write_timeout, UnsetType):
            warn_deprecated(
                "faest.Timeout(..., write_timeout=...) is deprecated and will "
                "raise errors in a future version. "
                "Use faest.Timeout(..., write=...) instead."
            )
            write = write_timeout
        ...
        if not isinstance(pool_timeout, UnsetType):
            warn_deprecated(
                "faest.Timeout(..., pool_timeout=...) is deprecated and will "
                "raise errors in a future version. "
                "Use faest.Timeout(..., pool=...) instead."
            )
            pool = pool_timeout
        ...
        if isinstance(timeout, Timeout):
            ...
            if isinstance(timeout, UnsetType):
                warnings.warn(
                    "faest.Timeout must either include a default, or set all "
...
class PoolLimits(Limits):
    def __init__(self, **kwargs: typing.Any) -> None:
        warn_deprecated(
            "faest.PoolLimits(...) is deprecated and will raise errors in the future. "
            "Use faest.Limits(...) instead."
        )
