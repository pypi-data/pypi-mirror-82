...
class QSVMLogger():
    ...
    def on_train_end(self, clf, train_kernel_matrix, train_test_kernel_matrix, y_test):
        ...
        np.savez(self.formatted_filename +'.npz', 
                 train_kernel_matrix=train_kernel_matrix,
                 test_kernel_matrix=train_test_kernel_matrix, 
                 y_test=y_test,
                 score=score,
                 **self.attributes)
