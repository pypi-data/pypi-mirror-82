...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'newrelic', '3.6.0-alpha.1602691752+583fdcaa'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource newrelic 3.6.0-alpha.1602691752+583fdcaa`
                """)
            else:
                raise
