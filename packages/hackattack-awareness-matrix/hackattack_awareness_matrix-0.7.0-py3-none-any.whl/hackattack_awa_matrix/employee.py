...
def edit(project_id, employee_id):
    ...
    return render_template('employee/create_or_edit.html', employee=get_employee(employee_id), project=get_project(project_id))
...
def details(project_id, employee_id):
    return render_template('employee/details.html', employee=get_employee(employee_id), project=get_project(project_id), assigned_threats=get_threats_of_employee_group(project_id, employee_id))
