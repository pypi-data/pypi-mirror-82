...
class KNativeKafkaConsumer(threading.Thread):
    ...
    def __init__(self,topics:str,group_id:str):
        ...
        if is_tls_enable == 'True' or is_tls_enable == 'true':
            ...
            print(os.environ['KAFKA_NET_TLS_CA_CERT'])
            self.logger.info(os.environ['KAFKA_NET_TLS_CA_CERT'])
            self.ssl_certfile=os.environ['KAFKA_NET_TLS_CERT']
            print(self.ssl_certfile)
            self.logger.info(self.ssl_certfile)
            self.ssl_keyfile=os.environ['KAFKA_NET_TLS_KEY']
            print(self.ssl_keyfile)
            self.logger.info(self.ssl_keyfile)
            print("Inside if")
        ...
        try:                
            ...
            print("Inexception")
            print("Exception while creating consumer - {}".format(e))
