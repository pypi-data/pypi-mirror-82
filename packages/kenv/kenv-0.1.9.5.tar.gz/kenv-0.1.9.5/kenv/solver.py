...
class Simulation:
    ...
    def track(self,
        ...
        y0=X0_beam, t_eval=self.accelerator.parameter, method=method, rtol=rtol).y
        ...
        t_span=[self.accelerator.parameter[0], self.accelerator.parameter[-1]],
        y0=X0_centroid, t_eval=self.accelerator.parameter, method=method, rtol=rtol).y
        ...
        t_span=[self.accelerator.parameter[0], self.accelerator.parameter[-1]],
        y0=X0_particle, t_eval=self.accelerator.parameter, method=method, rtol=rtol).y
