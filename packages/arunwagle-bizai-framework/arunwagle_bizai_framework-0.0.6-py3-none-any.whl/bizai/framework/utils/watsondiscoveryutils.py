...
if __name__ == "__main__":
    ...
    wds_api_key = 'q5D6dfz9gYMhqmLruLJqyQVbskoy8Gs8RXNgLCOR5uh0'
    wds_url = 'https://gateway.watsonplatform.net/discovery/api'
    wds_api_version =  '2019-04-30'
    WDS_ENV_ID = "6e425e26-0ae2-4a72-a129-7c90c4190d73"
    WDS_CONTRACT_COL_ID = "ad657de9-a828-4c28-b5bb-e0647afa07b5"

    query = "Exclusions for Financial Insolvency"
    filter="metadata.SubmissionNo:TP10002612-2019-S"
