"""
Working version that writes txt horizontally
"""
...
def writeToTable(tableName, geo, col, value):
    ...
    with open('txt_export/' + tableName + '.txt', 'a', newline='') as writefile:
        a = csv.writer(writefile, delimiter=',')
        a.writerow((geo, col, value))
    print('{} total, {}'.format(time.time()-startTime, time.time()-startFuncTime))
