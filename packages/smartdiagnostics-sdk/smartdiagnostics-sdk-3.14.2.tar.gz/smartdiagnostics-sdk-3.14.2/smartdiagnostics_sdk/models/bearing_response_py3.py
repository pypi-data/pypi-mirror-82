...
class BearingResponse(Model):
    ...
    def __init__(self, *, id: str=None, name: str=None, manufacturer: str=None, roller_count: int=None, ftf: float=None, bsf: float=None, bpfo: float=None, bpfi: float=None, **kwargs) -> None:
