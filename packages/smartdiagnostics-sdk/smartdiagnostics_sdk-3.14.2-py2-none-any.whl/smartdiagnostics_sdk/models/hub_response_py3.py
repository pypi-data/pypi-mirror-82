...
class HubResponse(Model):
    ...
    _attribute_map = {
        ...
        'power_type_id': {'key': 'PowerTypeId', 'type': 'int'},
        'firmware_version': {'key': 'FirmwareVersion', 'type': 'str'},
        'hub_type_id': {'key': 'HubTypeId', 'type': 'int'},
    ...
    def __init__(self, *, id: int=None, receiver=None, location=None, corporation=None, serial_number: str=None, nickname: str=None, power_type_id: int=None, firmware_version: str=None, hub_type_id: int=None, created=None, updated=None, packet_success_rate: float=None, wireless_efficiency: float=None, is_online: bool=None, ports=None, **kwargs) -> None:
