...
class SystemResponse(Model):
    ...
    def __init__(self, *, id: str, name: str, active: bool, is_paused: bool, created, corporation, location, is_collector_dependent_system: bool=None, children=None, abbreviation: str=None, **kwargs) -> None:
