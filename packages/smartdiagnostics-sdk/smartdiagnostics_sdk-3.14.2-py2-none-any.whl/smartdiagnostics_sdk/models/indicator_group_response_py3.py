...
class IndicatorGroupResponse(Model):
    ...
    def __init__(self, *, id: str, name: str, active: bool, is_paused: bool, created, corporation, location, parent=None, hierarchy=None, abbreviation: str=None, **kwargs) -> None:
