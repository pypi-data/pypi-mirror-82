...
class SubSystemResponse(Model):
    ...
    def __init__(self, *, id: str, name: str, active: bool, is_paused: bool, created, corporation, location, parent=None, children=None, hierarchy=None, abbreviation: str=None, **kwargs) -> None:
