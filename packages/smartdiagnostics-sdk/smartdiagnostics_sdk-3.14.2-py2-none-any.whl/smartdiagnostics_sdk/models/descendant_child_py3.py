...
class DescendantChild(Model):
    ...
    def __init__(self, *, child_id: str=None, child_name: str=None, child_abbreviation: str=None, child_type: str=None, child_sort_order: int=None, child_has_children: bool=None, **kwargs) -> None:
