...
def data_transfer(
    ...
    for i in df.itertuples():
        # TODO: update run_records with new path
        statement = "UPDATE `raw_data` SET `s3uri`='{}' WHERE sampleData_id={}".format(
            os.path.join(i.dest, ""), i.id
        )
        try:
            ...
            statement2 = ""
        statements = "; ".join([statement, statement1, statement2])
