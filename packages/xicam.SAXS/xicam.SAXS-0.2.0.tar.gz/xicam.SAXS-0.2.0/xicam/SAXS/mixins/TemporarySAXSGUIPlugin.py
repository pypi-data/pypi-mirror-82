...
from xicam.stages.correlation import TwoTimeCorrelationStage, OneTimeCorrelationStage
...
from xicam.SAXS.widgets.parametertrees import CorrelationParameterTree, OneTimeParameterTree, TwoTimeParameterTree
from xicam.SAXS.widgets.SAXSViewerPlugin import SAXSViewerPluginBase
from xicam.SAXS.workflows.roi import ROIWorkflow


class TemporarySAXSGUIPlugin(GUIPlugin):
    name = 'SAXS'
    ...
    def __init__(self):
        ...
        #
        # self.onetime_workflow = OneTime()
        # self.onetime_editor = WorkflowEditor(self.onetime_workflow)
        # self.onetime_editor.sigRunWorkflow.connect(self.dothing)
        # self.twotime_workflow = TwoTime()
        # self.twotime_editor = WorkflowEditor(self.twotime_workflow)
        self.onetime_correlation_stage = OneTimeCorrelationStage(self.ensembleModel)
        self.twotime_correlation_stage = TwoTimeCorrelationStage(self.ensembleModel)
        ...
        self.stages = {
            ...
            'Correlate': {
                '2-Time Correlation': self.twotime_correlation_stage.gui_layout,
                '1-Time Correlation': self.onetime_correlation_stage.gui_layout
            }
        }
