...
from inventory.admin.utils import BaseChangelistView
from inventory.gpx_tools.humanize import convert_cash_values, human_distance, human_duration, human_seconds
from inventory.models import EventLinkModel, EventModel
from inventory.models.event import CostModel, ParticipationModel
...
class StatisticsView(BaseChangelistView):
    ...
    template_name = "admin/inventory/eventmodel/statistics.html"
