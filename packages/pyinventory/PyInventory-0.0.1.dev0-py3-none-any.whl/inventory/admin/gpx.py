...
from inventory.admin.gpx_import_export import GpxModelResource
from inventory.admin.utils import BaseChangelistView, BaseFormChangelistView
from inventory.exceptions import GpxDataError
from inventory.forms import INITIAL_DISTANCE, DistanceStatisticsForm, UploadGpxFileForm
from inventory.gpx import add_extension_data, get_2d_coordinate_list, iter_distance, iter_points
from inventory.models import GpxModel

from inventory.services.gpx_svg_generator import generate_svg
...
class UploadGpxFileView(generic.FormView):
    template_name = "inventory/upload_gpx_file.html"
...
class DistancePaceStatisticsView(BaseChangelistView):
    template_name = "inventory/distance_pace_statistics.html"
...
class DistanceStatisticsView(BaseFormChangelistView):
    template_name = "inventory/distance_statistics.html"
...
class GpxInfoView(BaseChangelistView):
    template_name = "inventory/gpx_info.html"
...
class GpxMetadataView(BaseChangelistView):
    template_name = "inventory/gpx_metadata.html"
...
class PrintMiniView(generic.TemplateView):
    ...
    template_name = "admin/inventory/gpxmodel/print_mini.html"
    ...
    def get_context_data(self, **kwargs):
        ...
        context = {"gpx_tracks": gpx_tracks, "back_url": reverse("admin:inventory_gpxmodel_changelist")}
        return context
...
class StatisticsListFilter(admin.SimpleListFilter):
    title = _("statistics")
    template = "admin/inventory/gpxmodel/filter.html"
...
class GpxModelAdmin(ExportMixin, admin.ModelAdmin):
    ...
    change_list_template = "admin/inventory/gpxmodel/change_list.html"
    resource_class = GpxModelResource

    def print_mini(self, request, queryset):
        url = reverse("admin:print-mini")  # inventory.admin.gpx.PrintMiniView
    ...
    def leaflet_map_html(self, obj):
        ...
        return render_to_string(template_name="admin/inventory/gpxmodel/leaflet_map.html", context=context)
    ...
    def dygraphs_html(self, obj):
        ...
        return render_to_string(template_name="admin/inventory/gpxmodel/dygraphs.html", context=context)
    ...
    def participation_links(self, obj):
        ...
        return render_to_string(template_name="admin/inventory/gpxmodel/participation_links.html", context=context)
