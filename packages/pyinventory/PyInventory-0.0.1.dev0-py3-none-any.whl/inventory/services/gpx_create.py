"""
    ...
    :copyleft: 2019 by the PyInventory team, see AUTHORS for more details.
...
from inventory.gpx import get_identifier, parse_gpx
...
def add_gpx(*, gpx_content, user):
    """
    Create a new inventory.models.GpxModel entry
