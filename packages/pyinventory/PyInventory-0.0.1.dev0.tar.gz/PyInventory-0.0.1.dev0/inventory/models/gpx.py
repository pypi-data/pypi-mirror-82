...
from inventory.gpx import GpxIdentifier, parse_gpx
from inventory.gpx_tools.humanize import human_distance, human_duration, human_seconds
from inventory.managers.gpx import GpxModelManager
from inventory.model_utils import ModelAdminUrlMixin
from inventory.models import DistanceModel, ParticipationModel
...
class GpxModel(ModelAdminUrlMixin, UpdateTimeBaseModel):
    ...
    def _get_track_upload_path(self, *, file_extension):
        """
        e.g:
            ~/DjangoInventoryEnv/media/gpx_track_<date>/<prefix_id>.<file_extension>
        """
    ...
    def get_svg_upload_path(self, *, filename):
        ...
        /home/<username>/DjangoInventoryEnv/media/gpx_track_<date>/<prefix_id>.svg
        """
    ...
    def get_gpx_upload_path(self, *, filename):
        ...
        /home/<username>/DjangoInventoryEnv/media/gpx_track_<date>/<prefix_id>.gpx
        """
