...
from inventory.svg import gpx2svg_string
...
def generate_svg(gpx_track, force=False):
    ...
    :param gpx_track: inventory.models.gpx.GpxModel instance
...
class CsvGenerator:
    """
    TODO: Replace with inventory.admin.gpx_import_export.GpxModelResource
    """
