...
setup(
  ...
  packages = ['instaclient'],   # Chose the same as "name"
  version = '1.0',      # Start with a small number and increase it with every change you make
  license='MIT',        # Chose a license from here: https://help.github.com/articles/licensing-a-repository
  description = 'Instagram client built with Python 3.8 and the Selenium package.',   # Give a short description about your library
  ...
  download_url = 'https://github.com/wickerdevs/py-instaclient/archive/v1.0.tar.gz',    # I explain this later on
