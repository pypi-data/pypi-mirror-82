...
[boto3.GlobalAccelerator 1.15.18](https://boto3.amazonaws.com/v1/documentation/api/1.15.18/reference/services/globalaccelerator.html#GlobalAccelerator) service
compatible with
