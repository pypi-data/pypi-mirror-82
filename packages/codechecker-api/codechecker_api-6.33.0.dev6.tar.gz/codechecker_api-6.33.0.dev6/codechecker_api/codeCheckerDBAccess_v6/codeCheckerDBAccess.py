...
class getDiffResultsHash_args(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i240 in range(_size236):
                        ...
                        self.reportHashes.append(_elem241)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 3:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i246 in range(_size242):
                        ...
                        self.skipDetectionStatuses.append(_elem247)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.skipDetectionStatuses is not None:
            ...
            for iter250 in self.skipDetectionStatuses:
...
class getLinesInSourceFileContents_args(object):
            ...
            if fid == 1:
                if ftype == TType.LIST:
                    ...
                    for _i304 in range(_size300):
                        _elem305 = LinesInFilesRequested()
                        _elem305.read(iprot)
                        self.linesInFilesRequested.append(_elem305)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 2:
    ...
    def write(self, oprot):
        ...
        if self.linesInFilesRequested is not None:
            ...
            for iter306 in self.linesInFilesRequested:
                iter306.write(oprot)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        if self.encoding is not None:
    ...
    def write(self, oprot):
        ...
        if self.success is not None:
            ...
            for kiter321, viter322 in self.success.items():
                ...
                oprot.writeMapBegin(TType.I64, TType.STRING, len(viter322))
            ...
            if fid == 0:
                if ftype == TType.MAP:
                    ...
                    for _i373 in range(_size369):
                        _key374 = iprot.readString().decode('utf-8') if sys.version_info[0] == 2 else iprot.readString()
            ...
            if fid == 0:
                if ftype == TType.MAP:
                    ...
                    for _i421 in range(_size417):
                        _key422 = iprot.readString().decode('utf-8') if sys.version_info[0] == 2 else iprot.readString()
            ...
            if fid == 0:
                if ftype == TType.MAP:
                    ...
                    for _i465 in range(_size461):
                        _key466 = iprot.readString().decode('utf-8') if sys.version_info[0] == 2 else iprot.readString()
    ...
    def write(self, oprot):
        ...
        if self.success is not None:
            ...
            for kiter468, viter469 in self.success.items():
                oprot.writeString(kiter468.encode('utf-8') if sys.version_info[0] == 2 else kiter468)
...
class getSourceComponents_args(object):
            ...
            if fid == 1:
                if ftype == TType.LIST:
                    ...
                    for _i474 in range(_size470):
                        ...
                        self.sourceComponentFilter.append(_elem475)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.sourceComponentFilter is not None:
            ...
            for iter476 in self.sourceComponentFilter:
...
class getMissingContentHashes_args(object):
            ...
            if fid == 1:
                if ftype == TType.LIST:
                    ...
                    for _i488 in range(_size484):
                        ...
                        self.fileHashes.append(_elem489)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.fileHashes is not None:
            ...
            for iter490 in self.fileHashes:
...
class massStoreRun_args(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i502 in range(_size498):
                        ...
                        self.trimPathPrefixes.append(_elem503)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 7:
    ...
    def write(self, oprot):
        ...
        if self.trimPathPrefixes is not None:
            ...
            for iter504 in self.trimPathPrefixes:
    ...
    def write(self, oprot):
        ...
        if self.success is not None:
            ...
            for kiter512, viter513 in self.success.items():
                oprot.writeI32(kiter512)
                oprot.writeI64(viter513)
            oprot.writeMapEnd()
            oprot.writeFieldEnd()
        if self.requestError is not None:
            oprot.writeFieldBegin('requestError', TType.STRUCT, 1)
