...
class Iface(object):
    ...
    def getFilesInDirectory(self, parentDir):
        """
        Parameters:
         - parentDir
        """
...
class Client(Iface):
    ...
    def getFilesInDirectory(self, parentDir):
        ...
        Parameters:
         - parentDir
        """
        self.send_getFilesInDirectory(parentDir)
        return self.recv_getFilesInDirectory()

    def send_getFilesInDirectory(self, parentDir):
        self._oprot.writeMessageBegin('getFilesInDirectory', TMessageType.CALL, self._seqid)
        args = getFilesInDirectory_args()
        args.parentDir = parentDir
        args.write(self._oprot)
        self._oprot.writeMessageEnd()
        self._oprot.trans.flush()

    def recv_getFilesInDirectory(self):
        iprot = self._iprot
        (fname, mtype, rseqid) = iprot.readMessageBegin()
        if mtype == TMessageType.EXCEPTION:
            x = TApplicationException()
            ...
            iprot.readMessageEnd()
            raise x
        result = getFilesInDirectory_result()
        result.read(iprot)
        iprot.readMessageEnd()
        if result.success is not None:
            return result.success
        if result.requestError is not None:
            raise result.requestError
        raise TApplicationException(TApplicationException.MISSING_RESULT, "getFilesInDirectory failed: unknown result")
...
class Processor(Iface, TProcessor):
    def __init__(self, handler):
        ...
        self._processMap["getFilesInDirectory"] = Processor.process_getFilesInDirectory
    ...
    def process_getFilesInDirectory(self, seqid, iprot, oprot):
        args = getFilesInDirectory_args()
        args.read(iprot)
        iprot.readMessageEnd()
        result = getFilesInDirectory_result()
        try:
            result.success = self._handler.getFilesInDirectory(args.parentDir)
            msg_type = TMessageType.REPLY
        except TTransport.TTransportException:
            raise
        except codechecker_api_shared.ttypes.RequestFailed as requestError:
            ...
            msg_type = TMessageType.EXCEPTION
            result = TApplicationException(TApplicationException.INTERNAL_ERROR, 'Internal error')
        oprot.writeMessageBegin("getFilesInDirectory", msg_type, seqid)
        result.write(oprot)
        oprot.writeMessageEnd()
        oprot.trans.flush()
...
class getFilesInDirectory_args(object):
    """
    Attributes:
     - parentDir
    """
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 1:
                if ftype == TType.STRING:
                    self.parentDir = iprot.readString().decode('utf-8') if sys.version_info[0] == 2 else iprot.readString()
                else:
                    iprot.skip(ftype)
            else:
                iprot.skip(ftype)
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('getFilesInDirectory_args')
        if self.parentDir is not None:
            oprot.writeFieldBegin('parentDir', TType.STRING, 1)
            oprot.writeString(self.parentDir.encode('utf-8') if sys.version_info[0] == 2 else self.parentDir)
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
        oprot.writeStructEnd()
    ...
    def __ne__(self, other):
        return not (self == other)
all_structs.append(getFilesInDirectory_args)
getFilesInDirectory_args.thrift_spec = (
    None,  # 0
    (1, TType.STRING, 'parentDir', 'UTF8', None, ),  # 1
)


class getFilesInDirectory_result(object):
    """
    Attributes:
     - success
     - requestError
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('getFilesInDirectory_result')
        if self.success is not None:
            oprot.writeFieldBegin('success', TType.LIST, 0)
            oprot.writeListBegin(TType.STRUCT, len(self.success))
    ...
    def __ne__(self, other):
        return not (self == other)
all_structs.append(getFilesInDirectory_result)
getFilesInDirectory_result.thrift_spec = (
    (0, TType.LIST, 'success', (TType.STRUCT, [File, None], False), None, ),  # 0
    (1, TType.STRUCT, 'requestError', [codechecker_api_shared.ttypes.RequestFailed, None], None, ),  # 1
)
