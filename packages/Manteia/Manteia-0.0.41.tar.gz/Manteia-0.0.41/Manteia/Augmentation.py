...
def pyramid(documents,labels,level=3):
	r"""
		This function compute pyramidal cut.
		...
		Args:
			...
			labels (:obj:`float`, optional, defaults to None):
				A list of labels.
			level (:obj:`int`, optional, defaults to 3)
		return
			documents_augmented (:obj:`list`, optional, defaults to None):
				A list of documents.
				
			labels_augmented (:obj:`float`, optional, defaults to None):
				A list of labels.

		Example::
			from Manteia.Dataset import Dataset
			from Manteia.Augmentation import pyramid

			ds=Dataset('drugscom')
			print(pyramid(ds.documents_train[0:1],ds.labels_train[0:1],level=3))
