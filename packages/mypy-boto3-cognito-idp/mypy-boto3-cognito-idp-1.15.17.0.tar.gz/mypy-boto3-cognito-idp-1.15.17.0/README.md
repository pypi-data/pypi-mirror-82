...
[boto3.CognitoIdentityProvider 1.15.17](https://boto3.amazonaws.com/v1/documentation/api/1.15.17/reference/services/cognito-idp.html#CognitoIdentityProvider) service
compatible with
