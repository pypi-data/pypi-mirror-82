...
casper.test.begin('Add-on Install', function(test) {
   ...
   /* submit form */
   casper.waitForSelector("form input[value='eea.zotero:default']",
       function success() {
           test.assertExists("form input[value='eea.zotero:default']", "eea.zotero check box is present");
           this.click("form input[value='eea.zotero:default']");
       },
       function fail() {
           test.assertExists("form input[value='eea.zotero:default']", "eea.zotero check box is present");
   });
