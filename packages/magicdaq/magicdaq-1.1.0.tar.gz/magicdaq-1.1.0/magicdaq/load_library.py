...
from loadlib import utils, DEFAULT_EXTENSION, IS_PYTHON2
    ...
    def __init__(self, path, libtype=None, **kwargs):
        ...
        **kwargs
        ...
        if libtype == 'cdll':
            ...
            raise IOError('Java files not supported. See load_library.py for more details.')

            # We do not want to include the py4j-wrapper.jar files in our distributed code, so we are
            # Removing the ability to import java libs
