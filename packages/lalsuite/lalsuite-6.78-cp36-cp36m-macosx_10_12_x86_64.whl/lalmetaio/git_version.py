...
id = "d1c1eecad9dae7ddb32bdc6367a155980783e120"
date = "2020-10-15 18:16:34 +0000"
branch = "None"
tag = "lalsuite-v6.78"
if tag == "None":
    tag = None
...
def check_match(foreign_id, onmismatch="raise"):
    ...
    if foreign_id == "d1c1eecad9dae7ddb32bdc6367a155980783e120":
        return
    msg = "Program id (d1c1eecad9dae7ddb32bdc6367a155980783e120) does not match given id (%s)." % foreign_id
    if onmismatch == "raise":
