...
id = "5ab512bcd10d410374cc8fddd9c5c3de4b7e3700"
date = "2020-10-9 08:26:54 +0000"
branch = "None"
tag = "None"
if tag == "None":
    tag = None
...
def check_match(foreign_id, onmismatch="raise"):
    ...
    if foreign_id == "5ab512bcd10d410374cc8fddd9c5c3de4b7e3700":
        return
    msg = "Program id (5ab512bcd10d410374cc8fddd9c5c3de4b7e3700) does not match given id (%s)." % foreign_id
    if onmismatch == "raise":
