...
def optimal_interpolation(*args):
    ...
    *Overload 1:*
    ...
    :type cross_validation_distance: float
...
def advection_implicit(y_dist, x_dist, dt):
    return _gridpp.advection_implicit(y_dist, x_dist, dt)
...
def init_ivec2(*args):
    ...
    return _gridpp.init_ivec2(*args)
...
def init_ivec3(*args):
    ...
    return _gridpp.init_ivec3(*args)
