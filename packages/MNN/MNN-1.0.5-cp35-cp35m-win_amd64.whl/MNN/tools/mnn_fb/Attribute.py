...
class Attribute(object):
    ...
    def Func(self):
        ...
        if o != 0:
            x = self._tab.Indirect(o + self._tab.Pos)
            from .NamedAttrList import NamedAttrList
            obj = NamedAttrList()
            obj.Init(self._tab.Bytes, x)
            return obj
        return None

def AttributeStart(builder): builder.StartObject(9)
...
def AttributeAddFunc(builder, func): builder.PrependUOffsetTRelativeSlot(8, flatbuffers.number_types.UOffsetTFlags.py_type(func), 0)
