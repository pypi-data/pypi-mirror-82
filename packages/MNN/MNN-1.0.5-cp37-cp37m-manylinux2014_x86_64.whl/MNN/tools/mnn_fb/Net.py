...
class Net(object):
    ...
    def Subgraphs(self, j):
        ...
        if o != 0:
            ...
            x += flatbuffers.number_types.UOffsetTFlags.py_type(j) * 4
            x = self._tab.Indirect(x)
            from .SubGraphProto import SubGraphProto
            obj = SubGraphProto()
            obj.Init(self._tab.Bytes, x)
            return obj
        return None
...
def NetStart(builder): builder.StartObject(11)
...
def NetAddSubgraphs(builder, subgraphs): builder.PrependUOffsetTRelativeSlot(10, flatbuffers.number_types.UOffsetTFlags.py_type(subgraphs), 0)
def NetStartSubgraphsVector(builder, numElems): return builder.StartVector(4, numElems, 4)
