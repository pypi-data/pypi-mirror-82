...
def usage():
    ...
    print("    [--saveInt8Weights {True,False}]")
...
def main():
    ...
    parser.add_argument("--saveInt8Weights", type=bool, default=False)
    ...
    Tools.mnnconvert(args.MNNModel, args. modelFile, framework_type,\
        args.fp16, args.prototxt, args.saveInt8Weights, args.compressionParamsFile)
    return 0
