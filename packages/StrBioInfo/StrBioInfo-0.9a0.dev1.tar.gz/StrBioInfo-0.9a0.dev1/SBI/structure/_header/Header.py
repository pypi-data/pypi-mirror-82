...
class PDBHeader(JSONer):
    ...
    @property
    def keywords(self):  # DONE
        return self._keywords

    @property
    def experiment(self):  # DONE
    ...
    @property
    def resolution(self):  # DONE
        return self.experiment.resolution

    @property
    def rfactor(self):  # DONE
