...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'gcp', '3.26.0-alpha.1602691780+f1f6f03c'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource gcp 3.26.0-alpha.1602691780+f1f6f03c`
                """)
            else:
                raise
