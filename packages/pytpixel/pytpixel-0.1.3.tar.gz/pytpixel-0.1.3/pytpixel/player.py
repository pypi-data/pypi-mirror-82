...
class User:
    ...
    def get_info(self, item, rewards_object=None, voting_object=None, links_object=None):
        ...
        self.rank = self.user_data['rank']
        self.rank_plus_color = self.user_data['rank_plus_color']
        self.rank_formatted = self.user_data['rank_formatted']
        self.prefix = self.user_data['prefix']
        self.karma = self.user_data['karma']
        self.exp = self.user_data['exp']
        self.level = self.user_data['level']
        self.achievement_points = self.user_data['achievement_points']
        self.quests_completed = self.user_data['quests_completed']
        self.total_kills = self.user_data['total_kills']
        self.total_wins = self.user_data['total_wins']
        self.coins = self.user_data['total_coins']
        self.mc_version = self.user_data['mc_version']
        self.first_login = datetime.datetime.fromtimestamp(round(self.user_data['first_login']/1000))
        self.last_login = datetime.datetime.fromtimestamp(round(self.user_data['last_login']/1000))
        self.last_logout = datetime.datetime.fromtimestamp(round(self.user_data['last_logout']/1000))
        self.last_game = self.user_data['last_game']
        self.language = self.user_data['language']
        self.gifts_sent = self.user_data['gifts_sent']
        self.gifts_received = self.user_data['gifts_received']
        self.contributor = self.user_data['is_contributor']
