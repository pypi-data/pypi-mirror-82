...
def emotion (ask, url) :
  ...
  if inp == 100:
    ...
    print("Sorry I don't know about" + inp + " ,but I am Curious about it Can you please tell me, How you feel about it? (give the answer in 'angry','sad','scared','excited','happy','h-cited','nothing' : ")
    emotion.l = 'enter'
    if l == 'angry':
      kit = 4
      print('Thanks!')
