...
class UserDatagramProtocol:
    ...
    def __copy__(self) -> 'UserDatagramProtocol':
        new_udp_packet = UserDatagramProtocol(self.internet_protocol)
        new_udp_packet.source_port = self.source_port
        new_udp_packet.destination_port = self.destination_port
        new_udp_packet.total_length = self.total_length
        new_udp_packet.checksum = self.checksum
        new_udp_packet.data = self.data
        return new_udp_packet
