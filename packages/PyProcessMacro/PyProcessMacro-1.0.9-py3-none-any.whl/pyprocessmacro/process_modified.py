...
class Process(object):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        #print("self._symb_to_var: ", self._symb_to_var) #####
        ...
        #print("_equations: ", self._equations)  #####
        ...
        #print("self._symb_to_ind: ", self._symb_to_ind)  #####
    ...
    def _gen_var_mapping(self, var_kwargs):
        ...
        for key, varnames in var_kwargs.items():
            if (key == "m") & (self.model_num > 3):  # Variable m is a mediator
                #print("_gene_var_mapping(): key-varnames", key, varnames)  #####
