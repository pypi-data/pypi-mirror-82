...
module_dir = os.path.join(__location__, "../src/mbf_sampledata")
try:
...
try:
    from mbf_sampledata import __version__ as version
except ImportError:
    pass
else:
    release = version
...
htmlhelp_basename = 'mbf_sampledata-doc'
...
latex_documents = [
  ('index', 'user_guide.tex', u'mbf_sampledata Documentation',
...
def setup(app):
    ...
    github_doc_root = "https://github.com/TyberiusPrime/mbf_sampledata"
