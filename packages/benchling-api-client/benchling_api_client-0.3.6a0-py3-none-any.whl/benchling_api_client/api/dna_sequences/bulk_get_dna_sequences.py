...
def _get_kwargs(
    *,
    ...
    if dna_sequence_ids is None:
        json_dna_sequence_ids = None
    else:
        json_dna_sequence_ids = dna_sequence_ids

    params: Dict[str, Any] = {}
    if dna_sequence_ids is not None:
        params["dnaSequenceIds"] = json_dna_sequence_ids
