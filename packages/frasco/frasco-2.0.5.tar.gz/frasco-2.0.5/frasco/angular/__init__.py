...
class FrascoAngular(Extension):
    ...
    @ext_stateful_method
    def build_templates(self, state, templates_dir=None, static_url_path=None):
        module = [("/* This file is auto-generated by frasco-angular. DO NOT MODIFY. */\n'use strict';\n"
        ...
        if not templates_dir:
            templates_dir = os.path.join(state.options["static_dir"], state.options['app_dir'])
        if not static_url_path:
            static_url_path = state.options["static_url_path"]
        ...
        def process_file(filename, path=None, content=None):
            ...
            relpath = os.path.relpath(path, templates_dir or state.options["static_dir"])
            relname = "/".join([p for p in [static_url_path, relpath, filename] if p])
