...
class AppyxHttpHandler(APIView):
    ...
    def handle_get(self, request, **kwargs):
        command = self._get_command_for_GET(request, kwargs)
    ...
    def handle_post(self, request, **kwargs):
        try:
            ...
            command = self._get_command_for_POST(request, kwargs)
            result = command.execute()
            response = self._response_for(result)
            self._notify_post_request(request, command, result)
            return response
    ...
    def _get_command_for_GET(self, request, kwargs):
        raise NotImplementedError('Subclass responsibility')
    ...
    def _get_command_for_POST(self, request, kwargs):
        raise NotImplementedError('Subclass responsibility')
    ...
    def _notify_post_request(self, request, command, result):
        """
