...
class RedisCache:
    ...
    def put_value_in_hash_set(self, redis_key: str, _hash_key: str, _hash_value: str):
        ...
        if redis_connection:
            try:
                ...
                self.exception(e, "RedisCache->put_value_in_hash_set()->>")
    ...
    @classmethod
    def exception(cls, e, log_message: str = "", can_print_stacktrace: bool = False):
        logger.error("%s, ExceptionMessage:%s", log_message, cls.get_exception_msg(e), exc_info=can_print_stacktrace)

    @classmethod
    def get_exception_msg(cls, e) -> str:
        try:
