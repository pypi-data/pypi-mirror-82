...
Source0: http://resources.ovirt.org/pub/src/ovirt-ansible-collection/ovirt-ansible-collection-1.1.4.tar.gz
...
%changelog
* Wed Sep 16 2020 Martin Necas <mnecas@redhat.com> - 1.1.4-1
- Fix ovirt inventory close of connection
