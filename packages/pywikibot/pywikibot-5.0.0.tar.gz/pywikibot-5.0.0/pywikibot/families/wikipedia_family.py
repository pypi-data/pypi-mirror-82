...
class Family(family.SubdomainFamily, family.WikimediaFamily):
    ...
    languages_by_size = [
        ...
        'hr', 'et', 'lt', 'be', 'el', 'simple', 'az', 'tt', 'sl', 'gl', 'ur',
        ...
        'cv', 'lmo', 'sco', 'wuu', 'an', 'diq', 'pa', 'ku', 'ne', 'yo', 'bar',
        ...
        'mrj', 'mhr', 'avk', 'gor', 'hif', 'hak', 'roa-tara', 'pam', 'hyw',
        'km', 'nso', 'rue', 'crh', 'se', 'as', 'bh', 'shn', 'vls', 'mi',
        'nds-nl', 'nah', 'sc', 'vep', 'gan', 'myv', 'sn', 'ab', 'glk', 'lrc',
        'bo', 'so', 'co', 'tk', 'fiu-vro', 'ha', 'csb', 'kv', 'ie', 'gv',
        'udm', 'pcd', 'ay', 'kab', 'zea', 'sat', 'nrm', 'zu', 'ug', 'lij',
        'kw', 'ban', 'frp', 'lez', 'lfn', 'stq', 'gn', 'mwl', 'gom', 'rm',
        'mt', 'lo', 'lad', 'koi', 'olo', 'fur', 'ang', 'dty', 'dsb', 'bjn',
        'ext', 'ln', 'cbk-zam', 'dv', 'ksh', 'tyv', 'ary', 'gag', 'pfl', 'pag',
        'pi', 'av', 'awa', 'haw', 'bxr', 'xal', 'krc', 'pap', 'za', 'rw',
        'pdc', 'kaa', 'ak', 'szy', 'arc', 'to', 'nov', 'jam', 'tpi', 'kbp',
        'kbd', 'ig', 'inh', 'na', 'tet', 'wo', 'tcy', 'ki', 'lld', 'atj',
        'jbo', 'bi', 'roa-rup', 'lbe', 'kg', 'ty', 'lg', 'mdf', 'fj', 'srn',
        'xh', 'gcr', 'ltg', 'chr', 'sm', 'om', 'kl', 'got', 'pih', 'st', 'ny',
        'cu', 'nqo', 'tn', 'tw', 'ts', 'mnw', 'rmy', 'bm', 'chy', 'rn', 'tum',
        'ss', 'ch', 'iu', 'pnt', 'ks', 'ady', 've', 'ee', 'ik', 'ff', 'sg',
        'din', 'dz', 'ti', 'cr', 'smn',
    ]
