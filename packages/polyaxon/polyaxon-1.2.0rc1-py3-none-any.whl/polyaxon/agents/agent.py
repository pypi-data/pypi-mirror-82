...
class Agent(BaseAgent):
    ...
    def sync(self):
        self.client.agents_v1.sync_agent(
            ...
            body=V1Agent(content=settings.AGENT_CONFIG.to_sync_dict()),
        )

    def sync_compatible_updates(self, compatible_updates: Dict):
        if compatible_updates and settings.AGENT_CONFIG and settings.AGENT_CONFIG.compatible_updates:
            ...
            if sidecar:
                ...
                settings.AGENT_CONFIG.sidecar = settings.AGENT_CONFIG.sidecar.patch(sidecar)
