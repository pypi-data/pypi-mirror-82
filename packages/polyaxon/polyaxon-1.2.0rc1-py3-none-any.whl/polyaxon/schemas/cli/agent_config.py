...
from polyaxon.env_vars.keys import (
    ...
    POLYAXON_KEYS_AGENT_COMPATIBLE_UPDATES,
...
class AgentSchema(BaseSchema):
    ...
    compatible_updates = fields.Str(
        allow_none=True,
        data_key=POLYAXON_KEYS_AGENT_COMPATIBLE_UPDATES
    )
...
class AgentConfig(BaseConfig):
    ...
    def to_sync_dict(self):
        ...
        obj_dict[POLYAXON_KEYS_API_VERSION] = pkg.VERSION
