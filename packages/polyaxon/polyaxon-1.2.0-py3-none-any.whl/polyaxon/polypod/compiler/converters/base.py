...
from polyaxon.polypod.common.env_vars import get_base_env_vars, get_env_var, get_service_env_vars
...
class BaseConverter(ConverterAbstract):
    ...
    def get_replica_resource(
        ...
        environment.service_account_name = (
            environment.service_account_name or default_sa or settings.AGENT_CONFIG.runs_sa
        )
