...
class ModelExporter(object):
    ...
    def predict_by_model(self, model_path, path_to_predict=None, records=None, features=None, 
        ...
        return ModelHelper.save_prediction(ds, prediction_id, 
            ...
            model_path, options.get('uid'), gzip_predict_file=gzip_predict_file,
            prediction_id_col=prediction_id_col, model_features=data_features)    
