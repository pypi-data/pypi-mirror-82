...
class ModelHelper(object):
    ...
    def save_prediction(ds, prediction_id, support_review_model, 
        ...
        gzip_predict_file=False, prediction_id_col=None,model_features=None):
        ...
        return ModelHelper.save_prediction_result(ds, prediction_id, support_review_model, 
            json_result, count_in_result, prediction_date, model_path, model_id, output=output, 
        ...
        if support_review_model:
            ...
            if model_features:
                try:
                    ...
                    #timeseries does not include features in predict result
                    pass
