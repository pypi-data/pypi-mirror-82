...
class AssetManager(TdxManager, TdxAppMixin, TdxCustomAttributeMixin):
    ...
    def add_comment(
        self, asset_id: int, comment: str, notify: Optional[List[str]] = None
    ) -> ItemUpdate:
        ...
        return self.dispatcher.send(
            ...
            self.add_comment.url.format(appId=self.app_id, id=asset_id),
    ...
    def add_resource(self, asset_id: int, resource_id: str) -> ResourceItem:
    ...
    def remove_resource(self, asset_id: int, resource_id: str) -> None:
    ...
    def add_to_ticket(self, asset_id: int, ticket_id: int) -> None:
    ...
    def remove_from_ticket(self, asset_id: int, ticket_id: int) -> None:
