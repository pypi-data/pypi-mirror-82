...
setup(
  ...
  packages = ['DataProduct','conection','entity'],   # Chose the same as "name"
  version = '0.11',      # Start with a small number and increase it with every change you make
  license='MIT',
  include_package_data=True,        # Chose a license from here: https://help.github.com/articles/licensing-a-repository
  ...
  download_url = 'https://github.com/rwkama/crudproductpython/archive/v_06.tar.gz',    # I explain this later on
