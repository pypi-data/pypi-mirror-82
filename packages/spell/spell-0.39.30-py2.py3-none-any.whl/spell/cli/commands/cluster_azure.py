...
def create_azure(ctx, name, resource_group_name, service_principal_name):
    ...
    create_and_assign_role(
        management_cred, subscription_id, authorization_client, resource_group.id, sp_object_id
    )
...
def create_and_assign_role(credentials, subscription_id, authorization_client, group_id, object_id):
