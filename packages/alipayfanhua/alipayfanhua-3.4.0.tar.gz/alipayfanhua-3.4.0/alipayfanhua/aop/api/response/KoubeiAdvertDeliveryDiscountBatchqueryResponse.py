...
from alipayfanhua.aop.api.domain.DiscountInfo import DiscountInfo
from alipayfanhua.aop.api.domain.KbAdvertIdentifyResponse import KbAdvertIdentifyResponse
