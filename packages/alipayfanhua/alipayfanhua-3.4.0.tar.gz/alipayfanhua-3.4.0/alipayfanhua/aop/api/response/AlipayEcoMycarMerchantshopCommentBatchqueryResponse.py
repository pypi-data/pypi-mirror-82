...
from alipayfanhua.aop.api.domain.MerchantshopCommentResult import MerchantshopCommentResult
from alipayfanhua.aop.api.domain.MerchantshopCommentStatistic import MerchantshopCommentStatistic
