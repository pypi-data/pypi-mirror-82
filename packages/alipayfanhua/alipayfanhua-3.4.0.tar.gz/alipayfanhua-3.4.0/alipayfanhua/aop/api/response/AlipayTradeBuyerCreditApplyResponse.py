...
class AlipayTradeBuyerCreditApplyResponse(AlipayResponse):

    def __init__(self):
        super(AlipayTradeBuyerCreditApplyResponse, self).__init__()
    ...
    def parse_response_content(self, response_content):
        response = super(AlipayTradeBuyerCreditApplyResponse, self).parse_response_content(response_content)
