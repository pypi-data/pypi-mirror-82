...
class ZhimaDataStateDataSyncResponse(AlipayResponse):

    def __init__(self):
        super(ZhimaDataStateDataSyncResponse, self).__init__()
    ...
    def parse_response_content(self, response_content):
        response = super(ZhimaDataStateDataSyncResponse, self).parse_response_content(response_content)
