...
from alipayfanhua.aop.api.domain.MiniAppCategoryInfo import MiniAppCategoryInfo
from alipayfanhua.aop.api.domain.MiniPackageInfo import MiniPackageInfo
from alipayfanhua.aop.api.domain.RegionInfo import RegionInfo
