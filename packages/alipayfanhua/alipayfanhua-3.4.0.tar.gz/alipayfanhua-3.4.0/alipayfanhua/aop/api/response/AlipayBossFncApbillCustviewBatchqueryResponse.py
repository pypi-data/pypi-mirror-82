...
from alipayfanhua.aop.api.domain.ApMonthlyBillCustOpenApiResponse import ApMonthlyBillCustOpenApiResponse


class AlipayBossFncApbillCustviewBatchqueryResponse(AlipayResponse):

    def __init__(self):
        super(AlipayBossFncApbillCustviewBatchqueryResponse, self).__init__()
    ...
    def parse_response_content(self, response_content):
        response = super(AlipayBossFncApbillCustviewBatchqueryResponse, self).parse_response_content(response_content)
