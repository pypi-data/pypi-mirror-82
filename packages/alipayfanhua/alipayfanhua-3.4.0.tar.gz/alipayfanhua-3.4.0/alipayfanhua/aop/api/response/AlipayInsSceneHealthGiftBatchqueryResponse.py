...
from alipayfanhua.aop.api.domain.InsHealthGainFlowResult import InsHealthGainFlowResult
from alipayfanhua.aop.api.domain.InsHealthGiftBatchAlreadyOpenedResult import InsHealthGiftBatchAlreadyOpenedResult
from alipayfanhua.aop.api.domain.InsHealthGiftBatchGainSumInsuredResult import InsHealthGiftBatchGainSumInsuredResult
from alipayfanhua.aop.api.domain.InsHealthGiftBatchMySumInsuredResult import InsHealthGiftBatchMySumInsuredResult
from alipayfanhua.aop.api.domain.InsHealthGiftBatchValidGiftResult import InsHealthGiftBatchValidGiftResult
from alipayfanhua.aop.api.domain.InsHealthSendFlowResult import InsHealthSendFlowResult
