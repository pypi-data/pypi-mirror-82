...
class AlipayTradeCreditApplyQueryResponse(AlipayResponse):

    def __init__(self):
        super(AlipayTradeCreditApplyQueryResponse, self).__init__()
    ...
    def parse_response_content(self, response_content):
        response = super(AlipayTradeCreditApplyQueryResponse, self).parse_response_content(response_content)
