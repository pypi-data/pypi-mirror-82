...
class AlipayTradeBuyerCreditCloseResponse(AlipayResponse):

    def __init__(self):
        super(AlipayTradeBuyerCreditCloseResponse, self).__init__()
    ...
    def parse_response_content(self, response_content):
        response = super(AlipayTradeBuyerCreditCloseResponse, self).parse_response_content(response_content)
