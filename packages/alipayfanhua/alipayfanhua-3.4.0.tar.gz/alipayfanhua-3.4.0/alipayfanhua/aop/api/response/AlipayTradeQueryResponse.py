...
from alipayfanhua.aop.api.domain.TradeFundBill import TradeFundBill
from alipayfanhua.aop.api.domain.TradeSettleInfo import TradeSettleInfo
from alipayfanhua.aop.api.domain.VoucherDetail import VoucherDetail
