...
from alipayfanhua.aop.api.domain.BoothContentInfoModel import BoothContentInfoModel
from alipayfanhua.aop.api.domain.OperationExtDataModel import OperationExtDataModel
