...
from alipayfanhua.aop.api.domain.TradeItemResult import TradeItemResult


class AlipayDataBillBuyQueryResponse(AlipayResponse):

    def __init__(self):
        super(AlipayDataBillBuyQueryResponse, self).__init__()
    ...
    def parse_response_content(self, response_content):
        response = super(AlipayDataBillBuyQueryResponse, self).parse_response_content(response_content)
