...
class AlipayTradeBuyerCreditConfirmResponse(AlipayResponse):

    def __init__(self):
        super(AlipayTradeBuyerCreditConfirmResponse, self).__init__()
    ...
    def parse_response_content(self, response_content):
        response = super(AlipayTradeBuyerCreditConfirmResponse, self).parse_response_content(response_content)
