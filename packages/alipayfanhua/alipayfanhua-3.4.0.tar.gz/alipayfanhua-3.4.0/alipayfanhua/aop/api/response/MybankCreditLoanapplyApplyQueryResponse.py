...
from alipayfanhua.aop.api.domain.ApproveCreditResult import ApproveCreditResult
from alipayfanhua.aop.api.domain.InvestigCategoryResult import InvestigCategoryResult
