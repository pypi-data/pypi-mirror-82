...
from alipayfanhua.aop.api.domain.InsMktPreUseCampaignDTO import InsMktPreUseCampaignDTO
from alipayfanhua.aop.api.domain.InsMktPreUseCouponDTO import InsMktPreUseCouponDTO
