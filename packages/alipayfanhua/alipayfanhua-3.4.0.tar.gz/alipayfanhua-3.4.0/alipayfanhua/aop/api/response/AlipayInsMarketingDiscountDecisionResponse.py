...
from alipayfanhua.aop.api.domain.InsMktCouponCampaignDTO import InsMktCouponCampaignDTO
from alipayfanhua.aop.api.domain.InsMktCouponDTO import InsMktCouponDTO
