...
class MybankPaymentTradeNormalpayOrderCreateandpayResponse(AlipayResponse):

    def __init__(self):
        super(MybankPaymentTradeNormalpayOrderCreateandpayResponse, self).__init__()
        self._order_no = None
    ...
    def parse_response_content(self, response_content):
        response = super(MybankPaymentTradeNormalpayOrderCreateandpayResponse, self).parse_response_content(response_content)
