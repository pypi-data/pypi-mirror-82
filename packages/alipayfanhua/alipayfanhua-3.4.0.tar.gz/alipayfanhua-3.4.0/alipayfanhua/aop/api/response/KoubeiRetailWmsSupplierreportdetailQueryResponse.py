...
from alipayfanhua.aop.api.domain.SupplierReport import SupplierReport
from alipayfanhua.aop.api.domain.SupplierReportDetail import SupplierReportDetail
