...
from alipayfanhua.aop.api.domain.CustScpBillAmtVO import CustScpBillAmtVO
from alipayfanhua.aop.api.domain.CustScpInstallmentBudgetVO import CustScpInstallmentBudgetVO
