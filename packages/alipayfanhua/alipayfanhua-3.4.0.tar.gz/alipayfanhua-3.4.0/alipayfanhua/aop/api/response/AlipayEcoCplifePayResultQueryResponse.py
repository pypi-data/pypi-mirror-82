...
from alipayfanhua.aop.api.domain.TradeAssocBillDetails import TradeAssocBillDetails
from alipayfanhua.aop.api.domain.FundBillListEco import FundBillListEco
