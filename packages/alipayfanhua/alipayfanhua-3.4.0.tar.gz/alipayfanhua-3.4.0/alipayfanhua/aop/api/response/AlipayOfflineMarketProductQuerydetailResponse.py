...
from alipayfanhua.aop.api.domain.AlipayDataItemSalesRule import AlipayDataItemSalesRule
from alipayfanhua.aop.api.domain.AlipayDataItemVoucherTemplete import AlipayDataItemVoucherTemplete
