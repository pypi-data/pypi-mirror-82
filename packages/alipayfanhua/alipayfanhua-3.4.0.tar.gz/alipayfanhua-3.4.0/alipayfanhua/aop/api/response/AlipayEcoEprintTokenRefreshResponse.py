...
class AlipayEcoEprintTokenRefreshResponse(AlipayResponse):

    def __init__(self):
        super(AlipayEcoEprintTokenRefreshResponse, self).__init__()
    ...
    def parse_response_content(self, response_content):
        response = super(AlipayEcoEprintTokenRefreshResponse, self).parse_response_content(response_content)
