...
from alipayfanhua.aop.api.domain.TradePrecreateConfirmIndirectMerchantInfo import TradePrecreateConfirmIndirectMerchantInfo
from alipayfanhua.aop.api.domain.TradePrecreateConfirmTradeMerchantInfo import TradePrecreateConfirmTradeMerchantInfo
from alipayfanhua.aop.api.domain.TradePrecreateConfirmOrderInfo import TradePrecreateConfirmOrderInfo
from alipayfanhua.aop.api.domain.TradePrecreateConfirmPrecreateCodeInfo import TradePrecreateConfirmPrecreateCodeInfo
from alipayfanhua.aop.api.domain.TradePrecreateConfirmTradeStoreInfo import TradePrecreateConfirmTradeStoreInfo
