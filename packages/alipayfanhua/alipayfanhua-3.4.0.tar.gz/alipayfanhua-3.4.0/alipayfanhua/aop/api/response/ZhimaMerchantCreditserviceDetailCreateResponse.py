...
class ZhimaMerchantCreditserviceDetailCreateResponse(AlipayResponse):

    def __init__(self):
        super(ZhimaMerchantCreditserviceDetailCreateResponse, self).__init__()
    ...
    def parse_response_content(self, response_content):
        response = super(ZhimaMerchantCreditserviceDetailCreateResponse, self).parse_response_content(response_content)
