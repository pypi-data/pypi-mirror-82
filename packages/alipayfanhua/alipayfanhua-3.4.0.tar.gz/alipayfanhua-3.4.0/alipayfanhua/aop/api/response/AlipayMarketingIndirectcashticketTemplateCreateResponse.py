...
class AlipayMarketingIndirectcashticketTemplateCreateResponse(AlipayResponse):

    def __init__(self):
        super(AlipayMarketingIndirectcashticketTemplateCreateResponse, self).__init__()
    ...
    def parse_response_content(self, response_content):
        response = super(AlipayMarketingIndirectcashticketTemplateCreateResponse, self).parse_response_content(response_content)
