...
from alipayfanhua.aop.api.domain.MyBkAccountVO import MyBkAccountVO
from alipayfanhua.aop.api.domain.LoanChargeInfo import LoanChargeInfo
from alipayfanhua.aop.api.domain.InstallmentValue import InstallmentValue
