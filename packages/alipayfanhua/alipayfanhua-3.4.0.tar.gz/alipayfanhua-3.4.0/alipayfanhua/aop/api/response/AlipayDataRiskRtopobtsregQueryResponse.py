...
class AlipayDataRiskRtopobtsregQueryResponse(AlipayResponse):

    def __init__(self):
        super(AlipayDataRiskRtopobtsregQueryResponse, self).__init__()
    ...
    def parse_response_content(self, response_content):
        response = super(AlipayDataRiskRtopobtsregQueryResponse, self).parse_response_content(response_content)
