...
class AlipayMarketingCashticketTemplateCreateResponse(AlipayResponse):

    def __init__(self):
        super(AlipayMarketingCashticketTemplateCreateResponse, self).__init__()
    ...
    def parse_response_content(self, response_content):
        response = super(AlipayMarketingCashticketTemplateCreateResponse, self).parse_response_content(response_content)
