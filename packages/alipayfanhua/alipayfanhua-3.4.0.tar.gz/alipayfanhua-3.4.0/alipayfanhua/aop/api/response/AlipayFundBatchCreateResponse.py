...
class AlipayFundBatchCreateResponse(AlipayResponse):

    def __init__(self):
        super(AlipayFundBatchCreateResponse, self).__init__()
    ...
    def parse_response_content(self, response_content):
        response = super(AlipayFundBatchCreateResponse, self).parse_response_content(response_content)
