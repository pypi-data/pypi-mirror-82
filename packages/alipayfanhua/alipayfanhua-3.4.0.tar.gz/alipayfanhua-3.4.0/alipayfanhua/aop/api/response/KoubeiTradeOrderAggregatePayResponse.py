...
class KoubeiTradeOrderAggregatePayResponse(AlipayResponse):

    def __init__(self):
        super(KoubeiTradeOrderAggregatePayResponse, self).__init__()
        self._buyer_id = None
    ...
    def parse_response_content(self, response_content):
        response = super(KoubeiTradeOrderAggregatePayResponse, self).parse_response_content(response_content)
