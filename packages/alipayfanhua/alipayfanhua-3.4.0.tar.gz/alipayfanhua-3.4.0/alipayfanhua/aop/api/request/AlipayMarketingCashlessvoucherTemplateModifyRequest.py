...
from alipayfanhua.aop.api.domain.AlipayMarketingCashlessvoucherTemplateModifyModel import AlipayMarketingCashlessvoucherTemplateModifyModel
...
class AlipayMarketingCashlessvoucherTemplateModifyRequest(object):
    ...
    def get_params(self):
        params = dict()
        params[P_METHOD] = 'alipayfanhuamarketing.cashlessvoucher.template.modify'
