...
from alipayfanhua.aop.api.domain.AlipayPcreditHuabeiAuthSettleApplyModel import AlipayPcreditHuabeiAuthSettleApplyModel
...
class AlipayPcreditHuabeiAuthSettleApplyRequest(object):
    ...
    def get_params(self):
        params = dict()
        params[P_METHOD] = 'alipayfanhuapcredit.huabei.auth.settle.apply'
