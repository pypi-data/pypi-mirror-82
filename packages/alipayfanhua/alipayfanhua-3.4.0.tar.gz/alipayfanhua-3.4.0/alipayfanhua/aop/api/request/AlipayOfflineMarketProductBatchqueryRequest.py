...
from alipayfanhua.aop.api.domain.AlipayOfflineMarketProductBatchqueryModel import AlipayOfflineMarketProductBatchqueryModel
...
class AlipayOfflineMarketProductBatchqueryRequest(object):
    ...
    def get_params(self):
        params = dict()
        params[P_METHOD] = 'alipayfanhuaoffline.market.product.batchquery'
