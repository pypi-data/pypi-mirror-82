...
from alipayfanhua.aop.api.domain.AlipayEcoRenthouseRoomStateSyncModel import AlipayEcoRenthouseRoomStateSyncModel
...
class AlipayEcoRenthouseRoomStateSyncRequest(object):
    ...
    def get_params(self):
        params = dict()
        params[P_METHOD] = 'alipayfanhuaeco.renthouse.room.state.sync'
