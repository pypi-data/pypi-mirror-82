...
from alipayfanhua.aop.api.domain.AlipayInsSceneApplicationQueryModel import AlipayInsSceneApplicationQueryModel
...
class AlipayInsSceneApplicationQueryRequest(object):
    ...
    def get_params(self):
        params = dict()
        params[P_METHOD] = 'alipayfanhuains.scene.application.query'
