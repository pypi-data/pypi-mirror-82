...
from alipayfanhua.aop.api.domain.AlipayMarketingCampaignDiscountBudgetAppendModel import AlipayMarketingCampaignDiscountBudgetAppendModel
...
class AlipayMarketingCampaignDiscountBudgetAppendRequest(object):
    ...
    def get_params(self):
        params = dict()
        params[P_METHOD] = 'alipayfanhuamarketing.campaign.discount.budget.append'
