...
from alipayfanhua.aop.api.domain.AlipayOpenMiniDeploypackageQueryModel import AlipayOpenMiniDeploypackageQueryModel
...
class AlipayOpenMiniDeploypackageQueryRequest(object):
    ...
    def get_params(self):
        params = dict()
        params[P_METHOD] = 'alipayfanhuaopen.mini.deploypackage.query'
