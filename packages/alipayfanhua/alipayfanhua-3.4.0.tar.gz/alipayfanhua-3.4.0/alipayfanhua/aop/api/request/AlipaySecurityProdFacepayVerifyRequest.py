...
from alipayfanhua.aop.api.domain.AlipaySecurityProdFacepayVerifyModel import AlipaySecurityProdFacepayVerifyModel
...
class AlipaySecurityProdFacepayVerifyRequest(object):
    ...
    def get_params(self):
        params = dict()
        params[P_METHOD] = 'alipayfanhuasecurity.prod.facepay.verify'
