...
from alipayfanhua.aop.api.domain.AlipayBusinessOrderCreateModel import AlipayBusinessOrderCreateModel
...
class AlipayBusinessOrderCreateRequest(object):
    ...
    def get_params(self):
        params = dict()
        params[P_METHOD] = 'alipayfanhuabusiness.order.create'
