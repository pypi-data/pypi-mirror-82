...
from alipayfanhua.aop.api.domain.AlipayEbppJfexportBillCreateModel import AlipayEbppJfexportBillCreateModel
...
class AlipayEbppJfexportBillCreateRequest(object):
    ...
    def get_params(self):
        params = dict()
        params[P_METHOD] = 'alipayfanhuaebpp.jfexport.bill.create'
