...
from alipayfanhua.aop.api.domain.AlipayCommerceIotDapplyOrderdeviceQueryModel import AlipayCommerceIotDapplyOrderdeviceQueryModel
...
class AlipayCommerceIotDapplyOrderdeviceQueryRequest(object):
    ...
    def get_params(self):
        params = dict()
        params[P_METHOD] = 'alipayfanhuacommerce.iot.dapply.orderdevice.query'
