...
from alipayfanhua.aop.api.domain.AlipayCommerceLotteryPresentlistQueryModel import AlipayCommerceLotteryPresentlistQueryModel
...
class AlipayCommerceLotteryPresentlistQueryRequest(object):
    ...
    def get_params(self):
        params = dict()
        params[P_METHOD] = 'alipayfanhuacommerce.lottery.presentlist.query'
