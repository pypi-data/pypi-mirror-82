...
from alipayfanhua.aop.api.domain.AlipayOpenPublicLifeaccountCreateModel import AlipayOpenPublicLifeaccountCreateModel
...
class AlipayOpenPublicLifeaccountCreateRequest(object):
    ...
    def get_params(self):
        params = dict()
        params[P_METHOD] = 'alipayfanhuaopen.public.lifeaccount.create'
