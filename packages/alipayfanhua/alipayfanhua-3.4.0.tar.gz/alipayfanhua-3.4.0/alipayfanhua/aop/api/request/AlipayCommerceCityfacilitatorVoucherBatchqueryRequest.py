...
from alipayfanhua.aop.api.domain.AlipayCommerceCityfacilitatorVoucherBatchqueryModel import AlipayCommerceCityfacilitatorVoucherBatchqueryModel
...
class AlipayCommerceCityfacilitatorVoucherBatchqueryRequest(object):
    ...
    def get_params(self):
        params = dict()
        params[P_METHOD] = 'alipayfanhuacommerce.cityfacilitator.voucher.batchquery'
