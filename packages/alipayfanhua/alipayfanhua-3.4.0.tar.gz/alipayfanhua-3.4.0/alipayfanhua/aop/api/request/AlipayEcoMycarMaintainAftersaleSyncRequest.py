...
from alipayfanhua.aop.api.domain.AlipayEcoMycarMaintainAftersaleSyncModel import AlipayEcoMycarMaintainAftersaleSyncModel
...
class AlipayEcoMycarMaintainAftersaleSyncRequest(object):
    ...
    def get_params(self):
        params = dict()
        params[P_METHOD] = 'alipayfanhuaeco.mycar.maintain.aftersale.sync'
