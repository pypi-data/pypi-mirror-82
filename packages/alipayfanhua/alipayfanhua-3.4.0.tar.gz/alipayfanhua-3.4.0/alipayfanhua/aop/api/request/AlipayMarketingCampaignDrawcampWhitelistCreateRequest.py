...
from alipayfanhua.aop.api.domain.AlipayMarketingCampaignDrawcampWhitelistCreateModel import AlipayMarketingCampaignDrawcampWhitelistCreateModel
...
class AlipayMarketingCampaignDrawcampWhitelistCreateRequest(object):
    ...
    def get_params(self):
        params = dict()
        params[P_METHOD] = 'alipayfanhuamarketing.campaign.drawcamp.whitelist.create'
