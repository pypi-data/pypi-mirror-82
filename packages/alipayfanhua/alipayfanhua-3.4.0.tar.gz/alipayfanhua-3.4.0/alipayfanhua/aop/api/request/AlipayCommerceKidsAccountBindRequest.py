...
from alipayfanhua.aop.api.domain.AlipayCommerceKidsAccountBindModel import AlipayCommerceKidsAccountBindModel
...
class AlipayCommerceKidsAccountBindRequest(object):
    ...
    def get_params(self):
        params = dict()
        params[P_METHOD] = 'alipayfanhuacommerce.kids.account.bind'
