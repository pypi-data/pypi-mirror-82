...
from alipayfanhua.aop.api.domain.AlipayMarketingCampaignDiscountStatusUpdateModel import AlipayMarketingCampaignDiscountStatusUpdateModel
...
class AlipayMarketingCampaignDiscountStatusUpdateRequest(object):
    ...
    def get_params(self):
        params = dict()
        params[P_METHOD] = 'alipayfanhuamarketing.campaign.discount.status.update'
