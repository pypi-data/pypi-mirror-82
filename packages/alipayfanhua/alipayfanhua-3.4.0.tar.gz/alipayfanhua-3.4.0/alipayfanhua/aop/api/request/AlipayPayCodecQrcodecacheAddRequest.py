...
from alipayfanhua.aop.api.domain.AlipayPayCodecQrcodecacheAddModel import AlipayPayCodecQrcodecacheAddModel
...
class AlipayPayCodecQrcodecacheAddRequest(object):
    ...
    def get_params(self):
        params = dict()
        params[P_METHOD] = 'alipayfanhuapay.codec.qrcodecache.add'
