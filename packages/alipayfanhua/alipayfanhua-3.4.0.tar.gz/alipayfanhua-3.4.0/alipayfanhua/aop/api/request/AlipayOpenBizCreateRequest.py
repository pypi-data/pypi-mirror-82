...
from alipayfanhua.aop.api.domain.Gavintest import Gavintest
from alipayfanhua.aop.api.domain.GavintestNewLeveaOne import GavintestNewLeveaOne
...
class AlipayOpenBizCreateRequest(object):
    ...
    def get_params(self):
        params = dict()
        params[P_METHOD] = 'alipayfanhuaopen.biz.create'
