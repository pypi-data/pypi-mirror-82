...
from alipayfanhua.aop.api.domain.AlipayOpenMiniInnerversionOnlinePublishModel import AlipayOpenMiniInnerversionOnlinePublishModel
...
class AlipayOpenMiniInnerversionOnlinePublishRequest(object):
    ...
    def get_params(self):
        params = dict()
        params[P_METHOD] = 'alipayfanhuaopen.mini.innerversion.online.publish'
