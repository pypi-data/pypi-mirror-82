...
from alipayfanhua.aop.api.domain.AlipaySecurityRiskRainscoreQueryModel import AlipaySecurityRiskRainscoreQueryModel
...
class AlipaySecurityRiskRainscoreQueryRequest(object):
    ...
    def get_params(self):
        params = dict()
        params[P_METHOD] = 'alipayfanhuasecurity.risk.rainscore.query'
