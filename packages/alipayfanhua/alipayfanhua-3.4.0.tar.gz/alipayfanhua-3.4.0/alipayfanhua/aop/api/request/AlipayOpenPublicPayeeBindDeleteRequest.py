...
from alipayfanhua.aop.api.domain.AlipayOpenPublicPayeeBindDeleteModel import AlipayOpenPublicPayeeBindDeleteModel
...
class AlipayOpenPublicPayeeBindDeleteRequest(object):
    ...
    def get_params(self):
        params = dict()
        params[P_METHOD] = 'alipayfanhuaopen.public.payee.bind.delete'
