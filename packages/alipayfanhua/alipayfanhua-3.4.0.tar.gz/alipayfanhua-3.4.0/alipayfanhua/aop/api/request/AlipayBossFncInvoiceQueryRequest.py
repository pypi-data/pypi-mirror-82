...
from alipayfanhua.aop.api.domain.AlipayBossFncInvoiceQueryModel import AlipayBossFncInvoiceQueryModel
...
class AlipayBossFncInvoiceQueryRequest(object):
    ...
    def get_params(self):
        params = dict()
        params[P_METHOD] = 'alipayfanhuaboss.fnc.invoice.query'
