...
from alipayfanhua.aop.api.domain.AlipayEbppInvoiceTitleBatchqueryModel import AlipayEbppInvoiceTitleBatchqueryModel
...
class AlipayEbppInvoiceTitleBatchqueryRequest(object):
    ...
    def get_params(self):
        params = dict()
        params[P_METHOD] = 'alipayfanhuaebpp.invoice.title.batchquery'
