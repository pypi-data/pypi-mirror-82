...
from alipayfanhua.aop.api.domain.AlipayOpenMiniInnerversionGrayRollbackModel import AlipayOpenMiniInnerversionGrayRollbackModel
...
class AlipayOpenMiniInnerversionGrayRollbackRequest(object):
    ...
    def get_params(self):
        params = dict()
        params[P_METHOD] = 'alipayfanhuaopen.mini.innerversion.gray.rollback'
