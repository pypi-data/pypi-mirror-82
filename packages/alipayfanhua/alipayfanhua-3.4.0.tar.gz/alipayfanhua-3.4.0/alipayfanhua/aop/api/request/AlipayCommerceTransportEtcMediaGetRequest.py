...
from alipayfanhua.aop.api.domain.AlipayCommerceTransportEtcMediaGetModel import AlipayCommerceTransportEtcMediaGetModel
...
class AlipayCommerceTransportEtcMediaGetRequest(object):
    ...
    def get_params(self):
        params = dict()
        params[P_METHOD] = 'alipayfanhuacommerce.transport.etc.media.get'
