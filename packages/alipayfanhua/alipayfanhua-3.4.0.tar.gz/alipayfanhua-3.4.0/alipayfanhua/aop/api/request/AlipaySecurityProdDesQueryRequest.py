...
from alipayfanhua.aop.api.domain.AlipaySecurityProdDesQueryModel import AlipaySecurityProdDesQueryModel
...
class AlipaySecurityProdDesQueryRequest(object):
    ...
    def get_params(self):
        params = dict()
        params[P_METHOD] = 'alipayfanhuasecurity.prod.des.query'
