...
from alipayfanhua.aop.api.domain.AlipayCommerceKidsTokenCreateModel import AlipayCommerceKidsTokenCreateModel
...
class AlipayCommerceKidsTokenCreateRequest(object):
    ...
    def get_params(self):
        params = dict()
        params[P_METHOD] = 'alipayfanhuacommerce.kids.token.create'
