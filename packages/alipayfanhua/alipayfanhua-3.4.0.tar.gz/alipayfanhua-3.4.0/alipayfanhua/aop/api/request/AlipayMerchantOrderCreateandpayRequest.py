...
from alipayfanhua.aop.api.domain.AlipayMerchantOrderCreateandpayModel import AlipayMerchantOrderCreateandpayModel
...
class AlipayMerchantOrderCreateandpayRequest(object):
    ...
    def get_params(self):
        params = dict()
        params[P_METHOD] = 'alipayfanhuamerchant.order.createandpay'
