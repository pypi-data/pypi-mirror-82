...
from alipayfanhua.aop.api.domain.AlipayOpenPublicMessageContentCreateModel import AlipayOpenPublicMessageContentCreateModel
...
class AlipayOpenPublicMessageContentCreateRequest(object):
    ...
    def get_params(self):
        params = dict()
        params[P_METHOD] = 'alipayfanhuaopen.public.message.content.create'
