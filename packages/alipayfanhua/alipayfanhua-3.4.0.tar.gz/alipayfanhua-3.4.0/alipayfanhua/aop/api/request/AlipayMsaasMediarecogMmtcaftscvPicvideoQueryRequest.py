...
from alipayfanhua.aop.api.domain.AlipayMsaasMediarecogMmtcaftscvPicvideoQueryModel import AlipayMsaasMediarecogMmtcaftscvPicvideoQueryModel
...
class AlipayMsaasMediarecogMmtcaftscvPicvideoQueryRequest(object):
    ...
    def get_params(self):
        params = dict()
        params[P_METHOD] = 'alipayfanhuamsaas.mediarecog.mmtcaftscv.picvideo.query'
