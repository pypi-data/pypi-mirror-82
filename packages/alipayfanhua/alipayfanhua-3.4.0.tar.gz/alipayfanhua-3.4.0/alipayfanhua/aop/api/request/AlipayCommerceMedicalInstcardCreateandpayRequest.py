...
from alipayfanhua.aop.api.domain.AlipayCommerceMedicalInstcardCreateandpayModel import AlipayCommerceMedicalInstcardCreateandpayModel
...
class AlipayCommerceMedicalInstcardCreateandpayRequest(object):
    ...
    def get_params(self):
        params = dict()
        params[P_METHOD] = 'alipayfanhuacommerce.medical.instcard.createandpay'
