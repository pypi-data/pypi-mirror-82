...
from alipayfanhua.aop.api.domain.AlipayEcoMycarMaintainShopCreateModel import AlipayEcoMycarMaintainShopCreateModel
...
class AlipayEcoMycarMaintainShopCreateRequest(object):
    ...
    def get_params(self):
        params = dict()
        params[P_METHOD] = 'alipayfanhuaeco.mycar.maintain.shop.create'
