...
from alipayfanhua.aop.api.domain.AlipayFundTransBatchCreatesinglebatchModel import AlipayFundTransBatchCreatesinglebatchModel
...
class AlipayFundTransBatchCreatesinglebatchRequest(object):
    ...
    def get_params(self):
        params = dict()
        params[P_METHOD] = 'alipayfanhuafund.trans.batch.createsinglebatch'
