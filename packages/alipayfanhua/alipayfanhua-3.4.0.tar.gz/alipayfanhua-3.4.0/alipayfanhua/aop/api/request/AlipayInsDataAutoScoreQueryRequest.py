...
from alipayfanhua.aop.api.domain.AlipayInsDataAutoScoreQueryModel import AlipayInsDataAutoScoreQueryModel
...
class AlipayInsDataAutoScoreQueryRequest(object):
    ...
    def get_params(self):
        params = dict()
        params[P_METHOD] = 'alipayfanhuains.data.auto.score.query'
