...
from alipayfanhua.aop.api.domain.AlipayMarketingCampaignDiscountBudgetQueryModel import AlipayMarketingCampaignDiscountBudgetQueryModel
...
class AlipayMarketingCampaignDiscountBudgetQueryRequest(object):
    ...
    def get_params(self):
        params = dict()
        params[P_METHOD] = 'alipayfanhuamarketing.campaign.discount.budget.query'
