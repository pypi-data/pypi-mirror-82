...
from alipayfanhua.aop.api.domain.CommerceAppUploadRequestContent import CommerceAppUploadRequestContent
...
class AlipayCommerceAppUploadRequest(object):
    ...
    def get_params(self):
        params = dict()
        params[P_METHOD] = 'alipayfanhuacommerce.app.upload'
