...
from alipayfanhua.aop.api.domain.AlipayEcoEduKtSchoolinfoModifyModel import AlipayEcoEduKtSchoolinfoModifyModel
...
class AlipayEcoEduKtSchoolinfoModifyRequest(object):
    ...
    def get_params(self):
        params = dict()
        params[P_METHOD] = 'alipayfanhuaeco.edu.kt.schoolinfo.modify'
