...
from alipayfanhua.aop.api.domain.AlipayOfflineMarketItemCreateModel import AlipayOfflineMarketItemCreateModel
...
class AlipayOfflineMarketItemCreateRequest(object):
    ...
    def get_params(self):
        params = dict()
        params[P_METHOD] = 'alipayfanhuaoffline.market.item.create'
