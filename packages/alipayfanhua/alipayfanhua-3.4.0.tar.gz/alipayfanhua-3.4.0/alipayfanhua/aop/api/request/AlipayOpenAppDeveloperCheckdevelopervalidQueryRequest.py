...
from alipayfanhua.aop.api.domain.AlipayOpenAppDeveloperCheckdevelopervalidQueryModel import AlipayOpenAppDeveloperCheckdevelopervalidQueryModel
...
class AlipayOpenAppDeveloperCheckdevelopervalidQueryRequest(object):
    ...
    def get_params(self):
        params = dict()
        params[P_METHOD] = 'alipayfanhuaopen.app.developer.checkdevelopervalid.query'
