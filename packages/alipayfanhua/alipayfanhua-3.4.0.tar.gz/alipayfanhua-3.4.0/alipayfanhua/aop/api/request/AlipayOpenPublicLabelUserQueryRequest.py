...
from alipayfanhua.aop.api.domain.AlipayOpenPublicLabelUserQueryModel import AlipayOpenPublicLabelUserQueryModel
...
class AlipayOpenPublicLabelUserQueryRequest(object):
    ...
    def get_params(self):
        params = dict()
        params[P_METHOD] = 'alipayfanhuaopen.public.label.user.query'
