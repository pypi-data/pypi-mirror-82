...
from alipayfanhua.aop.api.domain.AlipayEbppIndustryBizinfoQueryModel import AlipayEbppIndustryBizinfoQueryModel
...
class AlipayEbppIndustryBizinfoQueryRequest(object):
    ...
    def get_params(self):
        params = dict()
        params[P_METHOD] = 'alipayfanhuaebpp.industry.bizinfo.query'
