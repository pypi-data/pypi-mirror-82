...
from alipayfanhua.aop.api.domain.AlipayMarketingToolFengdieActivityCreateModel import AlipayMarketingToolFengdieActivityCreateModel
...
class AlipayMarketingToolFengdieActivityCreateRequest(object):
    ...
    def get_params(self):
        params = dict()
        params[P_METHOD] = 'alipayfanhuamarketing.tool.fengdie.activity.create'
