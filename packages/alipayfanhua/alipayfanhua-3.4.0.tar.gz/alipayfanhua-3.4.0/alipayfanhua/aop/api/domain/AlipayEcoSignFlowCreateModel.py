...
from alipayfanhua.aop.api.domain.Attachment import Attachment
from alipayfanhua.aop.api.domain.ConfigInfo import ConfigInfo
from alipayfanhua.aop.api.domain.TemplateInfo import TemplateInfo
