...
from alipayfanhua.aop.api.domain.Article import Article
from alipayfanhua.aop.api.domain.Image import Image
from alipayfanhua.aop.api.domain.Text import Text
