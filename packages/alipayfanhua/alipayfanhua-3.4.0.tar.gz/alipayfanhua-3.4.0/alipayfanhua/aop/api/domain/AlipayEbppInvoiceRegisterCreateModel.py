...
from alipayfanhua.aop.api.domain.InvoiceContactInfo import InvoiceContactInfo
from alipayfanhua.aop.api.domain.InvoiceCompanyInfo import InvoiceCompanyInfo
from alipayfanhua.aop.api.domain.InvoiceOrderInfo import InvoiceOrderInfo
