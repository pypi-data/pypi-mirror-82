...
from alipayfanhua.aop.api.domain.PrizeCustomMenu import PrizeCustomMenu
from alipayfanhua.aop.api.domain.OpenPromoPrizeDimension import OpenPromoPrizeDimension
from alipayfanhua.aop.api.domain.OpenPromoPrizeRelativeTime import OpenPromoPrizeRelativeTime
