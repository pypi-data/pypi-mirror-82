...
from alipayfanhua.aop.api.domain.InteligentSendRule import InteligentSendRule
from alipayfanhua.aop.api.domain.InteligentVoucher import InteligentVoucher
