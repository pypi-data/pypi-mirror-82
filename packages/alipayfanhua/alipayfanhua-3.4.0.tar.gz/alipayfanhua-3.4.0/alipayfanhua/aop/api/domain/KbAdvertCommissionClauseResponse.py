...
from alipayfanhua.aop.api.domain.KbAdvertCommissionClausePercentageResponse import KbAdvertCommissionClausePercentageResponse
from alipayfanhua.aop.api.domain.KbAdvertCommissionClauseQuotaResponse import KbAdvertCommissionClauseQuotaResponse
