...
from alipayfanhua.aop.api.domain.SubShopInfo import SubShopInfo


class AlipayPcreditHuabeiDiscountSolutionCreateModel(object):
    ...
    def from_alipay_dict(d):
        if not d:
            return None
        o = AlipayPcreditHuabeiDiscountSolutionCreateModel()
