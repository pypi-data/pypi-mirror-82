...
from alipayfanhua.aop.api.domain.ItemLabelCreateInfo import ItemLabelCreateInfo
from alipayfanhua.aop.api.domain.ItemSkuCreateInfo import ItemSkuCreateInfo
