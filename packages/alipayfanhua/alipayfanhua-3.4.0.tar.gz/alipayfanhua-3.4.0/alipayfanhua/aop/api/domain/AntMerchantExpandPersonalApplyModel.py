...
from alipayfanhua.aop.api.domain.OperatorInfo import OperatorInfo
from alipayfanhua.aop.api.domain.PersonnalBankAccountInfo import PersonnalBankAccountInfo
