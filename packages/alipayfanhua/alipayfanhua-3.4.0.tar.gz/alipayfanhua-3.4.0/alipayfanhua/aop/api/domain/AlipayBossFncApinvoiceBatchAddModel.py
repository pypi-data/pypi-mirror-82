...
from alipayfanhua.aop.api.domain.ApInvoiceBillLinkOrderRequest import ApInvoiceBillLinkOrderRequest
from alipayfanhua.aop.api.domain.ApInvoiceOrderRequest import ApInvoiceOrderRequest
