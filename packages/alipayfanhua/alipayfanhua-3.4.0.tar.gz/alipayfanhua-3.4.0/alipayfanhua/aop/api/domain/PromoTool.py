...
from alipayfanhua.aop.api.domain.PointCard import PointCard
from alipayfanhua.aop.api.domain.SendRule import SendRule
from alipayfanhua.aop.api.domain.Voucher import Voucher
