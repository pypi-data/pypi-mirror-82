...
from alipayfanhua.aop.api.domain.MerchantCard import MerchantCard
from alipayfanhua.aop.api.domain.McardStylInfo import McardStylInfo
from alipayfanhua.aop.api.domain.McardNotifyMessage import McardNotifyMessage
