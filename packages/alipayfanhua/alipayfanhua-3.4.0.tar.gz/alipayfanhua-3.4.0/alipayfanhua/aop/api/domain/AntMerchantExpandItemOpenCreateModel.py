...
from alipayfanhua.aop.api.domain.ItemExtInfo import ItemExtInfo
from alipayfanhua.aop.api.domain.MaterialCreateInfo import MaterialCreateInfo
from alipayfanhua.aop.api.domain.ItemPropertyInfo import ItemPropertyInfo
from alipayfanhua.aop.api.domain.SkuCreateInfo import SkuCreateInfo
