...
from alipayfanhua.aop.api.domain.CertInfo import CertInfo
from alipayfanhua.aop.api.domain.ExchangeRate import ExchangeRate
from alipayfanhua.aop.api.domain.AccPayeeInfo import AccPayeeInfo
