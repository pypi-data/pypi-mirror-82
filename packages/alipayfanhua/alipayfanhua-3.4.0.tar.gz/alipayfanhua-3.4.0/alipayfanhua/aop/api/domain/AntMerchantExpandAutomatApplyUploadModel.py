...
from alipayfanhua.aop.api.domain.SmartAutomatAssociate import SmartAutomatAssociate
from alipayfanhua.aop.api.domain.SmartAddressInfo import SmartAddressInfo
from alipayfanhua.aop.api.domain.SmartAddressInfo import SmartAddressInfo
from alipayfanhua.aop.api.domain.SmartAutomatScene import SmartAutomatScene
