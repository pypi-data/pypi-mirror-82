...
from alipayfanhua.aop.api.domain.BusinessLicenseCertFileds import BusinessLicenseCertFileds
from alipayfanhua.aop.api.domain.CertFields import CertFields
from alipayfanhua.aop.api.domain.IdCardImg import IdCardImg
