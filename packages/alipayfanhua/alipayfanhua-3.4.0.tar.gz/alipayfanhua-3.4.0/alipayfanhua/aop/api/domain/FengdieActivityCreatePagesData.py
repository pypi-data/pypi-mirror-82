...
from alipayfanhua.aop.api.domain.FengdieActivityComponentModel import FengdieActivityComponentModel
from alipayfanhua.aop.api.domain.FengdieActivitySchemaModel import FengdieActivitySchemaModel
