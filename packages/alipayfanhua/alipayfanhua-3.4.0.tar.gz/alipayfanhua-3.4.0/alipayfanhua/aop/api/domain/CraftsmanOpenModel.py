...
from alipayfanhua.aop.api.domain.CraftsmanAssessment import CraftsmanAssessment
from alipayfanhua.aop.api.domain.CraftsmanShopRelationOpenModel import CraftsmanShopRelationOpenModel
