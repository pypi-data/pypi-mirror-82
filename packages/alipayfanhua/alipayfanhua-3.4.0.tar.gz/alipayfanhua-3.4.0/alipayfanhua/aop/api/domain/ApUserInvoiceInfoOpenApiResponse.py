...
from alipayfanhua.aop.api.domain.ApUserMailInfoOpenApiResponse import ApUserMailInfoOpenApiResponse


class ApUserInvoiceInfoOpenApiResponse(object):
    ...
    def user_mail_info_list(self, value):
        if isinstance(value, list):
            ...
            for i in value:
                if isinstance(i, ApUserMailInfoOpenApiResponse):
                    self._user_mail_info_list.append(i)
                else:
                    self._user_mail_info_list.append(ApUserMailInfoOpenApiResponse.from_alipay_dict(i))
    ...
    def from_alipay_dict(d):
        if not d:
            return None
        o = ApUserInvoiceInfoOpenApiResponse()
