...
from alipayfanhua.aop.api.domain.CommodityBaseInfo import CommodityBaseInfo
from alipayfanhua.aop.api.domain.SmartCityCommodityInfo import SmartCityCommodityInfo
