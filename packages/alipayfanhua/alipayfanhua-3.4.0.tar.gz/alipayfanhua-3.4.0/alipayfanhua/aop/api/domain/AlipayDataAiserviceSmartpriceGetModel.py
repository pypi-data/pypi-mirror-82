...
from alipayfanhua.aop.api.domain.HelloBikePriceCondition import HelloBikePriceCondition
from alipayfanhua.aop.api.domain.HelloBikePriceConstraint import HelloBikePriceConstraint
