...
from alipayfanhua.aop.api.domain.BatchFundItemAOPModel import BatchFundItemAOPModel
from alipayfanhua.aop.api.domain.ConsumeRecordAOPModel import ConsumeRecordAOPModel
