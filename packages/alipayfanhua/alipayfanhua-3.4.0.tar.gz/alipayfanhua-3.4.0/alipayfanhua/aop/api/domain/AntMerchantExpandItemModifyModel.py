...
from alipayfanhua.aop.api.domain.ItemLabelModifyInfo import ItemLabelModifyInfo
from alipayfanhua.aop.api.domain.ItemSkuModifyInfo import ItemSkuModifyInfo
