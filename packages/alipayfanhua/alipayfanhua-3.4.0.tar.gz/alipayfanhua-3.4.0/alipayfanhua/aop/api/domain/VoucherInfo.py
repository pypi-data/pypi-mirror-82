...
from alipayfanhua.aop.api.domain.UseRuleInfo import UseRuleInfo
from alipayfanhua.aop.api.domain.ValidDateInfo import ValidDateInfo
from alipayfanhua.aop.api.domain.VoucherTermInfo import VoucherTermInfo
