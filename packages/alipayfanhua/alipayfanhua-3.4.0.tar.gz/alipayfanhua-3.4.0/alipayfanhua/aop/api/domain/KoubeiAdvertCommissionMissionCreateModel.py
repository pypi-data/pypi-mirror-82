...
from alipayfanhua.aop.api.domain.KbAdvertCommissionClause import KbAdvertCommissionClause
from alipayfanhua.aop.api.domain.KbadvertSmartPromoRequest import KbadvertSmartPromoRequest
