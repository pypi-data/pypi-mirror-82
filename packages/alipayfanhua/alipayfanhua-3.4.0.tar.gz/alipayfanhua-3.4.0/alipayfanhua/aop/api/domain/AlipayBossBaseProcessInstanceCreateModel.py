...
from alipayfanhua.aop.api.domain.BPOpenApiAddSignContent import BPOpenApiAddSignContent
from alipayfanhua.aop.api.domain.BPOpenApiPUID import BPOpenApiPUID
