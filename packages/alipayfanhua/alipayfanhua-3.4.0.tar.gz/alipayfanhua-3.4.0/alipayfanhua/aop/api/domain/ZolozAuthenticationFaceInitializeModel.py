...
from alipayfanhua.aop.api.domain.FaceExtParams import FaceExtParams
from alipayfanhua.aop.api.domain.FaceMachineInfo import FaceMachineInfo
from alipayfanhua.aop.api.domain.FaceMerchantInfo import FaceMerchantInfo
