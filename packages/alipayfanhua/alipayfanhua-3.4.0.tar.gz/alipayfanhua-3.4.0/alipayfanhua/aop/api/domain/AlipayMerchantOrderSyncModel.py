...
from alipayfanhua.aop.api.domain.UserInfomation import UserInfomation
from alipayfanhua.aop.api.domain.OrderExtInfo import OrderExtInfo
from alipayfanhua.aop.api.domain.ItemOrderInfo import ItemOrderInfo
from alipayfanhua.aop.api.domain.OrderLogisticsInformationRequest import OrderLogisticsInformationRequest
