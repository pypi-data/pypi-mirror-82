...
from alipayfanhua.aop.api.domain.ControlInfo import ControlInfo
from alipayfanhua.aop.api.domain.EnvInfo import EnvInfo
from alipayfanhua.aop.api.domain.ItemDetail import ItemDetail
from alipayfanhua.aop.api.domain.MarketingSelectionInfo import MarketingSelectionInfo
from alipayfanhua.aop.api.domain.UserIdentity import UserIdentity
