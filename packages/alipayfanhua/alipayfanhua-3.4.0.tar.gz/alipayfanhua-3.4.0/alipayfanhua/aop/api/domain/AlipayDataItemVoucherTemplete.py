...
from alipayfanhua.aop.api.domain.AlipayDataItemDescription import AlipayDataItemDescription
from alipayfanhua.aop.api.domain.AlipayDataItemGoodsList import AlipayDataItemGoodsList
from alipayfanhua.aop.api.domain.AlipayDataItemLimitPeriodInfo import AlipayDataItemLimitPeriodInfo
