...
from alipayfanhua.aop.api.domain.LegalRepresentativeVO import LegalRepresentativeVO
from alipayfanhua.aop.api.domain.ManagerVO import ManagerVO
from alipayfanhua.aop.api.domain.StockHolderVO import StockHolderVO
from alipayfanhua.aop.api.domain.UboVO import UboVO
