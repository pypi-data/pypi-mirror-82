...
from alipayfanhua.aop.api.domain.PortfolioOperatorInfo import PortfolioOperatorInfo
from alipayfanhua.aop.api.domain.PortfolioShop import PortfolioShop
