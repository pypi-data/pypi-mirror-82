...
from alipayfanhua.aop.api.domain.StructureBrandInfo import StructureBrandInfo
from alipayfanhua.aop.api.domain.StructureServiceInfo import StructureServiceInfo
