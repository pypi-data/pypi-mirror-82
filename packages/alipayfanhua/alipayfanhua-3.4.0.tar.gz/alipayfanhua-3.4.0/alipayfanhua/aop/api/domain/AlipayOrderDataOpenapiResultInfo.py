...
from alipayfanhua.aop.api.domain.ItemOrderInfoResult import ItemOrderInfoResult
from alipayfanhua.aop.api.domain.OrderLogisticsInformation import OrderLogisticsInformation
from alipayfanhua.aop.api.domain.PreAmountInfoResult import PreAmountInfoResult
from alipayfanhua.aop.api.domain.PreAmountInfoResult import PreAmountInfoResult
