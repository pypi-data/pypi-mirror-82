...
from alipayfanhua.aop.api.domain.BaseInfoConfig import BaseInfoConfig
from alipayfanhua.aop.api.domain.PromiseConfig import PromiseConfig
from alipayfanhua.aop.api.domain.RiskConfig import RiskConfig
