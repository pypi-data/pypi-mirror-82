...
from alipayfanhua.aop.api.domain.OpenPromoBudget import OpenPromoBudget
from alipayfanhua.aop.api.domain.OpenPromoCamp import OpenPromoCamp
from alipayfanhua.aop.api.domain.OpenPromoPrize import OpenPromoPrize
