...
from alipayfanhua.aop.api.domain.TemplateActionInfoDTO import TemplateActionInfoDTO
from alipayfanhua.aop.api.domain.TemplateCardLevelConfDTO import TemplateCardLevelConfDTO
from alipayfanhua.aop.api.domain.TemplateColumnInfoDTO import TemplateColumnInfoDTO
from alipayfanhua.aop.api.domain.TemplateFieldRuleDTO import TemplateFieldRuleDTO
from alipayfanhua.aop.api.domain.TemplateMdcodeNotifyConfDTO import TemplateMdcodeNotifyConfDTO
from alipayfanhua.aop.api.domain.TemplateOpenCardConfDTO import TemplateOpenCardConfDTO
from alipayfanhua.aop.api.domain.PubChannelDTO import PubChannelDTO
from alipayfanhua.aop.api.domain.TemplateBenefitInfoDTO import TemplateBenefitInfoDTO
from alipayfanhua.aop.api.domain.TemplateStyleInfoDTO import TemplateStyleInfoDTO
