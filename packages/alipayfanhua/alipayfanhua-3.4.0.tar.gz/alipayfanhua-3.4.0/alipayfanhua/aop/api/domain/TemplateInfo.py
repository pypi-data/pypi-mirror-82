...
from alipayfanhua.aop.api.domain.FillContent import FillContent
from alipayfanhua.aop.api.domain.SignField import SignField
...
class TemplateInfo(object):
    ...
    def signfields(self, value):
        if isinstance(value, SignField):
            self._signfields = value
        else:
            self._signfields = SignField.from_alipay_dict(value)
    @property
