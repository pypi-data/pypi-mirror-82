...
from alipayfanhua.aop.api.domain.FengdieTemplateDetailModel import FengdieTemplateDetailModel
from alipayfanhua.aop.api.domain.FengdieListPaginator import FengdieListPaginator
