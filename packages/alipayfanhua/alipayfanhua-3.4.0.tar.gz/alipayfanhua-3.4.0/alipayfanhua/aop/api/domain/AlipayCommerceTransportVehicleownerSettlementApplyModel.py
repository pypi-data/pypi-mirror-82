...
from alipayfanhua.aop.api.domain.BankRepayData import BankRepayData
from alipayfanhua.aop.api.domain.HighwaySceneData import HighwaySceneData
from alipayfanhua.aop.api.domain.VehicleSettleInfo import VehicleSettleInfo
