...
from alipayfanhua.aop.api.domain.AlipayUserDeviceInfo import AlipayUserDeviceInfo
from alipayfanhua.aop.api.domain.AlipayUserPrincipalInfo import AlipayUserPrincipalInfo
