...
from alipayfanhua.aop.api.domain.MultiCurrencyMoneyVO import MultiCurrencyMoneyVO
from alipayfanhua.aop.api.domain.LoanPayConsultOrder import LoanPayConsultOrder
from alipayfanhua.aop.api.domain.LoanPayUser import LoanPayUser
