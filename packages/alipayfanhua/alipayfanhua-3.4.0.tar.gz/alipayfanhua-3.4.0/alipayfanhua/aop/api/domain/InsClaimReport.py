...
from alipayfanhua.aop.api.domain.InsClaimAttachment import InsClaimAttachment
from alipayfanhua.aop.api.domain.InsClaim import InsClaim
from alipayfanhua.aop.api.domain.InsClaimReportProgress import InsClaimReportProgress
