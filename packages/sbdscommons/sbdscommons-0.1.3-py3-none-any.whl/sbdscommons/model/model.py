...
class SbModel:
    ...
    def unload_model_data_to_s3(self):
        ...
        model_input_data_query = MODEL_INPUT_DATA_TEMPLATE_QUERY.format(MODEL_NAME=self.model_name).format(**query_dict)
        predict_input_data_query = PREDICT_INPUT_DATA_TEMPLATE_QUERY.format(MODEL_NAME=self.model_name).format(**query_dict)
