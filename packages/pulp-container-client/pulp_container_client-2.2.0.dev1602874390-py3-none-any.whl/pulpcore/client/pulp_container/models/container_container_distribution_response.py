...
class ContainerContainerDistributionResponse(object):
    ...
    def __init__(self, name=None, base_path=None, pulp_href=None, repository_version=None, repository=None, content_guard=None, pulp_created=None, registry_path=None, local_vars_configuration=None):  # noqa: E501
