...
class ContainerContainerDistributionResponse(object):
    ...
    def __init__(self, repository_version=None, name=None, content_guard=None, base_path=None, repository=None, pulp_created=None, pulp_href=None, registry_path=None, local_vars_configuration=None):  # noqa: E501
