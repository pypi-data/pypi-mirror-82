...
class ContainerContainerDistributionResponse(object):
    ...
    def __init__(self, repository=None, base_path=None, pulp_href=None, repository_version=None, pulp_created=None, name=None, content_guard=None, registry_path=None, local_vars_configuration=None):  # noqa: E501
