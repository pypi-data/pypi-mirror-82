...
class perACL:
    def __init__(self,plugIn, params_container_class,tokenKey="usr-token"):
    ...
    def AccessControlLists(self, func):
        ...
        def wapper(*args, **kwargs):
            ...
            if isinstance(params_instance, Request):
                if self._tokenKey in params_instance.META:
                    token= params_instance.META[self._tokenKey]
                else:
