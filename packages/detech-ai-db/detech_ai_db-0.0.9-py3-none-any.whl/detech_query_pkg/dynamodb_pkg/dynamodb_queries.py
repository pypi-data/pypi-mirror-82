...
def create_metric(id, name, provider, namespace, region_name,
  agent, org_id, component_id, alignment, dimension_name, dimension_value,
  description, is_active, dynamodb):
  '''
  create_metric(
