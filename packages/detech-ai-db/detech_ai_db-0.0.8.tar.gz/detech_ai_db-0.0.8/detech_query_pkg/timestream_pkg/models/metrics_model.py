class MetricModel(object):
  ...
  """
  def __init__(self, id, name, org_id, component_id, namespace,
  alignment, region_name, agent, dimension_name=None, dimension_value=None,
  is_active=False, description=None, unit=None):
    self.id = id
    self.name = name
    self.org_id = org_id
