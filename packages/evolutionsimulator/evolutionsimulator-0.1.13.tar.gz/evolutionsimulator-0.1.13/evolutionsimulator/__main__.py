...
DATA_PATH = pkg_resources.resource_filename('evolutionsimulator', 'resources/')
...
class MainWindow(Frame):
    def __init__(self, master):
        ...
        self.welcome_text = open(os.path.join(DATA_PATH, 'welcome_text.html'), 'r').read()
        print(os.path.join(script_dir, 'resources', 'welcome_text.html'))
        self.make_widgets()
