...
print(pkg_resources.resource_filename('evolutionsimulator', 'interactive.py',))
    ...
    def ok_button_pressed(self):
        if self.tk_var.get() in os.listdir(os.path.join(CONFIGS, "automatic_testing")) or \
            ...
            if self.interactive_mode:
                ...
                subprocess.Popen(f"python {pkg_resources.resource_filename('evolutionsimulator', 'interactive.py')} {os.path.join(CONFIGS, 'interactive', self.tk_var.get())}")
                print(os.path.join(CONFIGS, 'interactive', self.tk_var.get()))
            else:
                subprocess.Popen(f"python {pkg_resources.resource_filename('evolutionsimulator', 'automatic_testing.py')} {os.path.join(CONFIGS, 'automatic_testing', self.tk_var.get())}")
