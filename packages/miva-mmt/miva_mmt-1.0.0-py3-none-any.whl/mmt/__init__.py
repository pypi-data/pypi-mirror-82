...
def main():
	...
	parser_checkout.add_argument( '--ignore-unsynced-properties',	'-p',	action = 'store_true',						help = 'Ignore properites that do not have the sync flag' )
	...
	parser_config_delete.add_argument( 'key', type = str,					help = 'Name of the configration setting' )
