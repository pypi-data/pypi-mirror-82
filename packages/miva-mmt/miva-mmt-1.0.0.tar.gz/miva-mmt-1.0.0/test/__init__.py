...
class MMTTest( unittest.TestCase ):
	...
	def json_loads( self, data: object ) -> typing.Any:
	...
	def credential_add( self, key: str, url: typing.Optional[ str ] = None, token: typing.Optional[ str ] = None, signing_key: typing.Optional[ str ] = None, ssh_username: typing.Optional[ str ] = None, ssh_private_key: typing.Optional[ str ] = None ) -> str:
		if url is None:
			url = self._config.get( 'api_url' )

		params = { 'credential_command': 'add', 'key': key, 'url': url }
	...
	def credential_update( self, key: str, new_key: typing.Optional[ str ] = None, url: typing.Optional[ str ] = None, token: typing.Optional[ str ] = None, signing_key: typing.Optional[ str ] = None, ssh_username: typing.Optional[ str ] = None, ssh_private_key: typing.Optional[ str ] = None ) -> str:
		return self._run_command( CredentialUpdateCommand( { 'credential_command': 'update', 'key': key, 'credential_key': new_key, 'url': url, 'token': token, 'signing_key': signing_key, 'ssh_username': ssh_username, 'ssh_private_key': ssh_private_key } ) )
