...
class PushCommand( ConfiguredCommand ):
	...
	def _build_property_changes( self, state_file: StateMetadataBasePropertyFile, file: typing.Union[ File, BinaryFile ] ):
		...
		if ( state_file.property_type, state_file.property_code ) in self._property_changes_lookup:
			property_change = self._property_changes_lookup[ ( state_file.property_type, state_file.property_code ) ]
		else:
			...
			self._property_changes_lookup[ ( state_file.property_type, state_file.property_code ) ] = property_change
