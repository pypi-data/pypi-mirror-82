...
class TensorGenerator:
    ...
    def __init__(self):
        ...
        obs_tensor = self.compute_empty_tensor(cog_settings.actor_classes._otsa.observation_space)
        self.state_size = self.compute_tensor_size(obs_tensor)

        action_tensor = self.compute_empty_tensor(cog_settings.actor_classes._otsa.action_space)
    ...
    def compute_action_from_tensor(self, vector_action):
        action = cog_settings.actor_classes._otsa.action_space()
