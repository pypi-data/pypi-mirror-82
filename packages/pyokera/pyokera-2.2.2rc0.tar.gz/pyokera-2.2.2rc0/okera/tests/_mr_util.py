...
authorize_query_unsupported_datasets = [
    # Fails due to rewrite for views with multiple tables
    'authdb.alltypes_s3_join_clause_view',
    'authdb.map_t_join_clause_view',
    'authdb.strarray_t_join_clause_view',
    ...
    'nytaxi.unionallview',
    'okera_system.privileges',
    'okera_system.role_groups',
    'okera_system.steward_fs_audit_logs',
    'okera_system.steward_fs_audit_logs_preview',
    'okera_system.user_group_info',
    ...
    'rs_complex.pn_view',
    'tpch.nation_join',
    'tpch_sf1.customer_nation',
    'tpch_sf1.customer_nation_small',
    'tpch_sf1.lineitem_orders',
    'tpch_sf1.lineitem_orders_medium',
    'tpch_sf1.lineitem_orders_small',
    'tpch_sf5.customer_nation',
    'tpch_sf5.customer_nation_small',
    'tpch_sf5.lineitem_orders',
    'tpch_sf5.lineitem_orders_medium',
    'tpch_sf5.lineitem_orders_small',
    'zd1179large.store_sales_pk_view',

    # Hive/Spark cannot read these files (fixable in ddl)
    ...
    # BUG: Unsupported format? (very bad error message from us)
    'demo.audit_logs',
    'demo.audit_logs_base',
    'demo.daily_audit_logs',
    'demo.okera_audit_logs',
    'demo.reporting_audit_logs',
    'demo.steward_audit_logs',
