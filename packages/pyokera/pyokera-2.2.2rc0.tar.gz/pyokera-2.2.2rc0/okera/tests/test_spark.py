...
authorize_query_blacklisted_tbls = [
    ...
    # FIXME: detail:IllegalArgumentException: Query rewrite cannot reference views
    ...
    # TODO: Missing less relevant out of box UDFs
    ...
    # TODO: This is a corner case view definition where Spark does not have HMS
    # compatibility with default names for columns.
    'all_table_types.view_only',
    ...
    def test_select_single_row(self):
        ...
        for db in dbs:
            ...
            for table in tables:
                ...
                rows = self._session.sql(sql).limit(1).collect()
