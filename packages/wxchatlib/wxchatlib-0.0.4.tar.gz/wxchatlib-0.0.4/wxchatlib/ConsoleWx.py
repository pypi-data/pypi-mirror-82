...
class ChatRobot(object):
    '''
    from feichenxue.ConsoleWx import ChatRobot
    import threading


    def Print_all():
        mywchat = ChatRobot(False) //True 为自动消除消息小红点
        mywchat.Receive_All(infomsg=False)

    Print_all()
    '''
    def __init__(self, mark_as_read):
        # 实例化，并登录微信
        ...
        bot.auto_mark_as_read = mark_as_read
