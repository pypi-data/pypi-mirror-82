...
class Solver(object):
    ...
    def AddConstraint(self, c: "Constraint") -> "void":
        ...
        AddConstraint is called outside of search (i.e., with.. code-block:: c++
...
class BaseObject(object):
    ...
    A DebugString method and the associated.. code-block:: c++
...
class RoutingModel(object):
    ...
    def GetTopologicallySortedVisitTypes(self) -> "std::vector< int > const &":
        return _pywrapcp.RoutingModel_GetTopologicallySortedVisitTypes(self)
