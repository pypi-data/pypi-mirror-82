...
from client.delete_contact import DialogForDeleteContact
...
class ClientMainWindow(QMainWindow):
    ...
    def __init__(self, database, transit, keys):
        super().__init__()
        # основные переменные
        ...
        self.ui.list_contacts.doubleClicked.connect(self.select_active_client)

        self.update_list_of_contacts()
        self.close_input_field()
        self.show()

    def close_input_field(self):
    ...
    def update_messages_history(self):
        '''
        ...
        list = sorted(
            self.database.get_history_of_messages(
                self.current_chat),
    ...
    def set_active_client(self):
        ...
        self.update_messages_history()

    def update_list_of_contacts(self):
        '''Метод обновляющий список контактов.'''
        contacts_list = self.database.get_client_contacts()
    ...
    def add_contact_window(self):
        ...
        select_dialog = AddContactDialog(self.transit, self.database)
    ...
    def add_contact(self, new_contact):
        ...
        '''
        try:
            self.transit.add_contact(new_contact)
    ...
    def delete_contact_window(self):
        ...
        remove_dialog = DialogForDeleteContact(self.database)
    ...
    def delete_contact(self, item):
        ...
        try:
            self.transit.delete_contact(selected)
        except ServerError as err:
            self.messages.critical(self, 'Ошибка сервера', err.text)
        except OSError as err:
            if err.errno:
    ...
    def sig_205(self):
        ...
        '''
        if self.current_chat and not self.database.check_known_client(
                self.current_chat):
            self.messages.warning(
                self,
                'Сочувствую',
    ...
    def make_connection(self, trans_obj):
        ...
        trans_obj.lost_connect.connect(self.lost_connect)
