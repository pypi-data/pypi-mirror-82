...
{    
    public static LinkedHashSet computeClique(Graph graph, Random generator) throws Exception
    {
     ...
     */
    public static void randomRestart(Clique clique, Graph graph, int [] restarts, Random generator)
    {
        System.out.println("Random Restarting...");
        //int rand = (int)(Math.random() * (double)Constants.NUMBER_NODES);
        int rand = (int)(generator.nextDouble() * (double)Constants.NUMBER_NODES);
        int count = 0;
        while(restarts[rand] == 1)
        {
            ...
            rand = (int)(generator.nextDouble() * (double)Constants.NUMBER_NODES);
        }
        restarts[rand] = 1;
