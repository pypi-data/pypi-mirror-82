...
public class GraphColoring {
    ...
    public static void main(String [] args) throws Exception
    {
        ...
        /* Compute Clique */
        LinkedHashSet clique = MaxClique.computeClique(graph, generator);
        ...
        int [] colors = IteratedGreedy.iteratedGreedy(k, graph, generator);
        int maxColor = -1;
        ...
        colors = LocalSearch.localSearch(graph, maxColor, generator);
        maxColor = -1;
        for(int i=0; i<colors.length; i++)
        {
            if(maxColor == -1)
