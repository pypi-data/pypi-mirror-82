...
{    
     ...
     */
    public static int [] localSearch(Graph graph, int k, Random generator)
    {
        ...
        for(int p=0; p<Constants.LOCAL_SEARCH_ITERATIONS;p++)
        {
            ...
            for(int i=0; i<graph.nodes.length; i++)
            {
                ...
                if(node.color == k)
                {
                    ...
                    int c = ((int)(generator.nextDouble()*(double)maxColor)) + 1;
                    node.color = c;
                }   
            }
            ...
            for(int n=0; n<1000; n++)
            {
                ...
                {
                    changeColorsRandomly(conflicts, maxColor, generator);
                ...
                for(int i=0; i<1000; i++) 
                {
                    ...
                    int rand = (int)(generator.nextDouble() * conflicts.size());
    ...
    public static void changeColorsRandomly(List conflicts, int k, Random generator)
    {
        ...
        while(it.hasNext())
        {
            ...
            int color = ((int)(generator.nextDouble()*k)) + 1;
