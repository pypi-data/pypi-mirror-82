...
try:
    from .resnet_TF1 import resnet152_model
    from keras.models import Model

except:
    print("issue loading TF1")
    pass
...
class Extractor():
    def __init__(self, rootFolder,
        ...
        elif "TF1" in self.back_end:
            model = resnet152_model('weights_resnet152_imageNet_tf.h5')
            layer_name = 'Flatten'
    ...
    def extract(self, video_path, start=None, duration=None):
        ...
        if "TF2" in self.back_end:
            ...
            if self.grabber=="skvideo":
                ...
                videoLoader = FrameCV(video_path, transform=self.transform, start=start, duration=duration)
