...
[boto3.ApiGatewayManagementApi 1.16.0](https://boto3.amazonaws.com/v1/documentation/api/1.16.0/reference/services/apigatewaymanagementapi.html#ApiGatewayManagementApi) service
compatible with
