...
ProtoStatus = collections.namedtuple('ProtoStatus', 'host port proto open')
...
async def is_ip_up(ip: Text, semaphore: Sem = sem) -> OptionalBool:
    """
    Pings host.
...
async def which_open(ip: Text = LOCALHOST, semaphore: Sem = sem) -> UnionDictList:
    """
    Scan host or hosts.
    ...
    for port_status in ip_status:
        ...
        if ip_ports and text:
            ...
            rv.update({port_status.host: ip_ports})
    return rv
# </editor-fold>
