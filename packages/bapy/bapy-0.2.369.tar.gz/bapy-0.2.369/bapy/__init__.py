...
Sem = collections.namedtuple('Sem', 'atlas db io max nmap os ping socket ssh')
sem = Sem(499, 500, 500, 2000, 50, 400, 200, 200, 200)
# </editor-fold>
...
class Env(Asdict):
    ...
    def __init__(self, prefix: Text = str()):
        ...
        self.sem = Sem(*[self.file.int(upper_prefix(key, prefix=prefix), value)
                         for key, value in sem._asdict().items()])
