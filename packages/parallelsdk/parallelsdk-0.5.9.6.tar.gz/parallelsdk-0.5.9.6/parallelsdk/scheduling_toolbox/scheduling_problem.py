...
class SchedulingProblem:
    ...
    def status_to_string(self, status):
        ...
        elif status == optimizer_defs_pb2.OptimizerSolutionStatusProto.OPT_SOLVER_FAIL:
            return "STATUS_FAIL"
        elif status == optimizer_defs_pb2.OptimizerSolutionStatusProto.OPT_SOLVER_MODEL_INVALID:
            return "STATUS_MODEL_INVALID"
        elif status == optimizer_defs_pb2.OptimizerSolutionStatusProto.OPT_SOLVER_NOT_SOLVED:
            return "STATUS_MODEL_NOT_SOLVED"
        elif status == optimizer_defs_pb2.OptimizerSolutionStatusProto.OPT_SOLVER_FAIL_TIMEOUT:
            return "STATUS_FAIL_TIMEOUT"
        elif status == optimizer_defs_pb2.OptimizerSolutionStatusProto.OPT_SOLVER_SUCCESS:
