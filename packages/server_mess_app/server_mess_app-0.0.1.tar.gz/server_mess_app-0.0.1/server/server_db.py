...
if __name__ == '__main__':
    db_test = ServerStorage('server_database.db3')
    db_test.user_login('Moon', '192.168.1.3', 3333, 1)
    db_test.user_login('Guru', '192.168.1.4', 3343, 2)
    print(db_test.active_users_list())
    db_test.user_logout('Moon')
    print(db_test.active_users_list())
    db_test.login_history('Moon')
    print(db_test.users_list())
    db_test.add_contact('test2', 'test1')
    db_test.add_contact('test1', 'test3')
    db_test.add_contact('test1', 'test6')
    db_test.remove_contact('test1', 'test3')
    db_test.process_message('Moon', 'Guru')
    print(db_test.message_history())
