...
def md_format_message(
    ...
    """
    from convo.shared.nlu.training_data.formats.readerwriter import TrainingDataWriter
...
class Event:
    ...
    a conversation and tell the :class:`convo.shared.core.trackers.DialogueStateTracker`
    ...
    def resolve_by_type(
        ...
        for cls in convo.shared.utils.common.all_subclasses(Event):
