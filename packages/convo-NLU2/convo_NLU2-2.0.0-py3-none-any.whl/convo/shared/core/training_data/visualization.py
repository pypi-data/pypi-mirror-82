...
from convo.shared.core.constants import ACTION_LISTEN_NAME
...
from convo.shared.core.generator import TrainingDataGenerator
from convo.shared.core.training_data.structures import StoryGraph, StoryStep
...
def persist_graph(graph: "networkx.Graph", output_file: Text) -> None:
    ...
    template = convo.shared.utils.io.read_file(visualization_html_path())
    ...
    convo.shared.utils.io.write_text_file(template, output_file)
