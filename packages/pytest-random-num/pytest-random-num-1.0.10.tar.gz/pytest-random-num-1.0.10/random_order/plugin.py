...
def pytest_addoption(parser):
    ...
    group.addoption(
        '--random-order-num',
        type=int,
        dest='random_order_num',
        help='Randomise test case num to run for report.',
    )
...
def pytest_report_header(config):
    ...
    return (
        ...
        'Using --random-order-num={plugin.run_case_num} {te}\n'
