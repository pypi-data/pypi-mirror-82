...
class PipelineEndpointsOperations(object):
    ...
    def list_pipeline_endpoints(
            self, subscription_id, resource_group_name, workspace_name, continuation_token=None, continuation_token1=None, count=500, active_only=False, custom_headers=None, raw=False, **operation_config):
        """
