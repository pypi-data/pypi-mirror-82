...
from ._module_constants import PARAMETERS, OUTPUTS, INPUTS
...
def create_kw_function_from_parameters(
    ...
    def f(**kwargs):
        ...
        # This should be removed soon since this break the design of the function.
        kwargs = compatible_old_version_params(kwargs, old_to_new_param_name_dict)
...
def compatible_old_version_params(init_params, old_to_new_param_name_dict):
    """
    Make init_params compatible since the rules that generate the default argument name have changed.
    ...
    :rtype: dict[str, str]
    """
    if old_to_new_param_name_dict is None or len(old_to_new_param_name_dict) == 0:
        return init_params
