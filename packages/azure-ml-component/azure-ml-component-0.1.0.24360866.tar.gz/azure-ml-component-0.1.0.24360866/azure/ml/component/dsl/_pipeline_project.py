...
from azure.ml.component._loggerfactory import track, _LoggerFactory, _PUBLIC_API, _most_recent_context
from azure.ml.component._telemetry import WorkspaceTelemetryMixin
from azure.ml.component._utils import _sanitize_python_variable_name, \
...
from azure.ml.component.dsl.component import ComponentExecutor, TooManyDSLComponentsError
...
class ComponentConfigBase:
    ...
    def register(self, workspace, version: str = None):
        ...
        from azure.ml.component._module_registration import _register_module_from_yaml
        _register_module_from_yaml(workspace, str(self.spec_path), version=version)
...
class DSLComponentConfig(ComponentConfigBase):
    ...
    def init(self, entry_only=False):
        ...
        # init resources
        job_type = self.dsl_component.component_executor.job_type
    ...
    def build(target=None, source_dir=None):
        ...
        for component in pipeline_project.components:
            if isinstance(component, DSLComponentConfig):
                job_type = component.dsl_component.component_executor.job_type
            else:
                job_type = 'UNKNOWN'
