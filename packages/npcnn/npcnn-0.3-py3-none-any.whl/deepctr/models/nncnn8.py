...
def NNCNN8(linear_feature_columns, dnn_feature_columns, 
         conv_kernel_width=(5, 5, 3), conv_filters=(64, 64, 64),
         mlp_feat_filters=((22, 22), (22, 22), (22, 22)), feat_pooling_width=(3, 3), feat_pooling_stride=2, ave_pooling_width=8, ave_stride=1,
    ...
    for i in range(1, l + 1):
        ...
        if i < l:
           ...
           x = tf.keras.layers.MaxPooling2D(pool_size=(p_width, p_width), strides=(p_stride, p_stride))(x)
