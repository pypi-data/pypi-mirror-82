...
def NNCNN11(linear_feature_columns, dnn_feature_columns, 
    ...
    for i in range(1, l + 1):
        ...
        x = tf.keras.layers.Conv2D(filters=filters, kernel_size=(1, width), strides=(1, 1), padding='same',
                                             activation='tanh', use_bias=True, )(x)
    ...
    x = DNN(dnn_hidden_units, activation='tanh', dropout_rate=dnn_dropout,l2_reg=l2_reg_dnn, seed=seed)(x)
