    ...
    def update_object(self, employee, data, local_data=None):
        ...
        if 'customer_id' in self.fields:
            ...
            if customer_id:
                ...
                while person._customers:
                    person_x_customer = person._customers.pop()
                    self.session.delete(person_x_customer)
    ...
    def update_object(self, customer, data, local_data=None):
        ...
        if 'group_id' in self.fields:
            ...
            if group_id:
                ...
                while customer._groups:
                    customer_x_group = customer._groups.pop()
                    self.session.delete(customer_x_group)
    ...
    def update_object(self, vendor, data, local_data=None):
        ...
        if 'contact_name' in self.fields:
            if data['contact_name']:
                ...
                while vendor._contacts:
                    vendor_x_contact = vendor._contacts.pop()
                    self.session.delete(vendor_x_contact)
