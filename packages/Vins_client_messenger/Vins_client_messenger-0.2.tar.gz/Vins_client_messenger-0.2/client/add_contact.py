...
class AddContactDialog(QDialog):
    ...
    Предлагает пользователю список всех контактов (уже добавленные контакты не отображаются)
    ...
    def update_possible_contacts(self):
        """
        Обновление списка контактов. Запрашивает с сервера
        список известных пользователей и обновляет отображение списка.
        """
        try:
