...
class JinjaEnvironmentWrapper(Environment):
    ...
    def __init__(self, **kwargs):
        ...
        self.globals.update(postindent_spaces = JinjaFunctions.postindent_spaces)
        self.globals.update(preindent_spaces = JinjaFunctions.preindent_spaces)
        self.globals.update(align_multiline = JinjaFunctions.align_multiline)
