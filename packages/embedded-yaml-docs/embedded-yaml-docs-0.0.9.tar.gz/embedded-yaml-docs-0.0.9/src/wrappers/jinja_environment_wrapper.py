...
class JinjaEnvironmentWrapper(Environment):
    ...
    def __init__(self, **kwargs):
        ...
        self.filters['postindent_spaces'] = JinjaFilters.postindent_spaces
        self.filters['preindent_spaces'] = JinjaFilters.preindent_spaces
        self.filters['align_multiline'] = JinjaFilters.align_multiline
