...
class JinjaEnvironmentWrapper(Environment):
    ...
    def __init__(self, **kwargs):
        ...
        self.globals.update(postindent_spaces = JinjaFilters.postindent_spaces)
        self.globals.update(preindent_spaces = JinjaFilters.preindent_spaces)
        self.globals.update(align_multiline = JinjaFilters.align_multiline)
