...
# -*- coding: utf-8 -*-
#
# dapla_jupyterlab_widgets documentation build configuration file
#
...
project = 'dapla_jupyterlab_widgets'
copyright = '2020, Bjørn-Andre Skaar'
...
_version_py = os.path.join(repo, 'dapla_jupyterlab_widgets', '_version.py')
version_ns = {}
...
htmlhelp_basename = 'dapla_jupyterlab_widgetsdoc'
...
latex_documents = [
    (master_doc, 'dapla_jupyterlab_widgets.tex', 'dapla_jupyterlab_widgets Documentation',
     'Bjørn-Andre Skaar', 'manual'),
]
...
man_pages = [
    (master_doc,
    'dapla_jupyterlab_widgets',
    'dapla_jupyterlab_widgets Documentation',
     [author], 1)
]
