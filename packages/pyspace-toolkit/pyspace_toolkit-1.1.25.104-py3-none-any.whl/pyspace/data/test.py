...
def test_maxi(config={}, data='default', intent_filter_for_entities=False):
    ...
    if isinstance(data, pd.DataFrame):
        ...
        if data == 'default':
            ...
            data.append( ('pound hesabımı getir', 'account_tr', {'_TYPE_': ['pound']}) )
            data.append( ('vadeli hesabimda ne kadar var', 'account_tr', {'_TYPE_': ['vadeli']}) )
            data.append( ('maxi kredi kartım kaç para olduğunu', 'credit_card_tr', {}) )
            ...
            data.append( ('kredi kartimda ne kadar limit var', 'credit_card_tr', {}) )
            data.append( ('kredi karti borcum ne kadar', 'credit_card_tr', {}) )
            data.append( ('4534 ile biten kartımın bakiyesi', 'credit_card_tr', {'_TYPE_': ['4534 ile biten kartımın']}) )
            ...
            # inform
            data.append( ('elli iki lira', 'transfer_money_tr', {}) )
            data.append( ('500 tl', 'transfer_money_tr', {}) )
            data.append( ('600 tl', 'transfer_money_tr', {}) )
            data.append( ('100 usd', 'foreign_currency_tr', {}) )
            data.append( ('5000 tl', 'transfer_money_tr', {}) )
            data.append( ('1 aylik', 'term_deposit_calculation_tr', {}) )
            data.append( ('elli bin tl', 'transfer_money_tr', {}) )
            data.append( ('iki yuz bin bes yuz lira', 'transfer_money_tr', {}) )
            ...
            data.append( ('250 lira 678902 numarali hesabimdan Murat\'in Levent Subesi aktarmak istiyorum', 'transfer_money_tr', {'_TO_ACCOUNT_TRANSFER_MONEY_TR_': ["Murat'in", 'Levent'], '_FROM_ACCOUNT_TRANSFER_MONEY_TR_': ['678902']}) )
            data.append( ('2M Enerji elektrik faturamı ödemek istiyorum', 'bill_payment_tr', {'_TARGET_TR_': ['2M'], '_CATEGORY_TR_': ['Enerji elektrik']}) )
            data.append( ('10 20 Nisan tarihleri arası hesabımdan ne kadar çekim yaptım?', 'history_tr', {'_DATE_SVP_': ['10 20 Nisan tarihleri arası'], '_DATE_': [{'startDate': '2020-04-10T00:00:00Z', 'endDate': '2020-04-20T23:59:59Z', 'tokens': '10 20 Nisan tarihleri arası'}], '_ACCOUNT_SVP_': ['hesabımdan']}) )
            data.append( ('ekimde bauhaus\'a ne kadar harcamışım', 'history_tr', {'_DATE_SVP_': ['ekimde'],'_DATE_': [{'startDate': '2020-10-01T00:00:00Z','endDate': '2020-10-31T23:59:59Z','tokens': 'ekimde'}],'_MODIFIER_SVP_': ['harcamışım'],'_MOD_TR_': [{'value': 'SPEND'}],'_TARGET_SVP_': ["bauhaus'a"]}) )
            data.append( ('1 Ocak 2018 kredi kartı kullanım dökümü?', 'history_tr', {'_DATE_SVP_': ['1 Ocak 2018'],'_DATE_': [{'startDate': '2018-01-01T00:00:00Z','endDate': '2018-01-01T23:59:59Z','tokens': '1 Ocak 2018'}],'_ACCOUNT_SVP_': ['kredi kartı']}) )
            data.append( ('1 şubat ile 1 kasım arasında yaptığım en yüksek üç anadolu jet harcamamı listele', 'txnlist_tr', {'_DATE_SVP_': ['1 şubat ile 1 kasım arasında'],'_DATE_': [{'startDate': '2020-02-01T00:00:00Z','endDate': '2020-11-01T23:59:59Z','tokens': '1 şubat ile 1 kasım arasında'}],'_MODIFIER_SVP_': ['en yüksek', 'harcamamı'],'_MOD_TR_': [{'value': 'MAX'}, {'value': 'SPEND'}],'_TARGET_SVP_': ['anadolu jet'],'_COUNT_SVP_': ['üç']}) )
            data.append( ('2 ay once en pahalı harcamam ne üzerine oldu?', 'txnlist_tr', {'_DATE_SVP_': ['2 ay once'],'_DATE_': [{'startDate': '2020-08-01T00:00:00Z','endDate': '2020-08-31T23:59:59Z','tokens': '2 ay once'}],'_MODIFIER_SVP_': ['en pahalı', 'harcamam'],'_MOD_TR_': [{'value': 'MAX'}, {'value': 'SPEND'}]}) )
            data.append( ('4553 ile sonlanan kredi kartımdan son ay çekilen bireysel emeklilik ücreti nedir?', 'txnlist_tr', {'_DATE_SVP_': ['son ay'],'_DATE_': [{'startDate': '2020-09-07T00:00:00Z','endDate': '2020-10-07T23:59:59Z','tokens': 'son ay'}],'_ACCOUNT_SVP_': ['4553 ile sonlanan'],'_TARGET_SVP_': ['bireysel emeklilik']}) )
            data.append( ('10 bin eur yatırsam yılda kazanırım', 'term_deposit_calculation_tr', {'_TYPE_': ['eur'],'_AMOUNT_': ['10 bin'],'_DATE_YEAR_': ['yılda']}) )
            data.append( ('10bin sterlin yatırsam ayda kazanırım', 'term_deposit_calculation_tr', {'_TYPE_': ['sterlin'],'_AMOUNT_': ['10bin'],'_DATE_MONTH_': ['ayda']}) )
            data.append( ('100 tl ye ne kadar faiz veriyorsunuz günlük', 'term_deposit_calculation_tr', {'_TYPE_': ['tl'], '_AMOUNT_': ['100'], '_DATE_DAY_': ['günlük']}) )
            data.append( ('5000 usd 32 gün', 'term_deposit_calculation_tr', {'_TYPE_': ['usd'],'_AMOUNT_': ['5000'],'_DATE_DAY_': ['32']}) )
            data.append( ('bi milyon aylık getirisi', 'term_deposit_calculation_tr', {'_AMOUNT_': ['bi milyon'], '_DATE_MONTH_': ['aylık']}) )
            data.append( ('bi trilyon ayık getiri', 'term_deposit_calculation_tr', {'_AMOUNT_': ['bi trilyon'], '_DATE_MONTH_': ['ayık']}) )
            data.append( ('5000 bin doların aylık faizi ne dir', 'term_deposit_calculation_tr', {'_TYPE_': ['doların'],'_AMOUNT_': ['5000 bin'],'_DATE_MONTH_': ['aylık']}) )
            data.append( ('100 bin lira yatırsam yıllık kazancım', 'term_deposit_calculation_tr', {'_TYPE_': ['lira'],'_AMOUNT_': ['100 bin'],'_DATE_YEAR_': ['yıllık']}) )
            data.append( ('50 000 tl senelik nekadar faiz veriliyorr', 'term_deposit_calculation_tr', {'_TYPE_': ['tl'],'_AMOUNT_': ['50 000'],'_DATE_YEAR_': ['senelik']}) )
            data.append( ('faiz yıllık getiri', 'term_deposit_calculation_tr', {'_DATE_YEAR_': ['yıllık']}) )
            data.append( ('bana faiz hesapla', 'term_deposit_calculation_tr', {'_RECALCULATION_': ['hesapla']}) )
            data.append( ('bana mevduat getiri hesaplamasi yap', 'term_deposit_calculation_tr', {'_RECALCULATION_': ['hesaplamasi']}) )
            data.append( ('bana konut kredısı cıkar mo', 'loan_application_tr', {'_CREDIT_TYPE_': ['konut']}) )
            data.append( ('ihtiyaç', 'loan_application_tr', {'_CREDIT_TYPE_': ['ihtiyac']}) )
            data.append( ('10.000 tl 48 ay ticari kredi ver', 'loan_application_tr', {'_CURRENCY_': ['tl'],'_AMOUNT_': ['10.000'],'_DATE_MONTH_': ['48'], '_CREDIT_TYPE_': ['ticari']}) )
            data.append( ('bana kredi hesapla', 'loan_application_tr', {'_RECALCULATION_': ['hesapla']}) )
            data.append( ('kredi hesapla', 'loan_application_tr', {'_RECALCULATION_': ['hesapla']}) )
            data.append( ('kredi basvurusunu istiyorum', 'loan_application_tr', {}) )
            data.append( ('bu ay kac liralik benzin alabilirim', 'spendadvice_tr', {'_TARGET_SVP_': ['benzin']}) )
            data.append( ('bu ay benzine en fazla ne kadar harcayabilirim', 'spendadvice_tr', {'_TARGET_SVP_': ['benzine']}) )
            data.append( ('bu ay benzine 1000 lira harcayabilirim', 'spendadvice_tr', {'_TARGET_SVP_': ['benzine'],'_MONEY_': [{'tokens': '1000 lira','numbers': [{'value': '1000', 'tokens': '1000'}],'value': '1000','currency': 'lira','svp_tokens': '1000 lira'}],'_AMOUNT_TR_': ['1000 lira']}) )
            data.append( ('1000tl harcayabilir miyim', 'spendadvice_tr', {'_MONEY_': [{'tokens': '1000tl', 'numbers': [{'value': '1000tl', 'tokens': '1000tl'}], 'value': '1000tl', 'currency': '1000tl', 'svp_tokens': '1000tl'}], '_AMOUNT_TR_': ['1000tl']}) )
            data.append( ('1300tl sınav ücreti ödemem bu ay ki harcamalarımı nasıl etkiler ?', 'spendadvice_tr', {'_TARGET_SVP_': ['sınav'], '_MONEY_': [{'tokens': '1300tl', 'numbers': [{'value': '1300tl', 'tokens': '1300tl'}], 'value': '1300tl', 'currency': '1300tl', 'svp_tokens': '1300tl'}], '_AMOUNT_TR_': ['1300tl']}) )
            data.append( ('250₺’lik züccaciye alisverisimi kredi kartindan ödeyebilirmiyim ?', 'spendadvice_tr', {'_TARGET_SVP_': ['züccaciye'], '_MONEY_': [{'tokens': '250₺', 'numbers': [{'value': 250, 'tokens': '250'}], 'value': 250, 'currency': 'lira', 'svp_tokens': '250₺'}], '_AMOUNT_TR_': ['250₺']}) )
            data.append( ('50 liralık benzin alabilir miyim?', 'spendadvice_tr', {'_TARGET_SVP_': ['benzin'], '_MONEY_': [{'tokens': '50 liralık', 'numbers': [{'value': '50', 'tokens': '50'}], 'value': '50', 'currency': 'liralık', 'svp_tokens': '50 liralık'}], '_AMOUNT_TR_': ['50 liralık']}) )
            data.append( ('acil DIGDIGDIG lira lazım var mı ?', 'spendadvice_tr', {'_MONEY_': [{'tokens': 'DIGDIGDIG lira', 'numbers': [{'value': 'DIGDIGDIG', 'tokens': 'DIGDIGDIG'}], 'value': 'DIGDIGDIG', 'currency': 'lira', 'svp_tokens': 'DIGDIGDIG lira'}], '_AMOUNT_TR_': ['DIGDIGDIG lira']}) )
            data.append( ('altı yüz lira harcayabilir miyim', 'spendadvice_tr', {'_MONEY_': [{'tokens': 'altı yüz lira', 'numbers': [{'value': 'altı yüz', 'tokens': 'altı yüz'}], 'value': 'altı yüz', 'currency': 'lira', 'svp_tokens': 'altı yüz lira'}], '_AMOUNT_TR_': ['altı yüz lira']}) )
            data.append( ('arkadaşlarla kahvaltıya gideceğim . DIGDIGDIG tl yeter mi ?', 'spendadvice_tr', {'_TARGET_SVP_': ['kahvaltıya'], '_MONEY_': [{'tokens': 'DIGDIGDIG tl', 'numbers': [{'value': 'DIGDIGDIG', 'tokens': 'DIGDIGDIG'}], 'value': 'DIGDIGDIG', 'currency': 'tl', 'svp_tokens': 'DIGDIGDIG tl'}], '_AMOUNT_TR_': ['DIGDIGDIG tl']}) )
            data.append( ('aylık bilançoya göre takım elbiseye 800tl ayırabiliyor muyum ?', 'spendadvice_tr', {'_TARGET_SVP_': ['takım elbiseye'], '_MONEY_': [{'tokens': '800tl', 'numbers': [{'value': '800tl', 'tokens': '800tl'}], 'value': '800tl', 'currency': '800tl', 'svp_tokens': '800tl'}], '_AMOUNT_TR_': ['800tl']}) )
            data.append( ('DIG.DIGDIGDIG liralık mobilya satın alabilir miyim ?', 'spendadvice_tr', {'_TARGET_SVP_': ['mobilya'], '_MONEY_': [{'tokens': 'DIG.DIGDIGDIG liralık', 'numbers': [{'value': 'DIG.DIGDIGDIG', 'tokens': 'DIG.DIGDIGDIG'}], 'value': 'DIG.DIGDIGDIG', 'currency': 'liralık', 'svp_tokens': 'DIG.DIGDIGDIG liralık'}], '_AMOUNT_TR_': ['DIG.DIGDIGDIG liralık']}) )
            data.append( ('harcamak için DIGDIG liram var mı ?', 'spendadvice_tr', {'_MONEY_': [{'tokens': 'DIGDIG liram', 'numbers': [{'value': 'DIGDIG', 'tokens': 'DIGDIG'}], 'value': 'DIGDIG', 'currency': 'liram', 'svp_tokens': 'DIGDIG liram'}], '_AMOUNT_TR_': ['DIGDIG liram']}) )
            data.append( ("itunes'a DIGDIG tl harcama yapabilecek bütçem var mı ?", 'spendadvice_tr', {'_TARGET_SVP_': ["itunes'a"], '_MONEY_': [{'tokens': 'DIGDIG tl', 'numbers': [{'value': 'DIGDIG', 'tokens': 'DIGDIG'}], 'value': 'DIGDIG', 'currency': 'tl', 'svp_tokens': 'DIGDIG tl'}], '_AMOUNT_TR_': ['DIGDIG tl']}) )
            data.append( ("kredi kartimdan DIGDIGDIG tl lik bot alabilirmiyim", 'spendadvice_tr', {'_TARGET_SVP_': ['bot'], '_MONEY_': [{'tokens': 'DIGDIGDIG tl', 'numbers': [{'value': 'DIGDIGDIG', 'tokens': 'DIGDIGDIG'}], 'value': 'DIGDIGDIG', 'currency': 'tl', 'svp_tokens': 'DIGDIGDIG tl'}], '_AMOUNT_TR_': ['DIGDIGDIG tl']}) )
            data.append( ("kredi kartim harcama limitim doldu fakat ben DIGDIGDIG tl'lik benzin almak istiyorum mümkün mü ?", 'spendadvice_tr', {'_TARGET_SVP_': ['benzin'], '_MONEY_': [{'tokens': "DIGDIGDIG tl'lik", 'numbers': [{'value': 'DIGDIGDIG', 'tokens': 'DIGDIGDIG'}], 'value': 'DIGDIGDIG', 'currency': "tl'lik", 'svp_tokens': "DIGDIGDIG tl'lik"}], '_AMOUNT_TR_': ["DIGDIGDIG tl'lik"]}) )
            data.append( ("market ten DIGDIGDIG tl lik erzak alışverişi yapabilir miyim ?", 'spendadvice_tr', {'_TARGET_SVP_': ['market', 'erzak alışverişi'], '_MONEY_': [{'tokens': 'DIGDIGDIG tl', 'numbers': [{'value': 'DIGDIGDIG', 'tokens': 'DIGDIGDIG'}], 'value': 'DIGDIGDIG', 'currency': 'tl', 'svp_tokens': 'DIGDIGDIG tl'}], '_AMOUNT_TR_': ['DIGDIGDIG tl']}) )
            data.append( ("taksitle DIGDIGDIG liralık bir çanta alışverişi bütçem var mı ?", 'spendadvice_tr', {'_TARGET_SVP_': ['çanta alışverişi'], '_MONEY_': [{'tokens': 'DIGDIGDIG liralık', 'numbers': [{'value': 'DIGDIGDIG', 'tokens': 'DIGDIGDIG'}], 'value': 'DIGDIGDIG', 'currency': 'liralık', 'svp_tokens': 'DIGDIGDIG liralık'}], '_AMOUNT_TR_': ['DIGDIGDIG liralık']}) )
            data.append( ("yaz tatilinde DIGDIGDIGDIG liralık bir tatil yapabilir miyim ?", 'spendadvice_tr', {'_TARGET_SVP_': ['tatil'], '_MONEY_': [{'tokens': 'DIGDIGDIGDIG liralık', 'numbers': [{'value': 'DIGDIGDIGDIG', 'tokens': 'DIGDIGDIGDIG'}], 'value': 'DIGDIGDIGDIG', 'currency': 'liralık', 'svp_tokens': 'DIGDIGDIGDIG liralık'}], '_AMOUNT_TR_': ['DIGDIGDIGDIG liralık']}) )
            data.append( ("1300tl sınav ücreti ödemem bu ay ki harcamalarımı nasıl etkiler ?", 'spendadvice_tr', {'_TARGET_SVP_': ['sınav'], '_MONEY_': [{'tokens': '1300tl', 'numbers': [{'value': '1300tl', 'tokens': '1300tl'}], 'value': '1300tl', 'currency': '1300tl', 'svp_tokens': '1300tl'}], '_AMOUNT_TR_': ['1300tl']}) )
            data.append( ("akşam etkinliği yaparsam ne kadarlık harcama yaparım ?", 'spendadvice_tr', {'_TARGET_SVP_': ['etkinliği']}) )
            data.append( ("amazon haramalarım ne kadar olabilir ?", 'spendadvice_tr', {'_TARGET_SVP_': ['amazon']}) )
            data.append( ("ankaragücü kombinesi DIGDIGDIGDIG tl . benim bütçem var mı ?", 'spendadvice_tr', {'_TARGET_SVP_': ['ankaragücü kombinesi'], '_MONEY_': [{'tokens': 'DIGDIGDIGDIG tl', 'numbers': [{'value': 'DIGDIGDIGDIG', 'tokens': 'DIGDIGDIGDIG'}], 'value': 'DIGDIGDIGDIG', 'currency': 'tl', 'svp_tokens': 'DIGDIGDIGDIG tl'}], '_AMOUNT_TR_': ['DIGDIGDIGDIG tl']}) )
            data.append( ("araba almayı karşılayabilir miyim ?", 'spendadvice_tr', {'_TARGET_SVP_': ['araba']}) )
            data.append( ("arabama ne kadarlık benzin alabilirim ?", 'spendadvice_tr', {'_TARGET_SVP_': ['benzin']}) )
            data.append( ("arkadaşlarla kahvaltıya gideceğim . DIGDIGDIG tl yeter mi ?", 'spendadvice_tr', {'_TARGET_SVP_': ['kahvaltıya'], '_MONEY_': [{'tokens': 'DIGDIGDIG tl', 'numbers': [{'value': 'DIGDIGDIG', 'tokens': 'DIGDIGDIG'}], 'value': 'DIGDIGDIG', 'currency': 'tl', 'svp_tokens': 'DIGDIGDIG tl'}], '_AMOUNT_TR_': ['DIGDIGDIG tl']}) )
            data.append( ("arkadaşıma hediye almak için ne kadar bütçem var ?", 'spendadvice_tr', {'_TARGET_SVP_': ['hediye']}) )
            ...
            data.append( ("avrupa tatili düşünüyorum . bir haftalık , her şey dahil ne kadar harcayabiliriz ?", 'spendadvice_tr', {'_TARGET_SVP_': ['tatili']}) )
            data.append( ("aynı kirayı vermeye devam edebilir miyim ?", 'spendadvice_tr', {'_TARGET_SVP_': ['kirayı']}) )
            data.append( ("bilekliğe DIGDIGDIG lira verebilir miyim ?", 'spendadvice_tr', {'_TARGET_SVP_': ['bilekliğe'], '_MONEY_': [{'tokens': 'DIGDIGDIG lira', 'numbers': [{'value': 'DIGDIGDIG', 'tokens': 'DIGDIGDIG'}], 'value': 'DIGDIGDIG', 'currency': 'lira', 'svp_tokens': 'DIGDIGDIG lira'}], '_AMOUNT_TR_': ['DIGDIGDIG lira']}) )
            data.append( ("bu akşam konferans sonrası lüks bir restoranta gideceğim . ne kadar harcayabilirim ?", 'spendadvice_tr', {'_TARGET_SVP_': ['restoranta']}) )
            data.append( ("bu ay gsm operatörüm için ne kadar harcayabilirim ?", 'spendadvice_tr', {'_TARGET_SVP_': ['gsm operatörüm']}) )
            data.append( ("evleneceğim , mobilyalar için ne kadar ayırabilirim ?", 'spendadvice_tr', {'_TARGET_SVP_': ['mobilyalar']}) )
            data.append( ("hafta sonu gezmek için yeterli bütçem var mıdır ?", 'spendadvice_tr', {'_TARGET_SVP_': ['gezmek']}) )
            data.append( ("hafta sonu kaçamak yapabilmem için ne kadar harcarım", 'spendadvice_tr', {'_TARGET_SVP_': ['kaçamak']}) )
            data.append( ("lc waikiki de en fazla ne kadar harcayabilirim .", 'spendadvice_tr', {'_TARGET_SVP_': ['lc waikiki']}) )
            ...
            data.append( ("1100 tl 10 ay vadeli nakit avans", 'cash_advance_tr', {'_AMOUNT_TR_': ['1100 tl '], '_INSTALLMENT_TR_': ['10']}) )
            data.append( ("yedi ay vadeli nakit avans kullanmak istiyorum", 'cash_advance_tr', {'_INSTALLMENT_TR_': ['yedi']}) )
            data.append( ("para gönder", 'transfer_money_tr', {}) )
            data.append( ("para aktar", 'transfer_money_tr', {}) )
            data.append( ("20 tl para gönder", 'transfer_money_tr', {'_AMOUNT_TRANSFER_MONEY_TR_': ['20 tl ']}) )
            data.append( ("ortak hesaba beş lira on kuruş gönder", 'transfer_money_tr', { "_TO_ACCOUNT_TRANSFER_MONEY_TR_": ["ortak"], '_AMOUNT_TRANSFER_MONEY_TR_': ['beş lira on kuruş ']}) )
            data.append( ("para transferi", 'transfer_money_tr', {}) )
            data.append( ("igdaş faturamı kredi kartım ile öde", 'bill_payment_tr', {'_ACCOUNT_TR_': ['kredi kart'], '_TARGET_TR_': ['igdaş']}) )
            data.append( ("dolar kaça vurdu", 'foreign_currency_tr', {'_TARGET_AMOUNT_TR_': ['dolar']}) )
            data.append( ("dolar kaça ulaştı", 'foreign_currency_tr', {'_TARGET_AMOUNT_TR_': ['dolar']}) )
            data.append( ("dolar tavan yapar mı", 'foreign_currency_tr', {'_TARGET_AMOUNT_TR_': ['dolar']}) )
            data.append( ("dolar hesabımdan 100 dolar gönder", 'transfer_money_tr', {'_AMOUNT_TRANSFER_MONEY_TR_': ['100 dolar'], '_FROM_ACCOUNT_TRANSFER_MONEY_TR_': ['dolar']}) )
            data.append( ("5575 ile biten kredi kartı", 'credit_card_tr', {'_TYPE_': ['5575']}) )
            data.append( ("mayıs temmuz arasında kredi kartımdan ne kadar harcadım", 'history_tr', {'_DATE_SVP_': ['mayıs temmuz arasında'], '_DATE_': [{'startDate': '2020-05-01T00:00:00Z', 'endDate': '2020-07-31T23:59:59Z', 'tokens': 'mayıs temmuz arasında'}], '_ACCOUNT_SVP_': ['kredi kartımdan']}) )
            data.append( ("geçen ay harcamalarım", 'history_tr', {'_DATE_SVP_': ['geçen ay'], '_DATE_': [{'startDate': '2020-09-01T00:00:00Z', 'endDate': '2020-09-30T23:59:59Z', 'tokens': 'geçen ay'}], '_MODIFIER_SVP_': ['harcamalarım'], '_MOD_TR_': [{'value': 'SPEND'}]}) )
            data.append( ("geçen ay ne kadar harcadım", 'history_tr', {'_DATE_SVP_': ['geçen ay'], '_DATE_': [{'startDate': '2020-09-01T00:00:00Z', 'endDate': '2020-09-30T23:59:59Z', 'tokens': 'geçen ay'}]}) )
            data.append( ("euro hesabımdan beş euro gönderelim", 'transfer_money_tr', {'_AMOUNT_TRANSFER_MONEY_TR_': ['beş euro'], '_FROM_ACCOUNT_TRANSFER_MONEY_TR_': ['euro']}) )
            data.append( ("dolar hesabımdan simgeye para transferi yap", 'transfer_money_tr', {'_TO_ACCOUNT_TRANSFER_MONEY_TR_': ['simgeye'], '_FROM_ACCOUNT_TRANSFER_MONEY_TR_': ['dolar']}) )
            data.append( ("maximiles kartı dönem sonu borcunu öder misin", 'credit_card_payment_tr', {'_CARD_TYPE_TR_': ['maximiles'], '_PAYMENT_TYPE_TR_': ['dönem sonu']}) )
            data.append( ("bu ay 500 lira ve üzeri akaryakıt alışveriş yaptım mı", 'txnlist_tr', {'_DATE_SVP_': ['bu ay'], '_DATE_': [{'startDate': '2020-10-01T00:00:00Z', 'endDate': '2020-10-08T23:59:59Z', 'tokens': 'bu ay'}], '_MODIFIER_SVP_': ['alışveriş'], '_MOD_TR_': [{'value': 'SPEND'}], '_TARGET_SVP_': ['akaryakıt'], '_MONEY_MIN_SVP_': ['500']}) )
            data.append( ("bu ay içinde hesaımdan yaptığım alışverişler", 'history_tr', {'_DATE_SVP_': ['bu ay içinde'], '_DATE_': [{'startDate': '2020-10-01T00:00:00Z', 'endDate': '2020-10-08T23:59:59Z', 'tokens': 'bu ay içinde'}], '_MODIFIER_SVP_': ['alışverişler'], '_MOD_TR_': [{'value': 'SPEND'}], '_ACCOUNT_SVP_': ['hesaımdan']}) )
            data.append( ("bu yılki market harcamalarım", 'history_tr', {'_DATE_SVP_': ['bu yılki'], '_DATE_': [{'startDate': '2020-01-01T00:00:00Z', 'endDate': '2020-10-08T23:59:59Z', 'tokens': 'bu yılki'}], '_TARGET_SVP_': ['market']}) )
            data.append( ("bir seneden beri yaptığım migros alışverişlerim ne kadar", 'history_tr', {'_DATE_SVP_': ['bir seneden beri'], '_DATE_': [{'startDate': '2019-10-08T00:00:00Z', 'endDate': '2020-10-08T23:59:59Z', 'tokens': 'bir seneden beri'}], '_TARGET_SVP_': ['migros']}) )
            data.append( ("dolar göndermek istiyorum", 'transfer_money_tr', {'_AMOUNT_TRANSFER_MONEY_TR_': ['dolar']}) )
            data.append( ("para transferi yapcam", 'transfer_money_tr', {}) )
            data.append( ("para transferi yapacağım", 'transfer_money_tr', {}) )
            data.append( ("para transferi yapma", 'transfer_money_tr', {}) )
            data.append( ("maxi para transferi", 'transfer_money_tr', {}) )
            data.append( ("para transferi yapsana", 'transfer_money_tr', {}) )
            data.append( ("para transferi", 'transfer_money_tr', {}) )
            data.append( ("dolar hesabımdan 40 dolar boz", 'foreign_currency_tr', {'_TARGET_AMOUNT_TR_': ['40 dolar'], '_SELL_TR_': ['boz']}) )
            data.append( ("dolar hesabımdan otuz dolar boz", 'foreign_currency_tr', {'_TARGET_AMOUNT_TR_': ['otuz dolar'], '_SELL_TR_': ['boz']}) )
            data.append( ("200 tl ye denk gelen tutarda dolar boz", 'foreign_currency_tr', {'_TARGET_AMOUNT_TR_': ['dolar'], '_REF_AMOUNT_TR_': ['200 tl'], '_SELL_TR_': ['boz']}) )
            data.append( ("200 tl lik dolar boz", 'foreign_currency_tr', {'_TARGET_AMOUNT_TR_': ['dolar'], '_REF_AMOUNT_TR_': ['200 tl'], '_SELL_TR_': ['boz']}) )
            data.append( ("200 tl ye denk gelen tutarda euro boz", 'foreign_currency_tr', {'_TARGET_AMOUNT_TR_': ['euro'], '_REF_AMOUNT_TR_': ['200 tl'], '_SELL_TR_': ['boz']}) )
            data.append( ("200 tl ye denk gelen tutarda euro al", 'foreign_currency_tr', {'_TARGET_AMOUNT_TR_': ['euro'], '_REF_AMOUNT_TR_': ['200 tl'], '_BUY_TR_': ['al']}) )
            data.append( ("döviz", 'foreign_currency_tr', {'_TARGET_AMOUNT_TR_': ['döviz']}) )
            data.append( ("riyal kuru", 'foreign_currency_tr', {'_TARGET_AMOUNT_TR_': ['riyal']}) )
            data.append( ("aud kur", 'foreign_currency_tr', {'_TARGET_AMOUNT_TR_': ['aud']}) )
            data.append( ("dkk kur", 'foreign_currency_tr', {'_TARGET_AMOUNT_TR_': ['dkk']}) )
            data.append( ("sek kur", 'foreign_currency_tr', {'_TARGET_AMOUNT_TR_': ['sek']}) )
            data.append( ("nok kur", 'foreign_currency_tr', {'_TARGET_AMOUNT_TR_': ['nok']}) )
            data.append( ("jpy kur", 'foreign_currency_tr', {'_TARGET_AMOUNT_TR_': ['jpy']}) )
            data.append( ("sar kur", 'foreign_currency_tr', {'_TARGET_AMOUNT_TR_': ['sar']}) )
            data.append( ("amerikan doları", 'foreign_currency_tr', {'_TARGET_AMOUNT_TR_': ['amerikan doları']}) )
            data.append( ("ingiliz sterlini", 'foreign_currency_tr', {'_TARGET_AMOUNT_TR_': ['ingiliz sterlini']}) )
            data.append( ("isviçre frangı", 'foreign_currency_tr', {'_TARGET_AMOUNT_TR_': ['isviçre frangı']}) )
            data.append( ("kanada doları", 'foreign_currency_tr', {'_TARGET_AMOUNT_TR_': ['kanada doları']}) )
            data.append( ("danimarka kronu", 'foreign_currency_tr', {'_TARGET_AMOUNT_TR_': ['danimarka kronu']}) )
            data.append( ("isveç kronu", 'foreign_currency_tr', {'_TARGET_AMOUNT_TR_': ['isveç kronu']}) )
            data.append( ("norveç kronu", 'foreign_currency_tr', {'_TARGET_AMOUNT_TR_': ['norveç kronu']}) )
            data.append( ("japon yeni", 'foreign_currency_tr', {'_TARGET_AMOUNT_TR_': ['japon yeni']}) )
            data.append( ("kuveyt dinarı", 'foreign_currency_tr', {'_TARGET_AMOUNT_TR_': ['kuveyt dinarı']}) )
            data.append( ("suudi arab. Riyali", 'foreign_currency_tr', {'_TARGET_AMOUNT_TR_': ['suudi arab. Riyali']}) )
            data.append( ("riyal", 'foreign_currency_tr', {'_TARGET_AMOUNT_TR_': ['riyal']}) )
            data.append( ("kron", 'foreign_currency_tr', {'_TARGET_AMOUNT_TR_': ['kron']}) )
            data.append( ("dolar", 'foreign_currency_tr', {'_TARGET_AMOUNT_TR_': ['dolar']}) )
            data.append( ("sterlin", 'foreign_currency_tr', {'_TARGET_AMOUNT_TR_': ['sterlin']}) )
            data.append( ("frank", 'foreign_currency_tr', {'_TARGET_AMOUNT_TR_': ['frank']}) )
            data.append( ("hesap bilgilerim", 'account_tr', {}) )
            data.append( ("hesaplarım", 'account_tr', {}) )
            data.append( ("hesap numaram", 'account_tr', {}) )
            data.append( ("hesap numaramı göster", 'account_tr', {}) )
            data.append( ("hesap bilgilerimi göster", 'account_tr', {}) )
            data.append( ("maxi hesap bilgilerimi göster", 'account_tr', {}) )
            data.append( ("maxi hesap numaralarımı göster", 'account_tr', {}) )
            data.append( ("hesap bilgileri", 'account_tr', {}) )
            data.append( ("hesap numarası", 'account_tr', {}) )
            data.append( ("hesap bakiyesi", 'account_tr', {}) )
            data.append( ("hesap bakiyeleri", 'account_tr', {}) )
            data.append( ("hesap bakiyelerimi göster", 'account_tr', {}) )
            data.append( ("hesap bakiyeleri", 'account_tr', {}) )
            data.append( ("iban", 'account_tr', {'_TYPE_': ['iban']}) )
            data.append( ("ibanı yolla", 'account_tr', {'_TYPE_': ['ibanı']}) )
            data.append( ("iban yolla", 'account_tr', {'_TYPE_': ['iban']}) )
            data.append( ("iban yollama", 'account_tr', {'_TYPE_': ['iban']}) )
            data.append( ("iban paylaş", 'account_tr', {'_TYPE_': ['iban']}) )
            data.append( ("ibanı paylaşma", 'account_tr', {'_TYPE_': ['ibanı']}) )
            data.append( ("iban paylaşma", 'account_tr', {'_TYPE_': ['iban']}) )
            data.append( ("ibanı paylaşmak istiyorum", 'account_tr', {'_TYPE_': ['ibanı']}) )
            data.append( ("ibanı göstersene", 'account_tr', {'_TYPE_': ['ibanı']}) )
            data.append( ("iban paylaşımı", 'account_tr', {'_TYPE_': ['iban']}) )
            data.append( ("hesap bakiyem", 'account_tr', {}) )
            data.append( ("bakiyem", 'account_tr', {}) )
            data.append( ("vadeli hesaplarım", 'account_tr', {'_TYPE_': ['vadeli']}) )
            data.append( ("dolar hesabım", 'account_tr', {'_TYPE_': ['dolar']}) )
            data.append( ("euro hesabım", 'account_tr', {'_TYPE_': ['euro']}) )
            data.append( ("ne kadar param kaldı", 'account_tr', {}) )
            data.append( ("ek hesabım", 'account_tr', {'_TYPE_': ['ek']}) )
            data.append( ("ek hesaplarım", 'account_tr', {'_TYPE_': ['ek']}) )
            data.append( ("faturalı hat ödeme", 'bill_payment_tr', {'_CATEGORY_TR_': ['faturalı hat']}) )
            data.append( ("faturalı hat ödemesi", 'bill_payment_tr', {'_CATEGORY_TR_': ['faturalı hat']}) )
            data.append( ("faturalı hattımı ödeme", 'bill_payment_tr', {'_CATEGORY_TR_': ['faturalı hatımı']}) )
            data.append( ("kredi kartından hesabıma para gönderme", 'cash_advance_tr', {}) )
            data.append( ("karttan hesabıma para at", 'cash_advance_tr', {}) )
            data.append( ("karttan hesabıma para aktarma", 'cash_advance_tr', {}) )
            data.append( ("karttan atm hesabına para at", 'cash_advance_tr', {}) )
            data.append( ("kredi kartından atm hesabına 300 lira aktar", 'cash_advance_tr', {'_AMOUNT_TR_': ['300 lira ']}) )
            data.append( ("kredi kartından bankamatik hesabına 450 lira aktar", 'cash_advance_tr', {'_AMOUNT_TR_': ['450 lira ']}) )
            data.append( ("kredi kartından vadesiz hesabıma 200 lira gönder", 'cash_advance_tr', {'_AMOUNT_TR_': ['200 lira ']}) )
            data.append( ("5520 nl kartımın borcunu öde", 'credit_card_payment_tr', {'_CARD_TYPE_TR_ ': ['5520 nl']}) )
            data.append( ("kartlarımın borçlarını öde", 'credit_card_payment_tr', {}) )
            data.append( ("select kartımı ödemek istiyorum", 'credit_card_payment_tr', {'_CARD_TYPE_TR_': ['select']}) )
            data.append( ("başkent hesabımdan maximiles kartıma elli lira yatır", 'credit_card_payment_tr', {'_CARD_TYPE_TR_': ['maximiles'], '_AMOUNT_TR_': ['elli lira ']}) )
            data.append( ("başkent hesabından maximum karta 300 lira yatır", 'credit_card_payment_tr', {'_AMOUNT_TR_': ['300 lira ']}) )
            data.append( ("başkent hesabından privia karta 300 lira yatır", 'credit_card_payment_tr', {'_CARD_TYPE_TR_': ['privia',], '_AMOUNT_TR_': ['300 lira ']}) )
            data.append( ("başkent hesabından visa karta 300 lira yatır", 'credit_card_payment_tr', {'_CARD_TYPE_TR_': ['visa'], '_AMOUNT_TR_': ['300 lira ']}) )
            data.append( ("Altın", 'gold_buy_sale_tr', {}) )
            data.append( ("Para Transferi", 'transfer_money_tr', {}) )
            data.append( ("usd eur günlük kur bilgileri", 'foreign_currency_tr', {'_TARGET_AMOUNT_TR_': ['usd', 'eur'],}) )
            data.append( ("usd altın günlük kur bilgileri", 'foreign_currency_tr', {'_TARGET_AMOUNT_TR_': ['usd', 'altın']}) )
            data.append( ("eur altın günlük kur bilgileri", 'foreign_currency_tr', {'_TARGET_AMOUNT_TR_': ['eur', 'altın']}) )
            data.append( ("usd eur altın günlük kur bilgileri", 'foreign_currency_tr', {'_TARGET_AMOUNT_TR_': ['usd', 'eur', 'altın']}) )
            data.append( ("Kart Borcu Ödeme", 'credit_card_payment_tr', {}) )
            data.append( ("Harcama Önerisi", 'spendadvice_tr', {}) )
            data.append( ("Bu ay ne kadar harcadım?", 'history_tr', {'_DATE_SVP_': ['Bu ay'], '_DATE_': [{'startDate': '2020-10-01T00:00:00Z', 'endDate': '2020-10-08T23:59:59Z', 'tokens': 'Bu ay'}]}) )
            data.append( ("Son 6 ayda yaptığım 50 TL den fazla benzin harcamalarım", 'history_tr', {'_DATE_SVP_': ['Son 6 ayda'], '_DATE_': [{'startDate': '2020-04-08T00:00:00Z', 'endDate': '2020-10-08T23:59:59Z', 'tokens': 'Son 6 ayda'}], '_MODIFIER_SVP_': ['harcamalarım'], '_MOD_TR_': [{'value': 'SPEND'}], '_TARGET_SVP_': ['benzin'], '_MONEY_MIN_SVP_': ['50 tl']}) )
            data.append( ("Bu yılki en pahalı ilk 3 harcamam", 'txnlist_tr', {'_DATE_SVP_': ['Bu yılki'], '_DATE_': [{'startDate': '2020-01-01T00:00:00Z', 'endDate': '2020-10-08T23:59:59Z', 'tokens': 'Bu yılki'}], '_MODIFIER_SVP_': ['en pahalı', 'ilk', 'harcamam'], '_MOD_TR_': [{'value': 'MAX'}, {'value': 'SPEND'}], '_COUNT_SVP_': ['3'], '_COUNT_': [3]}) )
            data.append( ("maximum kartım", 'credit_card_tr', {'_TYPE_': ['maximum']}) )
            data.append( ("maximum kartlarım", 'credit_card_tr', {'_TYPE_': ['maximum']}) )
            data.append( ("kartlarım", 'credit_card_tr', {}) )
            data.append( ("kredi kartı", 'credit_card_tr', {}) )
            data.append( ("kredi kartım", 'credit_card_tr', {}) )
            data.append( ("maximiles kartım", 'credit_card_tr', {'_TYPE_': ['maximiles']}) )
            data.append( ("maximiles kartlarım", 'credit_card_tr', {'_TYPE_': ['maximiles']}) )
            data.append( ("gold kartlarım", 'credit_card_tr', {'_TYPE_': ['gold']}) )
            data.append( ("maksimum kartım", 'credit_card_tr', {'_TYPE_': ['maksimum']}) )
            data.append( ("maksimum kartlarım", 'credit_card_tr', {'_TYPE_': ['maksimum']}) )
            data.append( ("visa kartlarım", 'credit_card_tr', {'_TYPE_': ['visa']}) )
            data.append( ("visa kartım", 'credit_card_tr', {'_TYPE_': ['visa']}) )
            data.append( ("toplam borcum", 'credit_card_tr', {}) )
            data.append( ("kart kullanılabilir limitim kaç", 'credit_card_tr', {}) )
            data.append( ("asgari ödeme ne kadar", 'credit_card_tr', {}) )
            data.append( ("kartın asgari ödemesi ne kadar", 'credit_card_tr', {}) )
            data.append( ("işte üniversiteli kartım", 'credit_card_tr', {'_TYPE_': ['işte üniversiteli']}) )
            data.append( ("1341 ile biten kartım", 'credit_card_tr', {'_TYPE_': ['1341']}) )
            data.append( ("yeniden hesapla", 'inform#recalculation_tr', {'_RECALCULATION_': ['hesapla']}) )
            data.append( ("tekrar hesapla", 'inform#recalculation_tr', {'_RECALCULATION_': ['hesapla']}) )
            data.append( ("sekiz bin otuz gün ne kadar getirir", 'term_deposit_calculation_tr', {'_AMOUNT_': ['sekiz bin'], '_DATE_DAY_': ['otuz']}) )
            data.append( ("1 yılda 1 milyon ne getirir", 'term_deposit_calculation_tr', {'_AMOUNT_': ['1 milyon'], '_DATE_YEAR_': ['1']}) )
            data.append( ("vadeli hesapla", 'term_deposit_calculation_tr', {'_RECALCULATION_': ['hesapla']}) )
            data.append( ("vade hesaplama", 'term_deposit_calculation_tr', {'_RECALCULATION_': ['hesaplama']}) )
            data.append( ("vadeli getiri bulma", 'term_deposit_calculation_tr', {}) )
            data.append( ("bakiye", 'account_tr', {}) )
            data.append( ("bakiyem", 'account_tr', {}) )
            data.append( ("türkiye iş bankası", 'isbank', {}) )
            data.append( ("Türkiye iş bankası", 'isbank', {}) )
            data.append( ("Türkiye İş Bankası", 'isbank', {}) )
            data.append( ("serkan kaygalak", 'ust_yonetim', {}) )
            data.append( ("serkan uğraş kaygalak", 'ust_yonetim', {}) )
            data.append( ("yalçın sezen kimdir", 'ust_yonetim', {}) )
            data.append( ("adnan bali kimdir", 'ust_yonetim', {}) )
            data.append( ("hakan aran ne zamandan beri sizde", 'ust_yonetim', {}) )
            data.append( ("hakan aran ne zamandır sizde", 'ust_yonetim', {}) )
            data.append( ("ayşe kimdir", 'oos', {}) )
            data.append( ("mümtaz kimdir", 'oos', {}) )
            data.append( ("kredi kartı", 'credit_card_tr', {}) )
            data.append( ("maximiles", 'credit_card_tr', {'_TYPE_': ['maximiles']}) )
            data.append( ("maximiles kartımın toplam borcunu ödemek istiyorunm", 'credit_card_payment_tr', {'_CARD_TYPE_TR_': ['maximiles']}) )
            data.append( ("maximiles kartı dönem sonu borcunu öder misin", 'credit_card_payment_tr', {'_CARD_TYPE_TR_': ['maximiles'], '_PAYMENT_TYPE_TR_': ['dönem sonu']}) )
            data.append( ("kredi hesapla", 'loan_application_tr', {'_RECALCULATION_': ['hesapla']}) )
            data.append( ("toplam borcu öde", 'credit_card_payment_tr', {'_PAYMENT_TYPE_TR_': ['toplam']}) )
            data.append( ("toplam borcu mecidiyeköy hesabından öde", 'credit_card_payment_tr', {'_CARD_TYPE_TR_': ['mecidiyeköy'], '_PAYMENT_TYPE_TR_': ['toplam']}) )
            data.append( ("usd kartın asgarisi", 'credit_card_tr', {'_TYPE_': ['usd']}) )
            data.append( ("maximiles kartın asgarisi", 'credit_card_tr', {'_TYPE_': ['maximiles']}) )
            data.append( ("maximum kartın asgarisi", 'credit_card_tr', {'_TYPE_': ['maximum']}) )
            data.append( ("hesap kesim tarihim", 'credit_card_tr', {}) )
            data.append( ("maximum kart", 'credit_card_tr', {'_TYPE_': ['maximum']}) )
            data.append( ("maksimum kart", 'credit_card_tr', {'_TYPE_': ['maksimum']}) )
            data.append( ("maximiles kart", 'credit_card_tr', {'_TYPE_': ['maximiles']}) )
            data.append( ("gold kart", 'credit_card_tr', {'_TYPE_': ['gold']}) )
            data.append( ("gold kartım", 'credit_card_tr', {'_TYPE_': ['gold']}) )
            data.append( ("kart", 'credit_card_tr', {}) )
            data.append( ("kartım", 'credit_card_tr', {}) )
            data.append( ("kart kullanılabilir limit", 'credit_card_tr', {}) )
            data.append( ("gold kartın asgarisi", 'credit_card_tr', {'_TYPE_': ['gold']}) )
            data.append( ("visa kartın asgarisi", 'credit_card_tr', {'_TYPE_': ['visa']}) )
            data.append( ("vadesiz yp hesaplarımı listeler misin", 'account_tr', {'_TYPE_': ['vadesiz yp']}) )
            data.append( ("başkent ankara şubesindeki vadeli tl hesabımda ne kadar var", 'account_tr', {'_TYPE_': ['vadeli', 'tl', 'başkent ankara']}) )
            data.append( ("hesabımı göster", 'account_tr', {}) )
            data.append( ("hesap", 'account_tr', {}) )
            data.append( ("hesabım", 'account_tr', {}) )
            data.append( ("hesabımın bilgileri", 'account_tr', {}) )
            data.append( ("hesap bilgilerim", 'account_tr', {}) )
            data.append( ("hesap bilgilerimi göster", 'account_tr', {}) )
            data.append( ("kıbrıs hesabımdan harun keskin adlı kişiye 1 tl transfer edeceğim", 'transfer_money_tr', {'_AMOUNT_TRANSFER_MONEY_TR_': ['1 tl '], '_TO_ACCOUNT_TRANSFER_MONEY_TR_': ['harun keskin'], '_FROM_ACCOUNT_TRANSFER_MONEY_TR_': ['kıbrıs']}) )
            data.append( ("fatura ödeme işlemi yapıcaktım", 'bill_payment_tr', {}) )
            data.append( ("su faturasını buradan ödeyebilir miyim", 'bill_payment_tr', {'_CATEGORY_TR_': ['su']}) )
            data.append( ("dolar hesabımdan bir dolar boz", 'foreign_currency_tr', {'_TARGET_AMOUNT_TR_': ['bir dolar'], '_REF_AMOUNT_TR_': ['dolar'], '_SELL_TR_': ['boz']}) )
            data.append( ("2 tl ye denk gelen tutarda dolar boz", 'foreign_currency_tr', {'_TARGET_AMOUNT_TR_': ['dolar'], '_REF_AMOUNT_TR_': ['2 tl'], '_SELL_TR_': ['boz']}) )
            data.append( ("2 tl ye denk gelen tutarda euro boz", 'foreign_currency_tr', {'_TARGET_AMOUNT_TR_': ['euro'], '_REF_AMOUNT_TR_': ['2 tl'], '_SELL_TR_': ['boz']}) )
            data.append( ("2 tl lik dolar boz", 'foreign_currency_tr', {'_TARGET_AMOUNT_TR_': ['dolar'], '_REF_AMOUNT_TR_': ['2 tl'], '_SELL_TR_': ['boz']}) )
            data.append( ("2 tl ye denk gelen tutarda euro al", 'foreign_currency_tr', {'_REF_AMOUNT_TR_': ['2 tl'], '_TARGET_AMOUNT_TR_': ['euro'], '_BUY_TR_': ['al']}) )
            data.append( ("kaç maximilim var", 'credit_card_tr', {}) )
            data.append( ("maxipuan", 'credit_card_tr', {}) )
            data.append( ("kaç maxipuanım var", 'credit_card_tr', {}) )
            data.append( ("kaç maxi puanım var", 'credit_card_tr', {}) )
            data.append( ("kart puanım", 'credit_card_tr', {}) )
            data.append( ("kart puanlarım", 'credit_card_tr', {}) )
            data.append( ("ne kadar maximilim var", 'credit_card_tr', {}) )
            data.append( ("uçuş puanım", 'credit_card_tr', {}) )
            data.append( ("uçuş milim var mı", 'credit_card_tr', {}) )
            data.append( ("kullanabileceğim maximil var mı", 'credit_card_tr', {}) )
            data.append( ("mil puanım var mı", 'credit_card_tr', {}) )
            data.append( ("maxipuan", 'credit_card_tr', {}) )
            data.append( ("ne kadar maxipuanım var", 'credit_card_tr', {}) )
            data.append( ("ne kadar kart paunım var", 'credit_card_tr', {}) )
            data.append( ("kartımda ne kadar puan birikti", 'credit_card_tr', {}) )
            data.append( ("kartımda ne kadar maxi puan birikti", 'credit_card_tr', {}) )
            data.append( ("kartımda biriken puanları göster", 'credit_card_tr', {}) )
            data.append( ("kartımda biriken puan var mı", 'credit_card_tr', {}) )
            data.append( ("kart puan sorgulama", 'credit_card_tr', {}) )
            data.append( ("kartımdaki puanlar", 'credit_card_tr', {}) )
            data.append( ("kullanabileceğim puan", 'credit_card_tr', {}) )
            data.append( ("maxipuan", 'credit_card_tr', {}) )
            data.append( ("anlık kredi kartı borcum", 'credit_card_tr', {}) )
            data.append( ("ne kadar limitim var", 'credit_card_tr', {}) )
            data.append( ("hesap özeti borcumu öğrenmek istiyorum", 'credit_card_tr', {}) )
            data.append( ("hesap özeti borcum", 'credit_card_tr', {}) )
            data.append( ("kullanılabilir limit bilgisi", 'credit_card_tr', {}) )
            data.append( ("kullanılabilir limitim", 'credit_card_tr', {}) )
            data.append( ("kullanılabilir müşteri limitim ne kadar", 'credit_card_tr', {}) )
            data.append( ("kredi kartı millerim", 'credit_card_tr', {}) )
            data.append( ("kartımda biriken uçuş milini öğrenebilir miyim", 'credit_card_tr', {}) )
            data.append( ("millerimi göster", 'credit_card_tr', {}) )
            data.append( ("Maximiles kartım ne durumda", 'credit_card_tr', {'_TYPE_': ['Maximiles']}) )
            data.append( ("kart limitin", 'credit_card_tr', {}) )
            data.append( ("Limitim ne", 'credit_card_tr', {}) )
            data.append( ("Çiftlik Şubesi hesabımdan kredi kartıma 1 lira aktar", 'credit_card_payment_tr', {'_AMOUNT_TR_': ['1 lira ']}) )
            data.append( ("maxi suyu öde", 'bill_payment_tr', {'_CATEGORY_TR_': ['suyu']}) )
            data.append( ("maxi faturayı nerden ödicem", 'bill_payment_tr', {}) )
            data.append( ("faturayı nerden ödicem", 'bill_payment_tr', {}) )
            data.append( ("faturayı nereden ödeyeceğim", 'bill_payment_tr', {}) )
            data.append( ("maxi hadi faturalarımı ödeyelim", 'bill_payment_tr', {}) )
            data.append( ("sen elektrik faturası ödeyebiliyonmu", 'bill_payment_tr', {'_CATEGORY_TR_': ['elektrik']}) )
            data.append( ("sen doğalgaz faturası ödeyebiliyonmu", 'bill_payment_tr', {'_CATEGORY_TR_': ['doğalgaz']}) )
            data.append( ("Kartımla alışveriş yapabilir miyim", 'spendadvice_tr', {}) )
            data.append( ("çalışanlara özel kampanyalar", 'campaign_tr', {'_STAFF_TR_': ['çalışanlara']}) )
            data.append( ("maximum mobil kampanyaları", 'campaign_tr', {'_TARGET_TR_': ['maximum mobil']}) )
            data.append( ("bankamatik kartlarına özel kampanya", 'campaign_tr', {}) )
            data.append( ("temmuz ayında ne kadar harcadım", 'history_tr', {'_DATE_SVP_': ['temmuz ayında'], '_DATE_': [{'startDate': '2020-07-01T00:00:00Z', 'endDate': '2020-07-31T23:59:59Z', 'tokens': 'temmuz ayında'}]}) )
            data.append( ("pound", 'foreign_currency_tr', {'_TARGET_AMOUNT_TR_': ['pound']}) )
            data.append( ("Kredi kartımdan 500 lirayı 4 aylık çekmek istiyorum", 'cash_advance_tr', {'_AMOUNT_TR_': ['500 lirayı'], '_INSTALLMENT_TR_': ['4']}) )
            data.append( ("kartımdan 500 hesabıma aktar", 'cash_advance_tr', {'_AMOUNT_TR_': ['500']}) )
            data.append( ("Maximiles kartımdan İçerenköy Hesabıma 500 TL aktar", 'cash_advance_tr', {'_AMOUNT_TR_': ['500 TL ']}) )
            data.append( ("Kartıma para yatırmak istiyorum", 'credit_card_payment_tr', {}) )
            data.append( ("Kartıma para yatır", 'credit_card_payment_tr', {}) )
            data.append( ("Kredi kartıma para yatırmak istiyorum", 'credit_card_payment_tr', {}) )
            data.append( ("Kartıma para aktar", 'credit_card_payment_tr', {}) )
            data.append( ("kartıma ödeme yapacağım", 'credit_card_payment_tr', {}) )
            data.append( ("kartımın borcunu bitireceğim", 'credit_card_payment_tr', {}) )
            data.append( ("kart ödeme", 'credit_card_payment_tr', {}) )
            data.append( ("Kredi kartımı ödemek istiyorum", 'credit_card_payment_tr', {}) )
            data.append( ("Kart borcumu kapatacağım", 'credit_card_payment_tr', {}) )
            data.append( ("Kredi kartıma 1 dolar öde", 'credit_card_payment_tr', {'_AMOUNT_TR_': ['1 dolar']}) )
            data.append( ("Kredi kartı borcumu ödeyebilir miyim", 'credit_card_payment_tr', {}) )
            data.append( ("Maximiles kartıma 1 lira aktar", 'credit_card_payment_tr', {'_CARD_TYPE_TR_': ['Maximiles'], '_AMOUNT_TR_': ['1 lira ']}) )
            data.append( ("Kartıma 1 dolar aktar", 'credit_card_payment_tr', {'_AMOUNT_TR_': ['1 dolar ']}) )
            data.append( ("Kredi kartı borcumu sıfırla", 'credit_card_payment_tr', {}) )
            data.append( ("Kart harcamalarımı ödeyelim", 'credit_card_payment_tr', {}) )
            data.append( ("Kredi kartı borcu nereden ödeniyor", 'credit_card_payment_tr', {}) )
            data.append( ("alış işlemi yapmak istiyorum", 'foreign_currency_tr', {'_BUY_TR_': ['alış']}) )
            data.append( ("bu ay benzine ne kadar harcadım", 'history_tr', {'_DATE_SVP_': ['bu ay'], '_DATE_': [{'startDate': '2020-10-01T00:00:00Z', 'endDate': '2020-10-08T23:59:59Z', 'tokens': 'bu ay'}], '_TARGET_SVP_': ['benzine']}) )
            data.append( ("2019 yılında boynerde ne harcadım", 'history_tr', {'_DATE_SVP_': ['2019 yılında'], '_DATE_': [{'startDate': '2019-01-01T00:00:00Z', 'endDate': '2019-12-31T23:59:59Z', 'tokens': '2019 yılında'}], '_TARGET_SVP_': ['boynerde']}) )
            data.append( ("2019 yılında trendyolda ne harcadım", 'history_tr', {'_DATE_SVP_': ['2019 yılında'], '_DATE_': [{'startDate': '2019-01-01T00:00:00Z', 'endDate': '2019-12-31T23:59:59Z', 'tokens': '2019 yılında'}], '_TARGET_SVP_': ['trendyolda']}) )
            data.append( ("2019 aralık harcamalarım", 'history_tr', {'_DATE_SVP_': ['2019 aralık'], '_DATE_': [{'startDate': '2019-12-01T00:00:00Z', 'endDate': '2019-12-31T23:59:59Z', 'tokens': '2019 aralık'}], '_MODIFIER_SVP_': ['harcamalarım'], '_MOD_TR_': [{'value': 'SPEND'}]}) )
            data.append( ("bu yıl mağazada yaptığım harcamalar", 'history_tr', {'_DATE_SVP_': ['bu yıl'], '_DATE_': [{'startDate': '2020-01-01T00:00:00Z', 'endDate': '2020-10-08T23:59:59Z', 'tokens': 'bu yıl'}], '_TARGET_SVP_': ['mağazada']}) )
            data.append( ("20 kasım nerelere harcama yaptım", 'history_tr', {'_DATE_SVP_': ['20 kasım'], '_DATE_': [{'startDate': '2019-11-20T00:00:00Z', 'endDate': '2019-11-20T23:59:59Z', 'tokens': '20 kasım'}]}) )
            data.append( ("mağaza harcamalarım", 'history_tr', {'_DATE_': [{'startDate': '2020-07-08T00:00:00Z', 'endDate': '2020-10-08T23:59:59Z', 'tokens': 'DEFAULT GENERATED'}], '_TARGET_SVP_': ['mağaza']}) )
            data.append( ("bu yıl mağazalarda yaptığım harcamalar", 'history_tr', {'_DATE_SVP_': ['bu yıl'], '_DATE_': [{'startDate': '2020-01-01T00:00:00Z', 'endDate': '2020-10-08T23:59:59Z', 'tokens': 'bu yıl'}], '_TARGET_SVP_': ['mağazalarda']}) )
            data.append( ("bu yıl mağazada yaptığım harcamalar", 'history_tr', {'_DATE_SVP_': ['bu yıl'], '_DATE_': [{'startDate': '2020-01-01T00:00:00Z', 'endDate': '2020-10-08T23:59:59Z', 'tokens': 'bu yıl'}], '_TARGET_SVP_': ['mağazada']}) )
            data.append( ("bu yıl marketlerde yaptığım harcama tutarı", 'history_tr', {'_DATE_SVP_': ['bu yıl'], '_DATE_': [{'startDate': '2020-01-01T00:00:00Z', 'endDate': '2020-10-08T23:59:59Z', 'tokens': 'bu yıl'}], '_TARGET_SVP_': ['marketlerde']}) )
            data.append( ("bu yıl marketlerde ne kadar harcadım", 'history_tr', {'_DATE_SVP_': ['bu yıl'], '_DATE_': [{'startDate': '2020-01-01T00:00:00Z', 'endDate': '2020-10-08T23:59:59Z', 'tokens': 'bu yıl'}], '_TARGET_SVP_': ['marketlerde']}) )
            data.append( ("bu yıl benzincilerde yaptığım harcamalar", 'history_tr', {'_DATE_SVP_': ['bu yıl'], '_DATE_': [{'startDate': '2020-01-01T00:00:00Z', 'endDate': '2020-10-08T23:59:59Z', 'tokens': 'bu yıl'}], '_TARGET_SVP_': ['benzincilerde']}) )
            data.append( ("yolladığım kiralar", 'txnlist_tr', {'_DATE_': [{'startDate': '2020-07-08T00:00:00Z', 'endDate': '2020-10-08T23:59:59Z', 'tokens': 'DEFAULT GENERATED'}], '_MODIFIER_SVP_': ['yolladığım'], '_TARGET_SVP_': ['kiralar']}) )
            data.append( ("kiralarım", 'txnlist_tr', {'_DATE_': [{'startDate': '2020-07-08T00:00:00Z', 'endDate': '2020-10-08T23:59:59Z', 'tokens': 'DEFAULT GENERATED'}], '_TARGET_SVP_': ['kiralarım']}) )
            data.append( ("telefon faturası yatırcam", 'bill_payment_tr', {'_CATEGORY_TR_': ['telefon']}) )
            data.append( ("faturalarımı ödiycem", 'bill_payment_tr', {}) )
            data.append( ("faturalarımı yatırcam", 'bill_payment_tr', {}) )
            data.append( ("hesaplarımı listele", 'account_tr', {}) )
            data.append( ("Bu akşam dışarıda yemek için 1000 liram var mı", 'spendadvice_tr', {'_TARGET_SVP_': ['dışarıda yemek'], '_MONEY_': [{'tokens': '1000 liram', 'numbers': [{'value': '1000', 'tokens': '1000'}], 'value': '1000', 'currency': 'liram', 'svp_tokens': '1000 liram'}], '_AMOUNT_TR_': ['1000 liram']}) )
            data.append( ("Bu akşam dışarıda yemek için 1000 tl var mı", 'spendadvice_tr', {'_TARGET_SVP_': ['dışarıda'], '_MONEY_': [{'tokens': '1000 tl', 'numbers': [{'value': '1000', 'tokens': '1000'}], 'value': '1000', 'currency': 'tl', 'svp_tokens': '1000 tl'}], '_AMOUNT_TR_': ['1000 tl']}) )
            data.append( ("Kahvaltı için 250 liram var mı", 'spendadvice_tr', {'_TARGET_SVP_': ['Kahvaltı'], '_MONEY_': [{'tokens': '250 liram', 'numbers': [{'value': '250', 'tokens': '250'}], 'value': '250', 'currency': 'liram', 'svp_tokens': '250 liram'}], '_AMOUNT_TR_': ['250 liram']}) )
            data.append( ("vadeli hesaplama", 'term_deposit_calculation_tr', {'_RECALCULATION_': ['hesaplama']}) )
            data.append( ("ay sonu getirisi hesaplama", 'term_deposit_calculation_tr', {'_RECALCULATION_': ['hesaplama']}) )
            data.append( ("ay sonu mevduat getirisi hesaplama", 'term_deposit_calculation_tr', {'_RECALCULATION_': ['hesaplama']}) )
            data.append( ("1200 lira 30 gün ay sonu getirisini hesapla", 'term_deposit_calculation_tr', {'_TYPE_': ['lira'], '_AMOUNT_': ['1200'], '_DATE_DAY_': ['30'], '_RECALCULATION_': ['hesapla']}) )
            data.append( ("1244 euronun aylık getirisi", 'term_deposit_calculation_tr', {'_TYPE_': ['euronun'], '_AMOUNT_': ['1244'], '_DATE_MONTH_': ['aylık']}) )
            data.append( ("1milyon 1 ayda ne getirir", 'term_deposit_calculation_tr', {'_AMOUNT_': ['1milyon'], '_DATE_MONTH_': ['1']}) )
            data.append( ("gram kaç lira oldu", 'gold_buy_sale_tr', {}) )
            data.append( ("bu ay ödenecek talimatlarım", 'upcoming_payments_tr', {}) )
            data.append( ("0899 ile biten kartımı göster", 'credit_card_tr', {'_TYPE_': ['0899']}) )
            data.append( ("kredi kartlarım", 'credit_card_tr', {}) )
            data.append( ("geçen haziran migros'ta ne kadar harcamışım", 'history_tr', {'_DATE_SVP_': ['geçen haziran'], '_DATE_': [{'startDate': '2020-06-01T00:00:00Z', 'endDate': '2020-06-30T23:59:59Z', 'tokens': 'geçen haziran'}], '_TARGET_SVP_': ["migros'ta"]}) )
            data.append( ("nisan ayı kart kullanımım", 'history_tr', {'_DATE_SVP_': ['nisan ayı'], '_DATE_': [{'startDate': '2020-04-01T00:00:00Z', 'endDate': '2020-04-30T23:59:59Z', 'tokens': 'nisan ayı'}], '_ACCOUNT_SVP_': ['kart']}) )
            data.append( ("temmuzun başından sonuna kadar en pahalı harcamam ne üzerine oldu?", 'history_tr', {'_DATE_SVP_': ['temmuzun başından sonuna'], '_DATE_': [{'startDate': '2020-07-01T00:00:00Z', 'endDate': '2020-07-31T23:59:59Z', 'tokens': 'temmuzun başından sonuna'}], '_MODIFIER_SVP_': ['en pahalı', 'harcamam'], '_MOD_TR_': [{'value': 'MAX'}, {'value': 'SPEND'}]}) )
            data.append( ("haziran ayı en az harcadığım 3 şey", 'txnlist_tr', {'_DATE_SVP_': ['haziran ayı'], '_DATE_': [{'startDate': '2020-06-01T00:00:00Z', 'endDate': '2020-06-30T23:59:59Z', 'tokens': 'haziran ayı'}], '_MODIFIER_SVP_': ['en az'], '_MOD_TR_': [{'value': 'MIN'}], '_COUNT_SVP_': ['3'], '_COUNT_': [3]}) )
            data.append( ("marttan nisan ayına kadar kredi kartımdan ne kadar harcadım", 'history_tr', {'_DATE_SVP_': ['marttan nisan ayına'], '_DATE_': [{'startDate': '2020-03-01T00:00:00Z', 'endDate': '2020-04-30T23:59:59Z', 'tokens': 'marttan nisan ayına'}], '_ACCOUNT_SVP_': ['kredi kartımdan']}) )
            data.append( ("4329 ile biten hesabımdan para gönder", 'transfer_money_tr', {'_FROM_ACCOUNT_TRANSFER_MONEY_TR_': ['4329']}) )
            data.append( ("kredi kartı borç ödeme", 'credit_card_payment_tr', {}) )
            data.append( ("geçen haftaki işlemlerim", 'history_tr', {'_DATE_SVP_': ['geçen haftaki'], '_DATE_': [{'startDate': '2020-09-28T00:00:00Z', 'endDate': '2020-10-04T23:59:59Z', 'tokens': 'geçen haftaki'}]}) )
            data.append( ("bu haftaki işlemlerim", 'history_tr', {'_DATE_SVP_': ['bu haftaki'], '_DATE_': [{'startDate': '2020-10-05T00:00:00Z', 'endDate': '2020-10-11T23:59:59Z', 'tokens': 'bu haftaki'}]}) )
    ...
    if 'rasa' in config:
        ...
        if 'raw_entities' in data.loc[0]['temp']:
