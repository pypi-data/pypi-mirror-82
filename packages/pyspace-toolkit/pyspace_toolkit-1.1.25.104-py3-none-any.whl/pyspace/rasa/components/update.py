            ...
            for e in entities:
                if e['extractor'] in ['DucklingHTTPExtractor', 'DucklingExtractor']:
                    ...
                    if e['entity'] == 'B-account':
                        ...
                        e['value'] = remove_words(e['value'], entity_blacklist['account_tr']['_TYPE_']['exact'], suffix=False)
                        e['value'] = remove_words(e['value'], entity_blacklist['account_tr']['_TYPE_']['with_suffix'])
                        if e['value'] == '':
                            continue
            ...
            for e in entities:
                if e['extractor'] in ['DucklingHTTPExtractor', 'DucklingExtractor']:
                    ...
                    if e['entity'] in ['B-account', 'B-cardtype', 'B-CARDTYPE']:
                        ...
                        e['value'] = remove_words(e['value'], entity_blacklist['credit_card_tr']['_TYPE_']['exact'], suffix=False)
                        e['value'] = remove_words(e['value'], entity_blacklist['credit_card_tr']['_TYPE_']['with_suffix'])
            ...
            for e in entities:
                if e['extractor'] in ['DucklingHTTPExtractor', 'DucklingExtractor']:
                    ...
                    if e['entity'] in ['B-cardtype', 'B-CARDTYPE']:
                        ...
                        e['value'] = remove_words(e['value'], entity_blacklist['cash_advance_tr']['_CARD_TYPE_TR_']['exact'], suffix=False)
                        e['value'] = remove_words(e['value'], entity_blacklist['cash_advance_tr']['_CARD_TYPE_TR_']['with_suffix'])
            ...
            for e in entities:
                if e['extractor'] in ['DucklingHTTPExtractor', 'DucklingExtractor']:
                    ...
                    if e['entity'] in ['B-account', 'B-cardtype', 'B-CARDTYPE']:
                        ...
                        e['value'] = remove_words(e['value'], entity_blacklist['credit_card_payment_tr']['_CARD_TYPE_TR_']['exact'], suffix=False)
                        e['value'] = remove_words(e['value'], entity_blacklist['credit_card_payment_tr']['_CARD_TYPE_TR_']['with_suffix'])
            ...
            for e in entities:
                if e['extractor'] in ['DucklingHTTPExtractor', 'DucklingExtractor']:
                    ...
                    if e['entity'] == 'B-account':
                        ...
                        e['value'] = remove_words(e['value'], entity_blacklist['bill_payment_tr']['B-bill-agency']['exact'], suffix=False)
                        if e['value'] == '':
                            continue
