...
class ClearSparseFeatures(Component):
    ...
    def train(self, training_data: TrainingData, config: Optional[RasaNLUModelConfig] = None, **kwargs: Any,):
        ...
        for message in training_data.training_examples:
            ...
            del message.data[SPARSE_FEATURE_NAMES[TEXT]] if SPARSE_FEATURE_NAMES[TEXT] in message.data
            del message.data[DENSE_FEATURIZABLE_ATTRIBUTES[TEXT]] if DENSE_FEATURIZABLE_ATTRIBUTES[TEXT] in message.data
