...
cdef class DeepNetworkModel(NeuralNetworkModel):
    ...
    def __init__(self, trainSet: InstanceList, validationSet: InstanceList, parameters: DeepNetworkParameter):
        ...
        """
        cdef list deltaWeights, hidden, hiddenBiased, bestWeights
        ...
        cdef Vector rMinusY, oneMinusHidden, tmph, tmpHidden
        cdef Matrix m
    ...
    cpdef calculateOutput(self):
        ...
        """
        cdef Vector hiddenBiased, hidden
        cdef int i
        hiddenBiased = None
