...
_COMMITSTATSREQUEST = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      ...
      serialized_options=b'\230\306,\001', file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
...
_LISTCOMMITSBYREFNAMERESPONSE = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='commits', full_name='gitaly.ListCommitsByRefNameResponse.commits', index=0,
      number=1, type=11, cpp_type=10, label=3,
      has_default_value=False, default_value=[],
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_LISTCOMMITSBYREFNAMERESPONSE.fields_by_name['commits'].message_type = shared__pb2._GITCOMMIT
