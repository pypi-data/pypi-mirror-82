...
def play(*, open_browser: bool, host: str, port: str) -> None:
    with server.ServerThread(host=host, port=port) as server_thread:
        ...
        print(f'Calculating states in the game in an infinite loop, press Ctrl-C to stop.')
        for state in state.write_to_game_folder():
            pass
