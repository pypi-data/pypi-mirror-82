...
from mastapy.bearings.tolerances import _1583, _1570, _1576
from mastapy._internal.cast_exception import CastException
from mastapy.detailed_rigid_connectors import _977
...
class InterferenceFitHalfDesign(_977.DetailedRigidConnectorHalfDesign):
    '''InterferenceFitHalfDesign
    ...
    @property
    def stress_region(self) -> '_1036.StressRegions':
        ...
        return constructor.new(_1036.StressRegions)(value) if value else None
    ...
    @property
    def tolerance(self) -> '_1583.SupportTolerance':
        ...
        if _1583.SupportTolerance.TYPE not in self.wrapped.Tolerance.__class__.__mro__:
    ...
    @property
    def tolerance_of_type_inner_support_tolerance(self) -> '_1570.InnerSupportTolerance':
        ...
        if _1570.InnerSupportTolerance.TYPE not in self.wrapped.Tolerance.__class__.__mro__:
    ...
    @property
    def tolerance_of_type_outer_support_tolerance(self) -> '_1576.OuterSupportTolerance':
        ...
        if _1576.OuterSupportTolerance.TYPE not in self.wrapped.Tolerance.__class__.__mro__:
