...
from mastapy.utility.cad_export import _1366
from mastapy.utility.report import _1314
...
class CustomReportCadDrawing(_1314.CustomReportNameableItem):
    '''CustomReportCadDrawing
    ...
    @property
    def stock_drawing(self) -> '_1366.StockDrawings':
        '''StockDrawings: 'StockDrawing' is the original name of this property.'''

        value = conversion.pn_to_mp_enum(self.wrapped.StockDrawing)
        return constructor.new(_1366.StockDrawings)(value) if value else None

    @stock_drawing.setter
    def stock_drawing(self, value: '_1366.StockDrawings'):
