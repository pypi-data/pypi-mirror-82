...
from mastapy.utility.report import (
    _1306, _1289, _1294, _1295,
    _1296, _1297, _1298, _1299,
    _1301, _1302, _1303, _1304,
    _1305, _1307, _1309, _1310,
    _1313, _1314, _1315, _1317,
    _1318, _1319, _1320, _1322,
    _1323
)
from mastapy.shafts import _20
from mastapy._internal.cast_exception import CastException
from mastapy.gears.gear_designs.cylindrical import _791
from mastapy.utility_gui.charts import _1533, _1534
from mastapy.bearings.bearing_results import _1604, _1607, _1615
...
from mastapy.system_model.analyses_and_results.modal_analyses.reporting import _4882, _4886
...
class DynamicCustomReportItem(_1314.CustomReportNameableItem):
    '''DynamicCustomReportItem
    ...
    @property
    def inner_item(self) -> '_1306.CustomReportItem':
        ...
        if _1306.CustomReportItem.TYPE not in self.wrapped.InnerItem.__class__.__mro__:
    ...
    @property
    def inner_item_of_type_ad_hoc_custom_table(self) -> '_1289.AdHocCustomTable':
        ...
        if _1289.AdHocCustomTable.TYPE not in self.wrapped.InnerItem.__class__.__mro__:
    ...
    @property
    def inner_item_of_type_custom_chart(self) -> '_1294.CustomChart':
        ...
        if _1294.CustomChart.TYPE not in self.wrapped.InnerItem.__class__.__mro__:
    ...
    @property
    def inner_item_of_type_custom_graphic(self) -> '_1295.CustomGraphic':
        ...
        if _1295.CustomGraphic.TYPE not in self.wrapped.InnerItem.__class__.__mro__:
    ...
    @property
    def inner_item_of_type_custom_image(self) -> '_1296.CustomImage':
        ...
        if _1296.CustomImage.TYPE not in self.wrapped.InnerItem.__class__.__mro__:
    ...
    @property
    def inner_item_of_type_custom_report(self) -> '_1297.CustomReport':
        ...
        if _1297.CustomReport.TYPE not in self.wrapped.InnerItem.__class__.__mro__:
    ...
    @property
    def inner_item_of_type_custom_report_cad_drawing(self) -> '_1298.CustomReportCadDrawing':
        ...
        if _1298.CustomReportCadDrawing.TYPE not in self.wrapped.InnerItem.__class__.__mro__:
    ...
    @property
    def inner_item_of_type_custom_report_chart(self) -> '_1299.CustomReportChart':
        ...
        if _1299.CustomReportChart.TYPE not in self.wrapped.InnerItem.__class__.__mro__:
    ...
    @property
    def inner_item_of_type_custom_report_column(self) -> '_1301.CustomReportColumn':
        ...
        if _1301.CustomReportColumn.TYPE not in self.wrapped.InnerItem.__class__.__mro__:
    ...
    @property
    def inner_item_of_type_custom_report_columns(self) -> '_1302.CustomReportColumns':
        ...
        if _1302.CustomReportColumns.TYPE not in self.wrapped.InnerItem.__class__.__mro__:
    ...
    @property
    def inner_item_of_type_custom_report_definition_item(self) -> '_1303.CustomReportDefinitionItem':
        ...
        if _1303.CustomReportDefinitionItem.TYPE not in self.wrapped.InnerItem.__class__.__mro__:
    ...
    @property
    def inner_item_of_type_custom_report_horizontal_line(self) -> '_1304.CustomReportHorizontalLine':
        ...
        if _1304.CustomReportHorizontalLine.TYPE not in self.wrapped.InnerItem.__class__.__mro__:
    ...
    @property
    def inner_item_of_type_custom_report_html_item(self) -> '_1305.CustomReportHtmlItem':
        ...
        if _1305.CustomReportHtmlItem.TYPE not in self.wrapped.InnerItem.__class__.__mro__:
    ...
    @property
    def inner_item_of_type_custom_report_item_container(self) -> '_1307.CustomReportItemContainer':
        ...
        if _1307.CustomReportItemContainer.TYPE not in self.wrapped.InnerItem.__class__.__mro__:
    ...
    @property
    def inner_item_of_type_custom_report_item_container_collection_base(self) -> '_1309.CustomReportItemContainerCollectionBase':
        ...
        if _1309.CustomReportItemContainerCollectionBase.TYPE not in self.wrapped.InnerItem.__class__.__mro__:
    ...
    @property
    def inner_item_of_type_custom_report_item_container_collection_item(self) -> '_1310.CustomReportItemContainerCollectionItem':
        ...
        if _1310.CustomReportItemContainerCollectionItem.TYPE not in self.wrapped.InnerItem.__class__.__mro__:
    ...
    @property
    def inner_item_of_type_custom_report_multi_property_item_base(self) -> '_1313.CustomReportMultiPropertyItemBase':
        ...
        if _1313.CustomReportMultiPropertyItemBase.TYPE not in self.wrapped.InnerItem.__class__.__mro__:
    ...
    @property
    def inner_item_of_type_custom_report_nameable_item(self) -> '_1314.CustomReportNameableItem':
        ...
        if _1314.CustomReportNameableItem.TYPE not in self.wrapped.InnerItem.__class__.__mro__:
    ...
    @property
    def inner_item_of_type_custom_report_named_item(self) -> '_1315.CustomReportNamedItem':
        ...
        if _1315.CustomReportNamedItem.TYPE not in self.wrapped.InnerItem.__class__.__mro__:
    ...
    @property
    def inner_item_of_type_custom_report_status_item(self) -> '_1317.CustomReportStatusItem':
        ...
        if _1317.CustomReportStatusItem.TYPE not in self.wrapped.InnerItem.__class__.__mro__:
    ...
    @property
    def inner_item_of_type_custom_report_tab(self) -> '_1318.CustomReportTab':
        ...
        if _1318.CustomReportTab.TYPE not in self.wrapped.InnerItem.__class__.__mro__:
    ...
    @property
    def inner_item_of_type_custom_report_tabs(self) -> '_1319.CustomReportTabs':
        ...
        if _1319.CustomReportTabs.TYPE not in self.wrapped.InnerItem.__class__.__mro__:
    ...
    @property
    def inner_item_of_type_custom_report_text(self) -> '_1320.CustomReportText':
        ...
        if _1320.CustomReportText.TYPE not in self.wrapped.InnerItem.__class__.__mro__:
    ...
    @property
    def inner_item_of_type_custom_sub_report(self) -> '_1322.CustomSubReport':
        ...
        if _1322.CustomSubReport.TYPE not in self.wrapped.InnerItem.__class__.__mro__:
    ...
    @property
    def inner_item_of_type_custom_table(self) -> '_1323.CustomTable':
        ...
        if _1323.CustomTable.TYPE not in self.wrapped.InnerItem.__class__.__mro__:
    ...
    @property
    def inner_item_of_type_custom_line_chart(self) -> '_1533.CustomLineChart':
        ...
        if _1533.CustomLineChart.TYPE not in self.wrapped.InnerItem.__class__.__mro__:
    ...
    @property
    def inner_item_of_type_custom_table_and_chart(self) -> '_1534.CustomTableAndChart':
        ...
        if _1534.CustomTableAndChart.TYPE not in self.wrapped.InnerItem.__class__.__mro__:
    ...
    @property
    def inner_item_of_type_loaded_bearing_chart_reporter(self) -> '_1604.LoadedBearingChartReporter':
        ...
        if _1604.LoadedBearingChartReporter.TYPE not in self.wrapped.InnerItem.__class__.__mro__:
    ...
    @property
    def inner_item_of_type_loaded_bearing_temperature_chart(self) -> '_1607.LoadedBearingTemperatureChart':
        ...
        if _1607.LoadedBearingTemperatureChart.TYPE not in self.wrapped.InnerItem.__class__.__mro__:
    ...
    @property
    def inner_item_of_type_loaded_roller_element_chart_reporter(self) -> '_1615.LoadedRollerElementChartReporter':
        ...
        if _1615.LoadedRollerElementChartReporter.TYPE not in self.wrapped.InnerItem.__class__.__mro__:
    ...
    @property
    def inner_item_of_type_shaft_system_deflection_sections_report(self) -> '_2400.ShaftSystemDeflectionSectionsReport':
        ...
        if _2400.ShaftSystemDeflectionSectionsReport.TYPE not in self.wrapped.InnerItem.__class__.__mro__:
    ...
    @property
    def inner_item_of_type_parametric_study_histogram(self) -> '_3594.ParametricStudyHistogram':
        ...
        if _3594.ParametricStudyHistogram.TYPE not in self.wrapped.InnerItem.__class__.__mro__:
    ...
    @property
    def inner_item_of_type_campbell_diagram_report(self) -> '_4882.CampbellDiagramReport':
        ...
        if _4882.CampbellDiagramReport.TYPE not in self.wrapped.InnerItem.__class__.__mro__:
    ...
    @property
    def inner_item_of_type_per_mode_results_report(self) -> '_4886.PerModeResultsReport':
        ...
        if _4886.PerModeResultsReport.TYPE not in self.wrapped.InnerItem.__class__.__mro__:
