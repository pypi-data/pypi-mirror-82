...
from mastapy.utility.report import _1309, _1310
...
T = TypeVar('T', bound='_1310.CustomReportItemContainerCollectionItem')


class CustomReportItemContainerCollection(_1309.CustomReportItemContainerCollectionBase, Generic[T]):
    '''CustomReportItemContainerCollection
