...
from mastapy.utility.report import _1313, _1316
...
TItem = TypeVar('TItem', bound='_1316.CustomReportPropertyItem')


class CustomReportMultiPropertyItem(_1313.CustomReportMultiPropertyItemBase, Generic[TItem]):
    '''CustomReportMultiPropertyItem
