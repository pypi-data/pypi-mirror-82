...
from mastapy.utility.modal_analysis.gears import _1338, _1341, _1343
...
class GearOrderForTE(_1343.OrderWithRadius):
    '''GearOrderForTE
    ...
    @property
    def position(self) -> '_1338.GearPositions':
        ...
        return constructor.new(_1338.GearPositions)(value) if value else None

    @property
    def additional_orders_and_harmonics(self) -> 'List[_1341.OrderForTE]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AdditionalOrdersAndHarmonics, constructor.new(_1341.OrderForTE))
        return value
