...
from mastapy.utility.modal_analysis.gears import _1337, _1341
...
class GearMeshForTE(_1341.OrderForTE):
    '''GearMeshForTE
    ...
    @property
    def attached_gears(self) -> 'List[_1337.GearOrderForTE]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AttachedGears, constructor.new(_1337.GearOrderForTE))
        return value
