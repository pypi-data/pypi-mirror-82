...
from mastapy.utility.databases import _1362, _1364, _1363
...
TValue = TypeVar('TValue', bound='_1362.NamedDatabaseItem')


class NamedDatabase(_1364.SQLDatabase['_1363.NamedKey', 'TValue'], Generic[TValue]):
    '''NamedDatabase
    ...
    def rename(self, item: '_1362.NamedDatabaseItem', new_name: 'str') -> 'bool':
