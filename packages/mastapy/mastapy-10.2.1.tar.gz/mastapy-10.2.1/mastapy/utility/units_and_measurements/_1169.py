...
class MeasurementBase(_0.APIBase):
    ...
    @property
    def rounding_method(self) -> '_1162.RoundingMethods':
        ...
        return constructor.new(_1162.RoundingMethods)(value) if value else None

    @rounding_method.setter
    def rounding_method(self, value: '_1162.RoundingMethods'):
    ...
    @property
    def current_unit(self) -> '_1174.Unit':
        ...
        if _1174.Unit.TYPE not in self.wrapped.CurrentUnit.__class__.__mro__:
