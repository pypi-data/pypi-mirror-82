...
from mastapy.utility.units_and_measurements.measurements import _1200
...
class DutyCyclePropertySummaryForce(_1368.DutyCyclePropertySummary['_1200.Force', 'T'], Generic[T]):
    '''DutyCyclePropertySummaryForce
