...
from mastapy.utility.units_and_measurements.measurements import _1179
...
class DutyCyclePropertySummarySmallAngle(_1368.DutyCyclePropertySummary['_1179.AngleSmall', 'T'], Generic[T]):
    '''DutyCyclePropertySummarySmallAngle
