...
from mastapy.nodal_analysis import _1387, _1415, _1402
...
class FEMeshingOptions(_0.APIBase):
    ...
    @property
    def element_order(self) -> '_1387.ElementOrder':
        '''ElementOrder: 'ElementOrder' is the original name of this property.'''

        value = conversion.pn_to_mp_enum(self.wrapped.ElementOrder)
        return constructor.new(_1387.ElementOrder)(value) if value else None

    @element_order.setter
    def element_order(self, value: '_1387.ElementOrder'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.ElementOrder = value

    @property
    def element_shape(self) -> '_1415.VolumeElementShape':
        ...
        return constructor.new(_1415.VolumeElementShape)(value) if value else None

    @element_shape.setter
    def element_shape(self, value: '_1415.VolumeElementShape'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def meshing_diameter_for_gear(self) -> '_1402.MeshingDiameterForGear':
        ...
        return constructor.new(_1402.MeshingDiameterForGear)(value) if value else None

    @meshing_diameter_for_gear.setter
    def meshing_diameter_for_gear(self, value: '_1402.MeshingDiameterForGear'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
