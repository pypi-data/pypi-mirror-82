...
from mastapy.fe_tools.vfx_tools import _972
...
class CMSOptions(_0.APIBase):
    ...
    @property
    def precision_when_saving_expansion_vectors(self) -> '_1078.DataPrecision':
        ...
        return constructor.new(_1078.DataPrecision)(value) if value else None

    @precision_when_saving_expansion_vectors.setter
    def precision_when_saving_expansion_vectors(self, value: '_1078.DataPrecision'):
    ...
    @property
    def internal_mode_options(self) -> '_1477.EigenvalueOptions':
        ...
        return constructor.new(_1477.EigenvalueOptions)(self.wrapped.InternalModeOptions) if self.wrapped.InternalModeOptions else None

    @property
    def solver_options(self) -> '_972.ProSolveOptions':
        ...
        return constructor.new(_972.ProSolveOptions)(self.wrapped.SolverOptions) if self.wrapped.SolverOptions else None
