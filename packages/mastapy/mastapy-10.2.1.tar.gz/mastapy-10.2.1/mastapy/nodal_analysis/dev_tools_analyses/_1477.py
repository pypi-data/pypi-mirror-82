...
class EigenvalueOptions(_0.APIBase):
    ...
    @property
    def mass_matrix_type(self) -> '_1495.MassMatrixType':
        ...
        return constructor.new(_1495.MassMatrixType)(value) if value else None

    @mass_matrix_type.setter
    def mass_matrix_type(self, value: '_1495.MassMatrixType'):
