...
class DrawStyleForImportedFE(_0.APIBase):
    ...
    @property
    def line_option(self) -> '_1388.FEMeshElementEntityOption':
        ...
        return constructor.new(_1388.FEMeshElementEntityOption)(value) if value else None

    @line_option.setter
    def line_option(self, value: '_1388.FEMeshElementEntityOption'):
