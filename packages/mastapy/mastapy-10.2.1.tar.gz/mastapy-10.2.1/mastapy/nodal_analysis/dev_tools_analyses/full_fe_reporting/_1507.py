...
from mastapy.nodal_analysis.dev_tools_analyses.full_fe_reporting import _1504
...
class ElementPropertiesMass(_1504.ElementPropertiesBase):
    '''ElementPropertiesMass
    ...
    @property
    def inertia(self) -> '_1091.InertiaTensor':
        ...
        return constructor.new(_1091.InertiaTensor)(self.wrapped.Inertia) if self.wrapped.Inertia else None
