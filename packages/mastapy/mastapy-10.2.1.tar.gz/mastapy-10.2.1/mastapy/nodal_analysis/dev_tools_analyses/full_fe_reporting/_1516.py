...
from mastapy.nodal_analysis.dev_tools_analyses.full_fe_reporting import _1501
...
class RigidElementNodeDegreesOfFreedom(_0.APIBase):
    ...
    @property
    def type_(self) -> '_1501.DegreeOfFreedomType':
        ...
        return constructor.new(_1501.DegreeOfFreedomType)(value) if value else None
