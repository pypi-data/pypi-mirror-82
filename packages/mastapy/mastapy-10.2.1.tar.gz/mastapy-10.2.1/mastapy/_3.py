...
from mastapy.bearings import _1546, _1558
...
from mastapy.nodal_analysis import _1379, _1394
...
from mastapy.utility import _1160, _1161
...
class MastaSettings:
    ...
    @property
    def iso14179_settings_database(self) -> '_1629.ISO14179SettingsDatabase':
        ...
        return constructor.new(_1629.ISO14179SettingsDatabase)(self.wrapped.ISO14179SettingsDatabase) if self.wrapped.ISO14179SettingsDatabase else None

    @property
    def bearing_settings(self) -> '_1546.BearingSettings':
        ...
        return constructor.new(_1546.BearingSettings)(self.wrapped.BearingSettings) if self.wrapped.BearingSettings else None
    ...
    @property
    def fe_user_settings(self) -> '_1394.FEUserSettings':
        ...
        return constructor.new(_1394.FEUserSettings)(self.wrapped.FEUserSettings) if self.wrapped.FEUserSettings else None
    ...
    @property
    def planet_carrier_settings(self) -> '_2056.PlanetCarrierSettings':
        ...
        return constructor.new(_2056.PlanetCarrierSettings)(self.wrapped.PlanetCarrierSettings) if self.wrapped.PlanetCarrierSettings else None

    @property
    def cad_export_settings(self) -> '_1365.CADExportSettings':
        ...
        return constructor.new(_1365.CADExportSettings)(self.wrapped.CADExportSettings) if self.wrapped.CADExportSettings else None

    @property
    def database_settings(self) -> '_1360.DatabaseSettings':
        ...
        return constructor.new(_1360.DatabaseSettings)(self.wrapped.DatabaseSettings) if self.wrapped.DatabaseSettings else None

    @property
    def program_settings(self) -> '_1160.ProgramSettings':
        ...
        return constructor.new(_1160.ProgramSettings)(self.wrapped.ProgramSettings) if self.wrapped.ProgramSettings else None

    @property
    def pushbullet_settings(self) -> '_1161.PushbulletSettings':
        ...
        return constructor.new(_1161.PushbulletSettings)(self.wrapped.PushbulletSettings) if self.wrapped.PushbulletSettings else None

    @property
    def scripting_setup(self) -> '_1284.ScriptingSetup':
        ...
        return constructor.new(_1284.ScriptingSetup)(self.wrapped.ScriptingSetup) if self.wrapped.ScriptingSetup else None

    @property
    def measurement_settings(self) -> '_1170.MeasurementSettings':
        ...
        return constructor.new(_1170.MeasurementSettings)(self.wrapped.MeasurementSettings) if self.wrapped.MeasurementSettings else None
