...
class GearMeshLoadDistributionAnalysis(_957.GearMeshImplementationAnalysis):
    ...
    @property
    def transmission_error_fourier_series(self) -> '_1087.FourierSeries':
        ...
        return constructor.new(_1087.FourierSeries)(self.wrapped.TransmissionErrorFourierSeries) if self.wrapped.TransmissionErrorFourierSeries else None
    ...
    def maximum_root_stress_with_flanks(self, gear: '_614.GearLoadDistributionAnalysis', flank: '_126.GearFlanks', stress_type: '_1410.StressResultsType') -> 'float':
    ...
    def maximum_root_stress(self, gear: '_614.GearLoadDistributionAnalysis', stress_type: '_1410.StressResultsType') -> 'float':
        ''' 'MaximumRootStress' is the original name of this method.
