...
from mastapy.utility.units_and_measurements import _1171
...
class CylindricalGearDesignSettings(_1158.PerMachineSettings):
    '''CylindricalGearDesignSettings
    ...
    @property
    def tolerance_rounding_system(self) -> '_1171.MeasurementSystem':
        ...
        return constructor.new(_1171.MeasurementSystem)(value) if value else None

    @tolerance_rounding_system.setter
    def tolerance_rounding_system(self, value: '_1171.MeasurementSystem'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
