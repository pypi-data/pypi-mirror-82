...
class CylindricalGearMeshDesign(_715.GearMeshDesign):
    ...
    @property
    def valid_normal_module_range(self) -> '_1139.ShortLengthRange':
        ...
        return constructor.new(_1139.ShortLengthRange)(self.wrapped.ValidNormalModuleRange) if self.wrapped.ValidNormalModuleRange else None
