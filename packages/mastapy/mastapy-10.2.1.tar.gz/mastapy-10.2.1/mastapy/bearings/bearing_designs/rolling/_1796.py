...
from mastapy.bearings.bearing_designs.rolling import _1798, _1799, _1797
...
class NonBarrelRollerBearing(_1797.RollerBearing):
    '''NonBarrelRollerBearing
    ...
    @property
    def roller_end_shape(self) -> '_1798.RollerEndShape':
        ...
        return constructor.new(_1798.RollerEndShape)(value) if value else None

    @roller_end_shape.setter
    def roller_end_shape(self, value: '_1798.RollerEndShape'):
    ...
    @property
    def ribs(self) -> 'List[_1799.RollerRibDetail]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Ribs, constructor.new(_1799.RollerRibDetail))
        return value
