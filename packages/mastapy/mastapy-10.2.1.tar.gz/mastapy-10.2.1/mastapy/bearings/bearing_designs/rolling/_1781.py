...
from mastapy.bearings.bearing_designs.rolling import _1782, _1800
...
class BallBearing(_1800.RollingBearing):
    '''BallBearing
    ...
    @property
    def shoulders(self) -> 'List[_1782.BallBearingShoulderDefinition]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Shoulders, constructor.new(_1782.BallBearingShoulderDefinition))
        return value
