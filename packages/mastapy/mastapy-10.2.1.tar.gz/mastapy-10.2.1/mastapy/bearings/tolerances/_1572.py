...
from mastapy.bearings.tolerances import _1567, _1564
...
class InterferenceTolerance(_1564.BearingConnectionComponent):
    '''InterferenceTolerance
    ...
    @property
    def definition_option(self) -> '_1567.BearingToleranceDefinitionOptions':
    ...
    def definition_option(self, value: '_1567.BearingToleranceDefinitionOptions'):
    ...
    @property
    def mounting_point_surface_finish(self) -> '_1553.MountingPointSurfaceFinishes':
        ...
        return constructor.new(_1553.MountingPointSurfaceFinishes)(value) if value else None

    @mounting_point_surface_finish.setter
    def mounting_point_surface_finish(self, value: '_1553.MountingPointSurfaceFinishes'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
