...
from mastapy.bearings.bearing_results.rolling import _1724, _1683
...
class LoadedBallBearingResults(_1683.LoadedRollingBearingResults):
    '''LoadedBallBearingResults
    ...
    @property
    def track_truncation(self) -> '_1724.TrackTruncationSafetyFactorResults':
        ...
        return constructor.new(_1724.TrackTruncationSafetyFactorResults)(self.wrapped.TrackTruncation) if self.wrapped.TrackTruncation else None
