...
from mastapy.bearings.bearing_results.rolling import _1705, _1653
...
class LoadedThrustBallBearingRow(_1653.LoadedBallBearingRow):
    '''LoadedThrustBallBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1705.LoadedThrustBallBearingResults':
        ...
        return constructor.new(_1705.LoadedThrustBallBearingResults)(self.wrapped.LoadedBearing) if self.wrapped.LoadedBearing else None
