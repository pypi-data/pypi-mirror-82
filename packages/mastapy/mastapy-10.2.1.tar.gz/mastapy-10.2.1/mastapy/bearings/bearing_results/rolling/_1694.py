...
from mastapy.bearings.bearing_results.rolling import _1693, _1680
...
class LoadedSphericalRollerThrustBearingRow(_1680.LoadedRollerBearingRow):
    '''LoadedSphericalRollerThrustBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1693.LoadedSphericalRollerThrustBearingResults':
        ...
        return constructor.new(_1693.LoadedSphericalRollerThrustBearingResults)(self.wrapped.LoadedBearing) if self.wrapped.LoadedBearing else None
