...
from mastapy.bearings.bearing_results.rolling import _1708, _1680
...
class LoadedToroidalRollerBearingRow(_1680.LoadedRollerBearingRow):
    '''LoadedToroidalRollerBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1708.LoadedToroidalRollerBearingResults':
        ...
        return constructor.new(_1708.LoadedToroidalRollerBearingResults)(self.wrapped.LoadedBearing) if self.wrapped.LoadedBearing else None
