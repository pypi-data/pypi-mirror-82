...
class LoadedNonBarrelRollerBearingRow(_1680.LoadedRollerBearingRow):
    '''LoadedNonBarrelRollerBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1674.LoadedNonBarrelRollerBearingResults':
