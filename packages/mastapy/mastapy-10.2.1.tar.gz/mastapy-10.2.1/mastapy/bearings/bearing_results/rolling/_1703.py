...
from mastapy.bearings.bearing_results.rolling import _1702, _1653
...
class LoadedThreePointContactBallBearingRow(_1653.LoadedBallBearingRow):
    '''LoadedThreePointContactBallBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1702.LoadedThreePointContactBallBearingResults':
        ...
        return constructor.new(_1702.LoadedThreePointContactBallBearingResults)(self.wrapped.LoadedBearing) if self.wrapped.LoadedBearing else None
