...
from mastapy.bearings.bearing_results.rolling import _1636, _1634
...
class LoadedAngularContactThrustBallBearingRow(_1634.LoadedAngularContactBallBearingRow):
    '''LoadedAngularContactThrustBallBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1636.LoadedAngularContactThrustBallBearingResults':
        ...
        return constructor.new(_1636.LoadedAngularContactThrustBallBearingResults)(self.wrapped.LoadedBearing) if self.wrapped.LoadedBearing else None
