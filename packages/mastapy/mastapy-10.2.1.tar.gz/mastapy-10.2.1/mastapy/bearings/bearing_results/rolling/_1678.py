...
from mastapy.bearings.bearing_results.rolling import _1717, _1664
...
class LoadedRollerBearingElement(_1664.LoadedElement):
    '''LoadedRollerBearingElement
    ...
    @property
    def results_at_roller_offsets(self) -> 'List[_1717.ResultsAtRollerOffset]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ResultsAtRollerOffsets, constructor.new(_1717.ResultsAtRollerOffset))
        return value
