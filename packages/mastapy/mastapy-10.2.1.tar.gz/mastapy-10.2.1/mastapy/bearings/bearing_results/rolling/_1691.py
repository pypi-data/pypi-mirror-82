...
from mastapy.bearings.bearing_results.rolling import _1690, _1680
...
class LoadedSphericalRollerRadialBearingRow(_1680.LoadedRollerBearingRow):
    '''LoadedSphericalRollerRadialBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1690.LoadedSphericalRollerRadialBearingResults':
        ...
        return constructor.new(_1690.LoadedSphericalRollerRadialBearingResults)(self.wrapped.LoadedBearing) if self.wrapped.LoadedBearing else None
