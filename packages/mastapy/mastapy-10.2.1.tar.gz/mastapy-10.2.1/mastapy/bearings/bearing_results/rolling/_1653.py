...
from mastapy.bearings.bearing_results.rolling import (
    _1652, _1633, _1636, _1662,
    _1667, _1686, _1702, _1705,
    _1651, _1684
)
...
class LoadedBallBearingRow(_1684.LoadedRollingBearingRow):
    '''LoadedBallBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1652.LoadedBallBearingResults':
    ...
    @property
    def race_results(self) -> 'List[_1651.LoadedBallBearingRaceResults]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.RaceResults, constructor.new(_1651.LoadedBallBearingRaceResults))
        return value
