...
from mastapy.math_utility import _1074, _1075
from mastapy.system_model.connections_and_sockets import (
    _1876, _1893, _1878, _1899
)
from mastapy.system_model.part_model import _2033, _2054
...
class Component(_2054.Part):
    ...
    @property
    def twod_drawing_full_model(self) -> '_6557.SMTBitmap':
        ...
        return constructor.new(_6557.SMTBitmap)(self.wrapped.TwoDDrawingFullModel) if self.wrapped.TwoDDrawingFullModel else None
    ...
    @property
    def component_connections(self) -> 'List[_1876.ComponentConnection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentConnections, constructor.new(_1876.ComponentConnection))
        return value
    ...
    def set_position_and_rotation_of_component_and_connected_components(self, new_coordinate_system: '_1074.CoordinateSystem3D') -> '_1893.RealignmentResult':
    ...
    def set_position_of_component_and_connected_components(self, position: 'Vector3D') -> '_1893.RealignmentResult':
    ...
    def create_coordinate_system_editor(self) -> '_1075.CoordinateSystemEditor':
    ...
    def diameter_at_middle_of_connection(self, connection: '_1878.Connection') -> 'float':
    ...
    def diameter_of_socket_for(self, connection: '_1878.Connection') -> 'float':
    ...
    def possible_sockets_to_connect_with(self, socket: '_1899.Socket') -> 'List[_1899.Socket]':
        ...
        return conversion.pn_to_mp_objects_in_list(self.wrapped.PossibleSocketsToConnectWith.Overloads[_SOCKET](socket.wrapped if socket else None), constructor.new(_1899.Socket))

    def connect_to_socket(self, socket: '_1899.Socket') -> '_2033.ComponentsConnectedResult':
    ...
    def possible_sockets_to_connect_with_component(self, component: 'Component') -> 'List[_1899.Socket]':
        ''' 'PossibleSocketsToConnectWith' is the original name of this method.
        ...
        return conversion.pn_to_mp_objects_in_list(self.wrapped.PossibleSocketsToConnectWith.Overloads[_COMPONENT](component.wrapped if component else None), constructor.new(_1899.Socket))

    def try_connect_to(self, component: 'Component', hint_offset: Optional['float'] = float('nan')) -> '_2033.ComponentsConnectedResult':
    ...
    def connect_to(self, component: 'Component') -> '_2033.ComponentsConnectedResult':
        ''' 'ConnectTo' is the original name of this method.
    ...
    def can_delete_connection(self, connection: '_1878.Connection') -> 'bool':
    ...
    def socket_named(self, socket_name: 'str') -> '_1899.Socket':
