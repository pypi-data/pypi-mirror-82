...
from mastapy.system_model.part_model.couplings import _2157, _2169
...
class BeltDrive(_2062.SpecialisedAssembly):
    '''BeltDrive
    ...
    @property
    def type_of_belt(self) -> '_2157.BeltDriveType':
        '''BeltDriveType: 'TypeOfBelt' is the original name of this property.'''

        value = conversion.pn_to_mp_enum(self.wrapped.TypeOfBelt)
        return constructor.new(_2157.BeltDriveType)(value) if value else None

    @type_of_belt.setter
    def type_of_belt(self, value: '_2157.BeltDriveType'):
    ...
    @property
    def pulleys(self) -> 'List[_2169.Pulley]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Pulleys, constructor.new(_2169.Pulley))
        return value

    @property
    def belt_connections(self) -> 'List[_1874.BeltConnection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.BeltConnections, constructor.new(_1874.BeltConnection))
        return value
