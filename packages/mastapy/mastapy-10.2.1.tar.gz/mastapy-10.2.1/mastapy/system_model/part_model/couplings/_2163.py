...
class Coupling(_2062.SpecialisedAssembly):
    '''Coupling
    ...
    @property
    def halves(self) -> 'List[_2164.CouplingHalf]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Halves, constructor.new(_2164.CouplingHalf))
        return value

    @property
    def half_a(self) -> '_2164.CouplingHalf':
        ...
        if _2164.CouplingHalf.TYPE not in self.wrapped.HalfA.__class__.__mro__:
    ...
    @property
    def half_a_of_type_clutch_half(self) -> '_2159.ClutchHalf':
        ...
        if _2159.ClutchHalf.TYPE not in self.wrapped.HalfA.__class__.__mro__:
            raise CastException('Failed to cast half_a to ClutchHalf. Expected: {}.'.format(self.wrapped.HalfA.__class__.__qualname__))

        return constructor.new_override(self.wrapped.HalfA.__class__)(self.wrapped.HalfA) if self.wrapped.HalfA else None

    @property
    def half_a_of_type_concept_coupling_half(self) -> '_2162.ConceptCouplingHalf':
        ...
        if _2162.ConceptCouplingHalf.TYPE not in self.wrapped.HalfA.__class__.__mro__:
    ...
    @property
    def half_a_of_type_cvt_pulley(self) -> '_2166.CVTPulley':
        ...
        if _2166.CVTPulley.TYPE not in self.wrapped.HalfA.__class__.__mro__:
            raise CastException('Failed to cast half_a to CVTPulley. Expected: {}.'.format(self.wrapped.HalfA.__class__.__qualname__))

        return constructor.new_override(self.wrapped.HalfA.__class__)(self.wrapped.HalfA) if self.wrapped.HalfA else None

    @property
    def half_a_of_type_part_to_part_shear_coupling_half(self) -> '_2168.PartToPartShearCouplingHalf':
        ...
        if _2168.PartToPartShearCouplingHalf.TYPE not in self.wrapped.HalfA.__class__.__mro__:
    ...
    @property
    def half_a_of_type_pulley(self) -> '_2169.Pulley':
        ...
        if _2169.Pulley.TYPE not in self.wrapped.HalfA.__class__.__mro__:
            raise CastException('Failed to cast half_a to Pulley. Expected: {}.'.format(self.wrapped.HalfA.__class__.__qualname__))

        return constructor.new_override(self.wrapped.HalfA.__class__)(self.wrapped.HalfA) if self.wrapped.HalfA else None

    @property
    def half_a_of_type_rolling_ring(self) -> '_2175.RollingRing':
        ...
        if _2175.RollingRing.TYPE not in self.wrapped.HalfA.__class__.__mro__:
            raise CastException('Failed to cast half_a to RollingRing. Expected: {}.'.format(self.wrapped.HalfA.__class__.__qualname__))

        return constructor.new_override(self.wrapped.HalfA.__class__)(self.wrapped.HalfA) if self.wrapped.HalfA else None

    @property
    def half_a_of_type_spring_damper_half(self) -> '_2179.SpringDamperHalf':
        ...
        if _2179.SpringDamperHalf.TYPE not in self.wrapped.HalfA.__class__.__mro__:
            raise CastException('Failed to cast half_a to SpringDamperHalf. Expected: {}.'.format(self.wrapped.HalfA.__class__.__qualname__))

        return constructor.new_override(self.wrapped.HalfA.__class__)(self.wrapped.HalfA) if self.wrapped.HalfA else None

    @property
    def half_a_of_type_synchroniser_half(self) -> '_2182.SynchroniserHalf':
        ...
        if _2182.SynchroniserHalf.TYPE not in self.wrapped.HalfA.__class__.__mro__:
            raise CastException('Failed to cast half_a to SynchroniserHalf. Expected: {}.'.format(self.wrapped.HalfA.__class__.__qualname__))

        return constructor.new_override(self.wrapped.HalfA.__class__)(self.wrapped.HalfA) if self.wrapped.HalfA else None

    @property
    def half_a_of_type_synchroniser_part(self) -> '_2183.SynchroniserPart':
        ...
        if _2183.SynchroniserPart.TYPE not in self.wrapped.HalfA.__class__.__mro__:
            raise CastException('Failed to cast half_a to SynchroniserPart. Expected: {}.'.format(self.wrapped.HalfA.__class__.__qualname__))

        return constructor.new_override(self.wrapped.HalfA.__class__)(self.wrapped.HalfA) if self.wrapped.HalfA else None

    @property
    def half_a_of_type_synchroniser_sleeve(self) -> '_2184.SynchroniserSleeve':
        ...
        if _2184.SynchroniserSleeve.TYPE not in self.wrapped.HalfA.__class__.__mro__:
    ...
    @property
    def half_a_of_type_torque_converter_pump(self) -> '_2186.TorqueConverterPump':
        ...
        if _2186.TorqueConverterPump.TYPE not in self.wrapped.HalfA.__class__.__mro__:
    ...
    @property
    def half_a_of_type_torque_converter_turbine(self) -> '_2188.TorqueConverterTurbine':
        ...
        if _2188.TorqueConverterTurbine.TYPE not in self.wrapped.HalfA.__class__.__mro__:
    ...
    @property
    def half_b(self) -> '_2164.CouplingHalf':
        ...
        if _2164.CouplingHalf.TYPE not in self.wrapped.HalfB.__class__.__mro__:
    ...
    @property
    def half_b_of_type_clutch_half(self) -> '_2159.ClutchHalf':
        ...
        if _2159.ClutchHalf.TYPE not in self.wrapped.HalfB.__class__.__mro__:
            raise CastException('Failed to cast half_b to ClutchHalf. Expected: {}.'.format(self.wrapped.HalfB.__class__.__qualname__))

        return constructor.new_override(self.wrapped.HalfB.__class__)(self.wrapped.HalfB) if self.wrapped.HalfB else None

    @property
    def half_b_of_type_concept_coupling_half(self) -> '_2162.ConceptCouplingHalf':
        ...
        if _2162.ConceptCouplingHalf.TYPE not in self.wrapped.HalfB.__class__.__mro__:
    ...
    @property
    def half_b_of_type_cvt_pulley(self) -> '_2166.CVTPulley':
        ...
        if _2166.CVTPulley.TYPE not in self.wrapped.HalfB.__class__.__mro__:
            raise CastException('Failed to cast half_b to CVTPulley. Expected: {}.'.format(self.wrapped.HalfB.__class__.__qualname__))

        return constructor.new_override(self.wrapped.HalfB.__class__)(self.wrapped.HalfB) if self.wrapped.HalfB else None

    @property
    def half_b_of_type_part_to_part_shear_coupling_half(self) -> '_2168.PartToPartShearCouplingHalf':
        ...
        if _2168.PartToPartShearCouplingHalf.TYPE not in self.wrapped.HalfB.__class__.__mro__:
    ...
    @property
    def half_b_of_type_pulley(self) -> '_2169.Pulley':
        ...
        if _2169.Pulley.TYPE not in self.wrapped.HalfB.__class__.__mro__:
            raise CastException('Failed to cast half_b to Pulley. Expected: {}.'.format(self.wrapped.HalfB.__class__.__qualname__))

        return constructor.new_override(self.wrapped.HalfB.__class__)(self.wrapped.HalfB) if self.wrapped.HalfB else None

    @property
    def half_b_of_type_rolling_ring(self) -> '_2175.RollingRing':
        ...
        if _2175.RollingRing.TYPE not in self.wrapped.HalfB.__class__.__mro__:
            raise CastException('Failed to cast half_b to RollingRing. Expected: {}.'.format(self.wrapped.HalfB.__class__.__qualname__))

        return constructor.new_override(self.wrapped.HalfB.__class__)(self.wrapped.HalfB) if self.wrapped.HalfB else None

    @property
    def half_b_of_type_spring_damper_half(self) -> '_2179.SpringDamperHalf':
        ...
        if _2179.SpringDamperHalf.TYPE not in self.wrapped.HalfB.__class__.__mro__:
            raise CastException('Failed to cast half_b to SpringDamperHalf. Expected: {}.'.format(self.wrapped.HalfB.__class__.__qualname__))

        return constructor.new_override(self.wrapped.HalfB.__class__)(self.wrapped.HalfB) if self.wrapped.HalfB else None

    @property
    def half_b_of_type_synchroniser_half(self) -> '_2182.SynchroniserHalf':
        ...
        if _2182.SynchroniserHalf.TYPE not in self.wrapped.HalfB.__class__.__mro__:
            raise CastException('Failed to cast half_b to SynchroniserHalf. Expected: {}.'.format(self.wrapped.HalfB.__class__.__qualname__))

        return constructor.new_override(self.wrapped.HalfB.__class__)(self.wrapped.HalfB) if self.wrapped.HalfB else None

    @property
    def half_b_of_type_synchroniser_part(self) -> '_2183.SynchroniserPart':
        ...
        if _2183.SynchroniserPart.TYPE not in self.wrapped.HalfB.__class__.__mro__:
            raise CastException('Failed to cast half_b to SynchroniserPart. Expected: {}.'.format(self.wrapped.HalfB.__class__.__qualname__))

        return constructor.new_override(self.wrapped.HalfB.__class__)(self.wrapped.HalfB) if self.wrapped.HalfB else None

    @property
    def half_b_of_type_synchroniser_sleeve(self) -> '_2184.SynchroniserSleeve':
        ...
        if _2184.SynchroniserSleeve.TYPE not in self.wrapped.HalfB.__class__.__mro__:
    ...
    @property
    def half_b_of_type_torque_converter_pump(self) -> '_2186.TorqueConverterPump':
        ...
        if _2186.TorqueConverterPump.TYPE not in self.wrapped.HalfB.__class__.__mro__:
    ...
    @property
    def half_b_of_type_torque_converter_turbine(self) -> '_2188.TorqueConverterTurbine':
        ...
        if _2188.TorqueConverterTurbine.TYPE not in self.wrapped.HalfB.__class__.__mro__:
