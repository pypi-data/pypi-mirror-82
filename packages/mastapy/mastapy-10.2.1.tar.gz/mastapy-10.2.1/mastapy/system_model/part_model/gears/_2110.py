...
from mastapy.system_model.part_model.gears import _2109, _2116
...
class CylindricalGearSet(_2116.GearSet):
    '''CylindricalGearSet
    ...
    @property
    def supercharger_rotor_set(self) -> '_2147.SuperchargerRotorSet':
        ...
        return constructor.new(_2147.SuperchargerRotorSet)(self.wrapped.SuperchargerRotorSet) if self.wrapped.SuperchargerRotorSet else None

    @property
    def cylindrical_gears(self) -> 'List[_2109.CylindricalGear]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CylindricalGears, constructor.new(_2109.CylindricalGear))
        return value

    @property
    def cylindrical_meshes(self) -> 'List[_1912.CylindricalGearMesh]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CylindricalMeshes, constructor.new(_1912.CylindricalGearMesh))
        return value
