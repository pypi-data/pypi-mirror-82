...
from mastapy.bearings.tolerances import (
    _1566, _1567, _1569, _1579,
    _1575, _1582, _1570, _1583,
    _1576, _1585
)
from mastapy._internal.overridable_constructor import _unpack_overridable
from mastapy.bearings.bearing_results import _1617, _1618
from mastapy.bearings import (
    _1544, _1551, _1540, _1536
)
from mastapy._internal.python_net import python_net_import
from mastapy.materials.efficiency import _95
from mastapy._internal.cast_exception import CastException
from mastapy.bearings.bearing_designs import (
    _1771, _1772, _1773, _1774,
    _1775
)
from mastapy.bearings.bearing_designs.rolling import (
    _1776, _1777, _1778, _1779,
    _1780, _1781, _1783, _1788,
    _1789, _1790, _1792, _1794,
    _1795, _1796, _1797, _1800,
    _1801, _1803, _1804, _1805,
    _1806, _1807, _1808
)
from mastapy.bearings.bearing_designs.fluid_film import (
    _1821, _1823, _1825, _1827,
    _1828, _1829
)
from mastapy.bearings.bearing_designs.concept import _1831, _1832, _1833
from mastapy.system_model.part_model import (
    _2027, _2059, _2029, _2033,
    _2035
)
...
class Bearing(_2035.Connector):
    ...
    @property
    def bearing_tolerance_definition(self) -> '_1567.BearingToleranceDefinitionOptions':
        ...
        return constructor.new(_1567.BearingToleranceDefinitionOptions)(value) if value else None

    @bearing_tolerance_definition.setter
    def bearing_tolerance_definition(self, value: '_1567.BearingToleranceDefinitionOptions'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.BearingToleranceDefinition = value

    @property
    def orientation(self) -> '_1617.Orientations':
        '''Orientations: 'Orientation' is the original name of this property.'''

        value = conversion.pn_to_mp_enum(self.wrapped.Orientation)
        return constructor.new(_1617.Orientations)(value) if value else None

    @orientation.setter
    def orientation(self, value: '_1617.Orientations'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def journal_bearing_type(self) -> '_1551.JournalBearingType':
        ...
        return constructor.new(_1551.JournalBearingType)(value) if value else None

    @journal_bearing_type.setter
    def journal_bearing_type(self, value: '_1551.JournalBearingType'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def damping_options(self) -> '_1540.BearingDampingMatrixOption':
        ...
        return constructor.new(_1540.BearingDampingMatrixOption)(value) if value else None

    @damping_options.setter
    def damping_options(self, value: '_1540.BearingDampingMatrixOption'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def ring_tolerance_inner(self) -> '_1569.InnerRingTolerance':
        ...
        return constructor.new(_1569.InnerRingTolerance)(self.wrapped.RingToleranceInner) if self.wrapped.RingToleranceInner else None

    @property
    def ring_tolerance_left(self) -> '_1579.RingTolerance':
        ...
        if _1579.RingTolerance.TYPE not in self.wrapped.RingToleranceLeft.__class__.__mro__:
    ...
    @property
    def ring_tolerance_left_of_type_inner_ring_tolerance(self) -> '_1569.InnerRingTolerance':
        ...
        if _1569.InnerRingTolerance.TYPE not in self.wrapped.RingToleranceLeft.__class__.__mro__:
    ...
    @property
    def ring_tolerance_left_of_type_outer_ring_tolerance(self) -> '_1575.OuterRingTolerance':
        ...
        if _1575.OuterRingTolerance.TYPE not in self.wrapped.RingToleranceLeft.__class__.__mro__:
    ...
    @property
    def ring_tolerance_outer(self) -> '_1575.OuterRingTolerance':
        ...
        return constructor.new(_1575.OuterRingTolerance)(self.wrapped.RingToleranceOuter) if self.wrapped.RingToleranceOuter else None

    @property
    def ring_tolerance_right(self) -> '_1579.RingTolerance':
        ...
        if _1579.RingTolerance.TYPE not in self.wrapped.RingToleranceRight.__class__.__mro__:
    ...
    @property
    def ring_tolerance_right_of_type_inner_ring_tolerance(self) -> '_1569.InnerRingTolerance':
        ...
        if _1569.InnerRingTolerance.TYPE not in self.wrapped.RingToleranceRight.__class__.__mro__:
    ...
    @property
    def ring_tolerance_right_of_type_outer_ring_tolerance(self) -> '_1575.OuterRingTolerance':
        ...
        if _1575.OuterRingTolerance.TYPE not in self.wrapped.RingToleranceRight.__class__.__mro__:
    ...
    @property
    def inner_support_detail(self) -> '_1582.SupportDetail':
        ...
        return constructor.new(_1582.SupportDetail)(self.wrapped.InnerSupportDetail) if self.wrapped.InnerSupportDetail else None

    @property
    def left_support_detail(self) -> '_1582.SupportDetail':
        ...
        return constructor.new(_1582.SupportDetail)(self.wrapped.LeftSupportDetail) if self.wrapped.LeftSupportDetail else None

    @property
    def outer_support_detail(self) -> '_1582.SupportDetail':
        ...
        return constructor.new(_1582.SupportDetail)(self.wrapped.OuterSupportDetail) if self.wrapped.OuterSupportDetail else None

    @property
    def right_support_detail(self) -> '_1582.SupportDetail':
        ...
        return constructor.new(_1582.SupportDetail)(self.wrapped.RightSupportDetail) if self.wrapped.RightSupportDetail else None

    @property
    def support_tolerance_inner(self) -> '_1570.InnerSupportTolerance':
        ...
        return constructor.new(_1570.InnerSupportTolerance)(self.wrapped.SupportToleranceInner) if self.wrapped.SupportToleranceInner else None

    @property
    def support_tolerance_left(self) -> '_1583.SupportTolerance':
        ...
        if _1583.SupportTolerance.TYPE not in self.wrapped.SupportToleranceLeft.__class__.__mro__:
    ...
    @property
    def support_tolerance_left_of_type_inner_support_tolerance(self) -> '_1570.InnerSupportTolerance':
        ...
        if _1570.InnerSupportTolerance.TYPE not in self.wrapped.SupportToleranceLeft.__class__.__mro__:
    ...
    @property
    def support_tolerance_left_of_type_outer_support_tolerance(self) -> '_1576.OuterSupportTolerance':
        ...
        if _1576.OuterSupportTolerance.TYPE not in self.wrapped.SupportToleranceLeft.__class__.__mro__:
    ...
    @property
    def support_tolerance_outer(self) -> '_1576.OuterSupportTolerance':
        ...
        return constructor.new(_1576.OuterSupportTolerance)(self.wrapped.SupportToleranceOuter) if self.wrapped.SupportToleranceOuter else None

    @property
    def support_tolerance_right(self) -> '_1583.SupportTolerance':
        ...
        if _1583.SupportTolerance.TYPE not in self.wrapped.SupportToleranceRight.__class__.__mro__:
    ...
    @property
    def support_tolerance_right_of_type_inner_support_tolerance(self) -> '_1570.InnerSupportTolerance':
        ...
        if _1570.InnerSupportTolerance.TYPE not in self.wrapped.SupportToleranceRight.__class__.__mro__:
    ...
    @property
    def support_tolerance_right_of_type_outer_support_tolerance(self) -> '_1576.OuterSupportTolerance':
        ...
        if _1576.OuterSupportTolerance.TYPE not in self.wrapped.SupportToleranceRight.__class__.__mro__:
    ...
    @property
    def inner_mounting_sleeve_bore_tolerance(self) -> '_1576.OuterSupportTolerance':
        ...
        return constructor.new(_1576.OuterSupportTolerance)(self.wrapped.InnerMountingSleeveBoreTolerance) if self.wrapped.InnerMountingSleeveBoreTolerance else None

    @property
    def inner_mounting_sleeve_outer_diameter_tolerance(self) -> '_1570.InnerSupportTolerance':
        ...
        return constructor.new(_1570.InnerSupportTolerance)(self.wrapped.InnerMountingSleeveOuterDiameterTolerance) if self.wrapped.InnerMountingSleeveOuterDiameterTolerance else None

    @property
    def outer_mounting_sleeve_bore_tolerance(self) -> '_1576.OuterSupportTolerance':
        ...
        return constructor.new(_1576.OuterSupportTolerance)(self.wrapped.OuterMountingSleeveBoreTolerance) if self.wrapped.OuterMountingSleeveBoreTolerance else None

    @property
    def outer_mounting_sleeve_outer_diameter_tolerance(self) -> '_1570.InnerSupportTolerance':
        ...
        return constructor.new(_1570.InnerSupportTolerance)(self.wrapped.OuterMountingSleeveOuterDiameterTolerance) if self.wrapped.OuterMountingSleeveOuterDiameterTolerance else None

    @property
    def simple_bearing_detail_property(self) -> '_1771.BearingDesign':
        ...
        if _1771.BearingDesign.TYPE not in self.wrapped.SimpleBearingDetailProperty.__class__.__mro__:
    ...
    @property
    def simple_bearing_detail_property_of_type_detailed_bearing(self) -> '_1772.DetailedBearing':
        ...
        if _1772.DetailedBearing.TYPE not in self.wrapped.SimpleBearingDetailProperty.__class__.__mro__:
    ...
    @property
    def simple_bearing_detail_property_of_type_dummy_rolling_bearing(self) -> '_1773.DummyRollingBearing':
        ...
        if _1773.DummyRollingBearing.TYPE not in self.wrapped.SimpleBearingDetailProperty.__class__.__mro__:
    ...
    @property
    def simple_bearing_detail_property_of_type_linear_bearing(self) -> '_1774.LinearBearing':
        ...
        if _1774.LinearBearing.TYPE not in self.wrapped.SimpleBearingDetailProperty.__class__.__mro__:
    ...
    @property
    def simple_bearing_detail_property_of_type_non_linear_bearing(self) -> '_1775.NonLinearBearing':
        ...
        if _1775.NonLinearBearing.TYPE not in self.wrapped.SimpleBearingDetailProperty.__class__.__mro__:
    ...
    @property
    def simple_bearing_detail_property_of_type_angular_contact_ball_bearing(self) -> '_1776.AngularContactBallBearing':
        ...
        if _1776.AngularContactBallBearing.TYPE not in self.wrapped.SimpleBearingDetailProperty.__class__.__mro__:
    ...
    @property
    def simple_bearing_detail_property_of_type_angular_contact_thrust_ball_bearing(self) -> '_1777.AngularContactThrustBallBearing':
        ...
        if _1777.AngularContactThrustBallBearing.TYPE not in self.wrapped.SimpleBearingDetailProperty.__class__.__mro__:
    ...
    @property
    def simple_bearing_detail_property_of_type_asymmetric_spherical_roller_bearing(self) -> '_1778.AsymmetricSphericalRollerBearing':
        ...
        if _1778.AsymmetricSphericalRollerBearing.TYPE not in self.wrapped.SimpleBearingDetailProperty.__class__.__mro__:
    ...
    @property
    def simple_bearing_detail_property_of_type_axial_thrust_cylindrical_roller_bearing(self) -> '_1779.AxialThrustCylindricalRollerBearing':
        ...
        if _1779.AxialThrustCylindricalRollerBearing.TYPE not in self.wrapped.SimpleBearingDetailProperty.__class__.__mro__:
    ...
    @property
    def simple_bearing_detail_property_of_type_axial_thrust_needle_roller_bearing(self) -> '_1780.AxialThrustNeedleRollerBearing':
        ...
        if _1780.AxialThrustNeedleRollerBearing.TYPE not in self.wrapped.SimpleBearingDetailProperty.__class__.__mro__:
    ...
    @property
    def simple_bearing_detail_property_of_type_ball_bearing(self) -> '_1781.BallBearing':
        ...
        if _1781.BallBearing.TYPE not in self.wrapped.SimpleBearingDetailProperty.__class__.__mro__:
    ...
    @property
    def simple_bearing_detail_property_of_type_barrel_roller_bearing(self) -> '_1783.BarrelRollerBearing':
        ...
        if _1783.BarrelRollerBearing.TYPE not in self.wrapped.SimpleBearingDetailProperty.__class__.__mro__:
    ...
    @property
    def simple_bearing_detail_property_of_type_crossed_roller_bearing(self) -> '_1788.CrossedRollerBearing':
        ...
        if _1788.CrossedRollerBearing.TYPE not in self.wrapped.SimpleBearingDetailProperty.__class__.__mro__:
    ...
    @property
    def simple_bearing_detail_property_of_type_cylindrical_roller_bearing(self) -> '_1789.CylindricalRollerBearing':
        ...
        if _1789.CylindricalRollerBearing.TYPE not in self.wrapped.SimpleBearingDetailProperty.__class__.__mro__:
    ...
    @property
    def simple_bearing_detail_property_of_type_deep_groove_ball_bearing(self) -> '_1790.DeepGrooveBallBearing':
        ...
        if _1790.DeepGrooveBallBearing.TYPE not in self.wrapped.SimpleBearingDetailProperty.__class__.__mro__:
    ...
    @property
    def simple_bearing_detail_property_of_type_four_point_contact_ball_bearing(self) -> '_1792.FourPointContactBallBearing':
        ...
        if _1792.FourPointContactBallBearing.TYPE not in self.wrapped.SimpleBearingDetailProperty.__class__.__mro__:
    ...
    @property
    def simple_bearing_detail_property_of_type_multi_point_contact_ball_bearing(self) -> '_1794.MultiPointContactBallBearing':
        ...
        if _1794.MultiPointContactBallBearing.TYPE not in self.wrapped.SimpleBearingDetailProperty.__class__.__mro__:
    ...
    @property
    def simple_bearing_detail_property_of_type_needle_roller_bearing(self) -> '_1795.NeedleRollerBearing':
        ...
        if _1795.NeedleRollerBearing.TYPE not in self.wrapped.SimpleBearingDetailProperty.__class__.__mro__:
    ...
    @property
    def simple_bearing_detail_property_of_type_non_barrel_roller_bearing(self) -> '_1796.NonBarrelRollerBearing':
        ...
        if _1796.NonBarrelRollerBearing.TYPE not in self.wrapped.SimpleBearingDetailProperty.__class__.__mro__:
    ...
    @property
    def simple_bearing_detail_property_of_type_roller_bearing(self) -> '_1797.RollerBearing':
        ...
        if _1797.RollerBearing.TYPE not in self.wrapped.SimpleBearingDetailProperty.__class__.__mro__:
    ...
    @property
    def simple_bearing_detail_property_of_type_rolling_bearing(self) -> '_1800.RollingBearing':
        ...
        if _1800.RollingBearing.TYPE not in self.wrapped.SimpleBearingDetailProperty.__class__.__mro__:
    ...
    @property
    def simple_bearing_detail_property_of_type_self_aligning_ball_bearing(self) -> '_1801.SelfAligningBallBearing':
        ...
        if _1801.SelfAligningBallBearing.TYPE not in self.wrapped.SimpleBearingDetailProperty.__class__.__mro__:
    ...
    @property
    def simple_bearing_detail_property_of_type_spherical_roller_bearing(self) -> '_1803.SphericalRollerBearing':
        ...
        if _1803.SphericalRollerBearing.TYPE not in self.wrapped.SimpleBearingDetailProperty.__class__.__mro__:
    ...
    @property
    def simple_bearing_detail_property_of_type_spherical_roller_thrust_bearing(self) -> '_1804.SphericalRollerThrustBearing':
        ...
        if _1804.SphericalRollerThrustBearing.TYPE not in self.wrapped.SimpleBearingDetailProperty.__class__.__mro__:
    ...
    @property
    def simple_bearing_detail_property_of_type_taper_roller_bearing(self) -> '_1805.TaperRollerBearing':
        ...
        if _1805.TaperRollerBearing.TYPE not in self.wrapped.SimpleBearingDetailProperty.__class__.__mro__:
    ...
    @property
    def simple_bearing_detail_property_of_type_three_point_contact_ball_bearing(self) -> '_1806.ThreePointContactBallBearing':
        ...
        if _1806.ThreePointContactBallBearing.TYPE not in self.wrapped.SimpleBearingDetailProperty.__class__.__mro__:
    ...
    @property
    def simple_bearing_detail_property_of_type_thrust_ball_bearing(self) -> '_1807.ThrustBallBearing':
        ...
        if _1807.ThrustBallBearing.TYPE not in self.wrapped.SimpleBearingDetailProperty.__class__.__mro__:
    ...
    @property
    def simple_bearing_detail_property_of_type_toroidal_roller_bearing(self) -> '_1808.ToroidalRollerBearing':
        ...
        if _1808.ToroidalRollerBearing.TYPE not in self.wrapped.SimpleBearingDetailProperty.__class__.__mro__:
    ...
    @property
    def simple_bearing_detail_property_of_type_pad_fluid_film_bearing(self) -> '_1821.PadFluidFilmBearing':
        ...
        if _1821.PadFluidFilmBearing.TYPE not in self.wrapped.SimpleBearingDetailProperty.__class__.__mro__:
    ...
    @property
    def simple_bearing_detail_property_of_type_plain_grease_filled_journal_bearing(self) -> '_1823.PlainGreaseFilledJournalBearing':
        ...
        if _1823.PlainGreaseFilledJournalBearing.TYPE not in self.wrapped.SimpleBearingDetailProperty.__class__.__mro__:
    ...
    @property
    def simple_bearing_detail_property_of_type_plain_journal_bearing(self) -> '_1825.PlainJournalBearing':
        ...
        if _1825.PlainJournalBearing.TYPE not in self.wrapped.SimpleBearingDetailProperty.__class__.__mro__:
    ...
    @property
    def simple_bearing_detail_property_of_type_plain_oil_fed_journal_bearing(self) -> '_1827.PlainOilFedJournalBearing':
        ...
        if _1827.PlainOilFedJournalBearing.TYPE not in self.wrapped.SimpleBearingDetailProperty.__class__.__mro__:
    ...
    @property
    def simple_bearing_detail_property_of_type_tilting_pad_journal_bearing(self) -> '_1828.TiltingPadJournalBearing':
        ...
        if _1828.TiltingPadJournalBearing.TYPE not in self.wrapped.SimpleBearingDetailProperty.__class__.__mro__:
    ...
    @property
    def simple_bearing_detail_property_of_type_tilting_pad_thrust_bearing(self) -> '_1829.TiltingPadThrustBearing':
        ...
        if _1829.TiltingPadThrustBearing.TYPE not in self.wrapped.SimpleBearingDetailProperty.__class__.__mro__:
    ...
    @property
    def simple_bearing_detail_property_of_type_concept_axial_clearance_bearing(self) -> '_1831.ConceptAxialClearanceBearing':
        ...
        if _1831.ConceptAxialClearanceBearing.TYPE not in self.wrapped.SimpleBearingDetailProperty.__class__.__mro__:
    ...
    @property
    def simple_bearing_detail_property_of_type_concept_clearance_bearing(self) -> '_1832.ConceptClearanceBearing':
        ...
        if _1832.ConceptClearanceBearing.TYPE not in self.wrapped.SimpleBearingDetailProperty.__class__.__mro__:
    ...
    @property
    def simple_bearing_detail_property_of_type_concept_radial_clearance_bearing(self) -> '_1833.ConceptRadialClearanceBearing':
        ...
        if _1833.ConceptRadialClearanceBearing.TYPE not in self.wrapped.SimpleBearingDetailProperty.__class__.__mro__:
    ...
    @property
    def detail(self) -> '_1771.BearingDesign':
        ...
        if _1771.BearingDesign.TYPE not in self.wrapped.Detail.__class__.__mro__:
    ...
    @property
    def detail_of_type_detailed_bearing(self) -> '_1772.DetailedBearing':
        ...
        if _1772.DetailedBearing.TYPE not in self.wrapped.Detail.__class__.__mro__:
            raise CastException('Failed to cast detail to DetailedBearing. Expected: {}.'.format(self.wrapped.Detail.__class__.__qualname__))

        return constructor.new_override(self.wrapped.Detail.__class__)(self.wrapped.Detail) if self.wrapped.Detail else None

    @property
    def detail_of_type_dummy_rolling_bearing(self) -> '_1773.DummyRollingBearing':
        ...
        if _1773.DummyRollingBearing.TYPE not in self.wrapped.Detail.__class__.__mro__:
    ...
    @property
    def detail_of_type_linear_bearing(self) -> '_1774.LinearBearing':
        ...
        if _1774.LinearBearing.TYPE not in self.wrapped.Detail.__class__.__mro__:
            raise CastException('Failed to cast detail to LinearBearing. Expected: {}.'.format(self.wrapped.Detail.__class__.__qualname__))

        return constructor.new_override(self.wrapped.Detail.__class__)(self.wrapped.Detail) if self.wrapped.Detail else None

    @property
    def detail_of_type_non_linear_bearing(self) -> '_1775.NonLinearBearing':
        ...
        if _1775.NonLinearBearing.TYPE not in self.wrapped.Detail.__class__.__mro__:
            raise CastException('Failed to cast detail to NonLinearBearing. Expected: {}.'.format(self.wrapped.Detail.__class__.__qualname__))

        return constructor.new_override(self.wrapped.Detail.__class__)(self.wrapped.Detail) if self.wrapped.Detail else None

    @property
    def detail_of_type_angular_contact_ball_bearing(self) -> '_1776.AngularContactBallBearing':
        ...
        if _1776.AngularContactBallBearing.TYPE not in self.wrapped.Detail.__class__.__mro__:
    ...
    @property
    def detail_of_type_angular_contact_thrust_ball_bearing(self) -> '_1777.AngularContactThrustBallBearing':
        ...
        if _1777.AngularContactThrustBallBearing.TYPE not in self.wrapped.Detail.__class__.__mro__:
    ...
    @property
    def detail_of_type_asymmetric_spherical_roller_bearing(self) -> '_1778.AsymmetricSphericalRollerBearing':
        ...
        if _1778.AsymmetricSphericalRollerBearing.TYPE not in self.wrapped.Detail.__class__.__mro__:
    ...
    @property
    def detail_of_type_axial_thrust_cylindrical_roller_bearing(self) -> '_1779.AxialThrustCylindricalRollerBearing':
        ...
        if _1779.AxialThrustCylindricalRollerBearing.TYPE not in self.wrapped.Detail.__class__.__mro__:
    ...
    @property
    def detail_of_type_axial_thrust_needle_roller_bearing(self) -> '_1780.AxialThrustNeedleRollerBearing':
        ...
        if _1780.AxialThrustNeedleRollerBearing.TYPE not in self.wrapped.Detail.__class__.__mro__:
    ...
    @property
    def detail_of_type_ball_bearing(self) -> '_1781.BallBearing':
        ...
        if _1781.BallBearing.TYPE not in self.wrapped.Detail.__class__.__mro__:
            raise CastException('Failed to cast detail to BallBearing. Expected: {}.'.format(self.wrapped.Detail.__class__.__qualname__))

        return constructor.new_override(self.wrapped.Detail.__class__)(self.wrapped.Detail) if self.wrapped.Detail else None

    @property
    def detail_of_type_barrel_roller_bearing(self) -> '_1783.BarrelRollerBearing':
        ...
        if _1783.BarrelRollerBearing.TYPE not in self.wrapped.Detail.__class__.__mro__:
    ...
    @property
    def detail_of_type_crossed_roller_bearing(self) -> '_1788.CrossedRollerBearing':
        ...
        if _1788.CrossedRollerBearing.TYPE not in self.wrapped.Detail.__class__.__mro__:
    ...
    @property
    def detail_of_type_cylindrical_roller_bearing(self) -> '_1789.CylindricalRollerBearing':
        ...
        if _1789.CylindricalRollerBearing.TYPE not in self.wrapped.Detail.__class__.__mro__:
    ...
    @property
    def detail_of_type_deep_groove_ball_bearing(self) -> '_1790.DeepGrooveBallBearing':
        ...
        if _1790.DeepGrooveBallBearing.TYPE not in self.wrapped.Detail.__class__.__mro__:
    ...
    @property
    def detail_of_type_four_point_contact_ball_bearing(self) -> '_1792.FourPointContactBallBearing':
        ...
        if _1792.FourPointContactBallBearing.TYPE not in self.wrapped.Detail.__class__.__mro__:
    ...
    @property
    def detail_of_type_multi_point_contact_ball_bearing(self) -> '_1794.MultiPointContactBallBearing':
        ...
        if _1794.MultiPointContactBallBearing.TYPE not in self.wrapped.Detail.__class__.__mro__:
    ...
    @property
    def detail_of_type_needle_roller_bearing(self) -> '_1795.NeedleRollerBearing':
        ...
        if _1795.NeedleRollerBearing.TYPE not in self.wrapped.Detail.__class__.__mro__:
    ...
    @property
    def detail_of_type_non_barrel_roller_bearing(self) -> '_1796.NonBarrelRollerBearing':
        ...
        if _1796.NonBarrelRollerBearing.TYPE not in self.wrapped.Detail.__class__.__mro__:
    ...
    @property
    def detail_of_type_roller_bearing(self) -> '_1797.RollerBearing':
        ...
        if _1797.RollerBearing.TYPE not in self.wrapped.Detail.__class__.__mro__:
            raise CastException('Failed to cast detail to RollerBearing. Expected: {}.'.format(self.wrapped.Detail.__class__.__qualname__))

        return constructor.new_override(self.wrapped.Detail.__class__)(self.wrapped.Detail) if self.wrapped.Detail else None

    @property
    def detail_of_type_rolling_bearing(self) -> '_1800.RollingBearing':
        ...
        if _1800.RollingBearing.TYPE not in self.wrapped.Detail.__class__.__mro__:
            raise CastException('Failed to cast detail to RollingBearing. Expected: {}.'.format(self.wrapped.Detail.__class__.__qualname__))

        return constructor.new_override(self.wrapped.Detail.__class__)(self.wrapped.Detail) if self.wrapped.Detail else None

    @property
    def detail_of_type_self_aligning_ball_bearing(self) -> '_1801.SelfAligningBallBearing':
        ...
        if _1801.SelfAligningBallBearing.TYPE not in self.wrapped.Detail.__class__.__mro__:
    ...
    @property
    def detail_of_type_spherical_roller_bearing(self) -> '_1803.SphericalRollerBearing':
        ...
        if _1803.SphericalRollerBearing.TYPE not in self.wrapped.Detail.__class__.__mro__:
    ...
    @property
    def detail_of_type_spherical_roller_thrust_bearing(self) -> '_1804.SphericalRollerThrustBearing':
        ...
        if _1804.SphericalRollerThrustBearing.TYPE not in self.wrapped.Detail.__class__.__mro__:
    ...
    @property
    def detail_of_type_taper_roller_bearing(self) -> '_1805.TaperRollerBearing':
        ...
        if _1805.TaperRollerBearing.TYPE not in self.wrapped.Detail.__class__.__mro__:
    ...
    @property
    def detail_of_type_three_point_contact_ball_bearing(self) -> '_1806.ThreePointContactBallBearing':
        ...
        if _1806.ThreePointContactBallBearing.TYPE not in self.wrapped.Detail.__class__.__mro__:
    ...
    @property
    def detail_of_type_thrust_ball_bearing(self) -> '_1807.ThrustBallBearing':
        ...
        if _1807.ThrustBallBearing.TYPE not in self.wrapped.Detail.__class__.__mro__:
    ...
    @property
    def detail_of_type_toroidal_roller_bearing(self) -> '_1808.ToroidalRollerBearing':
        ...
        if _1808.ToroidalRollerBearing.TYPE not in self.wrapped.Detail.__class__.__mro__:
    ...
    @property
    def detail_of_type_pad_fluid_film_bearing(self) -> '_1821.PadFluidFilmBearing':
        ...
        if _1821.PadFluidFilmBearing.TYPE not in self.wrapped.Detail.__class__.__mro__:
    ...
    @property
    def detail_of_type_plain_grease_filled_journal_bearing(self) -> '_1823.PlainGreaseFilledJournalBearing':
        ...
        if _1823.PlainGreaseFilledJournalBearing.TYPE not in self.wrapped.Detail.__class__.__mro__:
    ...
    @property
    def detail_of_type_plain_journal_bearing(self) -> '_1825.PlainJournalBearing':
        ...
        if _1825.PlainJournalBearing.TYPE not in self.wrapped.Detail.__class__.__mro__:
    ...
    @property
    def detail_of_type_plain_oil_fed_journal_bearing(self) -> '_1827.PlainOilFedJournalBearing':
        ...
        if _1827.PlainOilFedJournalBearing.TYPE not in self.wrapped.Detail.__class__.__mro__:
    ...
    @property
    def detail_of_type_tilting_pad_journal_bearing(self) -> '_1828.TiltingPadJournalBearing':
        ...
        if _1828.TiltingPadJournalBearing.TYPE not in self.wrapped.Detail.__class__.__mro__:
    ...
    @property
    def detail_of_type_tilting_pad_thrust_bearing(self) -> '_1829.TiltingPadThrustBearing':
        ...
        if _1829.TiltingPadThrustBearing.TYPE not in self.wrapped.Detail.__class__.__mro__:
    ...
    @property
    def detail_of_type_concept_axial_clearance_bearing(self) -> '_1831.ConceptAxialClearanceBearing':
        ...
        if _1831.ConceptAxialClearanceBearing.TYPE not in self.wrapped.Detail.__class__.__mro__:
    ...
    @property
    def detail_of_type_concept_clearance_bearing(self) -> '_1832.ConceptClearanceBearing':
        ...
        if _1832.ConceptClearanceBearing.TYPE not in self.wrapped.Detail.__class__.__mro__:
    ...
    @property
    def detail_of_type_concept_radial_clearance_bearing(self) -> '_1833.ConceptRadialClearanceBearing':
        ...
        if _1833.ConceptRadialClearanceBearing.TYPE not in self.wrapped.Detail.__class__.__mro__:
    ...
    @property
    def axial_internal_clearance_tolerance(self) -> '_2027.AxialInternalClearanceTolerance':
        ...
        return constructor.new(_2027.AxialInternalClearanceTolerance)(self.wrapped.AxialInternalClearanceTolerance) if self.wrapped.AxialInternalClearanceTolerance else None

    @property
    def radial_internal_clearance_tolerance(self) -> '_2059.RadialInternalClearanceTolerance':
        ...
        return constructor.new(_2059.RadialInternalClearanceTolerance)(self.wrapped.RadialInternalClearanceTolerance) if self.wrapped.RadialInternalClearanceTolerance else None
    ...
    @property
    def friction_coefficients(self) -> '_1719.RollingBearingFrictionCoefficients':
        ...
        return constructor.new(_1719.RollingBearingFrictionCoefficients)(self.wrapped.FrictionCoefficients) if self.wrapped.FrictionCoefficients else None

    @property
    def force_at_zero_displacement(self) -> '_1138.VectorWithLinearAndAngularComponents':
        ...
        return constructor.new(_1138.VectorWithLinearAndAngularComponents)(self.wrapped.ForceAtZeroDisplacement) if self.wrapped.ForceAtZeroDisplacement else None

    @property
    def tolerance_combinations(self) -> 'List[_1585.ToleranceCombination]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ToleranceCombinations, constructor.new(_1585.ToleranceCombination))
        return value

    @property
    def mounting(self) -> 'List[_2029.BearingRaceMountingOptions]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Mounting, constructor.new(_2029.BearingRaceMountingOptions))
        return value
    ...
    def set_detail_from_catalogue(self, catalogue: '_1536.BearingCatalog', designation: 'str'):
    ...
    def try_attach_left_side_to(self, shaft: '_2067.Shaft', offset: Optional['float'] = float('nan')) -> '_2033.ComponentsConnectedResult':
    ...
    def try_attach_right_side_to(self, shaft: '_2067.Shaft', offset: Optional['float'] = float('nan')) -> '_2033.ComponentsConnectedResult':
