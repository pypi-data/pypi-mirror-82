...
class FlexiblePinAssembly(_2062.SpecialisedAssembly):
    '''FlexiblePinAssembly
    ...
    @property
    def planet_gear(self) -> '_2109.CylindricalGear':
        ...
        if _2109.CylindricalGear.TYPE not in self.wrapped.PlanetGear.__class__.__mro__:
