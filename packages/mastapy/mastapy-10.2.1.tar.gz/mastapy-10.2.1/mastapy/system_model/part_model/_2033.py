...
class ComponentsConnectedResult(_0.APIBase):
    ...
    @property
    def created_socket_connection(self) -> '_2034.ConnectedSockets':
        ...
        return constructor.new(_2034.ConnectedSockets)(self.wrapped.CreatedSocketConnection) if self.wrapped.CreatedSocketConnection else None
