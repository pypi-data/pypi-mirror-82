...
from mastapy import _3, _6554, _0
...
from mastapy.system_model.part_model import (
    _2061, _2058, _2060, _2054,
    _2023, _2024, _2025, _2028,
    _2030, _2031, _2032, _2035,
    _2036, _2039, _2040, _2041,
    _2044, _2048, _2049, _2050,
    _2052, _2055, _2057, _2062,
    _2063, _2064
)
from mastapy._internal.overridable_constructor import _unpack_overridable
from mastapy.gears import _122, _128
from mastapy.gears.materials import _381
from mastapy.utility import _1151, _1150, _1149
from mastapy.system_model import _1853, _1852
from mastapy.shafts import _34
from mastapy.detailed_rigid_connectors.splines import _980
from mastapy._math.vector_3d import Vector3D
from mastapy.system_model.part_model.gears import (
    _2096, _2117, _2097, _2098,
...
from mastapy.system_model.part_model.configurations import _2192, _2190, _2193
...
from mastapy.system_model.database_access import _1873
from mastapy.bearings.bearing_designs.rolling import _1800
from mastapy.system_model.analyses_and_results.synchroniser_analysis import _2525
...
class Design(_0.APIBase):
    ...
    @property
    def masta_gui(self) -> '_1530.MASTAGUI':
        ...
        return constructor.new(_1530.MASTAGUI)(self.wrapped.MastaGUI) if self.wrapped.MastaGUI else None
    ...
    @property
    def file_save_details_most_recent(self) -> '_1151.FileHistoryItem':
        ...
        return constructor.new(_1151.FileHistoryItem)(self.wrapped.FileSaveDetailsMostRecent) if self.wrapped.FileSaveDetailsMostRecent else None
    ...
    @property
    def file_save_details_all(self) -> '_1150.FileHistory':
        ...
        return constructor.new(_1150.FileHistory)(self.wrapped.FileSaveDetailsAll) if self.wrapped.FileSaveDetailsAll else None
    ...
    @property
    def selected_gear_set_selection_group(self) -> '_2096.ActiveGearSetDesignSelectionGroup':
        ...
        return constructor.new(_2096.ActiveGearSetDesignSelectionGroup)(self.wrapped.SelectedGearSetSelectionGroup) if self.wrapped.SelectedGearSetSelectionGroup else None
    ...
    @property
    def fe_batch_operations(self) -> '_1956.BatchOperations':
        ...
        return constructor.new(_1956.BatchOperations)(self.wrapped.FEBatchOperations) if self.wrapped.FEBatchOperations else None

    @property
    def iso14179_settings_per_bearing_type(self) -> 'List[_1630.ISO14179SettingsPerBearingType]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ISO14179SettingsPerBearingType, constructor.new(_1630.ISO14179SettingsPerBearingType))
        return value

    @property
    def gear_set_configurations(self) -> 'List[_2096.ActiveGearSetDesignSelectionGroup]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.GearSetConfigurations, constructor.new(_2096.ActiveGearSetDesignSelectionGroup))
        return value

    @property
    def shaft_detail_configurations(self) -> 'List[_2192.ActiveShaftDesignSelectionGroup]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ShaftDetailConfigurations, constructor.new(_2192.ActiveShaftDesignSelectionGroup))
        return value

    @property
    def imported_fe_configurations(self) -> 'List[_2190.ActiveImportedFESelectionGroup]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ImportedFEConfigurations, constructor.new(_2190.ActiveImportedFESelectionGroup))
        return value

    @property
    def bearing_detail_configurations(self) -> 'List[_2193.BearingDetailConfiguration]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.BearingDetailConfigurations, constructor.new(_2193.BearingDetailConfiguration))
        return value
    ...
    @property
    def root_assembly(self) -> '_2060.RootAssembly':
        ...
        return constructor.new(_2060.RootAssembly)(self.wrapped.RootAssembly) if self.wrapped.RootAssembly else None

    @property
    def gear_set_config(self) -> '_2117.GearSetConfiguration':
        '''GearSetConfiguration: 'GearSetConfig' is the original name of this property.'''

        return constructor.new(_2117.GearSetConfiguration)(self.wrapped.GearSetConfig) if self.wrapped.GearSetConfig else None

    @gear_set_config.setter
    def gear_set_config(self, value: '_2117.GearSetConfiguration'):
        value = value.wrapped if value else None
        self.wrapped.GearSetConfig = value

    @property
    def status(self) -> '_1332.Status':
        ...
        return constructor.new(_1332.Status)(self.wrapped.Status) if self.wrapped.Status else None

    @property
    def databases(self) -> '_1873.Databases':
        ...
        return constructor.new(_1873.Databases)(self.wrapped.Databases) if self.wrapped.Databases else None
    ...
    def remove_bearing_from_database(self, rolling_bearing: '_1800.RollingBearing'):
    ...
    def save(self, file_name: 'str', save_results: 'bool') -> '_1332.Status':
    ...
    def save_with_progess(self, file_name: 'str', save_results: 'bool', progress: '_6554.TaskProgress') -> '_1332.Status':
        ''' 'Save' is the original name of this method.
    ...
    def remove_synchroniser_shift(self, shift: '_2525.SynchroniserShift'):
    ...
    def add_synchroniser_shift(self, name: 'str') -> '_2525.SynchroniserShift':
    ...
    def add_synchroniser_shift_empty(self) -> '_2525.SynchroniserShift':
        ''' 'AddSynchroniserShift' is the original name of this method.
    ...
    def all_parts_of_type_assembly(self) -> 'List[_2023.Assembly]':
        ''' 'AllParts' is the original name of this method.
        ...
        return conversion.pn_to_mp_objects_in_list(self.wrapped.AllParts[_2023.Assembly.TYPE](), constructor.new(_2023.Assembly))
    ...
    @staticmethod
    def load(file_path: 'str', load_full_fe_option: Optional['_1149.ExternalFullFEFileOption'] = _1149.ExternalFullFEFileOption.MESH_AND_EXPANSION_VECTORS) -> 'Design':
    ...
    def new_belt_creation_options(self, centre_distance: Optional['float'] = 0.1, pulley_a_diameter: Optional['float'] = 0.08, pulley_b_diameter: Optional['float'] = 0.08, name: Optional['str'] = 'Belt Drive') -> '_2152.BeltCreationOptions':
    ...
    def new_planet_carrier_creation_options(self, number_of_planets: Optional['int'] = 3, diameter: Optional['float'] = 0.05) -> '_2154.PlanetCarrierCreationOptions':
    ...
    def new_shaft_creation_options(self, length: Optional['float'] = 0.1, outer_diameter: Optional['float'] = 0.025, bore: Optional['float'] = 0.0, name: Optional['str'] = 'Shaft') -> '_2155.ShaftCreationOptions':
    ...
    def new_cylindrical_gear_linear_train_creation_options(self, number_of_gears: Optional['int'] = 3, name: Optional['str'] = 'Gear Train') -> '_2153.CylindricalGearLinearTrainCreationOptions':
    ...
    def new_nodal_matrix(self, dense_matrix: 'List[List[float]]') -> '_1404.NodalMatrix':
