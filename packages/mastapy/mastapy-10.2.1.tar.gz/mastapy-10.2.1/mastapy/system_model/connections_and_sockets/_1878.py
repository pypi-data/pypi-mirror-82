...
from mastapy.system_model.connections_and_sockets import (
    _1899, _1880, _1882, _1884,
    _1885, _1886, _1888, _1889,
    _1891, _1892, _1895, _1896,
    _1897
)
...
from mastapy.system_model.connections_and_sockets.gears import (
    ...
    _1919, _1920, _1924, _1925,
    _1927, _1929, _1931, _1933,
    _1935
)
...
class Connection(_1837.DesignEntity):
    ...
    @property
    def socket_a(self) -> '_1899.Socket':
        ...
        if _1899.Socket.TYPE not in self.wrapped.SocketA.__class__.__mro__:
    ...
    @property
    def socket_a_of_type_cvt_pulley_socket(self) -> '_1880.CVTPulleySocket':
        ...
        if _1880.CVTPulleySocket.TYPE not in self.wrapped.SocketA.__class__.__mro__:
    ...
    @property
    def socket_a_of_type_cylindrical_socket(self) -> '_1882.CylindricalSocket':
        ...
        if _1882.CylindricalSocket.TYPE not in self.wrapped.SocketA.__class__.__mro__:
    ...
    @property
    def socket_a_of_type_electric_machine_stator_socket(self) -> '_1884.ElectricMachineStatorSocket':
        ...
        if _1884.ElectricMachineStatorSocket.TYPE not in self.wrapped.SocketA.__class__.__mro__:
    ...
    @property
    def socket_a_of_type_inner_shaft_connecting_socket(self) -> '_1885.InnerShaftConnectingSocket':
        ...
        if _1885.InnerShaftConnectingSocket.TYPE not in self.wrapped.SocketA.__class__.__mro__:
    ...
    @property
    def socket_a_of_type_inner_shaft_socket(self) -> '_1886.InnerShaftSocket':
        ...
        if _1886.InnerShaftSocket.TYPE not in self.wrapped.SocketA.__class__.__mro__:
    ...
    @property
    def socket_a_of_type_outer_shaft_connecting_socket(self) -> '_1888.OuterShaftConnectingSocket':
        ...
        if _1888.OuterShaftConnectingSocket.TYPE not in self.wrapped.SocketA.__class__.__mro__:
    ...
    @property
    def socket_a_of_type_outer_shaft_socket(self) -> '_1889.OuterShaftSocket':
        ...
        if _1889.OuterShaftSocket.TYPE not in self.wrapped.SocketA.__class__.__mro__:
    ...
    @property
    def socket_a_of_type_planetary_socket(self) -> '_1891.PlanetarySocket':
        ...
        if _1891.PlanetarySocket.TYPE not in self.wrapped.SocketA.__class__.__mro__:
    ...
    @property
    def socket_a_of_type_pulley_socket(self) -> '_1892.PulleySocket':
        ...
        if _1892.PulleySocket.TYPE not in self.wrapped.SocketA.__class__.__mro__:
            raise CastException('Failed to cast socket_a to PulleySocket. Expected: {}.'.format(self.wrapped.SocketA.__class__.__qualname__))

        return constructor.new_override(self.wrapped.SocketA.__class__)(self.wrapped.SocketA) if self.wrapped.SocketA else None

    @property
    def socket_a_of_type_rolling_ring_socket(self) -> '_1895.RollingRingSocket':
        ...
        if _1895.RollingRingSocket.TYPE not in self.wrapped.SocketA.__class__.__mro__:
    ...
    @property
    def socket_a_of_type_shaft_connecting_socket(self) -> '_1896.ShaftConnectingSocket':
        ...
        if _1896.ShaftConnectingSocket.TYPE not in self.wrapped.SocketA.__class__.__mro__:
    ...
    @property
    def socket_a_of_type_shaft_socket(self) -> '_1897.ShaftSocket':
        ...
        if _1897.ShaftSocket.TYPE not in self.wrapped.SocketA.__class__.__mro__:
            raise CastException('Failed to cast socket_a to ShaftSocket. Expected: {}.'.format(self.wrapped.SocketA.__class__.__qualname__))

        return constructor.new_override(self.wrapped.SocketA.__class__)(self.wrapped.SocketA) if self.wrapped.SocketA else None

    @property
    def socket_a_of_type_agma_gleason_conical_gear_teeth_socket(self) -> '_1903.AGMAGleasonConicalGearTeethSocket':
        ...
        if _1903.AGMAGleasonConicalGearTeethSocket.TYPE not in self.wrapped.SocketA.__class__.__mro__:
    ...
    @property
    def socket_a_of_type_bevel_differential_gear_teeth_socket(self) -> '_1905.BevelDifferentialGearTeethSocket':
        ...
        if _1905.BevelDifferentialGearTeethSocket.TYPE not in self.wrapped.SocketA.__class__.__mro__:
    ...
    @property
    def socket_a_of_type_bevel_gear_teeth_socket(self) -> '_1907.BevelGearTeethSocket':
        ...
        if _1907.BevelGearTeethSocket.TYPE not in self.wrapped.SocketA.__class__.__mro__:
    ...
    @property
    def socket_a_of_type_concept_gear_teeth_socket(self) -> '_1909.ConceptGearTeethSocket':
        ...
        if _1909.ConceptGearTeethSocket.TYPE not in self.wrapped.SocketA.__class__.__mro__:
    ...
    @property
    def socket_a_of_type_conical_gear_teeth_socket(self) -> '_1911.ConicalGearTeethSocket':
        ...
        if _1911.ConicalGearTeethSocket.TYPE not in self.wrapped.SocketA.__class__.__mro__:
    ...
    @property
    def socket_a_of_type_cylindrical_gear_teeth_socket(self) -> '_1913.CylindricalGearTeethSocket':
        ...
        if _1913.CylindricalGearTeethSocket.TYPE not in self.wrapped.SocketA.__class__.__mro__:
    ...
    @property
    def socket_a_of_type_face_gear_teeth_socket(self) -> '_1915.FaceGearTeethSocket':
        ...
        if _1915.FaceGearTeethSocket.TYPE not in self.wrapped.SocketA.__class__.__mro__:
    ...
    @property
    def socket_a_of_type_gear_teeth_socket(self) -> '_1917.GearTeethSocket':
        ...
        if _1917.GearTeethSocket.TYPE not in self.wrapped.SocketA.__class__.__mro__:
    ...
    @property
    def socket_a_of_type_hypoid_gear_teeth_socket(self) -> '_1919.HypoidGearTeethSocket':
        ...
        if _1919.HypoidGearTeethSocket.TYPE not in self.wrapped.SocketA.__class__.__mro__:
    ...
    @property
    def socket_a_of_type_klingelnberg_conical_gear_teeth_socket(self) -> '_1920.KlingelnbergConicalGearTeethSocket':
        ...
        if _1920.KlingelnbergConicalGearTeethSocket.TYPE not in self.wrapped.SocketA.__class__.__mro__:
    ...
    @property
    def socket_a_of_type_klingelnberg_hypoid_gear_teeth_socket(self) -> '_1924.KlingelnbergHypoidGearTeethSocket':
        ...
        if _1924.KlingelnbergHypoidGearTeethSocket.TYPE not in self.wrapped.SocketA.__class__.__mro__:
    ...
    @property
    def socket_a_of_type_klingelnberg_spiral_bevel_gear_teeth_socket(self) -> '_1925.KlingelnbergSpiralBevelGearTeethSocket':
        ...
        if _1925.KlingelnbergSpiralBevelGearTeethSocket.TYPE not in self.wrapped.SocketA.__class__.__mro__:
    ...
    @property
    def socket_a_of_type_spiral_bevel_gear_teeth_socket(self) -> '_1927.SpiralBevelGearTeethSocket':
        ...
        if _1927.SpiralBevelGearTeethSocket.TYPE not in self.wrapped.SocketA.__class__.__mro__:
    ...
    @property
    def socket_a_of_type_straight_bevel_diff_gear_teeth_socket(self) -> '_1929.StraightBevelDiffGearTeethSocket':
        ...
        if _1929.StraightBevelDiffGearTeethSocket.TYPE not in self.wrapped.SocketA.__class__.__mro__:
    ...
    @property
    def socket_a_of_type_straight_bevel_gear_teeth_socket(self) -> '_1931.StraightBevelGearTeethSocket':
        ...
        if _1931.StraightBevelGearTeethSocket.TYPE not in self.wrapped.SocketA.__class__.__mro__:
    ...
    @property
    def socket_a_of_type_worm_gear_teeth_socket(self) -> '_1933.WormGearTeethSocket':
        ...
        if _1933.WormGearTeethSocket.TYPE not in self.wrapped.SocketA.__class__.__mro__:
    ...
    @property
    def socket_a_of_type_zerol_bevel_gear_teeth_socket(self) -> '_1935.ZerolBevelGearTeethSocket':
        ...
        if _1935.ZerolBevelGearTeethSocket.TYPE not in self.wrapped.SocketA.__class__.__mro__:
    ...
    @property
    def socket_a_of_type_clutch_socket(self) -> '_1937.ClutchSocket':
        ...
        if _1937.ClutchSocket.TYPE not in self.wrapped.SocketA.__class__.__mro__:
            raise CastException('Failed to cast socket_a to ClutchSocket. Expected: {}.'.format(self.wrapped.SocketA.__class__.__qualname__))

        return constructor.new_override(self.wrapped.SocketA.__class__)(self.wrapped.SocketA) if self.wrapped.SocketA else None

    @property
    def socket_a_of_type_concept_coupling_socket(self) -> '_1939.ConceptCouplingSocket':
        ...
        if _1939.ConceptCouplingSocket.TYPE not in self.wrapped.SocketA.__class__.__mro__:
    ...
    @property
    def socket_a_of_type_coupling_socket(self) -> '_1941.CouplingSocket':
        ...
        if _1941.CouplingSocket.TYPE not in self.wrapped.SocketA.__class__.__mro__:
    ...
    @property
    def socket_a_of_type_part_to_part_shear_coupling_socket(self) -> '_1943.PartToPartShearCouplingSocket':
        ...
        if _1943.PartToPartShearCouplingSocket.TYPE not in self.wrapped.SocketA.__class__.__mro__:
    ...
    @property
    def socket_a_of_type_spring_damper_socket(self) -> '_1945.SpringDamperSocket':
        ...
        if _1945.SpringDamperSocket.TYPE not in self.wrapped.SocketA.__class__.__mro__:
    ...
    @property
    def socket_a_of_type_torque_converter_pump_socket(self) -> '_1947.TorqueConverterPumpSocket':
        ...
        if _1947.TorqueConverterPumpSocket.TYPE not in self.wrapped.SocketA.__class__.__mro__:
    ...
    @property
    def socket_a_of_type_torque_converter_turbine_socket(self) -> '_1948.TorqueConverterTurbineSocket':
        ...
        if _1948.TorqueConverterTurbineSocket.TYPE not in self.wrapped.SocketA.__class__.__mro__:
    ...
    @property
    def socket_b(self) -> '_1899.Socket':
        ...
        if _1899.Socket.TYPE not in self.wrapped.SocketB.__class__.__mro__:
    ...
    @property
    def socket_b_of_type_cvt_pulley_socket(self) -> '_1880.CVTPulleySocket':
        ...
        if _1880.CVTPulleySocket.TYPE not in self.wrapped.SocketB.__class__.__mro__:
    ...
    @property
    def socket_b_of_type_cylindrical_socket(self) -> '_1882.CylindricalSocket':
        ...
        if _1882.CylindricalSocket.TYPE not in self.wrapped.SocketB.__class__.__mro__:
    ...
    @property
    def socket_b_of_type_electric_machine_stator_socket(self) -> '_1884.ElectricMachineStatorSocket':
        ...
        if _1884.ElectricMachineStatorSocket.TYPE not in self.wrapped.SocketB.__class__.__mro__:
    ...
    @property
    def socket_b_of_type_inner_shaft_connecting_socket(self) -> '_1885.InnerShaftConnectingSocket':
        ...
        if _1885.InnerShaftConnectingSocket.TYPE not in self.wrapped.SocketB.__class__.__mro__:
    ...
    @property
    def socket_b_of_type_inner_shaft_socket(self) -> '_1886.InnerShaftSocket':
        ...
        if _1886.InnerShaftSocket.TYPE not in self.wrapped.SocketB.__class__.__mro__:
    ...
    @property
    def socket_b_of_type_outer_shaft_connecting_socket(self) -> '_1888.OuterShaftConnectingSocket':
        ...
        if _1888.OuterShaftConnectingSocket.TYPE not in self.wrapped.SocketB.__class__.__mro__:
    ...
    @property
    def socket_b_of_type_outer_shaft_socket(self) -> '_1889.OuterShaftSocket':
        ...
        if _1889.OuterShaftSocket.TYPE not in self.wrapped.SocketB.__class__.__mro__:
    ...
    @property
    def socket_b_of_type_planetary_socket(self) -> '_1891.PlanetarySocket':
        ...
        if _1891.PlanetarySocket.TYPE not in self.wrapped.SocketB.__class__.__mro__:
    ...
    @property
    def socket_b_of_type_pulley_socket(self) -> '_1892.PulleySocket':
        ...
        if _1892.PulleySocket.TYPE not in self.wrapped.SocketB.__class__.__mro__:
            raise CastException('Failed to cast socket_b to PulleySocket. Expected: {}.'.format(self.wrapped.SocketB.__class__.__qualname__))

        return constructor.new_override(self.wrapped.SocketB.__class__)(self.wrapped.SocketB) if self.wrapped.SocketB else None

    @property
    def socket_b_of_type_rolling_ring_socket(self) -> '_1895.RollingRingSocket':
        ...
        if _1895.RollingRingSocket.TYPE not in self.wrapped.SocketB.__class__.__mro__:
    ...
    @property
    def socket_b_of_type_shaft_connecting_socket(self) -> '_1896.ShaftConnectingSocket':
        ...
        if _1896.ShaftConnectingSocket.TYPE not in self.wrapped.SocketB.__class__.__mro__:
    ...
    @property
    def socket_b_of_type_shaft_socket(self) -> '_1897.ShaftSocket':
        ...
        if _1897.ShaftSocket.TYPE not in self.wrapped.SocketB.__class__.__mro__:
            raise CastException('Failed to cast socket_b to ShaftSocket. Expected: {}.'.format(self.wrapped.SocketB.__class__.__qualname__))

        return constructor.new_override(self.wrapped.SocketB.__class__)(self.wrapped.SocketB) if self.wrapped.SocketB else None

    @property
    def socket_b_of_type_agma_gleason_conical_gear_teeth_socket(self) -> '_1903.AGMAGleasonConicalGearTeethSocket':
        ...
        if _1903.AGMAGleasonConicalGearTeethSocket.TYPE not in self.wrapped.SocketB.__class__.__mro__:
    ...
    @property
    def socket_b_of_type_bevel_differential_gear_teeth_socket(self) -> '_1905.BevelDifferentialGearTeethSocket':
        ...
        if _1905.BevelDifferentialGearTeethSocket.TYPE not in self.wrapped.SocketB.__class__.__mro__:
    ...
    @property
    def socket_b_of_type_bevel_gear_teeth_socket(self) -> '_1907.BevelGearTeethSocket':
        ...
        if _1907.BevelGearTeethSocket.TYPE not in self.wrapped.SocketB.__class__.__mro__:
    ...
    @property
    def socket_b_of_type_concept_gear_teeth_socket(self) -> '_1909.ConceptGearTeethSocket':
        ...
        if _1909.ConceptGearTeethSocket.TYPE not in self.wrapped.SocketB.__class__.__mro__:
    ...
    @property
    def socket_b_of_type_conical_gear_teeth_socket(self) -> '_1911.ConicalGearTeethSocket':
        ...
        if _1911.ConicalGearTeethSocket.TYPE not in self.wrapped.SocketB.__class__.__mro__:
    ...
    @property
    def socket_b_of_type_cylindrical_gear_teeth_socket(self) -> '_1913.CylindricalGearTeethSocket':
        ...
        if _1913.CylindricalGearTeethSocket.TYPE not in self.wrapped.SocketB.__class__.__mro__:
    ...
    @property
    def socket_b_of_type_face_gear_teeth_socket(self) -> '_1915.FaceGearTeethSocket':
        ...
        if _1915.FaceGearTeethSocket.TYPE not in self.wrapped.SocketB.__class__.__mro__:
    ...
    @property
    def socket_b_of_type_gear_teeth_socket(self) -> '_1917.GearTeethSocket':
        ...
        if _1917.GearTeethSocket.TYPE not in self.wrapped.SocketB.__class__.__mro__:
    ...
    @property
    def socket_b_of_type_hypoid_gear_teeth_socket(self) -> '_1919.HypoidGearTeethSocket':
        ...
        if _1919.HypoidGearTeethSocket.TYPE not in self.wrapped.SocketB.__class__.__mro__:
    ...
    @property
    def socket_b_of_type_klingelnberg_conical_gear_teeth_socket(self) -> '_1920.KlingelnbergConicalGearTeethSocket':
        ...
        if _1920.KlingelnbergConicalGearTeethSocket.TYPE not in self.wrapped.SocketB.__class__.__mro__:
    ...
    @property
    def socket_b_of_type_klingelnberg_hypoid_gear_teeth_socket(self) -> '_1924.KlingelnbergHypoidGearTeethSocket':
        ...
        if _1924.KlingelnbergHypoidGearTeethSocket.TYPE not in self.wrapped.SocketB.__class__.__mro__:
    ...
    @property
    def socket_b_of_type_klingelnberg_spiral_bevel_gear_teeth_socket(self) -> '_1925.KlingelnbergSpiralBevelGearTeethSocket':
        ...
        if _1925.KlingelnbergSpiralBevelGearTeethSocket.TYPE not in self.wrapped.SocketB.__class__.__mro__:
    ...
    @property
    def socket_b_of_type_spiral_bevel_gear_teeth_socket(self) -> '_1927.SpiralBevelGearTeethSocket':
        ...
        if _1927.SpiralBevelGearTeethSocket.TYPE not in self.wrapped.SocketB.__class__.__mro__:
    ...
    @property
    def socket_b_of_type_straight_bevel_diff_gear_teeth_socket(self) -> '_1929.StraightBevelDiffGearTeethSocket':
        ...
        if _1929.StraightBevelDiffGearTeethSocket.TYPE not in self.wrapped.SocketB.__class__.__mro__:
    ...
    @property
    def socket_b_of_type_straight_bevel_gear_teeth_socket(self) -> '_1931.StraightBevelGearTeethSocket':
        ...
        if _1931.StraightBevelGearTeethSocket.TYPE not in self.wrapped.SocketB.__class__.__mro__:
    ...
    @property
    def socket_b_of_type_worm_gear_teeth_socket(self) -> '_1933.WormGearTeethSocket':
        ...
        if _1933.WormGearTeethSocket.TYPE not in self.wrapped.SocketB.__class__.__mro__:
    ...
    @property
    def socket_b_of_type_zerol_bevel_gear_teeth_socket(self) -> '_1935.ZerolBevelGearTeethSocket':
        ...
        if _1935.ZerolBevelGearTeethSocket.TYPE not in self.wrapped.SocketB.__class__.__mro__:
    ...
    @property
    def socket_b_of_type_clutch_socket(self) -> '_1937.ClutchSocket':
        ...
        if _1937.ClutchSocket.TYPE not in self.wrapped.SocketB.__class__.__mro__:
            raise CastException('Failed to cast socket_b to ClutchSocket. Expected: {}.'.format(self.wrapped.SocketB.__class__.__qualname__))

        return constructor.new_override(self.wrapped.SocketB.__class__)(self.wrapped.SocketB) if self.wrapped.SocketB else None

    @property
    def socket_b_of_type_concept_coupling_socket(self) -> '_1939.ConceptCouplingSocket':
        ...
        if _1939.ConceptCouplingSocket.TYPE not in self.wrapped.SocketB.__class__.__mro__:
    ...
    @property
    def socket_b_of_type_coupling_socket(self) -> '_1941.CouplingSocket':
        ...
        if _1941.CouplingSocket.TYPE not in self.wrapped.SocketB.__class__.__mro__:
    ...
    @property
    def socket_b_of_type_part_to_part_shear_coupling_socket(self) -> '_1943.PartToPartShearCouplingSocket':
        ...
        if _1943.PartToPartShearCouplingSocket.TYPE not in self.wrapped.SocketB.__class__.__mro__:
    ...
    @property
    def socket_b_of_type_spring_damper_socket(self) -> '_1945.SpringDamperSocket':
        ...
        if _1945.SpringDamperSocket.TYPE not in self.wrapped.SocketB.__class__.__mro__:
    ...
    @property
    def socket_b_of_type_torque_converter_pump_socket(self) -> '_1947.TorqueConverterPumpSocket':
        ...
        if _1947.TorqueConverterPumpSocket.TYPE not in self.wrapped.SocketB.__class__.__mro__:
    ...
    @property
    def socket_b_of_type_torque_converter_turbine_socket(self) -> '_1948.TorqueConverterTurbineSocket':
        ...
        if _1948.TorqueConverterTurbineSocket.TYPE not in self.wrapped.SocketB.__class__.__mro__:
    ...
    @property
    def owner_a(self) -> '_2032.Component':
        ...
        if _2032.Component.TYPE not in self.wrapped.OwnerA.__class__.__mro__:
    ...
    @property
    def owner_a_of_type_abstract_shaft_or_housing(self) -> '_2025.AbstractShaftOrHousing':
        ...
        if _2025.AbstractShaftOrHousing.TYPE not in self.wrapped.OwnerA.__class__.__mro__:
    ...
    @property
    def owner_a_of_type_bearing(self) -> '_2028.Bearing':
    ...
    def owner_a_of_type_bolt(self) -> '_2030.Bolt':
        ...
        if _2030.Bolt.TYPE not in self.wrapped.OwnerA.__class__.__mro__:
            raise CastException('Failed to cast owner_a to Bolt. Expected: {}.'.format(self.wrapped.OwnerA.__class__.__qualname__))

        return constructor.new_override(self.wrapped.OwnerA.__class__)(self.wrapped.OwnerA) if self.wrapped.OwnerA else None

    @property
    def owner_a_of_type_connector(self) -> '_2035.Connector':
    ...
    def owner_a_of_type_datum(self) -> '_2036.Datum':
        ...
        if _2036.Datum.TYPE not in self.wrapped.OwnerA.__class__.__mro__:
            raise CastException('Failed to cast owner_a to Datum. Expected: {}.'.format(self.wrapped.OwnerA.__class__.__qualname__))

        return constructor.new_override(self.wrapped.OwnerA.__class__)(self.wrapped.OwnerA) if self.wrapped.OwnerA else None

    @property
    def owner_a_of_type_external_cad_model(self) -> '_2039.ExternalCADModel':
        ...
        if _2039.ExternalCADModel.TYPE not in self.wrapped.OwnerA.__class__.__mro__:
    ...
    @property
    def owner_a_of_type_guide_dxf_model(self) -> '_2041.GuideDxfModel':
        ...
        if _2041.GuideDxfModel.TYPE not in self.wrapped.OwnerA.__class__.__mro__:
            raise CastException('Failed to cast owner_a to GuideDxfModel. Expected: {}.'.format(self.wrapped.OwnerA.__class__.__qualname__))

        return constructor.new_override(self.wrapped.OwnerA.__class__)(self.wrapped.OwnerA) if self.wrapped.OwnerA else None

    @property
    def owner_a_of_type_imported_fe_component(self) -> '_2044.ImportedFEComponent':
        ...
        if _2044.ImportedFEComponent.TYPE not in self.wrapped.OwnerA.__class__.__mro__:
    ...
    @property
    def owner_a_of_type_mass_disc(self) -> '_2048.MassDisc':
        ...
        if _2048.MassDisc.TYPE not in self.wrapped.OwnerA.__class__.__mro__:
            raise CastException('Failed to cast owner_a to MassDisc. Expected: {}.'.format(self.wrapped.OwnerA.__class__.__qualname__))

        return constructor.new_override(self.wrapped.OwnerA.__class__)(self.wrapped.OwnerA) if self.wrapped.OwnerA else None

    @property
    def owner_a_of_type_measurement_component(self) -> '_2049.MeasurementComponent':
        ...
        if _2049.MeasurementComponent.TYPE not in self.wrapped.OwnerA.__class__.__mro__:
    ...
    @property
    def owner_a_of_type_mountable_component(self) -> '_2050.MountableComponent':
        ...
        if _2050.MountableComponent.TYPE not in self.wrapped.OwnerA.__class__.__mro__:
    ...
    @property
    def owner_a_of_type_oil_seal(self) -> '_2052.OilSeal':
        ...
        if _2052.OilSeal.TYPE not in self.wrapped.OwnerA.__class__.__mro__:
            raise CastException('Failed to cast owner_a to OilSeal. Expected: {}.'.format(self.wrapped.OwnerA.__class__.__qualname__))

        return constructor.new_override(self.wrapped.OwnerA.__class__)(self.wrapped.OwnerA) if self.wrapped.OwnerA else None

    @property
    def owner_a_of_type_planet_carrier(self) -> '_2055.PlanetCarrier':
        ...
        if _2055.PlanetCarrier.TYPE not in self.wrapped.OwnerA.__class__.__mro__:
            raise CastException('Failed to cast owner_a to PlanetCarrier. Expected: {}.'.format(self.wrapped.OwnerA.__class__.__qualname__))

        return constructor.new_override(self.wrapped.OwnerA.__class__)(self.wrapped.OwnerA) if self.wrapped.OwnerA else None

    @property
    def owner_a_of_type_point_load(self) -> '_2057.PointLoad':
        ...
        if _2057.PointLoad.TYPE not in self.wrapped.OwnerA.__class__.__mro__:
            raise CastException('Failed to cast owner_a to PointLoad. Expected: {}.'.format(self.wrapped.OwnerA.__class__.__qualname__))

        return constructor.new_override(self.wrapped.OwnerA.__class__)(self.wrapped.OwnerA) if self.wrapped.OwnerA else None

    @property
    def owner_a_of_type_power_load(self) -> '_2058.PowerLoad':
        ...
        if _2058.PowerLoad.TYPE not in self.wrapped.OwnerA.__class__.__mro__:
            raise CastException('Failed to cast owner_a to PowerLoad. Expected: {}.'.format(self.wrapped.OwnerA.__class__.__qualname__))

        return constructor.new_override(self.wrapped.OwnerA.__class__)(self.wrapped.OwnerA) if self.wrapped.OwnerA else None

    @property
    def owner_a_of_type_unbalanced_mass(self) -> '_2063.UnbalancedMass':
        ...
        if _2063.UnbalancedMass.TYPE not in self.wrapped.OwnerA.__class__.__mro__:
            raise CastException('Failed to cast owner_a to UnbalancedMass. Expected: {}.'.format(self.wrapped.OwnerA.__class__.__qualname__))

        return constructor.new_override(self.wrapped.OwnerA.__class__)(self.wrapped.OwnerA) if self.wrapped.OwnerA else None

    @property
    def owner_a_of_type_virtual_component(self) -> '_2064.VirtualComponent':
        ...
        if _2064.VirtualComponent.TYPE not in self.wrapped.OwnerA.__class__.__mro__:
    ...
    @property
    def owner_a_of_type_shaft(self) -> '_2067.Shaft':
        ...
        if _2067.Shaft.TYPE not in self.wrapped.OwnerA.__class__.__mro__:
            raise CastException('Failed to cast owner_a to Shaft. Expected: {}.'.format(self.wrapped.OwnerA.__class__.__qualname__))

        return constructor.new_override(self.wrapped.OwnerA.__class__)(self.wrapped.OwnerA) if self.wrapped.OwnerA else None

    @property
    def owner_a_of_type_agma_gleason_conical_gear(self) -> '_2097.AGMAGleasonConicalGear':
        ...
        if _2097.AGMAGleasonConicalGear.TYPE not in self.wrapped.OwnerA.__class__.__mro__:
    ...
    @property
    def owner_a_of_type_bevel_differential_gear(self) -> '_2099.BevelDifferentialGear':
        ...
        if _2099.BevelDifferentialGear.TYPE not in self.wrapped.OwnerA.__class__.__mro__:
    ...
    @property
    def owner_a_of_type_bevel_differential_planet_gear(self) -> '_2101.BevelDifferentialPlanetGear':
        ...
        if _2101.BevelDifferentialPlanetGear.TYPE not in self.wrapped.OwnerA.__class__.__mro__:
    ...
    @property
    def owner_a_of_type_bevel_differential_sun_gear(self) -> '_2102.BevelDifferentialSunGear':
        ...
        if _2102.BevelDifferentialSunGear.TYPE not in self.wrapped.OwnerA.__class__.__mro__:
    ...
    @property
    def owner_a_of_type_bevel_gear(self) -> '_2103.BevelGear':
        ...
        if _2103.BevelGear.TYPE not in self.wrapped.OwnerA.__class__.__mro__:
            raise CastException('Failed to cast owner_a to BevelGear. Expected: {}.'.format(self.wrapped.OwnerA.__class__.__qualname__))

        return constructor.new_override(self.wrapped.OwnerA.__class__)(self.wrapped.OwnerA) if self.wrapped.OwnerA else None

    @property
    def owner_a_of_type_concept_gear(self) -> '_2105.ConceptGear':
        ...
        if _2105.ConceptGear.TYPE not in self.wrapped.OwnerA.__class__.__mro__:
            raise CastException('Failed to cast owner_a to ConceptGear. Expected: {}.'.format(self.wrapped.OwnerA.__class__.__qualname__))

        return constructor.new_override(self.wrapped.OwnerA.__class__)(self.wrapped.OwnerA) if self.wrapped.OwnerA else None

    @property
    def owner_a_of_type_conical_gear(self) -> '_2107.ConicalGear':
        ...
        if _2107.ConicalGear.TYPE not in self.wrapped.OwnerA.__class__.__mro__:
            raise CastException('Failed to cast owner_a to ConicalGear. Expected: {}.'.format(self.wrapped.OwnerA.__class__.__qualname__))

        return constructor.new_override(self.wrapped.OwnerA.__class__)(self.wrapped.OwnerA) if self.wrapped.OwnerA else None

    @property
    def owner_a_of_type_cylindrical_gear(self) -> '_2109.CylindricalGear':
        ...
        if _2109.CylindricalGear.TYPE not in self.wrapped.OwnerA.__class__.__mro__:
            raise CastException('Failed to cast owner_a to CylindricalGear. Expected: {}.'.format(self.wrapped.OwnerA.__class__.__qualname__))

        return constructor.new_override(self.wrapped.OwnerA.__class__)(self.wrapped.OwnerA) if self.wrapped.OwnerA else None

    @property
    def owner_a_of_type_cylindrical_planet_gear(self) -> '_2111.CylindricalPlanetGear':
        ...
        if _2111.CylindricalPlanetGear.TYPE not in self.wrapped.OwnerA.__class__.__mro__:
    ...
    @property
    def owner_a_of_type_face_gear(self) -> '_2112.FaceGear':
    ...
    def owner_a_of_type_gear(self) -> '_2114.Gear':
        ...
        if _2114.Gear.TYPE not in self.wrapped.OwnerA.__class__.__mro__:
            raise CastException('Failed to cast owner_a to Gear. Expected: {}.'.format(self.wrapped.OwnerA.__class__.__qualname__))

        return constructor.new_override(self.wrapped.OwnerA.__class__)(self.wrapped.OwnerA) if self.wrapped.OwnerA else None

    @property
    def owner_a_of_type_hypoid_gear(self) -> '_2118.HypoidGear':
        ...
        if _2118.HypoidGear.TYPE not in self.wrapped.OwnerA.__class__.__mro__:
            raise CastException('Failed to cast owner_a to HypoidGear. Expected: {}.'.format(self.wrapped.OwnerA.__class__.__qualname__))

        return constructor.new_override(self.wrapped.OwnerA.__class__)(self.wrapped.OwnerA) if self.wrapped.OwnerA else None

    @property
    def owner_a_of_type_klingelnberg_cyclo_palloid_conical_gear(self) -> '_2120.KlingelnbergCycloPalloidConicalGear':
        ...
        if _2120.KlingelnbergCycloPalloidConicalGear.TYPE not in self.wrapped.OwnerA.__class__.__mro__:
    ...
    @property
    def owner_a_of_type_klingelnberg_cyclo_palloid_hypoid_gear(self) -> '_2122.KlingelnbergCycloPalloidHypoidGear':
        ...
        if _2122.KlingelnbergCycloPalloidHypoidGear.TYPE not in self.wrapped.OwnerA.__class__.__mro__:
    ...
    @property
    def owner_a_of_type_klingelnberg_cyclo_palloid_spiral_bevel_gear(self) -> '_2124.KlingelnbergCycloPalloidSpiralBevelGear':
        ...
        if _2124.KlingelnbergCycloPalloidSpiralBevelGear.TYPE not in self.wrapped.OwnerA.__class__.__mro__:
    ...
    @property
    def owner_a_of_type_spiral_bevel_gear(self) -> '_2127.SpiralBevelGear':
        ...
        if _2127.SpiralBevelGear.TYPE not in self.wrapped.OwnerA.__class__.__mro__:
            raise CastException('Failed to cast owner_a to SpiralBevelGear. Expected: {}.'.format(self.wrapped.OwnerA.__class__.__qualname__))

        return constructor.new_override(self.wrapped.OwnerA.__class__)(self.wrapped.OwnerA) if self.wrapped.OwnerA else None

    @property
    def owner_a_of_type_straight_bevel_diff_gear(self) -> '_2129.StraightBevelDiffGear':
        ...
        if _2129.StraightBevelDiffGear.TYPE not in self.wrapped.OwnerA.__class__.__mro__:
    ...
    @property
    def owner_a_of_type_straight_bevel_gear(self) -> '_2131.StraightBevelGear':
        ...
        if _2131.StraightBevelGear.TYPE not in self.wrapped.OwnerA.__class__.__mro__:
    ...
    @property
    def owner_a_of_type_straight_bevel_planet_gear(self) -> '_2133.StraightBevelPlanetGear':
        ...
        if _2133.StraightBevelPlanetGear.TYPE not in self.wrapped.OwnerA.__class__.__mro__:
    ...
    @property
    def owner_a_of_type_straight_bevel_sun_gear(self) -> '_2134.StraightBevelSunGear':
        ...
        if _2134.StraightBevelSunGear.TYPE not in self.wrapped.OwnerA.__class__.__mro__:
    ...
    @property
    def owner_a_of_type_worm_gear(self) -> '_2135.WormGear':
        ...
        if _2135.WormGear.TYPE not in self.wrapped.OwnerA.__class__.__mro__:
            raise CastException('Failed to cast owner_a to WormGear. Expected: {}.'.format(self.wrapped.OwnerA.__class__.__qualname__))

        return constructor.new_override(self.wrapped.OwnerA.__class__)(self.wrapped.OwnerA) if self.wrapped.OwnerA else None

    @property
    def owner_a_of_type_zerol_bevel_gear(self) -> '_2137.ZerolBevelGear':
        ...
        if _2137.ZerolBevelGear.TYPE not in self.wrapped.OwnerA.__class__.__mro__:
            raise CastException('Failed to cast owner_a to ZerolBevelGear. Expected: {}.'.format(self.wrapped.OwnerA.__class__.__qualname__))

        return constructor.new_override(self.wrapped.OwnerA.__class__)(self.wrapped.OwnerA) if self.wrapped.OwnerA else None

    @property
    def owner_a_of_type_clutch_half(self) -> '_2159.ClutchHalf':
        ...
        if _2159.ClutchHalf.TYPE not in self.wrapped.OwnerA.__class__.__mro__:
            raise CastException('Failed to cast owner_a to ClutchHalf. Expected: {}.'.format(self.wrapped.OwnerA.__class__.__qualname__))

        return constructor.new_override(self.wrapped.OwnerA.__class__)(self.wrapped.OwnerA) if self.wrapped.OwnerA else None

    @property
    def owner_a_of_type_concept_coupling_half(self) -> '_2162.ConceptCouplingHalf':
        ...
        if _2162.ConceptCouplingHalf.TYPE not in self.wrapped.OwnerA.__class__.__mro__:
    ...
    @property
    def owner_a_of_type_coupling_half(self) -> '_2164.CouplingHalf':
        ...
        if _2164.CouplingHalf.TYPE not in self.wrapped.OwnerA.__class__.__mro__:
            raise CastException('Failed to cast owner_a to CouplingHalf. Expected: {}.'.format(self.wrapped.OwnerA.__class__.__qualname__))

        return constructor.new_override(self.wrapped.OwnerA.__class__)(self.wrapped.OwnerA) if self.wrapped.OwnerA else None

    @property
    def owner_a_of_type_cvt_pulley(self) -> '_2166.CVTPulley':
        ...
        if _2166.CVTPulley.TYPE not in self.wrapped.OwnerA.__class__.__mro__:
            raise CastException('Failed to cast owner_a to CVTPulley. Expected: {}.'.format(self.wrapped.OwnerA.__class__.__qualname__))

        return constructor.new_override(self.wrapped.OwnerA.__class__)(self.wrapped.OwnerA) if self.wrapped.OwnerA else None

    @property
    def owner_a_of_type_part_to_part_shear_coupling_half(self) -> '_2168.PartToPartShearCouplingHalf':
        ...
        if _2168.PartToPartShearCouplingHalf.TYPE not in self.wrapped.OwnerA.__class__.__mro__:
    ...
    @property
    def owner_a_of_type_pulley(self) -> '_2169.Pulley':
        ...
        if _2169.Pulley.TYPE not in self.wrapped.OwnerA.__class__.__mro__:
            raise CastException('Failed to cast owner_a to Pulley. Expected: {}.'.format(self.wrapped.OwnerA.__class__.__qualname__))

        return constructor.new_override(self.wrapped.OwnerA.__class__)(self.wrapped.OwnerA) if self.wrapped.OwnerA else None

    @property
    def owner_a_of_type_rolling_ring(self) -> '_2175.RollingRing':
        ...
        if _2175.RollingRing.TYPE not in self.wrapped.OwnerA.__class__.__mro__:
            raise CastException('Failed to cast owner_a to RollingRing. Expected: {}.'.format(self.wrapped.OwnerA.__class__.__qualname__))

        return constructor.new_override(self.wrapped.OwnerA.__class__)(self.wrapped.OwnerA) if self.wrapped.OwnerA else None

    @property
    def owner_a_of_type_shaft_hub_connection(self) -> '_2177.ShaftHubConnection':
        ...
        if _2177.ShaftHubConnection.TYPE not in self.wrapped.OwnerA.__class__.__mro__:
    ...
    @property
    def owner_a_of_type_spring_damper_half(self) -> '_2179.SpringDamperHalf':
        ...
        if _2179.SpringDamperHalf.TYPE not in self.wrapped.OwnerA.__class__.__mro__:
    ...
    @property
    def owner_a_of_type_synchroniser_half(self) -> '_2182.SynchroniserHalf':
        ...
        if _2182.SynchroniserHalf.TYPE not in self.wrapped.OwnerA.__class__.__mro__:
    ...
    @property
    def owner_a_of_type_synchroniser_part(self) -> '_2183.SynchroniserPart':
        ...
        if _2183.SynchroniserPart.TYPE not in self.wrapped.OwnerA.__class__.__mro__:
    ...
    @property
    def owner_a_of_type_synchroniser_sleeve(self) -> '_2184.SynchroniserSleeve':
        ...
        if _2184.SynchroniserSleeve.TYPE not in self.wrapped.OwnerA.__class__.__mro__:
    ...
    @property
    def owner_a_of_type_torque_converter_pump(self) -> '_2186.TorqueConverterPump':
        ...
        if _2186.TorqueConverterPump.TYPE not in self.wrapped.OwnerA.__class__.__mro__:
    ...
    @property
    def owner_a_of_type_torque_converter_turbine(self) -> '_2188.TorqueConverterTurbine':
        ...
        if _2188.TorqueConverterTurbine.TYPE not in self.wrapped.OwnerA.__class__.__mro__:
    ...
    @property
    def owner_b(self) -> '_2032.Component':
        ...
        if _2032.Component.TYPE not in self.wrapped.OwnerB.__class__.__mro__:
    ...
    @property
    def owner_b_of_type_abstract_shaft_or_housing(self) -> '_2025.AbstractShaftOrHousing':
        ...
        if _2025.AbstractShaftOrHousing.TYPE not in self.wrapped.OwnerB.__class__.__mro__:
    ...
    @property
    def owner_b_of_type_bearing(self) -> '_2028.Bearing':
    ...
    def owner_b_of_type_bolt(self) -> '_2030.Bolt':
        ...
        if _2030.Bolt.TYPE not in self.wrapped.OwnerB.__class__.__mro__:
            raise CastException('Failed to cast owner_b to Bolt. Expected: {}.'.format(self.wrapped.OwnerB.__class__.__qualname__))

        return constructor.new_override(self.wrapped.OwnerB.__class__)(self.wrapped.OwnerB) if self.wrapped.OwnerB else None

    @property
    def owner_b_of_type_connector(self) -> '_2035.Connector':
    ...
    def owner_b_of_type_datum(self) -> '_2036.Datum':
        ...
        if _2036.Datum.TYPE not in self.wrapped.OwnerB.__class__.__mro__:
            raise CastException('Failed to cast owner_b to Datum. Expected: {}.'.format(self.wrapped.OwnerB.__class__.__qualname__))

        return constructor.new_override(self.wrapped.OwnerB.__class__)(self.wrapped.OwnerB) if self.wrapped.OwnerB else None

    @property
    def owner_b_of_type_external_cad_model(self) -> '_2039.ExternalCADModel':
        ...
        if _2039.ExternalCADModel.TYPE not in self.wrapped.OwnerB.__class__.__mro__:
    ...
    @property
    def owner_b_of_type_guide_dxf_model(self) -> '_2041.GuideDxfModel':
        ...
        if _2041.GuideDxfModel.TYPE not in self.wrapped.OwnerB.__class__.__mro__:
            raise CastException('Failed to cast owner_b to GuideDxfModel. Expected: {}.'.format(self.wrapped.OwnerB.__class__.__qualname__))

        return constructor.new_override(self.wrapped.OwnerB.__class__)(self.wrapped.OwnerB) if self.wrapped.OwnerB else None

    @property
    def owner_b_of_type_imported_fe_component(self) -> '_2044.ImportedFEComponent':
        ...
        if _2044.ImportedFEComponent.TYPE not in self.wrapped.OwnerB.__class__.__mro__:
    ...
    @property
    def owner_b_of_type_mass_disc(self) -> '_2048.MassDisc':
        ...
        if _2048.MassDisc.TYPE not in self.wrapped.OwnerB.__class__.__mro__:
            raise CastException('Failed to cast owner_b to MassDisc. Expected: {}.'.format(self.wrapped.OwnerB.__class__.__qualname__))

        return constructor.new_override(self.wrapped.OwnerB.__class__)(self.wrapped.OwnerB) if self.wrapped.OwnerB else None

    @property
    def owner_b_of_type_measurement_component(self) -> '_2049.MeasurementComponent':
        ...
        if _2049.MeasurementComponent.TYPE not in self.wrapped.OwnerB.__class__.__mro__:
    ...
    @property
    def owner_b_of_type_mountable_component(self) -> '_2050.MountableComponent':
        ...
        if _2050.MountableComponent.TYPE not in self.wrapped.OwnerB.__class__.__mro__:
    ...
    @property
    def owner_b_of_type_oil_seal(self) -> '_2052.OilSeal':
        ...
        if _2052.OilSeal.TYPE not in self.wrapped.OwnerB.__class__.__mro__:
            raise CastException('Failed to cast owner_b to OilSeal. Expected: {}.'.format(self.wrapped.OwnerB.__class__.__qualname__))

        return constructor.new_override(self.wrapped.OwnerB.__class__)(self.wrapped.OwnerB) if self.wrapped.OwnerB else None

    @property
    def owner_b_of_type_planet_carrier(self) -> '_2055.PlanetCarrier':
        ...
        if _2055.PlanetCarrier.TYPE not in self.wrapped.OwnerB.__class__.__mro__:
            raise CastException('Failed to cast owner_b to PlanetCarrier. Expected: {}.'.format(self.wrapped.OwnerB.__class__.__qualname__))

        return constructor.new_override(self.wrapped.OwnerB.__class__)(self.wrapped.OwnerB) if self.wrapped.OwnerB else None

    @property
    def owner_b_of_type_point_load(self) -> '_2057.PointLoad':
        ...
        if _2057.PointLoad.TYPE not in self.wrapped.OwnerB.__class__.__mro__:
            raise CastException('Failed to cast owner_b to PointLoad. Expected: {}.'.format(self.wrapped.OwnerB.__class__.__qualname__))

        return constructor.new_override(self.wrapped.OwnerB.__class__)(self.wrapped.OwnerB) if self.wrapped.OwnerB else None

    @property
    def owner_b_of_type_power_load(self) -> '_2058.PowerLoad':
        ...
        if _2058.PowerLoad.TYPE not in self.wrapped.OwnerB.__class__.__mro__:
            raise CastException('Failed to cast owner_b to PowerLoad. Expected: {}.'.format(self.wrapped.OwnerB.__class__.__qualname__))

        return constructor.new_override(self.wrapped.OwnerB.__class__)(self.wrapped.OwnerB) if self.wrapped.OwnerB else None

    @property
    def owner_b_of_type_unbalanced_mass(self) -> '_2063.UnbalancedMass':
        ...
        if _2063.UnbalancedMass.TYPE not in self.wrapped.OwnerB.__class__.__mro__:
            raise CastException('Failed to cast owner_b to UnbalancedMass. Expected: {}.'.format(self.wrapped.OwnerB.__class__.__qualname__))

        return constructor.new_override(self.wrapped.OwnerB.__class__)(self.wrapped.OwnerB) if self.wrapped.OwnerB else None

    @property
    def owner_b_of_type_virtual_component(self) -> '_2064.VirtualComponent':
        ...
        if _2064.VirtualComponent.TYPE not in self.wrapped.OwnerB.__class__.__mro__:
    ...
    @property
    def owner_b_of_type_shaft(self) -> '_2067.Shaft':
        ...
        if _2067.Shaft.TYPE not in self.wrapped.OwnerB.__class__.__mro__:
            raise CastException('Failed to cast owner_b to Shaft. Expected: {}.'.format(self.wrapped.OwnerB.__class__.__qualname__))

        return constructor.new_override(self.wrapped.OwnerB.__class__)(self.wrapped.OwnerB) if self.wrapped.OwnerB else None

    @property
    def owner_b_of_type_agma_gleason_conical_gear(self) -> '_2097.AGMAGleasonConicalGear':
        ...
        if _2097.AGMAGleasonConicalGear.TYPE not in self.wrapped.OwnerB.__class__.__mro__:
    ...
    @property
    def owner_b_of_type_bevel_differential_gear(self) -> '_2099.BevelDifferentialGear':
        ...
        if _2099.BevelDifferentialGear.TYPE not in self.wrapped.OwnerB.__class__.__mro__:
    ...
    @property
    def owner_b_of_type_bevel_differential_planet_gear(self) -> '_2101.BevelDifferentialPlanetGear':
        ...
        if _2101.BevelDifferentialPlanetGear.TYPE not in self.wrapped.OwnerB.__class__.__mro__:
    ...
    @property
    def owner_b_of_type_bevel_differential_sun_gear(self) -> '_2102.BevelDifferentialSunGear':
        ...
        if _2102.BevelDifferentialSunGear.TYPE not in self.wrapped.OwnerB.__class__.__mro__:
    ...
    @property
    def owner_b_of_type_bevel_gear(self) -> '_2103.BevelGear':
        ...
        if _2103.BevelGear.TYPE not in self.wrapped.OwnerB.__class__.__mro__:
            raise CastException('Failed to cast owner_b to BevelGear. Expected: {}.'.format(self.wrapped.OwnerB.__class__.__qualname__))

        return constructor.new_override(self.wrapped.OwnerB.__class__)(self.wrapped.OwnerB) if self.wrapped.OwnerB else None

    @property
    def owner_b_of_type_concept_gear(self) -> '_2105.ConceptGear':
        ...
        if _2105.ConceptGear.TYPE not in self.wrapped.OwnerB.__class__.__mro__:
            raise CastException('Failed to cast owner_b to ConceptGear. Expected: {}.'.format(self.wrapped.OwnerB.__class__.__qualname__))

        return constructor.new_override(self.wrapped.OwnerB.__class__)(self.wrapped.OwnerB) if self.wrapped.OwnerB else None

    @property
    def owner_b_of_type_conical_gear(self) -> '_2107.ConicalGear':
        ...
        if _2107.ConicalGear.TYPE not in self.wrapped.OwnerB.__class__.__mro__:
            raise CastException('Failed to cast owner_b to ConicalGear. Expected: {}.'.format(self.wrapped.OwnerB.__class__.__qualname__))

        return constructor.new_override(self.wrapped.OwnerB.__class__)(self.wrapped.OwnerB) if self.wrapped.OwnerB else None

    @property
    def owner_b_of_type_cylindrical_gear(self) -> '_2109.CylindricalGear':
        ...
        if _2109.CylindricalGear.TYPE not in self.wrapped.OwnerB.__class__.__mro__:
            raise CastException('Failed to cast owner_b to CylindricalGear. Expected: {}.'.format(self.wrapped.OwnerB.__class__.__qualname__))

        return constructor.new_override(self.wrapped.OwnerB.__class__)(self.wrapped.OwnerB) if self.wrapped.OwnerB else None

    @property
    def owner_b_of_type_cylindrical_planet_gear(self) -> '_2111.CylindricalPlanetGear':
        ...
        if _2111.CylindricalPlanetGear.TYPE not in self.wrapped.OwnerB.__class__.__mro__:
    ...
    @property
    def owner_b_of_type_face_gear(self) -> '_2112.FaceGear':
    ...
    def owner_b_of_type_gear(self) -> '_2114.Gear':
        ...
        if _2114.Gear.TYPE not in self.wrapped.OwnerB.__class__.__mro__:
            raise CastException('Failed to cast owner_b to Gear. Expected: {}.'.format(self.wrapped.OwnerB.__class__.__qualname__))

        return constructor.new_override(self.wrapped.OwnerB.__class__)(self.wrapped.OwnerB) if self.wrapped.OwnerB else None

    @property
    def owner_b_of_type_hypoid_gear(self) -> '_2118.HypoidGear':
        ...
        if _2118.HypoidGear.TYPE not in self.wrapped.OwnerB.__class__.__mro__:
            raise CastException('Failed to cast owner_b to HypoidGear. Expected: {}.'.format(self.wrapped.OwnerB.__class__.__qualname__))

        return constructor.new_override(self.wrapped.OwnerB.__class__)(self.wrapped.OwnerB) if self.wrapped.OwnerB else None

    @property
    def owner_b_of_type_klingelnberg_cyclo_palloid_conical_gear(self) -> '_2120.KlingelnbergCycloPalloidConicalGear':
        ...
        if _2120.KlingelnbergCycloPalloidConicalGear.TYPE not in self.wrapped.OwnerB.__class__.__mro__:
    ...
    @property
    def owner_b_of_type_klingelnberg_cyclo_palloid_hypoid_gear(self) -> '_2122.KlingelnbergCycloPalloidHypoidGear':
        ...
        if _2122.KlingelnbergCycloPalloidHypoidGear.TYPE not in self.wrapped.OwnerB.__class__.__mro__:
    ...
    @property
    def owner_b_of_type_klingelnberg_cyclo_palloid_spiral_bevel_gear(self) -> '_2124.KlingelnbergCycloPalloidSpiralBevelGear':
        ...
        if _2124.KlingelnbergCycloPalloidSpiralBevelGear.TYPE not in self.wrapped.OwnerB.__class__.__mro__:
    ...
    @property
    def owner_b_of_type_spiral_bevel_gear(self) -> '_2127.SpiralBevelGear':
        ...
        if _2127.SpiralBevelGear.TYPE not in self.wrapped.OwnerB.__class__.__mro__:
            raise CastException('Failed to cast owner_b to SpiralBevelGear. Expected: {}.'.format(self.wrapped.OwnerB.__class__.__qualname__))

        return constructor.new_override(self.wrapped.OwnerB.__class__)(self.wrapped.OwnerB) if self.wrapped.OwnerB else None

    @property
    def owner_b_of_type_straight_bevel_diff_gear(self) -> '_2129.StraightBevelDiffGear':
        ...
        if _2129.StraightBevelDiffGear.TYPE not in self.wrapped.OwnerB.__class__.__mro__:
    ...
    @property
    def owner_b_of_type_straight_bevel_gear(self) -> '_2131.StraightBevelGear':
        ...
        if _2131.StraightBevelGear.TYPE not in self.wrapped.OwnerB.__class__.__mro__:
    ...
    @property
    def owner_b_of_type_straight_bevel_planet_gear(self) -> '_2133.StraightBevelPlanetGear':
        ...
        if _2133.StraightBevelPlanetGear.TYPE not in self.wrapped.OwnerB.__class__.__mro__:
    ...
    @property
    def owner_b_of_type_straight_bevel_sun_gear(self) -> '_2134.StraightBevelSunGear':
        ...
        if _2134.StraightBevelSunGear.TYPE not in self.wrapped.OwnerB.__class__.__mro__:
    ...
    @property
    def owner_b_of_type_worm_gear(self) -> '_2135.WormGear':
        ...
        if _2135.WormGear.TYPE not in self.wrapped.OwnerB.__class__.__mro__:
            raise CastException('Failed to cast owner_b to WormGear. Expected: {}.'.format(self.wrapped.OwnerB.__class__.__qualname__))

        return constructor.new_override(self.wrapped.OwnerB.__class__)(self.wrapped.OwnerB) if self.wrapped.OwnerB else None

    @property
    def owner_b_of_type_zerol_bevel_gear(self) -> '_2137.ZerolBevelGear':
        ...
        if _2137.ZerolBevelGear.TYPE not in self.wrapped.OwnerB.__class__.__mro__:
            raise CastException('Failed to cast owner_b to ZerolBevelGear. Expected: {}.'.format(self.wrapped.OwnerB.__class__.__qualname__))

        return constructor.new_override(self.wrapped.OwnerB.__class__)(self.wrapped.OwnerB) if self.wrapped.OwnerB else None

    @property
    def owner_b_of_type_clutch_half(self) -> '_2159.ClutchHalf':
        ...
        if _2159.ClutchHalf.TYPE not in self.wrapped.OwnerB.__class__.__mro__:
            raise CastException('Failed to cast owner_b to ClutchHalf. Expected: {}.'.format(self.wrapped.OwnerB.__class__.__qualname__))

        return constructor.new_override(self.wrapped.OwnerB.__class__)(self.wrapped.OwnerB) if self.wrapped.OwnerB else None

    @property
    def owner_b_of_type_concept_coupling_half(self) -> '_2162.ConceptCouplingHalf':
        ...
        if _2162.ConceptCouplingHalf.TYPE not in self.wrapped.OwnerB.__class__.__mro__:
    ...
    @property
    def owner_b_of_type_coupling_half(self) -> '_2164.CouplingHalf':
        ...
        if _2164.CouplingHalf.TYPE not in self.wrapped.OwnerB.__class__.__mro__:
            raise CastException('Failed to cast owner_b to CouplingHalf. Expected: {}.'.format(self.wrapped.OwnerB.__class__.__qualname__))

        return constructor.new_override(self.wrapped.OwnerB.__class__)(self.wrapped.OwnerB) if self.wrapped.OwnerB else None

    @property
    def owner_b_of_type_cvt_pulley(self) -> '_2166.CVTPulley':
        ...
        if _2166.CVTPulley.TYPE not in self.wrapped.OwnerB.__class__.__mro__:
            raise CastException('Failed to cast owner_b to CVTPulley. Expected: {}.'.format(self.wrapped.OwnerB.__class__.__qualname__))

        return constructor.new_override(self.wrapped.OwnerB.__class__)(self.wrapped.OwnerB) if self.wrapped.OwnerB else None

    @property
    def owner_b_of_type_part_to_part_shear_coupling_half(self) -> '_2168.PartToPartShearCouplingHalf':
        ...
        if _2168.PartToPartShearCouplingHalf.TYPE not in self.wrapped.OwnerB.__class__.__mro__:
    ...
    @property
    def owner_b_of_type_pulley(self) -> '_2169.Pulley':
        ...
        if _2169.Pulley.TYPE not in self.wrapped.OwnerB.__class__.__mro__:
            raise CastException('Failed to cast owner_b to Pulley. Expected: {}.'.format(self.wrapped.OwnerB.__class__.__qualname__))

        return constructor.new_override(self.wrapped.OwnerB.__class__)(self.wrapped.OwnerB) if self.wrapped.OwnerB else None

    @property
    def owner_b_of_type_rolling_ring(self) -> '_2175.RollingRing':
        ...
        if _2175.RollingRing.TYPE not in self.wrapped.OwnerB.__class__.__mro__:
            raise CastException('Failed to cast owner_b to RollingRing. Expected: {}.'.format(self.wrapped.OwnerB.__class__.__qualname__))

        return constructor.new_override(self.wrapped.OwnerB.__class__)(self.wrapped.OwnerB) if self.wrapped.OwnerB else None

    @property
    def owner_b_of_type_shaft_hub_connection(self) -> '_2177.ShaftHubConnection':
        ...
        if _2177.ShaftHubConnection.TYPE not in self.wrapped.OwnerB.__class__.__mro__:
    ...
    @property
    def owner_b_of_type_spring_damper_half(self) -> '_2179.SpringDamperHalf':
        ...
        if _2179.SpringDamperHalf.TYPE not in self.wrapped.OwnerB.__class__.__mro__:
    ...
    @property
    def owner_b_of_type_synchroniser_half(self) -> '_2182.SynchroniserHalf':
        ...
        if _2182.SynchroniserHalf.TYPE not in self.wrapped.OwnerB.__class__.__mro__:
    ...
    @property
    def owner_b_of_type_synchroniser_part(self) -> '_2183.SynchroniserPart':
        ...
        if _2183.SynchroniserPart.TYPE not in self.wrapped.OwnerB.__class__.__mro__:
    ...
    @property
    def owner_b_of_type_synchroniser_sleeve(self) -> '_2184.SynchroniserSleeve':
        ...
        if _2184.SynchroniserSleeve.TYPE not in self.wrapped.OwnerB.__class__.__mro__:
    ...
    @property
    def owner_b_of_type_torque_converter_pump(self) -> '_2186.TorqueConverterPump':
        ...
        if _2186.TorqueConverterPump.TYPE not in self.wrapped.OwnerB.__class__.__mro__:
    ...
    @property
    def owner_b_of_type_torque_converter_turbine(self) -> '_2188.TorqueConverterTurbine':
        ...
        if _2188.TorqueConverterTurbine.TYPE not in self.wrapped.OwnerB.__class__.__mro__:
    ...
    def socket_for(self, component: '_2032.Component') -> '_1899.Socket':
    ...
    def other_owner(self, component: '_2032.Component') -> '_2032.Component':
    ...
    def other_socket_for_component(self, component: '_2032.Component') -> '_1899.Socket':
    ...
    def other_socket(self, socket: '_1899.Socket') -> '_1899.Socket':
        ''' 'OtherSocket' is the original name of this method.
