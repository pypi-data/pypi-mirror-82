...
from mastapy.system_model.analyses_and_results.modal_analyses_at_speeds_ns import _4071, _4070, _4018
...
class HypoidGearSetModalAnalysesAtSpeeds(_4018.AGMAGleasonConicalGearSetModalAnalysesAtSpeeds):
    '''HypoidGearSetModalAnalysesAtSpeeds
    ...
    @property
    def hypoid_gears_modal_analyses_at_speeds(self) -> 'List[_4071.HypoidGearModalAnalysesAtSpeeds]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.HypoidGearsModalAnalysesAtSpeeds, constructor.new(_4071.HypoidGearModalAnalysesAtSpeeds))
        return value

    @property
    def hypoid_meshes_modal_analyses_at_speeds(self) -> 'List[_4070.HypoidGearMeshModalAnalysesAtSpeeds]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.HypoidMeshesModalAnalysesAtSpeeds, constructor.new(_4070.HypoidGearMeshModalAnalysesAtSpeeds))
        return value
