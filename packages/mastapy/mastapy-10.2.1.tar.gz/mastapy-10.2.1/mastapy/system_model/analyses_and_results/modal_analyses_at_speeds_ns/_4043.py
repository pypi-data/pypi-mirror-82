...
from mastapy.system_model.analyses_and_results.modal_analyses_at_speeds_ns import _4042, _4041, _4068
...
class ConceptGearSetModalAnalysesAtSpeeds(_4068.GearSetModalAnalysesAtSpeeds):
    '''ConceptGearSetModalAnalysesAtSpeeds
    ...
    @property
    def concept_gears_modal_analyses_at_speeds(self) -> 'List[_4042.ConceptGearModalAnalysesAtSpeeds]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConceptGearsModalAnalysesAtSpeeds, constructor.new(_4042.ConceptGearModalAnalysesAtSpeeds))
        return value

    @property
    def concept_meshes_modal_analyses_at_speeds(self) -> 'List[_4041.ConceptGearMeshModalAnalysesAtSpeeds]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConceptMeshesModalAnalysesAtSpeeds, constructor.new(_4041.ConceptGearMeshModalAnalysesAtSpeeds))
        return value
