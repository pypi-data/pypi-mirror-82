...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_speed import _4575, _4509
...
class RootAssemblyModalAnalysisAtASpeed(_4509.AssemblyModalAnalysisAtASpeed):
    '''RootAssemblyModalAnalysisAtASpeed
    ...
    @property
    def modal_analysis_at_a_speed_inputs(self) -> '_4575.ModalAnalysisAtASpeed':
        ...
        return constructor.new(_4575.ModalAnalysisAtASpeed)(self.wrapped.ModalAnalysisAtASpeedInputs) if self.wrapped.ModalAnalysisAtASpeedInputs else None
