...
class SynchroniserSleeveCompoundModalAnalysisAtASpeed(_4733.SynchroniserPartCompoundModalAnalysisAtASpeed):
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_4613.SynchroniserSleeveModalAnalysisAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_4613.SynchroniserSleeveModalAnalysisAtASpeed))
        return value

    @property
    def component_modal_analysis_at_a_speed_load_cases(self) -> 'List[_4613.SynchroniserSleeveModalAnalysisAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentModalAnalysisAtASpeedLoadCases, constructor.new(_4613.SynchroniserSleeveModalAnalysisAtASpeed))
        return value
