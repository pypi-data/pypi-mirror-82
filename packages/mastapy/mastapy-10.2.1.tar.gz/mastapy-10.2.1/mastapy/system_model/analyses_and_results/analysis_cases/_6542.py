...
from mastapy.system_model.analyses_and_results import _2228, _2226
...
class DesignEntityCompoundAnalysis(_2226.DesignEntityAnalysis):
    '''DesignEntityCompoundAnalysis
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_2228.DesignEntitySingleContextAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_2228.DesignEntitySingleContextAnalysis))
        return value
