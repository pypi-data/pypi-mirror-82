...
class CylindricalPlanetGearSystemDeflection(_2302.CylindricalGearSystemDeflection):
    '''CylindricalPlanetGearSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3309.CylindricalPlanetGearPowerFlow':
        ...
        return constructor.new(_3309.CylindricalPlanetGearPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
