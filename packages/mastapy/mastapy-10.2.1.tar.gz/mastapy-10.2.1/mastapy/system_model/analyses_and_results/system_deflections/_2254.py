...
from mastapy.system_model.analyses_and_results.power_flows import _3265, _3323, _3355
...
class AbstractShaftOrHousingSystemDeflection(_2276.ComponentSystemDeflection):
    '''AbstractShaftOrHousingSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3265.AbstractShaftOrHousingPowerFlow':
        ...
        if _3265.AbstractShaftOrHousingPowerFlow.TYPE not in self.wrapped.PowerFlowResults.__class__.__mro__:
    ...
    @property
    def power_flow_results_of_type_imported_fe_component_power_flow(self) -> '_3323.ImportedFEComponentPowerFlow':
        ...
        if _3323.ImportedFEComponentPowerFlow.TYPE not in self.wrapped.PowerFlowResults.__class__.__mro__:
    ...
    @property
    def power_flow_results_of_type_shaft_power_flow(self) -> '_3355.ShaftPowerFlow':
        ...
        if _3355.ShaftPowerFlow.TYPE not in self.wrapped.PowerFlowResults.__class__.__mro__:
