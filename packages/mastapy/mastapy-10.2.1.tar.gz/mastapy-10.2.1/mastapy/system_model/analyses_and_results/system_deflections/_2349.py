...
class RollingRingConnectionSystemDeflection(_2321.InterMountableComponentConnectionSystemDeflection):
    '''RollingRingConnectionSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3351.RollingRingConnectionPowerFlow':
        ...
        return constructor.new(_3351.RollingRingConnectionPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
