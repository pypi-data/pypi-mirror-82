...
class PartToPartShearCouplingSystemDeflection(_2292.CouplingSystemDeflection):
    '''PartToPartShearCouplingSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3341.PartToPartShearCouplingPowerFlow':
        ...
        return constructor.new(_3341.PartToPartShearCouplingPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
