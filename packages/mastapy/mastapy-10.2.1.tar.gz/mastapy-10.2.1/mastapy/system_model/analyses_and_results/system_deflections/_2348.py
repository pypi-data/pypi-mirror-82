...
class RollingRingAssemblySystemDeflection(_2357.SpecialisedAssemblySystemDeflection):
    '''RollingRingAssemblySystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3350.RollingRingAssemblyPowerFlow':
        ...
        return constructor.new(_3350.RollingRingAssemblyPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
