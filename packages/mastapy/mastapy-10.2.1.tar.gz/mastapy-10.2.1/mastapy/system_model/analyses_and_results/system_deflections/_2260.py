...
class BeltConnectionSystemDeflection(_2321.InterMountableComponentConnectionSystemDeflection):
    '''BeltConnectionSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3271.BeltConnectionPowerFlow':
        ...
        if _3271.BeltConnectionPowerFlow.TYPE not in self.wrapped.PowerFlowResults.__class__.__mro__:
