...
class DatumSystemDeflection(_2276.ComponentSystemDeflection):
    '''DatumSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3310.DatumPowerFlow':
        ...
        return constructor.new(_3310.DatumPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
