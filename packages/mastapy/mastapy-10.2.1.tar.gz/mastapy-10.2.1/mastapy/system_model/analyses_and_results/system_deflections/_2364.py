...
class StraightBevelDiffGearMeshSystemDeflection(_2267.BevelGearMeshSystemDeflection):
    '''StraightBevelDiffGearMeshSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3364.StraightBevelDiffGearMeshPowerFlow':
        ...
        return constructor.new(_3364.StraightBevelDiffGearMeshPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
