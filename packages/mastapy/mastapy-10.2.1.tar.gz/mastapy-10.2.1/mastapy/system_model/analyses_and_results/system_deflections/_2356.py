...
from mastapy.system_model.analyses_and_results.power_flows import _3356, _3286, _3342
...
class ShaftToMountableComponentConnectionSystemDeflection(_2288.ConnectionSystemDeflection):
    '''ShaftToMountableComponentConnectionSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3356.ShaftToMountableComponentConnectionPowerFlow':
        ...
        if _3356.ShaftToMountableComponentConnectionPowerFlow.TYPE not in self.wrapped.PowerFlowResults.__class__.__mro__:
    ...
    @property
    def power_flow_results_of_type_coaxial_connection_power_flow(self) -> '_3286.CoaxialConnectionPowerFlow':
        ...
        if _3286.CoaxialConnectionPowerFlow.TYPE not in self.wrapped.PowerFlowResults.__class__.__mro__:
    ...
    @property
    def power_flow_results_of_type_planetary_connection_power_flow(self) -> '_3342.PlanetaryConnectionPowerFlow':
        ...
        if _3342.PlanetaryConnectionPowerFlow.TYPE not in self.wrapped.PowerFlowResults.__class__.__mro__:
