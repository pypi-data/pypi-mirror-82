...
from mastapy.system_model.drawing import _1870, _1868
...
class SystemDeflectionDrawStyle(_1868.ContourDrawStyle):
    '''SystemDeflectionDrawStyle
    ...
    @property
    def force_arrow_scaling(self) -> '_1870.ScalingDrawStyle':
        ...
        return constructor.new(_1870.ScalingDrawStyle)(self.wrapped.ForceArrowScaling) if self.wrapped.ForceArrowScaling else None
