...
from mastapy.system_model.analyses_and_results.power_flows import _3308, _3343
from mastapy.gears.rating.cylindrical import _262
from mastapy.gears.manufacturing.cylindrical import _404
from mastapy.system_model.analyses_and_results.system_deflections import _2302, _2296, _2314
...
class CylindricalGearSetSystemDeflection(_2314.GearSetSystemDeflection):
    '''CylindricalGearSetSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3308.CylindricalGearSetPowerFlow':
    ...
    @property
    def cylindrical_gears_system_deflection(self) -> 'List[_2302.CylindricalGearSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CylindricalGearsSystemDeflection, constructor.new(_2302.CylindricalGearSystemDeflection))
        return value

    @property
    def cylindrical_meshes_system_deflection(self) -> 'List[_2296.CylindricalGearMeshSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CylindricalMeshesSystemDeflection, constructor.new(_2296.CylindricalGearMeshSystemDeflection))
        return value
