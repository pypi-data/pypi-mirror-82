...
class ConceptCouplingSystemDeflection(_2292.CouplingSystemDeflection):
    '''ConceptCouplingSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3290.ConceptCouplingPowerFlow':
        ...
        return constructor.new(_3290.ConceptCouplingPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
