...
class CVTPulleySystemDeflection(_2347.PulleySystemDeflection):
    '''CVTPulleySystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3304.CVTPulleyPowerFlow':
        ...
        return constructor.new(_3304.CVTPulleyPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
