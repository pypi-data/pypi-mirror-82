...
class CVTSystemDeflection(_2261.BeltDriveSystemDeflection):
    '''CVTSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3303.CVTPowerFlow':
        ...
        return constructor.new(_3303.CVTPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
