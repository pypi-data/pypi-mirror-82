...
class BevelDifferentialSunGearSystemDeflection(_2264.BevelDifferentialGearSystemDeflection):
    '''BevelDifferentialSunGearSystemDeflection
    ...
    @property
    def component_design(self) -> '_2102.BevelDifferentialSunGear':
        ...
        return constructor.new(_2102.BevelDifferentialSunGear)(self.wrapped.ComponentDesign) if self.wrapped.ComponentDesign else None

    @property
    def power_flow_results(self) -> '_3277.BevelDifferentialSunGearPowerFlow':
        ...
        return constructor.new(_3277.BevelDifferentialSunGearPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
