...
class SpiralBevelGearSystemDeflection(_2269.BevelGearSystemDeflection):
    '''SpiralBevelGearSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3359.SpiralBevelGearPowerFlow':
        ...
        return constructor.new(_3359.SpiralBevelGearPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
