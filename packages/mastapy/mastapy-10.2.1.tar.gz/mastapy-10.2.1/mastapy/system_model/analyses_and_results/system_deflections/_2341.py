...
class PartToPartShearCouplingHalfSystemDeflection(_2291.CouplingHalfSystemDeflection):
    '''PartToPartShearCouplingHalfSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3340.PartToPartShearCouplingHalfPowerFlow':
        ...
        return constructor.new(_3340.PartToPartShearCouplingHalfPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
