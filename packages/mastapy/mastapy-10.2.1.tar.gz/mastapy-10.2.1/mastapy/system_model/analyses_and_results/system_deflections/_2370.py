...
class StraightBevelPlanetGearSystemDeflection(_2366.StraightBevelDiffGearSystemDeflection):
    '''StraightBevelPlanetGearSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3370.StraightBevelPlanetGearPowerFlow':
        ...
        return constructor.new(_3370.StraightBevelPlanetGearPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
