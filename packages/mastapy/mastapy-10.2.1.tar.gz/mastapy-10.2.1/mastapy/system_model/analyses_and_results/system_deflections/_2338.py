...
class OilSealSystemDeflection(_2289.ConnectorSystemDeflection):
    '''OilSealSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3337.OilSealPowerFlow':
        ...
        return constructor.new(_3337.OilSealPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
