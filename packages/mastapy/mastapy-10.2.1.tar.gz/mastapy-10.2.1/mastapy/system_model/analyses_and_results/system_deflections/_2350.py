...
class RollingRingSystemDeflection(_2291.CouplingHalfSystemDeflection):
    '''RollingRingSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3352.RollingRingPowerFlow':
        ...
        return constructor.new(_3352.RollingRingPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
