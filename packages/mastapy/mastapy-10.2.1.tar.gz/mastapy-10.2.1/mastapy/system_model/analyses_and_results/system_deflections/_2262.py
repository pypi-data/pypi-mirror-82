...
class BevelDifferentialGearMeshSystemDeflection(_2267.BevelGearMeshSystemDeflection):
    '''BevelDifferentialGearMeshSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3273.BevelDifferentialGearMeshPowerFlow':
        ...
        return constructor.new(_3273.BevelDifferentialGearMeshPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
