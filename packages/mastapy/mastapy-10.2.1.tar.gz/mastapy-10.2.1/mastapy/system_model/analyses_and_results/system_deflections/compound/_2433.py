...
class ConicalGearMeshCompoundSystemDeflection(_2455.GearMeshCompoundSystemDeflection):
    '''ConicalGearMeshCompoundSystemDeflection
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_2285.ConicalGearMeshSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_2285.ConicalGearMeshSystemDeflection))
        return value
