...
class TorqueConverterConnectionCompoundSystemDeflection(_2438.CouplingConnectionCompoundSystemDeflection):
    '''TorqueConverterConnectionCompoundSystemDeflection
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_2379.TorqueConverterConnectionSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_2379.TorqueConverterConnectionSystemDeflection))
        return value

    @property
    def connection_system_deflection_load_cases(self) -> 'List[_2379.TorqueConverterConnectionSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionSystemDeflectionLoadCases, constructor.new(_2379.TorqueConverterConnectionSystemDeflection))
        return value
