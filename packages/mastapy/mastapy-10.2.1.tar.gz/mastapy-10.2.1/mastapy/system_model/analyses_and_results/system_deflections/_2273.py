...
class ClutchHalfSystemDeflection(_2291.CouplingHalfSystemDeflection):
    '''ClutchHalfSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3284.ClutchHalfPowerFlow':
        ...
        return constructor.new(_3284.ClutchHalfPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
