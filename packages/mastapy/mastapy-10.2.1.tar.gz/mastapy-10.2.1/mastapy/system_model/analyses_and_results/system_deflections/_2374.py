...
class SynchroniserSleeveSystemDeflection(_2373.SynchroniserPartSystemDeflection):
    '''SynchroniserSleeveSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3375.SynchroniserSleevePowerFlow':
        ...
        return constructor.new(_3375.SynchroniserSleevePowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
