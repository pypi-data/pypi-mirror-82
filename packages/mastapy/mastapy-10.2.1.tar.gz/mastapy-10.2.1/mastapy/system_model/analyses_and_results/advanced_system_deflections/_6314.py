...
class ConceptGearAdvancedSystemDeflection(_6340.GearAdvancedSystemDeflection):
    '''ConceptGearAdvancedSystemDeflection
    ...
    @property
    def component_load_case(self) -> '_6127.ConceptGearLoadCase':
        ...
        return constructor.new(_6127.ConceptGearLoadCase)(self.wrapped.ComponentLoadCase) if self.wrapped.ComponentLoadCase else None
    ...
    @property
    def component_system_deflection_results(self) -> 'List[_2283.ConceptGearSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentSystemDeflectionResults, constructor.new(_2283.ConceptGearSystemDeflection))
        return value
