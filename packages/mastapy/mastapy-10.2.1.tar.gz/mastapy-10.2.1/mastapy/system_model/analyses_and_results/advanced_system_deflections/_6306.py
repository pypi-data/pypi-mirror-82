...
class ClutchAdvancedSystemDeflection(_6323.CouplingAdvancedSystemDeflection):
    '''ClutchAdvancedSystemDeflection
    ...
    @property
    def assembly_system_deflection_results(self) -> 'List[_2274.ClutchSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblySystemDeflectionResults, constructor.new(_2274.ClutchSystemDeflection))
        return value
