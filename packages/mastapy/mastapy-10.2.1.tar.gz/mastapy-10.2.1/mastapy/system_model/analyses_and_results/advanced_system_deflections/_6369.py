...
class PlanetCarrierAdvancedSystemDeflection(_6361.MountableComponentAdvancedSystemDeflection):
    '''PlanetCarrierAdvancedSystemDeflection
    ...
    @property
    def component_system_deflection_results(self) -> 'List[_2344.PlanetCarrierSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentSystemDeflectionResults, constructor.new(_2344.PlanetCarrierSystemDeflection))
        return value
