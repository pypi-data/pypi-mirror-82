...
from mastapy.system_model.analyses_and_results.advanced_system_deflections import _6358, _6380
...
class GearSetAdvancedSystemDeflection(_6380.SpecialisedAssemblyAdvancedSystemDeflection):
    '''GearSetAdvancedSystemDeflection
    ...
    @property
    def use_ltca_in_advanced_system_deflection(self) -> '_6358.UseLtcaInAsdOption':
        ...
        return constructor.new(_6358.UseLtcaInAsdOption)(value) if value else None

    @use_ltca_in_advanced_system_deflection.setter
    def use_ltca_in_advanced_system_deflection(self, value: '_6358.UseLtcaInAsdOption'):
