...
class PartToPartShearCouplingHalfAdvancedSystemDeflection(_6325.CouplingHalfAdvancedSystemDeflection):
    '''PartToPartShearCouplingHalfAdvancedSystemDeflection
    ...
    @property
    def component_system_deflection_results(self) -> 'List[_2341.PartToPartShearCouplingHalfSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentSystemDeflectionResults, constructor.new(_2341.PartToPartShearCouplingHalfSystemDeflection))
        return value
