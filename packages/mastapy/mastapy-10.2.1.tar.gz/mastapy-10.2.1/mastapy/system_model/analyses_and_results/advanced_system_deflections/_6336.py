...
class FaceGearAdvancedSystemDeflection(_6340.GearAdvancedSystemDeflection):
    '''FaceGearAdvancedSystemDeflection
    ...
    @property
    def component_load_case(self) -> '_6165.FaceGearLoadCase':
        ...
        return constructor.new(_6165.FaceGearLoadCase)(self.wrapped.ComponentLoadCase) if self.wrapped.ComponentLoadCase else None
    ...
    @property
    def component_system_deflection_results(self) -> 'List[_2311.FaceGearSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentSystemDeflectionResults, constructor.new(_2311.FaceGearSystemDeflection))
        return value
