...
class HypoidGearAdvancedSystemDeflection(_6289.AGMAGleasonConicalGearAdvancedSystemDeflection):
    '''HypoidGearAdvancedSystemDeflection
    ...
    @property
    def component_system_deflection_results(self) -> 'List[_2319.HypoidGearSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentSystemDeflectionResults, constructor.new(_2319.HypoidGearSystemDeflection))
        return value
