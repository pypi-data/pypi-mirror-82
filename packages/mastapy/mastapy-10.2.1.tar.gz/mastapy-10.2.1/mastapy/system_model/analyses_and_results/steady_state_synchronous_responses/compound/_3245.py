...
class SynchroniserSleeveCompoundSteadyStateSynchronousResponse(_3244.SynchroniserPartCompoundSteadyStateSynchronousResponse):
    '''SynchroniserSleeveCompoundSteadyStateSynchronousResponse
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_3123.SynchroniserSleeveSteadyStateSynchronousResponse]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_3123.SynchroniserSleeveSteadyStateSynchronousResponse))
        return value

    @property
    def component_steady_state_synchronous_response_load_cases(self) -> 'List[_3123.SynchroniserSleeveSteadyStateSynchronousResponse]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentSteadyStateSynchronousResponseLoadCases, constructor.new(_3123.SynchroniserSleeveSteadyStateSynchronousResponse))
        return value
