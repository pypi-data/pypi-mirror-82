...
from mastapy.system_model.analyses_and_results.dynamic_analyses import _5904, _5905, _5851
...
class HypoidGearSetDynamicAnalysis(_5851.AGMAGleasonConicalGearSetDynamicAnalysis):
    '''HypoidGearSetDynamicAnalysis
    ...
    @property
    def hypoid_gears_dynamic_analysis(self) -> 'List[_5904.HypoidGearDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.HypoidGearsDynamicAnalysis, constructor.new(_5904.HypoidGearDynamicAnalysis))
        return value

    @property
    def hypoid_meshes_dynamic_analysis(self) -> 'List[_5905.HypoidGearMeshDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.HypoidMeshesDynamicAnalysis, constructor.new(_5905.HypoidGearMeshDynamicAnalysis))
        return value
