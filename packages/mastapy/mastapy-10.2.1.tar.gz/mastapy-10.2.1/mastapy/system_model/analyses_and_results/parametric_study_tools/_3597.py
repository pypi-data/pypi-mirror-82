...
from mastapy.system_model.analyses_and_results.static_loads import _6104, _6206
from mastapy.system_model import _1841
from mastapy.system_model.analyses_and_results.parametric_study_tools import _3598, _3599
...
class ParametricStudyToolOptions(_0.APIBase):
    ...
    @property
    def parametric_study_type(self) -> '_6206.ParametricStudyType':
        ...
        return constructor.new(_6206.ParametricStudyType)(value) if value else None

    @parametric_study_type.setter
    def parametric_study_type(self, value: '_6206.ParametricStudyType'):
    ...
    @property
    def step_results(self) -> 'List[_3598.ParametricStudyToolStepResult]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StepResults, constructor.new(_3598.ParametricStudyToolStepResult))
        return value

    @property
    def study_variables(self) -> 'List[_3599.ParametricStudyVariable]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StudyVariables, constructor.new(_3599.ParametricStudyVariable))
        return value
