...
from mastapy.bearings.bearing_results import _1605, _1613, _1616
from mastapy._internal import constructor, conversion
from mastapy._internal.cast_exception import CastException
from mastapy.bearings.bearing_results.rolling import (
    _1642, _1649, _1657, _1673,
    _1697
)
...
class BearingCompoundParametricStudyTool(_3682.ConnectorCompoundParametricStudyTool):
    '''BearingCompoundParametricStudyTool
    ...
    @property
    def bearing_duty_cycle_results(self) -> '_1605.LoadedBearingDutyCycle':
        ...
        if _1605.LoadedBearingDutyCycle.TYPE not in self.wrapped.BearingDutyCycleResults.__class__.__mro__:
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_3516.BearingParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_3516.BearingParametricStudyTool))
        return value

    @property
    def component_parametric_study_tool_load_cases(self) -> 'List[_3516.BearingParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentParametricStudyToolLoadCases, constructor.new(_3516.BearingParametricStudyTool))
        return value
