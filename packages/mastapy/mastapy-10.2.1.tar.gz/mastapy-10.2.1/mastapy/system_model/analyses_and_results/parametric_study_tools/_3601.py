...
class PartToPartShearCouplingConnectionParametricStudyTool(_3545.CouplingConnectionParametricStudyTool):
    '''PartToPartShearCouplingConnectionParametricStudyTool
    ...
    @property
    def connection_system_deflection_results(self) -> 'List[_2340.PartToPartShearCouplingConnectionSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionSystemDeflectionResults, constructor.new(_2340.PartToPartShearCouplingConnectionSystemDeflection))
        return value
