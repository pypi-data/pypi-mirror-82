...
class GuideDxfModelParametricStudyTool(_3533.ComponentParametricStudyTool):
    '''GuideDxfModelParametricStudyTool
    ...
    @property
    def component_system_deflection_results(self) -> 'List[_2316.GuideDxfModelSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentSystemDeflectionResults, constructor.new(_2316.GuideDxfModelSystemDeflection))
        return value
