...
class SpringDamperParametricStudyTool(_3547.CouplingParametricStudyTool):
    '''SpringDamperParametricStudyTool
    ...
    @property
    def assembly_system_deflection_results(self) -> 'List[_2363.SpringDamperSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblySystemDeflectionResults, constructor.new(_2363.SpringDamperSystemDeflection))
        return value
