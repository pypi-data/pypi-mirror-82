...
class BeltDriveParametricStudyTool(_3617.SpecialisedAssemblyParametricStudyTool):
    '''BeltDriveParametricStudyTool
    ...
    @property
    def assembly_system_deflection_results(self) -> 'List[_2261.BeltDriveSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblySystemDeflectionResults, constructor.new(_2261.BeltDriveSystemDeflection))
        return value
