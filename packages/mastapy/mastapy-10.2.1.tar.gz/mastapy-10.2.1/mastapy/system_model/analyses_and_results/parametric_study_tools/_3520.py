...
class BevelDifferentialGearParametricStudyTool(_3525.BevelGearParametricStudyTool):
    '''BevelDifferentialGearParametricStudyTool
    ...
    @property
    def component_system_deflection_results(self) -> 'List[_2264.BevelDifferentialGearSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentSystemDeflectionResults, constructor.new(_2264.BevelDifferentialGearSystemDeflection))
        return value
