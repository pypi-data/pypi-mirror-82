...
from mastapy.system_model.analyses_and_results.parametric_study_tools import _3581, _3580, _3579
...
class KlingelnbergCycloPalloidHypoidGearSetParametricStudyTool(_3579.KlingelnbergCycloPalloidConicalGearSetParametricStudyTool):
    '''KlingelnbergCycloPalloidHypoidGearSetParametricStudyTool
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_gears_parametric_study_tool(self) -> 'List[_3581.KlingelnbergCycloPalloidHypoidGearParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.KlingelnbergCycloPalloidHypoidGearsParametricStudyTool, constructor.new(_3581.KlingelnbergCycloPalloidHypoidGearParametricStudyTool))
        return value

    @property
    def klingelnberg_cyclo_palloid_hypoid_meshes_parametric_study_tool(self) -> 'List[_3580.KlingelnbergCycloPalloidHypoidGearMeshParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.KlingelnbergCycloPalloidHypoidMeshesParametricStudyTool, constructor.new(_3580.KlingelnbergCycloPalloidHypoidGearMeshParametricStudyTool))
        return value
