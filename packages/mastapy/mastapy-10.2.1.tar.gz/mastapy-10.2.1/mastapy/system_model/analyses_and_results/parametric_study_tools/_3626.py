...
from mastapy.system_model.analyses_and_results.parametric_study_tools import _3625, _3624, _3526
...
class StraightBevelDiffGearSetParametricStudyTool(_3526.BevelGearSetParametricStudyTool):
    '''StraightBevelDiffGearSetParametricStudyTool
    ...
    @property
    def straight_bevel_diff_gears_parametric_study_tool(self) -> 'List[_3625.StraightBevelDiffGearParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StraightBevelDiffGearsParametricStudyTool, constructor.new(_3625.StraightBevelDiffGearParametricStudyTool))
        return value

    @property
    def straight_bevel_diff_meshes_parametric_study_tool(self) -> 'List[_3624.StraightBevelDiffGearMeshParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StraightBevelDiffMeshesParametricStudyTool, constructor.new(_3624.StraightBevelDiffGearMeshParametricStudyTool))
        return value
