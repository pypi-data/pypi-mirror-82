...
from mastapy.nodal_analysis.system_solvers import (
    _1441, _1423, _1424, _1427,
    _1428, _1429, _1430, _1431,
    _1432, _1433, _1434, _1439,
    _1442
)
from mastapy._internal.cast_exception import CastException
from mastapy.system_model.analyses_and_results.analysis_cases import _6550
...
class MultiBodyDynamicsAnalysis(_6550.TimeSeriesLoadAnalysisCase):
    '''MultiBodyDynamicsAnalysis
    ...
    @property
    def mbd_options(self) -> '_5093.MBDAnalysisOptions':
        ...
        return constructor.new(_5093.MBDAnalysisOptions)(self.wrapped.MBDOptions) if self.wrapped.MBDOptions else None

    @property
    def transient_solver(self) -> '_1441.TransientSolver':
        ...
        if _1441.TransientSolver.TYPE not in self.wrapped.TransientSolver.__class__.__mro__:
    ...
    @property
    def transient_solver_of_type_backward_euler_acceleration_step_halving_transient_solver(self) -> '_1423.BackwardEulerAccelerationStepHalvingTransientSolver':
        ...
        if _1423.BackwardEulerAccelerationStepHalvingTransientSolver.TYPE not in self.wrapped.TransientSolver.__class__.__mro__:
    ...
    @property
    def transient_solver_of_type_backward_euler_transient_solver(self) -> '_1424.BackwardEulerTransientSolver':
        ...
        if _1424.BackwardEulerTransientSolver.TYPE not in self.wrapped.TransientSolver.__class__.__mro__:
    ...
    @property
    def transient_solver_of_type_internal_transient_solver(self) -> '_1427.InternalTransientSolver':
        ...
        if _1427.InternalTransientSolver.TYPE not in self.wrapped.TransientSolver.__class__.__mro__:
    ...
    @property
    def transient_solver_of_type_lobatto_iiia_transient_solver(self) -> '_1428.LobattoIIIATransientSolver':
        ...
        if _1428.LobattoIIIATransientSolver.TYPE not in self.wrapped.TransientSolver.__class__.__mro__:
    ...
    @property
    def transient_solver_of_type_lobatto_iiic_transient_solver(self) -> '_1429.LobattoIIICTransientSolver':
        ...
        if _1429.LobattoIIICTransientSolver.TYPE not in self.wrapped.TransientSolver.__class__.__mro__:
    ...
    @property
    def transient_solver_of_type_newmark_acceleration_transient_solver(self) -> '_1430.NewmarkAccelerationTransientSolver':
        ...
        if _1430.NewmarkAccelerationTransientSolver.TYPE not in self.wrapped.TransientSolver.__class__.__mro__:
    ...
    @property
    def transient_solver_of_type_newmark_transient_solver(self) -> '_1431.NewmarkTransientSolver':
        ...
        if _1431.NewmarkTransientSolver.TYPE not in self.wrapped.TransientSolver.__class__.__mro__:
    ...
    @property
    def transient_solver_of_type_semi_implicit_transient_solver(self) -> '_1432.SemiImplicitTransientSolver':
        ...
        if _1432.SemiImplicitTransientSolver.TYPE not in self.wrapped.TransientSolver.__class__.__mro__:
    ...
    @property
    def transient_solver_of_type_simple_acceleration_based_step_halving_transient_solver(self) -> '_1433.SimpleAccelerationBasedStepHalvingTransientSolver':
        ...
        if _1433.SimpleAccelerationBasedStepHalvingTransientSolver.TYPE not in self.wrapped.TransientSolver.__class__.__mro__:
    ...
    @property
    def transient_solver_of_type_simple_velocity_based_step_halving_transient_solver(self) -> '_1434.SimpleVelocityBasedStepHalvingTransientSolver':
        ...
        if _1434.SimpleVelocityBasedStepHalvingTransientSolver.TYPE not in self.wrapped.TransientSolver.__class__.__mro__:
    ...
    @property
    def transient_solver_of_type_step_halving_transient_solver(self) -> '_1439.StepHalvingTransientSolver':
        ...
        if _1439.StepHalvingTransientSolver.TYPE not in self.wrapped.TransientSolver.__class__.__mro__:
    ...
    @property
    def transient_solver_of_type_wilson_theta_transient_solver(self) -> '_1442.WilsonThetaTransientSolver':
        ...
        if _1442.WilsonThetaTransientSolver.TYPE not in self.wrapped.TransientSolver.__class__.__mro__:
