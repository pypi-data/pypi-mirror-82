...
class StraightBevelGearCompoundMultiBodyDynamicsAnalysis(_5173.BevelGearCompoundMultiBodyDynamicsAnalysis):
    '''StraightBevelGearCompoundMultiBodyDynamicsAnalysis
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_5130.StraightBevelGearMultiBodyDynamicsAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_5130.StraightBevelGearMultiBodyDynamicsAnalysis))
        return value

    @property
    def component_multi_body_dynamics_analysis_load_cases(self) -> 'List[_5130.StraightBevelGearMultiBodyDynamicsAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentMultiBodyDynamicsAnalysisLoadCases, constructor.new(_5130.StraightBevelGearMultiBodyDynamicsAnalysis))
        return value
