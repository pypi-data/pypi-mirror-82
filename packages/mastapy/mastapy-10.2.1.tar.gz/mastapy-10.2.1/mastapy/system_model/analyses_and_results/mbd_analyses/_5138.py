...
from mastapy.system_model.analyses_and_results.mbd_analyses import _5142, _5052
...
class TorqueConverterConnectionMultiBodyDynamicsAnalysis(_5052.CouplingConnectionMultiBodyDynamicsAnalysis):
    '''TorqueConverterConnectionMultiBodyDynamicsAnalysis
    ...
    @property
    def locking_status(self) -> '_5142.TorqueConverterStatus':
        ...
        return constructor.new(_5142.TorqueConverterStatus)(value) if value else None
