...
class CriticalSpeedAnalysis(_6549.StaticLoadAnalysisCase):
    '''CriticalSpeedAnalysis
    ...
    @property
    def modal_analyses_at_stiffnesses_options(self) -> '_3841.ModalAnalysesAtStiffnessesOptions':
        ...
        return constructor.new(_3841.ModalAnalysesAtStiffnessesOptions)(self.wrapped.ModalAnalysesAtStiffnessesOptions) if self.wrapped.ModalAnalysesAtStiffnessesOptions else None
