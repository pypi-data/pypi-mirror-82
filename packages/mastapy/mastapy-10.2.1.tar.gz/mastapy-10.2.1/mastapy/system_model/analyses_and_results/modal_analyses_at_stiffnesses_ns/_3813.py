...
from mastapy.system_model.analyses_and_results.modal_analyses_at_stiffnesses_ns import _3812, _3811, _3823
...
class CylindricalGearSetModalAnalysesAtStiffnesses(_3823.GearSetModalAnalysesAtStiffnesses):
    '''CylindricalGearSetModalAnalysesAtStiffnesses
    ...
    @property
    def cylindrical_gears_modal_analyses_at_stiffnesses(self) -> 'List[_3812.CylindricalGearModalAnalysesAtStiffnesses]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CylindricalGearsModalAnalysesAtStiffnesses, constructor.new(_3812.CylindricalGearModalAnalysesAtStiffnesses))
        return value

    @property
    def cylindrical_meshes_modal_analyses_at_stiffnesses(self) -> 'List[_3811.CylindricalGearMeshModalAnalysesAtStiffnesses]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CylindricalMeshesModalAnalysesAtStiffnesses, constructor.new(_3811.CylindricalGearMeshModalAnalysesAtStiffnesses))
        return value
