...
from mastapy.system_model.analyses_and_results.modal_analyses_at_stiffnesses_ns import _3807, _3774
...
class RootAssemblyModalAnalysesAtStiffnesses(_3774.AssemblyModalAnalysesAtStiffnesses):
    '''RootAssemblyModalAnalysesAtStiffnesses
    ...
    @property
    def modal_analyses_at_stiffnesses_inputs(self) -> '_3807.CriticalSpeedAnalysis':
        ...
        return constructor.new(_3807.CriticalSpeedAnalysis)(self.wrapped.ModalAnalysesAtStiffnessesInputs) if self.wrapped.ModalAnalysesAtStiffnessesInputs else None
