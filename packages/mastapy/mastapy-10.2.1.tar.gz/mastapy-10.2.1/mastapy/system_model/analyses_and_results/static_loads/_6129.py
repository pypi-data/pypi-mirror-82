...
from mastapy.system_model.analyses_and_results.static_loads import _6127, _6128, _6175
...
class ConceptGearSetLoadCase(_6175.GearSetLoadCase):
    '''ConceptGearSetLoadCase
    ...
    @property
    def concept_gears_load_case(self) -> 'List[_6127.ConceptGearLoadCase]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConceptGearsLoadCase, constructor.new(_6127.ConceptGearLoadCase))
        return value

    @property
    def concept_meshes_load_case(self) -> 'List[_6128.ConceptGearMeshLoadCase]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConceptMeshesLoadCase, constructor.new(_6128.ConceptGearMeshLoadCase))
        return value
