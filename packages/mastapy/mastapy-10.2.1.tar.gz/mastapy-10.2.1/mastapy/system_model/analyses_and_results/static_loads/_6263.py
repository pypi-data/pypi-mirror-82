...
from mastapy.system_model.analyses_and_results.static_loads import _6261, _6262, _6175
...
class WormGearSetLoadCase(_6175.GearSetLoadCase):
    '''WormGearSetLoadCase
    ...
    @property
    def worm_gears_load_case(self) -> 'List[_6261.WormGearLoadCase]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.WormGearsLoadCase, constructor.new(_6261.WormGearLoadCase))
        return value

    @property
    def worm_meshes_load_case(self) -> 'List[_6262.WormGearMeshLoadCase]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.WormMeshesLoadCase, constructor.new(_6262.WormGearMeshLoadCase))
        return value
