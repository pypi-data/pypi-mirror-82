...
from mastapy.bearings.tolerances import _1577, _1582
...
class BearingLoadCase(_6136.ConnectorLoadCase):
    ...
    @property
    def include_fitting_effects(self) -> '_1156.LoadCaseOverrideOption':
        ...
        return constructor.new(_1156.LoadCaseOverrideOption)(value) if value else None

    @include_fitting_effects.setter
    def include_fitting_effects(self, value: '_1156.LoadCaseOverrideOption'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.IncludeFittingEffects = value

    @property
    def include_thermal_expansion_effects(self) -> '_1156.LoadCaseOverrideOption':
    ...
    def include_thermal_expansion_effects(self, value: '_1156.LoadCaseOverrideOption'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.IncludeThermalExpansionEffects = value

    @property
    def include_ring_ovality(self) -> '_1156.LoadCaseOverrideOption':
    ...
    def include_ring_ovality(self, value: '_1156.LoadCaseOverrideOption'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def left_ring_detail(self) -> '_1577.RaceDetail':
        ...
        return constructor.new(_1577.RaceDetail)(self.wrapped.LeftRingDetail) if self.wrapped.LeftRingDetail else None

    @property
    def right_ring_detail(self) -> '_1577.RaceDetail':
        ...
        return constructor.new(_1577.RaceDetail)(self.wrapped.RightRingDetail) if self.wrapped.RightRingDetail else None
    ...
    @property
    def inner_ring_detail(self) -> '_1577.RaceDetail':
        ...
        return constructor.new(_1577.RaceDetail)(self.wrapped.InnerRingDetail) if self.wrapped.InnerRingDetail else None
    ...
    @property
    def outer_ring_detail(self) -> '_1577.RaceDetail':
        ...
        return constructor.new(_1577.RaceDetail)(self.wrapped.OuterRingDetail) if self.wrapped.OuterRingDetail else None
