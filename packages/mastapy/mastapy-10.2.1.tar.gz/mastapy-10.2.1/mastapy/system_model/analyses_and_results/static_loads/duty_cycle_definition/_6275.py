...
from mastapy.utility.file_access_helpers import _1355
from mastapy.utility_gui import _1532
...
class MultiTimeSeriesDataInputFileOptions(_1532.DataInputFileOptions):
    '''MultiTimeSeriesDataInputFileOptions
    ...
    @property
    def delimiter_options(self) -> '_1355.TextFileDelimiterOptions':
        ...
        return constructor.new(_1355.TextFileDelimiterOptions)(self.wrapped.DelimiterOptions) if self.wrapped.DelimiterOptions else None
