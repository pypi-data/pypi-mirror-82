...
from mastapy.system_model.analyses_and_results.static_loads import _6255, _6184, _6229
...
class ElectricMachineHarmonicLoadData(_6229.SpeedDependentHarmonicLoadData):
    '''ElectricMachineHarmonicLoadData
    ...
    @property
    def force_distribution(self) -> '_6557.SMTBitmap':
        ...
        return constructor.new(_6557.SMTBitmap)(self.wrapped.ForceDistribution) if self.wrapped.ForceDistribution else None
