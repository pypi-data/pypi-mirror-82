...
from mastapy.system_model.part_model import _2057
from mastapy.nodal_analysis.varying_input_components import _1418, _1419
from mastapy.system_model.analyses_and_results.static_loads import _6216, _6260
...
class PointLoadLoadCase(_6260.VirtualComponentLoadCase):
    '''PointLoadLoadCase
    ...
    @property
    def component_design(self) -> '_2057.PointLoad':
        ...
        return constructor.new(_2057.PointLoad)(self.wrapped.ComponentDesign) if self.wrapped.ComponentDesign else None

    @property
    def force_x(self) -> '_1418.ForceInputComponent':
        ...
        return constructor.new(_1418.ForceInputComponent)(self.wrapped.ForceX) if self.wrapped.ForceX else None

    @property
    def force_y(self) -> '_1418.ForceInputComponent':
        ...
        return constructor.new(_1418.ForceInputComponent)(self.wrapped.ForceY) if self.wrapped.ForceY else None

    @property
    def axial_load(self) -> '_1418.ForceInputComponent':
        ...
        return constructor.new(_1418.ForceInputComponent)(self.wrapped.AxialLoad) if self.wrapped.AxialLoad else None

    @property
    def moment_x(self) -> '_1419.MomentInputComponent':
        ...
        return constructor.new(_1419.MomentInputComponent)(self.wrapped.MomentX) if self.wrapped.MomentX else None

    @property
    def moment_y(self) -> '_1419.MomentInputComponent':
        ...
        return constructor.new(_1419.MomentInputComponent)(self.wrapped.MomentY) if self.wrapped.MomentY else None

    @property
    def moment_z(self) -> '_1419.MomentInputComponent':
        ...
        return constructor.new(_1419.MomentInputComponent)(self.wrapped.MomentZ) if self.wrapped.MomentZ else None

    def get_harmonic_load_data_for_import(self) -> '_6216.PointLoadHarmonicLoadData':
