...
from mastapy.system_model.analyses_and_results.static_loads import _6144, _6170
...
class CylindricalGearLoadCase(_6170.GearLoadCase):
    '''CylindricalGearLoadCase
    ...
    @property
    def gear_manufacture_errors(self) -> '_6144.CylindricalGearManufactureError':
        ...
        return constructor.new(_6144.CylindricalGearManufactureError)(self.wrapped.GearManufactureErrors) if self.wrapped.GearManufactureErrors else None
