...
from mastapy.system_model.analyses_and_results.static_loads import _6240, _6241, _6116
...
class StraightBevelGearSetLoadCase(_6116.BevelGearSetLoadCase):
    '''StraightBevelGearSetLoadCase
    ...
    @property
    def straight_bevel_gears_load_case(self) -> 'List[_6240.StraightBevelGearLoadCase]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StraightBevelGearsLoadCase, constructor.new(_6240.StraightBevelGearLoadCase))
        return value

    @property
    def straight_bevel_meshes_load_case(self) -> 'List[_6241.StraightBevelGearMeshLoadCase]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StraightBevelMeshesLoadCase, constructor.new(_6241.StraightBevelGearMeshLoadCase))
        return value
