...
from mastapy.system_model.analyses_and_results.static_loads import _6204, _6180, _6160
...
class HarmonicLoadDataExcelImport(_6180.HarmonicLoadDataImportBase['_6160.ElectricMachineHarmonicLoadExcelImportOptions']):
    '''HarmonicLoadDataExcelImport
    ...
    @property
    def speeds(self) -> 'List[_6204.NamedSpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Speeds, constructor.new(_6204.NamedSpeed))
        return value
