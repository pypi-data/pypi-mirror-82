...
class PlanetaryGearSetLoadCase(_6147.CylindricalGearSetLoadCase):
    '''PlanetaryGearSetLoadCase
    ...
    @property
    def include_gear_blank_elastic_distortion(self) -> '_1156.LoadCaseOverrideOption':
    ...
    def include_gear_blank_elastic_distortion(self, value: '_1156.LoadCaseOverrideOption'):
    ...
    @property
    def assembly_design(self) -> '_2126.PlanetaryGearSet':
        ...
        return constructor.new(_2126.PlanetaryGearSet)(self.wrapped.AssemblyDesign) if self.wrapped.AssemblyDesign else None
