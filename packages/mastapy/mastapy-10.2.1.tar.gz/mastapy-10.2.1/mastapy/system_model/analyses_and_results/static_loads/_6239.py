...
from mastapy.system_model.analyses_and_results.static_loads import _6237, _6238, _6116
...
class StraightBevelDiffGearSetLoadCase(_6116.BevelGearSetLoadCase):
    '''StraightBevelDiffGearSetLoadCase
    ...
    @property
    def straight_bevel_diff_gears_load_case(self) -> 'List[_6237.StraightBevelDiffGearLoadCase]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StraightBevelDiffGearsLoadCase, constructor.new(_6237.StraightBevelDiffGearLoadCase))
        return value

    @property
    def straight_bevel_diff_meshes_load_case(self) -> 'List[_6238.StraightBevelDiffGearMeshLoadCase]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StraightBevelDiffMeshesLoadCase, constructor.new(_6238.StraightBevelDiffGearMeshLoadCase))
        return value
