...
class RollingRingGearWhineAnalysis(_5339.CouplingHalfGearWhineAnalysis):
    ...
    @property
    def system_deflection_results(self) -> '_2350.RollingRingSystemDeflection':
        ...
        return constructor.new(_2350.RollingRingSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
