...
from mastapy.system_model.connections_and_sockets import _1879
...
class CVTBeltConnectionGearWhineAnalysis(_5308.BeltConnectionGearWhineAnalysis):
    '''CVTBeltConnectionGearWhineAnalysis
    ...
    @property
    def connection_design(self) -> '_1879.CVTBeltConnection':
        ...
        return constructor.new(_1879.CVTBeltConnection)(self.wrapped.ConnectionDesign) if self.wrapped.ConnectionDesign else None

    @property
    def system_deflection_results(self) -> '_2293.CVTBeltConnectionSystemDeflection':
        ...
        return constructor.new(_2293.CVTBeltConnectionSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
