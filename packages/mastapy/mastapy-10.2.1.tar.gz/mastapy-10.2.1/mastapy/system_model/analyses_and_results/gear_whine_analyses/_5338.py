...
class CouplingGearWhineAnalysis(_5415.SpecialisedAssemblyGearWhineAnalysis):
    '''CouplingGearWhineAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2292.CouplingSystemDeflection':
