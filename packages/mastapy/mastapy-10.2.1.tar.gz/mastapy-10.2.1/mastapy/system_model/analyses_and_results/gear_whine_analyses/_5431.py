...
class SynchroniserGearWhineAnalysis(_5415.SpecialisedAssemblyGearWhineAnalysis):
    '''SynchroniserGearWhineAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2375.SynchroniserSystemDeflection':
        ...
        return constructor.new(_2375.SynchroniserSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
