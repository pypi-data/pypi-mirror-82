...
class PlanetaryConnectionGearWhineAnalysis(_5413.ShaftToMountableComponentConnectionGearWhineAnalysis):
    '''PlanetaryConnectionGearWhineAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2343.PlanetaryConnectionSystemDeflection':
        ...
        return constructor.new(_2343.PlanetaryConnectionSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
