...
from mastapy.system_model.analyses_and_results.gear_whine_analyses.single_mesh_whine_analyses import _5503, _5501, _5512
...
class CylindricalGearSetSingleMeshWhineAnalysis(_5512.GearSetSingleMeshWhineAnalysis):
    '''CylindricalGearSetSingleMeshWhineAnalysis
    ...
    @property
    def cylindrical_gears_single_mesh_whine_analysis(self) -> 'List[_5503.CylindricalGearSingleMeshWhineAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CylindricalGearsSingleMeshWhineAnalysis, constructor.new(_5503.CylindricalGearSingleMeshWhineAnalysis))
        return value

    @property
    def cylindrical_meshes_single_mesh_whine_analysis(self) -> 'List[_5501.CylindricalGearMeshSingleMeshWhineAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CylindricalMeshesSingleMeshWhineAnalysis, constructor.new(_5501.CylindricalGearMeshSingleMeshWhineAnalysis))
        return value
