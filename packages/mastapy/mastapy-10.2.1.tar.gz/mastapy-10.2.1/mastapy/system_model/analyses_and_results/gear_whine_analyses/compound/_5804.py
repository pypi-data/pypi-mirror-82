...
class ShaftCompoundGearWhineAnalysis(_5718.AbstractShaftOrHousingCompoundGearWhineAnalysis):
    '''ShaftCompoundGearWhineAnalysis
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_5411.ShaftGearWhineAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_5411.ShaftGearWhineAnalysis))
        return value

    @property
    def component_gear_whine_analysis_load_cases(self) -> 'List[_5411.ShaftGearWhineAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentGearWhineAnalysisLoadCases, constructor.new(_5411.ShaftGearWhineAnalysis))
        return value
