...
class KlingelnbergCycloPalloidHypoidGearMeshCompoundSingleMeshWhineAnalysis(_5644.KlingelnbergCycloPalloidConicalGearMeshCompoundSingleMeshWhineAnalysis):
    '''KlingelnbergCycloPalloidHypoidGearMeshCompoundSingleMeshWhineAnalysis
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_5523.KlingelnbergCycloPalloidHypoidGearMeshSingleMeshWhineAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_5523.KlingelnbergCycloPalloidHypoidGearMeshSingleMeshWhineAnalysis))
        return value

    @property
    def connection_single_mesh_whine_analysis_load_cases(self) -> 'List[_5523.KlingelnbergCycloPalloidHypoidGearMeshSingleMeshWhineAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionSingleMeshWhineAnalysisLoadCases, constructor.new(_5523.KlingelnbergCycloPalloidHypoidGearMeshSingleMeshWhineAnalysis))
        return value
