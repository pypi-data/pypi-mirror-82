...
class HypoidGearGearWhineAnalysis(_5303.AGMAGleasonConicalGearGearWhineAnalysis):
    '''HypoidGearGearWhineAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2319.HypoidGearSystemDeflection':
        ...
        return constructor.new(_2319.HypoidGearSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
