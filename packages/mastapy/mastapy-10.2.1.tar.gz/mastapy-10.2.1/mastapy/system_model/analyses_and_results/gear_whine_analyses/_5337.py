...
class CouplingConnectionGearWhineAnalysis(_5382.InterMountableComponentConnectionGearWhineAnalysis):
    '''CouplingConnectionGearWhineAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2290.CouplingConnectionSystemDeflection':
