...
class CVTPulleyGearWhineAnalysis(_5406.PulleyGearWhineAnalysis):
    '''CVTPulleyGearWhineAnalysis
    ...
    @property
    def component_design(self) -> '_2166.CVTPulley':
        ...
        return constructor.new(_2166.CVTPulley)(self.wrapped.ComponentDesign) if self.wrapped.ComponentDesign else None

    @property
    def system_deflection_results(self) -> '_2294.CVTPulleySystemDeflection':
        ...
        return constructor.new(_2294.CVTPulleySystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
