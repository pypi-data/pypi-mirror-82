...
class BearingGearWhineAnalysis(_5336.ConnectorGearWhineAnalysis):
    ...
    @property
    def rolling_bearing_speed_results(self) -> '_1720.RollingBearingSpeedResults':
        ...
        return constructor.new(_1720.RollingBearingSpeedResults)(self.wrapped.RollingBearingSpeedResults) if self.wrapped.RollingBearingSpeedResults else None
    ...
    @property
    def system_deflection_results(self) -> '_2259.BearingSystemDeflection':
        ...
        return constructor.new(_2259.BearingSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
