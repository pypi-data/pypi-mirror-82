...
class ConicalGearSetModalAnalysis(_4802.GearSetModalAnalysis):
    '''ConicalGearSetModalAnalysis
    ...
    @property
    def assembly_design(self) -> '_2108.ConicalGearSet':
    ...
    @property
    def system_deflection_results(self) -> '_2286.ConicalGearSetSystemDeflection':
