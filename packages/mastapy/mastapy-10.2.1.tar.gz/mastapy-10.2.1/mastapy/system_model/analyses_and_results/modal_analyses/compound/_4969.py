...
class PartToPartShearCouplingHalfCompoundModalAnalysis(_4930.CouplingHalfCompoundModalAnalysis):
    '''PartToPartShearCouplingHalfCompoundModalAnalysis
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_4829.PartToPartShearCouplingHalfModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_4829.PartToPartShearCouplingHalfModalAnalysis))
        return value

    @property
    def component_modal_analysis_load_cases(self) -> 'List[_4829.PartToPartShearCouplingHalfModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentModalAnalysisLoadCases, constructor.new(_4829.PartToPartShearCouplingHalfModalAnalysis))
        return value
