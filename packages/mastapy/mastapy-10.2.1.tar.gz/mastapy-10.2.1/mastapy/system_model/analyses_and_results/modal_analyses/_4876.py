...
class WormGearModalAnalysis(_4801.GearModalAnalysis):
    '''WormGearModalAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2389.WormGearSystemDeflection':
        ...
        return constructor.new(_2389.WormGearSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
