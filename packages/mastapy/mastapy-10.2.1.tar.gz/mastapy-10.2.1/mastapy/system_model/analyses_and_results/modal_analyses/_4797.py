...
from mastapy.system_model.analyses_and_results.modal_analyses import _4796, _4795, _4802
...
class FaceGearSetModalAnalysis(_4802.GearSetModalAnalysis):
    '''FaceGearSetModalAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2310.FaceGearSetSystemDeflection':
        ...
        return constructor.new(_2310.FaceGearSetSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None

    @property
    def face_gears_modal_analysis(self) -> 'List[_4796.FaceGearModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.FaceGearsModalAnalysis, constructor.new(_4796.FaceGearModalAnalysis))
        return value

    @property
    def face_meshes_modal_analysis(self) -> 'List[_4795.FaceGearMeshModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.FaceMeshesModalAnalysis, constructor.new(_4795.FaceGearMeshModalAnalysis))
        return value
