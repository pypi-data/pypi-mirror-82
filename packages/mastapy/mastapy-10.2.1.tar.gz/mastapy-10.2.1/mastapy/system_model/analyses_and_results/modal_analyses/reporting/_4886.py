...
class PerModeResultsReport(_1299.CustomReportChart):
    '''PerModeResultsReport
    ...
    @property
    def display_option(self) -> '_1356.TableAndChartOptions':
    ...
    def display_option(self, value: '_1356.TableAndChartOptions'):
