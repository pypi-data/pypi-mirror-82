...
from mastapy.math_utility import (
    _1082, _1106, _1070, _1094,
    _1081, _1066, _1080, _1100
)
from mastapy._internal.overridable_constructor import _unpack_overridable
from mastapy._internal import enum_with_selected_value_runtime, conversion, constructor
from mastapy.system_model.analyses_and_results.modal_analyses import (
    _4782, _4871, _4870, _4826,
    _4872
)
from mastapy.system_model.analyses_and_results.gear_whine_analyses.whine_analyses_results import (
    _5449, _5452, _5458, _5459
)
from mastapy.system_model.analyses_and_results.gear_whine_analyses import _5365, _5416
from mastapy.utility.units_and_measurements.measurements import (
    _1226, _1179, _1278, _1185,
    _1176, _1181, _1200, _1273,
    _1194, _1244, _1245, _1248
)
from mastapy.utility.property import _1373
...
class WhineWaterfallSettings(_0.APIBase):
    ...
    @property
    def translation_or_rotation(self) -> '_1106.TranslationRotation':
        ...
        return constructor.new(_1106.TranslationRotation)(value) if value else None

    @translation_or_rotation.setter
    def translation_or_rotation(self, value: '_1106.TranslationRotation'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.TranslationOrRotation = value

    @property
    def coordinate_system(self) -> '_4782.CoordinateSystemForWhine':
        ...
        return constructor.new(_4782.CoordinateSystemForWhine)(value) if value else None

    @coordinate_system.setter
    def coordinate_system(self, value: '_4782.CoordinateSystemForWhine'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.CoordinateSystem = value

    @property
    def complex_component(self) -> '_1070.ComplexPartDisplayOption':
        ...
        return constructor.new(_1070.ComplexPartDisplayOption)(value) if value else None

    @complex_component.setter
    def complex_component(self, value: '_1070.ComplexPartDisplayOption'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.ComplexComponent = value

    @property
    def magnitude_method_for_complex_vectors(self) -> '_1094.ComplexMagnitudeMethod':
        ...
        return constructor.new(_1094.ComplexMagnitudeMethod)(value) if value else None

    @magnitude_method_for_complex_vectors.setter
    def magnitude_method_for_complex_vectors(self, value: '_1094.ComplexMagnitudeMethod'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def weighting(self) -> '_1066.AcousticWeighting':
        '''AcousticWeighting: 'Weighting' is the original name of this property.'''

        value = conversion.pn_to_mp_enum(self.wrapped.Weighting)
        return constructor.new(_1066.AcousticWeighting)(value) if value else None

    @weighting.setter
    def weighting(self, value: '_1066.AcousticWeighting'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def chart_type(self) -> '_1080.DynamicsResponse3DChartType':
        ...
        return constructor.new(_1080.DynamicsResponse3DChartType)(value) if value else None

    @chart_type.setter
    def chart_type(self, value: '_1080.DynamicsResponse3DChartType'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def connected_component_type(self) -> '_5449.ConnectedComponentType':
        ...
        return constructor.new(_5449.ConnectedComponentType)(value) if value else None

    @connected_component_type.setter
    def connected_component_type(self, value: '_5449.ConnectedComponentType'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.ConnectedComponentType = value

    @property
    def whine_waterfall_export_option(self) -> '_4871.WhineWaterfallExportOption':
        ...
        return constructor.new(_4871.WhineWaterfallExportOption)(value) if value else None

    @whine_waterfall_export_option.setter
    def whine_waterfall_export_option(self, value: '_4871.WhineWaterfallExportOption'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def selected_excitations(self) -> '_5452.ExcitationSourceSelectionGroup':
        ...
        return constructor.new(_5452.ExcitationSourceSelectionGroup)(self.wrapped.SelectedExcitations) if self.wrapped.SelectedExcitations else None

    @property
    def waterfall_chart_settings(self) -> '_4870.WaterfallChartSettings':
        ...
        return constructor.new(_4870.WaterfallChartSettings)(self.wrapped.WaterfallChartSettings) if self.wrapped.WaterfallChartSettings else None

    @property
    def order_cuts_chart_settings(self) -> '_4826.OrderCutsChartSettings':
        ...
        return constructor.new(_4826.OrderCutsChartSettings)(self.wrapped.OrderCutsChartSettings) if self.wrapped.OrderCutsChartSettings else None

    @property
    def frequency_options(self) -> '_5365.FrequencyOptionsForGearWhineAnalysisResults':
        ...
        return constructor.new(_5365.FrequencyOptionsForGearWhineAnalysisResults)(self.wrapped.FrequencyOptions) if self.wrapped.FrequencyOptions else None

    @property
    def reference_speed_options(self) -> '_5416.SpeedOptionsForGearWhineAnalysisResults':
        ...
        return constructor.new(_5416.SpeedOptionsForGearWhineAnalysisResults)(self.wrapped.ReferenceSpeedOptions) if self.wrapped.ReferenceSpeedOptions else None

    @property
    def very_short_length_reference_values(self) -> '_4872.WhineWaterfallReferenceValues[_1226.LengthVeryShort]':
        ...
        return constructor.new(_4872.WhineWaterfallReferenceValues)[_1226.LengthVeryShort](self.wrapped.VeryShortLengthReferenceValues) if self.wrapped.VeryShortLengthReferenceValues else None

    @property
    def small_angle_reference_values(self) -> '_4872.WhineWaterfallReferenceValues[_1179.AngleSmall]':
        ...
        return constructor.new(_4872.WhineWaterfallReferenceValues)[_1179.AngleSmall](self.wrapped.SmallAngleReferenceValues) if self.wrapped.SmallAngleReferenceValues else None

    @property
    def small_velocity_reference_values(self) -> '_4872.WhineWaterfallReferenceValues[_1278.VelocitySmall]':
        ...
        return constructor.new(_4872.WhineWaterfallReferenceValues)[_1278.VelocitySmall](self.wrapped.SmallVelocityReferenceValues) if self.wrapped.SmallVelocityReferenceValues else None

    @property
    def angular_velocity_reference_values(self) -> '_4872.WhineWaterfallReferenceValues[_1185.AngularVelocity]':
        ...
        return constructor.new(_4872.WhineWaterfallReferenceValues)[_1185.AngularVelocity](self.wrapped.AngularVelocityReferenceValues) if self.wrapped.AngularVelocityReferenceValues else None

    @property
    def acceleration_reference_values(self) -> '_4872.WhineWaterfallReferenceValues[_1176.Acceleration]':
        ...
        return constructor.new(_4872.WhineWaterfallReferenceValues)[_1176.Acceleration](self.wrapped.AccelerationReferenceValues) if self.wrapped.AccelerationReferenceValues else None

    @property
    def angular_acceleration_reference_values(self) -> '_4872.WhineWaterfallReferenceValues[_1181.AngularAcceleration]':
        ...
        return constructor.new(_4872.WhineWaterfallReferenceValues)[_1181.AngularAcceleration](self.wrapped.AngularAccelerationReferenceValues) if self.wrapped.AngularAccelerationReferenceValues else None

    @property
    def force_reference_values(self) -> '_4872.WhineWaterfallReferenceValues[_1200.Force]':
        ...
        return constructor.new(_4872.WhineWaterfallReferenceValues)[_1200.Force](self.wrapped.ForceReferenceValues) if self.wrapped.ForceReferenceValues else None

    @property
    def torque_reference_values(self) -> '_4872.WhineWaterfallReferenceValues[_1273.Torque]':
        ...
        return constructor.new(_4872.WhineWaterfallReferenceValues)[_1273.Torque](self.wrapped.TorqueReferenceValues) if self.wrapped.TorqueReferenceValues else None

    @property
    def energy_reference_values(self) -> '_4872.WhineWaterfallReferenceValues[_1194.Energy]':
        ...
        return constructor.new(_4872.WhineWaterfallReferenceValues)[_1194.Energy](self.wrapped.EnergyReferenceValues) if self.wrapped.EnergyReferenceValues else None

    @property
    def power_small_reference_values(self) -> '_4872.WhineWaterfallReferenceValues[_1244.PowerSmall]':
        ...
        return constructor.new(_4872.WhineWaterfallReferenceValues)[_1244.PowerSmall](self.wrapped.PowerSmallReferenceValues) if self.wrapped.PowerSmallReferenceValues else None

    @property
    def power_small_per_unit_area_reference_values(self) -> '_4872.WhineWaterfallReferenceValues[_1245.PowerSmallPerArea]':
        ...
        return constructor.new(_4872.WhineWaterfallReferenceValues)[_1245.PowerSmallPerArea](self.wrapped.PowerSmallPerUnitAreaReferenceValues) if self.wrapped.PowerSmallPerUnitAreaReferenceValues else None

    @property
    def pressure_reference_values(self) -> '_4872.WhineWaterfallReferenceValues[_1248.Pressure]':
        ...
        return constructor.new(_4872.WhineWaterfallReferenceValues)[_1248.Pressure](self.wrapped.PressureReferenceValues) if self.wrapped.PressureReferenceValues else None

    @property
    def result_location_selection_groups(self) -> '_5458.ResultLocationSelectionGroups':
        ...
        return constructor.new(_5458.ResultLocationSelectionGroups)(self.wrapped.ResultLocationSelectionGroups) if self.wrapped.ResultLocationSelectionGroups else None

    @property
    def active_result_locations(self) -> 'List[_5459.ResultNodeSelection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ActiveResultLocations, constructor.new(_5459.ResultNodeSelection))
        return value

    @property
    def degrees_of_freedom(self) -> 'List[_1373.EnumWithBool[_1100.ResultOptionsFor3DVector]]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.DegreesOfFreedom, constructor.new(_1373.EnumWithBool)[_1100.ResultOptionsFor3DVector])
        return value
