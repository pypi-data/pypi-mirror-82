...
class ShaftModalAnalysis(_4748.AbstractShaftOrHousingModalAnalysis):
    '''ShaftModalAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2355.ShaftSystemDeflection':
        ...
        return constructor.new(_2355.ShaftSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
