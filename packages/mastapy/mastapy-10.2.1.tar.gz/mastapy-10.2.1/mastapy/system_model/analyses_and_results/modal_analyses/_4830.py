...
class PartToPartShearCouplingModalAnalysis(_4785.CouplingModalAnalysis):
    '''PartToPartShearCouplingModalAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2342.PartToPartShearCouplingSystemDeflection':
        ...
        return constructor.new(_2342.PartToPartShearCouplingSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
