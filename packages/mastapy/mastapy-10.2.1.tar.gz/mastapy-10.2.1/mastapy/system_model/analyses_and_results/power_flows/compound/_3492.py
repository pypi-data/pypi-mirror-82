...
from mastapy.system_model.analyses_and_results.power_flows.compound import _3486
...
class StraightBevelPlanetGearCompoundPowerFlow(_3486.StraightBevelDiffGearCompoundPowerFlow):
    '''StraightBevelPlanetGearCompoundPowerFlow
