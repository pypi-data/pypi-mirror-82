...
class PowerLoadCompoundPowerFlow(_3503.VirtualComponentCompoundPowerFlow):
    '''PowerLoadCompoundPowerFlow
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_3348.PowerLoadPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_3348.PowerLoadPowerFlow))
        return value

    @property
    def component_power_flow_load_cases(self) -> 'List[_3348.PowerLoadPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentPowerFlowLoadCases, constructor.new(_3348.PowerLoadPowerFlow))
        return value
