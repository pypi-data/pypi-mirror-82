...
from mastapy.system_model.analyses_and_results.power_flows import _3346, _3269
...
class RootAssemblyPowerFlow(_3269.AssemblyPowerFlow):
    '''RootAssemblyPowerFlow
    ...
    @property
    def power_flow_inputs(self) -> '_3346.PowerFlow':
        ...
        return constructor.new(_3346.PowerFlow)(self.wrapped.PowerFlowInputs) if self.wrapped.PowerFlowInputs else None
