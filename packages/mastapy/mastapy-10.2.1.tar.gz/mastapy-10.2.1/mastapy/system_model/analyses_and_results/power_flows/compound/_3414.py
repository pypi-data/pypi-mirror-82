...
class ConceptCouplingConnectionCompoundPowerFlow(_3425.CouplingConnectionCompoundPowerFlow):
    '''ConceptCouplingConnectionCompoundPowerFlow
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_3288.ConceptCouplingConnectionPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_3288.ConceptCouplingConnectionPowerFlow))
        return value

    @property
    def connection_power_flow_load_cases(self) -> 'List[_3288.ConceptCouplingConnectionPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionPowerFlowLoadCases, constructor.new(_3288.ConceptCouplingConnectionPowerFlow))
        return value
