...
from mastapy.system_model.imported_fes import _1968, _1984
...
class ImportedFEElectricMachineStatorLink(_1984.ImportedFEMultiNodeLink):
    '''ImportedFEElectricMachineStatorLink
    ...
    @property
    def electric_machine_dynamic_load_data(self) -> '_1968.ElectricMachineDynamicLoadData':
        ...
        return constructor.new(_1968.ElectricMachineDynamicLoadData)(self.wrapped.ElectricMachineDynamicLoadData) if self.wrapped.ElectricMachineDynamicLoadData else None
