...
from mastapy.nodal_analysis.dev_tools_analyses import _1486, _1477
...
class ImportedFEWithSelectionModalAnalysis(_1992.ImportedFEWithSelection):
    '''ImportedFEWithSelectionModalAnalysis
    ...
    @property
    def modal_draw_style(self) -> '_1486.FEModelModalAnalysisDrawStyle':
        ...
        return constructor.new(_1486.FEModelModalAnalysisDrawStyle)(self.wrapped.ModalDrawStyle) if self.wrapped.ModalDrawStyle else None
    ...
    @property
    def fe_modal_frequencies(self) -> 'List[_1390.FEModalFrequencyComparison]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.FEModalFrequencies, constructor.new(_1390.FEModalFrequencyComparison))
        return value
