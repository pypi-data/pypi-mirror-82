...
from mastapy.system_model.imported_fes.version_comparer import _2021, _2017
...
class ImportedFEVersionComparer(_0.APIBase):
    ...
    @property
    def load_cases_to_run(self) -> '_2021.LoadCasesToRun':
        ...
        return constructor.new(_2021.LoadCasesToRun)(value) if value else None

    @load_cases_to_run.setter
    def load_cases_to_run(self, value: '_2021.LoadCasesToRun'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.LoadCasesToRun = value

    @property
    def design_results(self) -> 'List[_2017.DesignResults]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.DesignResults, constructor.new(_2017.DesignResults))
        return value
