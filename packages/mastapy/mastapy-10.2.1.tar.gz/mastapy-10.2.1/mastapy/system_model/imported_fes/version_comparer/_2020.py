...
class LoadCaseResults(_0.APIBase):
    ...
    @property
    def imported_fe_results(self) -> 'List[_2018.ImportedFEResults]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ImportedFEResults, constructor.new(_2018.ImportedFEResults))
        return value
