...
from mastapy.nodal_analysis.dev_tools_analyses.full_fe_reporting import _1513
...
class MaterialPropertiesWithSelection(_0.APIBase):
    ...
    @property
    def material_properties(self) -> '_1513.MaterialPropertiesReporting':
        ...
        return constructor.new(_1513.MaterialPropertiesReporting)(self.wrapped.MaterialProperties) if self.wrapped.MaterialProperties else None
