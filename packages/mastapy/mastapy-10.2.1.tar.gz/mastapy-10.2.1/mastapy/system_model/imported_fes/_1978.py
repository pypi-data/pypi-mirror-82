...
from mastapy.system_model.imported_fes import (
    _1957, _1991, _2015, _1951,
    _1953, _2016, _2011, _1990,
    _1949, _1974, _1977, _1997,
    _1996, _1993, _1994, _1995
)
from mastapy._internal.python_net import python_net_import
from mastapy.system_model.part_model import _2036, _2032, _2044
from mastapy.nodal_analysis import _1396, _1389, _1392
...
class ImportedFE(_1392.FEStiffness):
    '''ImportedFE
    ...
    @property
    def bearing_node_alignment(self) -> '_1957.BearingNodeAlignmentOption':
        ...
        return constructor.new(_1957.BearingNodeAlignmentOption)(value) if value else None

    @bearing_node_alignment.setter
    def bearing_node_alignment(self, value: '_1957.BearingNodeAlignmentOption'):
    ...
    @property
    def alignment_method(self) -> '_1951.AlignmentMethod':
        ...
        return constructor.new(_1951.AlignmentMethod)(value) if value else None

    @alignment_method.setter
    def alignment_method(self, value: '_1951.AlignmentMethod'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def gravity_force_source(self) -> '_1396.GravityForceSource':
        ...
        return constructor.new(_1396.GravityForceSource)(value) if value else None
    ...
    @property
    def fe_meshing_options(self) -> '_1389.FEMeshingOptions':
        ...
        return constructor.new(_1389.FEMeshingOptions)(self.wrapped.FEMeshingOptions) if self.wrapped.FEMeshingOptions else None

    @property
    def cms_model(self) -> '_1525.FullFEModel':
        ...
        return constructor.new(_1525.FullFEModel)(self.wrapped.CMSModel) if self.wrapped.CMSModel else None

    @property
    def alignment_to_component(self) -> '_1850.RelativeComponentAlignment[_2032.Component]':
        ...
        return constructor.new(_1850.RelativeComponentAlignment)[_2032.Component](self.wrapped.AlignmentToComponent) if self.wrapped.AlignmentToComponent else None

    @property
    def alignment_using_axial_node_positions(self) -> '_1953.AlignmentUsingAxialNodePositions':
        ...
        return constructor.new(_1953.AlignmentUsingAxialNodePositions)(self.wrapped.AlignmentUsingAxialNodePositions) if self.wrapped.AlignmentUsingAxialNodePositions else None

    @property
    def coordinate_system(self) -> '_1074.CoordinateSystem3D':
        ...
        return constructor.new(_1074.CoordinateSystem3D)(self.wrapped.CoordinateSystem) if self.wrapped.CoordinateSystem else None

    @property
    def export(self) -> '_2016.UsedForExportingAnImportedFEsSetupOrSubstructuringStepToAnFEFile':
        ...
        return constructor.new(_2016.UsedForExportingAnImportedFEsSetupOrSubstructuringStepToAnFEFile)(self.wrapped.Export) if self.wrapped.Export else None
    ...
    @property
    def shafts_that_can_be_replaced(self) -> 'List[_2011.ReplacedShaftSelectionHelper]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ShaftsThatCanBeReplaced, constructor.new(_2011.ReplacedShaftSelectionHelper))
        return value

    @property
    def nodes(self) -> 'List[_1990.ImportedFEStiffnessNode]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Nodes, constructor.new(_1990.ImportedFEStiffnessNode))
        return value

    @property
    def replaced_shafts(self) -> 'List[_2067.Shaft]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ReplacedShafts, constructor.new(_2067.Shaft))
        return value

    @property
    def links(self) -> 'List[_1949.ImportedFELink]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Links, constructor.new(_1949.ImportedFELink))
        return value

    @property
    def thermal_expansion_forces(self) -> 'List[_1138.VectorWithLinearAndAngularComponents]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ThermalExpansionForces, constructor.new(_1138.VectorWithLinearAndAngularComponents))
        return value

    @property
    def thermal_expansion_displacements(self) -> 'List[_1138.VectorWithLinearAndAngularComponents]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ThermalExpansionDisplacements, constructor.new(_1138.VectorWithLinearAndAngularComponents))
        return value

    @property
    def geometries(self) -> 'List[_1974.FEStiffnessGeometry]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Geometries, constructor.new(_1974.FEStiffnessGeometry))
        return value

    @property
    def gear_meshing_options(self) -> 'List[_1977.GearMeshingOptions]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.GearMeshingOptions, constructor.new(_1977.GearMeshingOptions))
        return value

    @property
    def independent_masta_created_condensation_nodes(self) -> 'List[_1997.IndependentMastaCreatedCondensationNode]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.IndependentMastaCreatedCondensationNodes, constructor.new(_1997.IndependentMastaCreatedCondensationNode))
        return value

    @property
    def imported_fe_component(self) -> '_2044.ImportedFEComponent':
        ...
        return constructor.new(_2044.ImportedFEComponent)(self.wrapped.ImportedFEComponent) if self.wrapped.ImportedFEComponent else None
    ...
    def load_existing_masta_fe_file_with_progress(self, file_name: 'str', progress: '_6554.TaskProgress'):
        ''' 'LoadExistingMastaFEFile' is the original name of this method.
    ...
    def create_imported_fe_with_selection_static_analysis(self) -> '_1996.ImportedFEWithSelectionStaticAnalysis':
    ...
    def create_imported_fe_with_selection_components(self) -> '_1993.ImportedFEWithSelectionComponents':
    ...
    def create_imported_fe_with_selection_for_harmonic_analysis(self) -> '_1994.ImportedFEWithSelectionForHarmonicAnalysis':
    ...
    def create_imported_fe_with_selection_modal_analysis(self) -> '_1995.ImportedFEWithSelectionModalAnalysis':
    ...
    def links_for(self, node: '_1990.ImportedFEStiffnessNode') -> 'List[_1949.ImportedFELink]':
        ...
        return conversion.pn_to_mp_objects_in_list(self.wrapped.LinksFor(node.wrapped if node else None), constructor.new(_1949.ImportedFELink))
