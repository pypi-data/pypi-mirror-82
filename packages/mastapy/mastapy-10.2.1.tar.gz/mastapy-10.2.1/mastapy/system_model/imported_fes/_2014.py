...
from mastapy.system_model.imported_fes import _2007, _2006
...
class SystemDeflectionFEExportOptions(_0.APIBase):
    ...
    @property
    def nodes(self) -> 'List[_2007.PerNodeExportOptions]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Nodes, constructor.new(_2007.PerNodeExportOptions))
        return value

    @property
    def links(self) -> 'List[_2006.PerLinkExportOptions]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Links, constructor.new(_2006.PerLinkExportOptions))
        return value
