...
from mastapy.system_model.drawing import _1870, _1869
...
class ContourDrawStyle(_110.DrawStyleBase):
    ...
    @property
    def contour(self) -> '_1357.ThreeDViewContourOption':
        '''ThreeDViewContourOption: 'Contour' is the original name of this property.'''

        value = conversion.pn_to_mp_enum(self.wrapped.Contour)
        return constructor.new(_1357.ThreeDViewContourOption)(value) if value else None

    @contour.setter
    def contour(self, value: '_1357.ThreeDViewContourOption'):
    ...
    @property
    def deflection_scaling(self) -> '_1870.ScalingDrawStyle':
        ...
        return constructor.new(_1870.ScalingDrawStyle)(self.wrapped.DeflectionScaling) if self.wrapped.DeflectionScaling else None

    @property
    def model_view_options(self) -> '_1869.ModelViewOptionsDrawStyle':
        ...
        return constructor.new(_1869.ModelViewOptionsDrawStyle)(self.wrapped.ModelViewOptions) if self.wrapped.ModelViewOptions else None
