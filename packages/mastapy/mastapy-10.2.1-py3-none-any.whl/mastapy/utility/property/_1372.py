...
from mastapy.utility.units_and_measurements.measurements import _1262
...
class DutyCyclePropertySummaryStress(_1368.DutyCyclePropertySummary['_1262.Stress', 'T'], Generic[T]):
    '''DutyCyclePropertySummaryStress
