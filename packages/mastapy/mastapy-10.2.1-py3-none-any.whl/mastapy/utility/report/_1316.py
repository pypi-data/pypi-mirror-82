...
from mastapy.utility.report import _1327, _1326
...
class CustomReportPropertyItem(_0.APIBase):
    ...
    @property
    def font_weight(self) -> '_1327.FontWeight':
        '''FontWeight: 'FontWeight' is the original name of this property.'''

        value = conversion.pn_to_mp_enum(self.wrapped.FontWeight)
        return constructor.new(_1327.FontWeight)(value) if value else None

    @font_weight.setter
    def font_weight(self, value: '_1327.FontWeight'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.FontWeight = value

    @property
    def font_style(self) -> '_1326.FontStyle':
        '''FontStyle: 'FontStyle' is the original name of this property.'''

        value = conversion.pn_to_mp_enum(self.wrapped.FontStyle)
        return constructor.new(_1326.FontStyle)(value) if value else None

    @font_style.setter
    def font_style(self, value: '_1326.FontStyle'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.FontStyle = value

    @property
    def horizontal_position(self) -> '_1287.CellValuePosition':
        ...
        return constructor.new(_1287.CellValuePosition)(value) if value else None

    @horizontal_position.setter
    def horizontal_position(self, value: '_1287.CellValuePosition'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
