...
from mastapy.bearings import (
    _1536, _1561, _1550, _1559
)
from mastapy.math_utility import _1064
from mastapy._internal.python_net import python_net_import
from mastapy.utility.databases import _1364
...
class RollingBearingDatabase(_1364.SQLDatabase['_1559.RollingBearingKey', '_1800.RollingBearing']):
    '''RollingBearingDatabase
    ...
    def add_to_database(self, bearing: '_1800.RollingBearing'):
    ...
    def remove_from_database(self, bearing: '_1800.RollingBearing'):
    ...
    def search_for_rolling_bearing(self, designation: 'str', catalog: '_1536.BearingCatalog', type_: '_1561.RollingBearingType', bore_range: '_1064.Range', outer_diameter_range: '_1064.Range', width_range: '_1064.Range', dynamic_capacity_range: '_1064.Range', number_of_rows: 'int', material_type: '_1550.HybridSteelAll') -> 'List[_1800.RollingBearing]':
    ...
    def search_for_rolling_bearing_with_name_catalog_and_type(self, designation: 'str', catalog: '_1536.BearingCatalog', type_: '_1561.RollingBearingType') -> 'List[_1800.RollingBearing]':
        ...
        catalog = conversion.mp_to_pn_enum(catalog)
        type_ = conversion.mp_to_pn_enum(type_)
        return conversion.pn_to_mp_objects_in_list(self.wrapped.SearchForRollingBearing.Overloads[_STRING, _BEARING_CATALOG, _ROLLING_BEARING_TYPE](designation if designation else None, catalog, type_), constructor.new(_1800.RollingBearing))

    def search_for_rolling_bearing_with_name_and_catalog(self, designation: 'str', catalog: '_1536.BearingCatalog') -> '_1800.RollingBearing':
        ''' 'SearchForRollingBearing' is the original name of this method.
    ...
    def search_for_rolling_bearing_with_catalog(self, catalog: '_1536.BearingCatalog') -> 'List[_1800.RollingBearing]':
        ''' 'SearchForRollingBearing' is the original name of this method.
        ...
        catalog = conversion.mp_to_pn_enum(catalog)
        return conversion.pn_to_mp_objects_in_list(self.wrapped.SearchForRollingBearing.Overloads[_BEARING_CATALOG](catalog), constructor.new(_1800.RollingBearing))

    def create_bearing(self, type_: '_1561.RollingBearingType', designation: Optional['str'] = 'None') -> '_1800.RollingBearing':
    ...
    def create_bearing_with_type_name(self, type_: 'str', designation: Optional['str'] = 'None') -> '_1800.RollingBearing':
        ''' 'CreateBearing' is the original name of this method.
    ...
    def create_key(self, type_: '_1561.RollingBearingType', designation: Optional['str'] = 'None') -> '_1559.RollingBearingKey':
    ...
    def create_key_with_type_name(self, type_: 'str', designation: Optional['str'] = 'None') -> '_1559.RollingBearingKey':
        ''' 'CreateKey' is the original name of this method.
