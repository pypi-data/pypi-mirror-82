...
from mastapy.bearings.tolerances import _1581, _1578
...
class RoundnessSpecification(_1153.IndependentReportablePropertiesBase['RoundnessSpecification']):
    '''RoundnessSpecification
    ...
    @property
    def specification_type(self) -> '_1581.RoundnessSpecificationType':
        ...
        return constructor.new(_1581.RoundnessSpecificationType)(value) if value else None

    @specification_type.setter
    def specification_type(self, value: '_1581.RoundnessSpecificationType'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.SpecificationType = value

    @property
    def roundness_distribution(self) -> 'List[_1578.RaceRoundnessAtAngle]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.RoundnessDistribution, constructor.new(_1578.RaceRoundnessAtAngle))
        return value
