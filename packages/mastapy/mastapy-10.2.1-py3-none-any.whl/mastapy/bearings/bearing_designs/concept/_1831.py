...
from mastapy.bearings.bearing_designs.concept import _1830, _1832
...
class ConceptAxialClearanceBearing(_1832.ConceptClearanceBearing):
    '''ConceptAxialClearanceBearing
    ...
    @property
    def node_position(self) -> '_1830.BearingNodePosition':
        ...
        return constructor.new(_1830.BearingNodePosition)(value) if value else None

    @node_position.setter
    def node_position(self, value: '_1830.BearingNodePosition'):
