...
class RollingBearing(_1772.DetailedBearing):
    '''RollingBearing
    ...
    @property
    def catalogue(self) -> '_1536.BearingCatalog':
        ...
        return constructor.new(_1536.BearingCatalog)(value) if value else None
    ...
    @property
    def type_information(self) -> '_1787.BearingTypeExtraInformation':
        ...
        return constructor.new(_1787.BearingTypeExtraInformation)(value) if value else None
    ...
    @property
    def cage_material(self) -> '_1539.BearingCageMaterial':
        ...
        return constructor.new(_1539.BearingCageMaterial)(value) if value else None

    @cage_material.setter
    def cage_material(self, value: '_1539.BearingCageMaterial'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.CageMaterial = value

    @property
    def sleeve_type(self) -> '_1802.SleeveType':
        ...
        return constructor.new(_1802.SleeveType)(value) if value else None
    ...
    @property
    def history(self) -> '_1150.FileHistory':
        ...
        return constructor.new(_1150.FileHistory)(self.wrapped.History) if self.wrapped.History else None

    @property
    def protection(self) -> '_1784.BearingProtection':
        ...
        return constructor.new(_1784.BearingProtection)(self.wrapped.Protection) if self.wrapped.Protection else None
