...
from mastapy.bearings.bearing_results.rolling import _1721, _1674
...
class LoadedCylindricalRollerBearingResults(_1674.LoadedNonBarrelRollerBearingResults):
    '''LoadedCylindricalRollerBearingResults
    ...
    @property
    def skf_maximal_constantly_acting_axial_load(self) -> '_1721.SKFMaximalConstantlyActingAxialLoadResults':
        ...
        return constructor.new(_1721.SKFMaximalConstantlyActingAxialLoadResults)(self.wrapped.SKFMaximalConstantlyActingAxialLoad) if self.wrapped.SKFMaximalConstantlyActingAxialLoad else None
