...
from mastapy.bearings.bearing_results.rolling import (
    _1679, _1639, _1644, _1647,
    _1655, _1659, _1671, _1674,
    _1690, _1693, _1699, _1708,
    _1625, _1684
)
...
class LoadedRollerBearingRow(_1684.LoadedRollingBearingRow):
    '''LoadedRollerBearingRow
    ...
    @property
    def shear_stress_chart_inner(self) -> '_6557.SMTBitmap':
        ...
        return constructor.new(_6557.SMTBitmap)(self.wrapped.ShearStressChartInner) if self.wrapped.ShearStressChartInner else None

    @property
    def shear_stress_chart_outer(self) -> '_6557.SMTBitmap':
        ...
        return constructor.new(_6557.SMTBitmap)(self.wrapped.ShearStressChartOuter) if self.wrapped.ShearStressChartOuter else None

    @property
    def depth_of_maximum_shear_stress_chart_inner(self) -> '_6557.SMTBitmap':
        ...
        return constructor.new(_6557.SMTBitmap)(self.wrapped.DepthOfMaximumShearStressChartInner) if self.wrapped.DepthOfMaximumShearStressChartInner else None

    @property
    def depth_of_maximum_shear_stress_chart_outer(self) -> '_6557.SMTBitmap':
        ...
        return constructor.new(_6557.SMTBitmap)(self.wrapped.DepthOfMaximumShearStressChartOuter) if self.wrapped.DepthOfMaximumShearStressChartOuter else None

    @property
    def loaded_bearing(self) -> '_1679.LoadedRollerBearingResults':
    ...
    @property
    def lamina_dynamic_equivalent_loads(self) -> 'List[_1625.ForceAtLaminaGroupReportable]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LaminaDynamicEquivalentLoads, constructor.new(_1625.ForceAtLaminaGroupReportable))
        return value
