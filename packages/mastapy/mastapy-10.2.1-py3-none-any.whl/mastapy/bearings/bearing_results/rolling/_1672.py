...
from mastapy.bearings.bearing_results.rolling import _1671, _1660
...
class LoadedNeedleRollerBearingRow(_1660.LoadedCylindricalRollerBearingRow):
    '''LoadedNeedleRollerBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1671.LoadedNeedleRollerBearingResults':
        ...
        return constructor.new(_1671.LoadedNeedleRollerBearingResults)(self.wrapped.LoadedBearing) if self.wrapped.LoadedBearing else None
