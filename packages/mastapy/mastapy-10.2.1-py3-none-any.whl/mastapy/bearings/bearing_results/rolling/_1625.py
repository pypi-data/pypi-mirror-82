...
from mastapy.bearings.bearing_results.rolling import _1626
...
class ForceAtLaminaGroupReportable(_0.APIBase):
    ...
    @property
    def forces_at_laminae(self) -> 'List[_1626.ForceAtLaminaReportable]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ForcesAtLaminae, constructor.new(_1626.ForceAtLaminaReportable))
        return value
