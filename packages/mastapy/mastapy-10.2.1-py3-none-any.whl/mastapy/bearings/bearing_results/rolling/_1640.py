...
from mastapy.bearings.bearing_results.rolling import _1639, _1680
...
class LoadedAsymmetricSphericalRollerBearingRow(_1680.LoadedRollerBearingRow):
    '''LoadedAsymmetricSphericalRollerBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1639.LoadedAsymmetricSphericalRollerBearingResults':
        ...
        return constructor.new(_1639.LoadedAsymmetricSphericalRollerBearingResults)(self.wrapped.LoadedBearing) if self.wrapped.LoadedBearing else None
