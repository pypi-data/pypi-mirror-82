...
from mastapy.bearings.bearing_results.rolling import _1633, _1636, _1653
...
class LoadedAngularContactBallBearingRow(_1653.LoadedBallBearingRow):
    '''LoadedAngularContactBallBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1633.LoadedAngularContactBallBearingResults':
