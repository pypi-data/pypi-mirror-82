...
from mastapy.bearings.bearing_results.rolling import _1686, _1653
...
class LoadedSelfAligningBallBearingRow(_1653.LoadedBallBearingRow):
    '''LoadedSelfAligningBallBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1686.LoadedSelfAligningBallBearingResults':
        ...
        return constructor.new(_1686.LoadedSelfAligningBallBearingResults)(self.wrapped.LoadedBearing) if self.wrapped.LoadedBearing else None
