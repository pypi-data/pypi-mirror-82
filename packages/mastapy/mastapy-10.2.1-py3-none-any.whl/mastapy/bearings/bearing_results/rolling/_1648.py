...
from mastapy.bearings.bearing_results.rolling import _1647, _1645
...
class LoadedAxialThrustNeedleRollerBearingRow(_1645.LoadedAxialThrustCylindricalRollerBearingRow):
    '''LoadedAxialThrustNeedleRollerBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1647.LoadedAxialThrustNeedleRollerBearingResults':
        ...
        return constructor.new(_1647.LoadedAxialThrustNeedleRollerBearingResults)(self.wrapped.LoadedBearing) if self.wrapped.LoadedBearing else None
