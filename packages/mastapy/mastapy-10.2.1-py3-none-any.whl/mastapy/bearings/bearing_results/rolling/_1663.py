...
from mastapy.bearings.bearing_results.rolling import _1662, _1653
...
class LoadedDeepGrooveBallBearingRow(_1653.LoadedBallBearingRow):
    '''LoadedDeepGrooveBallBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1662.LoadedDeepGrooveBallBearingResults':
        ...
        return constructor.new(_1662.LoadedDeepGrooveBallBearingResults)(self.wrapped.LoadedBearing) if self.wrapped.LoadedBearing else None
