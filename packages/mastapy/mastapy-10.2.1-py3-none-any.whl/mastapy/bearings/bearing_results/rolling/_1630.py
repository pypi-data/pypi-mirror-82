...
class ISO14179SettingsPerBearingType(_1153.IndependentReportablePropertiesBase['ISO14179SettingsPerBearingType']):
    '''ISO14179SettingsPerBearingType
    ...
    @property
    def rolling_bearing_type(self) -> '_1561.RollingBearingType':
        ...
        return constructor.new(_1561.RollingBearingType)(value) if value else None
