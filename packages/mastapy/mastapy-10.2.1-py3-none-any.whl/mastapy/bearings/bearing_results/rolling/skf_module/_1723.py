...
from mastapy.bearings.bearing_results.rolling.skf_module import _1717, _1719
...
class Viscosities(_1719.SKFCalculationResult):
    '''Viscosities
    ...
    @property
    def operating_viscosity(self) -> '_1717.OperatingViscosity':
        ...
        return constructor.new(_1717.OperatingViscosity)(self.wrapped.OperatingViscosity) if self.wrapped.OperatingViscosity else None
