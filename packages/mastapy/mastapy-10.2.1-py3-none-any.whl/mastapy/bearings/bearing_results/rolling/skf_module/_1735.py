...
class GreaseLifeAndRelubricationInterval(_1742.SKFCalculationResult):
    '''GreaseLifeAndRelubricationInterval
    ...
    def grease(self) -> '_1734.Grease':
        ...
        return constructor.new(_1734.Grease)(self.wrapped.Grease) if self.wrapped.Grease else None

    @property
    def initial_fill(self) -> '_1737.InitialFill':
        ...
        return constructor.new(_1737.InitialFill)(self.wrapped.InitialFill) if self.wrapped.InitialFill else None

    @property
    def grease_quantity(self) -> '_1736.GreaseQuantity':
        ...
        return constructor.new(_1736.GreaseQuantity)(self.wrapped.GreaseQuantity) if self.wrapped.GreaseQuantity else None
