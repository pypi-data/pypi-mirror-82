...
from mastapy.bearings.bearing_results.rolling.skf_module import _1738, _1742
...
class BearingRatingLife(_1742.SKFCalculationResult):
    '''BearingRatingLife
    ...
    @property
    def life_model(self) -> '_1738.LifeModel':
        ...
        return constructor.new(_1738.LifeModel)(self.wrapped.LifeModel) if self.wrapped.LifeModel else None
