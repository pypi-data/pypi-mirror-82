...
from mastapy.bearings.bearing_results.rolling.skf_module import _1726, _1742
...
class AdjustedSpeed(_1742.SKFCalculationResult):
    '''AdjustedSpeed
    ...
    @property
    def adjustment_factors(self) -> '_1726.AdjustmentFactors':
        ...
        return constructor.new(_1726.AdjustmentFactors)(self.wrapped.AdjustmentFactors) if self.wrapped.AdjustmentFactors else None
