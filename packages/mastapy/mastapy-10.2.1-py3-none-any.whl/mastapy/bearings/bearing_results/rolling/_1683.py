...
from mastapy.bearings import _1549
from mastapy.bearings.bearing_results.rolling.fitting import _1758, _1756, _1759
from mastapy.bearings.bearing_results.rolling import (
    _1627, _1624, _1711, _1684
)
from mastapy.bearings.bearing_results.rolling.iso_rating_results import (
    _1749, _1747, _1753, _1752,
    _1748, _1754, _1750
)
from mastapy._internal.cast_exception import CastException
from mastapy.bearings.bearing_results.rolling.skf_module import _1744
from mastapy.bearings.bearing_results import _1611
...
class LoadedRollingBearingResults(_1611.LoadedDetailedBearingResults):
    '''LoadedRollingBearingResults
    ...
    @property
    def fluid_film_temperature_source(self) -> '_1549.FluidFilmTemperatureOptions':
        ...
        return constructor.new(_1549.FluidFilmTemperatureOptions)(value) if value else None
    ...
    @property
    def outer_ring_fitting_at_assembly(self) -> '_1758.OuterRingFittingThermalResults':
        ...
        return constructor.new(_1758.OuterRingFittingThermalResults)(self.wrapped.OuterRingFittingAtAssembly) if self.wrapped.OuterRingFittingAtAssembly else None

    @property
    def outer_ring_fitting_at_operating_conditions(self) -> '_1758.OuterRingFittingThermalResults':
        ...
        return constructor.new(_1758.OuterRingFittingThermalResults)(self.wrapped.OuterRingFittingAtOperatingConditions) if self.wrapped.OuterRingFittingAtOperatingConditions else None

    @property
    def inner_ring_fitting_at_assembly(self) -> '_1756.InnerRingFittingThermalResults':
        ...
        return constructor.new(_1756.InnerRingFittingThermalResults)(self.wrapped.InnerRingFittingAtAssembly) if self.wrapped.InnerRingFittingAtAssembly else None

    @property
    def inner_ring_fitting_at_operating_conditions(self) -> '_1756.InnerRingFittingThermalResults':
        ...
        return constructor.new(_1756.InnerRingFittingThermalResults)(self.wrapped.InnerRingFittingAtOperatingConditions) if self.wrapped.InnerRingFittingAtOperatingConditions else None
    ...
    @property
    def din732(self) -> '_1624.DIN732Results':
        ...
        return constructor.new(_1624.DIN732Results)(self.wrapped.DIN732) if self.wrapped.DIN732 else None

    @property
    def iso2812007(self) -> '_1749.ISO2812007Results':
        ...
        if _1749.ISO2812007Results.TYPE not in self.wrapped.ISO2812007.__class__.__mro__:
    ...
    @property
    def iso2812007_of_type_ball_iso2812007_results(self) -> '_1747.BallISO2812007Results':
        ...
        if _1747.BallISO2812007Results.TYPE not in self.wrapped.ISO2812007.__class__.__mro__:
    ...
    @property
    def iso2812007_of_type_roller_iso2812007_results(self) -> '_1753.RollerISO2812007Results':
        ...
        if _1753.RollerISO2812007Results.TYPE not in self.wrapped.ISO2812007.__class__.__mro__:
    ...
    @property
    def isots162812008(self) -> '_1752.ISOTS162812008Results':
        ...
        if _1752.ISOTS162812008Results.TYPE not in self.wrapped.ISOTS162812008.__class__.__mro__:
    ...
    @property
    def isots162812008_of_type_ball_isots162812008_results(self) -> '_1748.BallISOTS162812008Results':
        ...
        if _1748.BallISOTS162812008Results.TYPE not in self.wrapped.ISOTS162812008.__class__.__mro__:
    ...
    @property
    def isots162812008_of_type_roller_isots162812008_results(self) -> '_1754.RollerISOTS162812008Results':
        ...
        if _1754.RollerISOTS162812008Results.TYPE not in self.wrapped.ISOTS162812008.__class__.__mro__:
    ...
    @property
    def iso762006(self) -> '_1750.ISO762006Results':
        ...
        return constructor.new(_1750.ISO762006Results)(self.wrapped.ISO762006) if self.wrapped.ISO762006 else None

    @property
    def maximum_static_contact_stress(self) -> '_1711.MaximumStaticContactStress':
        ...
        return constructor.new(_1711.MaximumStaticContactStress)(self.wrapped.MaximumStaticContactStress) if self.wrapped.MaximumStaticContactStress else None

    @property
    def skf_module_results(self) -> '_1744.SKFModuleResults':
        ...
        return constructor.new(_1744.SKFModuleResults)(self.wrapped.SKFModuleResults) if self.wrapped.SKFModuleResults else None

    @property
    def rows(self) -> 'List[_1684.LoadedRollingBearingRow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Rows, constructor.new(_1684.LoadedRollingBearingRow))
        return value

    @property
    def all_mounting_results(self) -> 'List[_1759.RingFittingThermalResults]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AllMountingResults, constructor.new(_1759.RingFittingThermalResults))
        return value
