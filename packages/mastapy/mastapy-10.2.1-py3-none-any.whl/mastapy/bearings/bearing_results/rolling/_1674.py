...
from mastapy.bearings.bearing_results.rolling import _1722, _1679
...
class LoadedNonBarrelRollerBearingResults(_1679.LoadedRollerBearingResults):
    '''LoadedNonBarrelRollerBearingResults
    ...
    @property
    def smt_rib_stress(self) -> '_1722.SMTRibStressResults':
        ...
        return constructor.new(_1722.SMTRibStressResults)(self.wrapped.SMTRibStress) if self.wrapped.SMTRibStress else None
