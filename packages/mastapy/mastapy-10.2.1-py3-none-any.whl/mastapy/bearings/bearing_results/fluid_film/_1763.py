...
from mastapy.bearings.bearing_results.fluid_film import _1764
...
class LoadedPlainJournalBearingResults(_1611.LoadedDetailedBearingResults):
    '''LoadedPlainJournalBearingResults
    ...
    @property
    def journal_bearing_rows(self) -> 'List[_1764.LoadedPlainJournalBearingRow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.JournalBearingRows, constructor.new(_1764.LoadedPlainJournalBearingRow))
        return value
