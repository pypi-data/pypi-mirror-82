...
from mastapy.bearings import _1545
...
class LoadedPlainJournalBearingRow(_0.APIBase):
    ...
    def row(self) -> '_1545.BearingRow':
        ...
        return constructor.new(_1545.BearingRow)(value) if value else None
    ...
    @property
    def journal_bearing_loading_chart(self) -> '_6557.SMTBitmap':
        ...
        return constructor.new(_6557.SMTBitmap)(self.wrapped.JournalBearingLoadingChart) if self.wrapped.JournalBearingLoadingChart else None
