...
from mastapy.nodal_analysis import _1405, _1406
...
class AnalysisSettings(_1158.PerMachineSettings):
    '''AnalysisSettings
    ...
    @property
    def rating_type_for_bearing_reliability(self) -> '_1405.RatingTypeForBearingReliability':
        ...
        return constructor.new(_1405.RatingTypeForBearingReliability)(value) if value else None

    @rating_type_for_bearing_reliability.setter
    def rating_type_for_bearing_reliability(self, value: '_1405.RatingTypeForBearingReliability'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.RatingTypeForBearingReliability = value

    @property
    def rating_type_for_shaft_reliability(self) -> '_1406.RatingTypeForShaftReliability':
        ...
        return constructor.new(_1406.RatingTypeForShaftReliability)(value) if value else None

    @rating_type_for_shaft_reliability.setter
    def rating_type_for_shaft_reliability(self, value: '_1406.RatingTypeForShaftReliability'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
