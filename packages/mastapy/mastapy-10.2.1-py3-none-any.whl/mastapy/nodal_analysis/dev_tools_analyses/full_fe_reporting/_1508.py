...
from mastapy.nodal_analysis.dev_tools_analyses.full_fe_reporting import _1516, _1504
...
class ElementPropertiesRigid(_1504.ElementPropertiesBase):
    '''ElementPropertiesRigid
    ...
    @property
    def degrees_of_freedom_list(self) -> 'List[_1516.RigidElementNodeDegreesOfFreedom]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.DegreesOfFreedomList, constructor.new(_1516.RigidElementNodeDegreesOfFreedom))
        return value
