...
from mastapy.nodal_analysis.system_solvers import _1435
...
class SingularVectorAnalysis(_0.APIBase):
    ...
    @property
    def largest_singular_vector_components(self) -> 'List[_1435.SingularDegreeOfFreedomAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LargestSingularVectorComponents, constructor.new(_1435.SingularDegreeOfFreedomAnalysis))
        return value
