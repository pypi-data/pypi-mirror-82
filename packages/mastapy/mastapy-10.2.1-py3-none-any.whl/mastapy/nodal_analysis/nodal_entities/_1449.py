...
class Bar(_1464.NodalComponent):
    '''Bar
    ...
    @property
    def bar_geometry(self) -> '_1380.BarGeometry':
        ...
        return constructor.new(_1380.BarGeometry)(self.wrapped.BarGeometry) if self.wrapped.BarGeometry else None
