...
from mastapy.nodal_analysis.dev_tools_analyses import _1482
from mastapy.nodal_analysis.component_mode_synthesis import _1523, _1520
...
class FullFEModel(_0.APIBase):
    ...
    @property
    def fe_model(self) -> '_1482.FEModel':
        ...
        return constructor.new(_1482.FEModel)(self.wrapped.FEModel) if self.wrapped.FEModel else None

    @property
    def reduction_options(self) -> '_1523.CMSOptions':
        ...
        return constructor.new(_1523.CMSOptions)(self.wrapped.ReductionOptions) if self.wrapped.ReductionOptions else None

    @property
    def element_face_groups(self) -> 'List[_1520.CMSElementFaceGroup]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ElementFaceGroups, constructor.new(_1520.CMSElementFaceGroup))
        return value
