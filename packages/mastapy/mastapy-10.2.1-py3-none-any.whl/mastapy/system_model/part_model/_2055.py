...
from mastapy.system_model.part_model import _2026, _2047, _2050
...
class PlanetCarrier(_2050.MountableComponent):
    '''PlanetCarrier
    ...
    @property
    def planetary_load_sharing_agma_application_level(self) -> '_2026.AGMALoadSharingTableApplicationLevel':
        ...
        return constructor.new(_2026.AGMALoadSharingTableApplicationLevel)(value) if value else None

    @planetary_load_sharing_agma_application_level.setter
    def planetary_load_sharing_agma_application_level(self, value: '_2026.AGMALoadSharingTableApplicationLevel'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.PlanetaryLoadSharingAGMAApplicationLevel = value

    @property
    def planetary_load_sharing(self) -> '_2047.LoadSharingModes':
        ...
        return constructor.new(_2047.LoadSharingModes)(value) if value else None

    @planetary_load_sharing.setter
    def planetary_load_sharing(self, value: '_2047.LoadSharingModes'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def planetary_sockets(self) -> 'List[_1891.PlanetarySocket]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.PlanetarySockets, constructor.new(_1891.PlanetarySocket))
        return value

    def attach_carrier_shaft(self, shaft: '_2067.Shaft', offset: Optional['float'] = float('nan')):
    ...
    def attach_pin_shaft(self, shaft: '_2067.Shaft', offset: Optional['float'] = float('nan')):
