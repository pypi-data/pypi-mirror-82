...
from mastapy.system_model.part_model.part_groups import _2071, _2072, _2075
...
class ConcentricPartGroupParallelToThis(_0.APIBase):
    ...
    @property
    def parallel_group(self) -> '_2071.ConcentricOrParallelPartGroup':
        ...
        if _2071.ConcentricOrParallelPartGroup.TYPE not in self.wrapped.ParallelGroup.__class__.__mro__:
    ...
    @property
    def parallel_group_of_type_concentric_part_group(self) -> '_2072.ConcentricPartGroup':
        ...
        if _2072.ConcentricPartGroup.TYPE not in self.wrapped.ParallelGroup.__class__.__mro__:
    ...
    @property
    def parallel_group_of_type_parallel_part_group(self) -> '_2075.ParallelPartGroup':
        ...
        if _2075.ParallelPartGroup.TYPE not in self.wrapped.ParallelGroup.__class__.__mro__:
