...
class ImportedFEComponent(_2025.AbstractShaftOrHousing):
    '''ImportedFEComponent
    ...
    @property
    def default_active_imported_fe(self) -> '_1978.ImportedFE':
        ...
        return constructor.new(_1978.ImportedFE)(self.wrapped.DefaultActiveImportedFE) if self.wrapped.DefaultActiveImportedFE else None
    ...
    def add_imported_fe(self) -> '_1978.ImportedFE':
    ...
    def add_imported_fe_with_name(self, name: 'str') -> '_1978.ImportedFE':
        ''' 'AddImportedFE' is the original name of this method.
    ...
    def select_imported_fe(self, imported_fe: '_1978.ImportedFE'):
    ...
    def remove_imported_fe(self, imported_fe: '_1978.ImportedFE') -> 'bool':
