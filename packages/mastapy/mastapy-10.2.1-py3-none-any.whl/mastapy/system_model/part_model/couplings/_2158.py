...
from mastapy.system_model.part_model.couplings import _2160, _2163
...
class Clutch(_2163.Coupling):
    ...
    @property
    def clutch_type(self) -> '_2160.ClutchType':
        '''ClutchType: 'ClutchType' is the original name of this property.'''

        value = conversion.pn_to_mp_enum(self.wrapped.ClutchType)
        return constructor.new(_2160.ClutchType)(value) if value else None

    @clutch_type.setter
    def clutch_type(self, value: '_2160.ClutchType'):
    ...
    @property
    def clutch_connection(self) -> '_1936.ClutchConnection':
        ...
        return constructor.new(_1936.ClutchConnection)(self.wrapped.ClutchConnection) if self.wrapped.ClutchConnection else None
