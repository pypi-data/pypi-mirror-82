...
class ShaftHubConnection(_2012.Connector):
    '''ShaftHubConnection
    ...
    @property
    def tilt_stiffness_type(self) -> '_2148.RigidConnectorTiltStiffnessTypes':
        ...
        return constructor.new(_2148.RigidConnectorTiltStiffnessTypes)(value) if value else None

    @tilt_stiffness_type.setter
    def tilt_stiffness_type(self, value: '_2148.RigidConnectorTiltStiffnessTypes'):
    ...
    @property
    def spline_type(self) -> '_995.SplineDesignTypes':
        '''SplineDesignTypes: 'SplineType' is the original name of this property.'''

        value = conversion.pn_to_mp_enum(self.wrapped.SplineType)
        return constructor.new(_995.SplineDesignTypes)(value) if value else None

    @spline_type.setter
    def spline_type(self, value: '_995.SplineDesignTypes'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def interference_fit_design(self) -> '_1030.InterferenceFitDesign':
        ...
        if _1030.InterferenceFitDesign.TYPE not in self.wrapped.InterferenceFitDesign.__class__.__mro__:
    ...
    @property
    def nonlinear_stiffness(self) -> '_1370.DiagonalNonlinearStiffness':
        ...
        return constructor.new(_1370.DiagonalNonlinearStiffness)(self.wrapped.NonlinearStiffness) if self.wrapped.NonlinearStiffness else None

    @property
    def tooth_locations_external_spline_half(self) -> 'List[_2149.RigidConnectorToothLocation]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ToothLocationsExternalSplineHalf, constructor.new(_2149.RigidConnectorToothLocation))
        return value
