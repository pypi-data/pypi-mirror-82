...
from mastapy.system_model.part_model.couplings import _2186, _2188, _2163
...
class TorqueConverter(_2163.Coupling):
    '''TorqueConverter
    ...
    @property
    def pump(self) -> '_2186.TorqueConverterPump':
        ...
        return constructor.new(_2186.TorqueConverterPump)(self.wrapped.Pump) if self.wrapped.Pump else None

    @property
    def turbine(self) -> '_2188.TorqueConverterTurbine':
        ...
        return constructor.new(_2188.TorqueConverterTurbine)(self.wrapped.Turbine) if self.wrapped.Turbine else None
