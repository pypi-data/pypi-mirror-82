...
from mastapy.system_model.part_model.gears import _2107, _2116
...
class ConicalGearSet(_2116.GearSet):
    '''ConicalGearSet
    ...
    @property
    def conical_gears(self) -> 'List[_2107.ConicalGear]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConicalGears, constructor.new(_2107.ConicalGear))
        return value
