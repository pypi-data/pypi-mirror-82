...
from mastapy.system_model.part_model.gears import _2103, _2104
...
class BevelDifferentialGearSet(_2104.BevelGearSet):
    '''BevelDifferentialGearSet
    ...
    @property
    def bevel_gears(self) -> 'List[_2103.BevelGear]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.BevelGears, constructor.new(_2103.BevelGear))
        return value

    @property
    def bevel_meshes(self) -> 'List[_1906.BevelGearMesh]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.BevelMeshes, constructor.new(_1906.BevelGearMesh))
        return value
