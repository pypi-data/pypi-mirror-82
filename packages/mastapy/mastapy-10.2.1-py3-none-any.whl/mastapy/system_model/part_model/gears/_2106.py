...
from mastapy.system_model.part_model.gears import _2105, _2116
...
class ConceptGearSet(_2116.GearSet):
    '''ConceptGearSet
    ...
    @property
    def concept_gears(self) -> 'List[_2105.ConceptGear]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConceptGears, constructor.new(_2105.ConceptGear))
        return value

    @property
    def concept_meshes(self) -> 'List[_1908.ConceptGearMesh]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConceptMeshes, constructor.new(_1908.ConceptGearMesh))
        return value
