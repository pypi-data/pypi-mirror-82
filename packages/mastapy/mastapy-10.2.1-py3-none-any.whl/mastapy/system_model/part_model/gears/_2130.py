...
from mastapy.system_model.part_model.gears import _2129, _2104
...
class StraightBevelDiffGearSet(_2104.BevelGearSet):
    '''StraightBevelDiffGearSet
    ...
    @property
    def straight_bevel_diff_gears(self) -> 'List[_2129.StraightBevelDiffGear]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StraightBevelDiffGears, constructor.new(_2129.StraightBevelDiffGear))
        return value

    @property
    def straight_bevel_diff_meshes(self) -> 'List[_1928.StraightBevelDiffGearMesh]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StraightBevelDiffMeshes, constructor.new(_1928.StraightBevelDiffGearMesh))
        return value
