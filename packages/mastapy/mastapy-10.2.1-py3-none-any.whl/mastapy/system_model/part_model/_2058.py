...
from mastapy.system_model.part_model import _2066, _2064
...
class PowerLoad(_2064.VirtualComponent):
    '''PowerLoad
    ...
    @property
    def single_blade_details(self) -> '_2066.WindTurbineSingleBladeDetails':
        ...
        return constructor.new(_2066.WindTurbineSingleBladeDetails)(self.wrapped.SingleBladeDetails) if self.wrapped.SingleBladeDetails else None

    @property
    def electric_machine_detail(self) -> '_6153.ElectricMachineDetail':
        ...
        return constructor.new(_6153.ElectricMachineDetail)(self.wrapped.ElectricMachineDetail) if self.wrapped.ElectricMachineDetail else None
