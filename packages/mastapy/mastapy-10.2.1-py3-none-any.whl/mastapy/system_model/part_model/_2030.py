...
from mastapy.system_model.part_model import _2031, _2032
...
class Bolt(_2032.Component):
    ...
    @property
    def bolted_joint(self) -> '_2031.BoltedJoint':
        ...
        return constructor.new(_2031.BoltedJoint)(self.wrapped.BoltedJoint) if self.wrapped.BoltedJoint else None
