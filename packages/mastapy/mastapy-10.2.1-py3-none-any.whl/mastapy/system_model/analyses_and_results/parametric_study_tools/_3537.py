...
class ConceptGearMeshParametricStudyTool(_3568.GearMeshParametricStudyTool):
    '''ConceptGearMeshParametricStudyTool
    ...
    @property
    def connection_system_deflection_results(self) -> 'List[_2281.ConceptGearMeshSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionSystemDeflectionResults, constructor.new(_2281.ConceptGearMeshSystemDeflection))
        return value
