...
from mastapy.system_model.analyses_and_results.parametric_study_tools.compound import _3730
...
class CVTPulleyCompoundParametricStudyTool(_3730.PulleyCompoundParametricStudyTool):
    '''CVTPulleyCompoundParametricStudyTool
