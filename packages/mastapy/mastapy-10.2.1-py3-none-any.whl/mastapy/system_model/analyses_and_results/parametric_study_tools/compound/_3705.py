...
from mastapy.system_model.analyses_and_results.parametric_study_tools.compound import _3703, _3704, _3652
...
class HypoidGearSetCompoundParametricStudyTool(_3652.AGMAGleasonConicalGearSetCompoundParametricStudyTool):
    '''HypoidGearSetCompoundParametricStudyTool
    ...
    @property
    def hypoid_gears_compound_parametric_study_tool(self) -> 'List[_3703.HypoidGearCompoundParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.HypoidGearsCompoundParametricStudyTool, constructor.new(_3703.HypoidGearCompoundParametricStudyTool))
        return value

    @property
    def hypoid_meshes_compound_parametric_study_tool(self) -> 'List[_3704.HypoidGearMeshCompoundParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.HypoidMeshesCompoundParametricStudyTool, constructor.new(_3704.HypoidGearMeshCompoundParametricStudyTool))
        return value

    @property
    def load_case_analyses_ready(self) -> 'List[_3574.HypoidGearSetParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_3574.HypoidGearSetParametricStudyTool))
        return value

    @property
    def assembly_parametric_study_tool_load_cases(self) -> 'List[_3574.HypoidGearSetParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyParametricStudyToolLoadCases, constructor.new(_3574.HypoidGearSetParametricStudyTool))
        return value
