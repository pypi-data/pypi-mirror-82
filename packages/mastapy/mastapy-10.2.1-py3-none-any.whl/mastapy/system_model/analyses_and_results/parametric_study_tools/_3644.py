...
from mastapy.system_model.analyses_and_results.parametric_study_tools import _3643, _3642, _3570
...
class WormGearSetParametricStudyTool(_3570.GearSetParametricStudyTool):
    '''WormGearSetParametricStudyTool
    ...
    @property
    def worm_gears_parametric_study_tool(self) -> 'List[_3643.WormGearParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.WormGearsParametricStudyTool, constructor.new(_3643.WormGearParametricStudyTool))
        return value

    @property
    def worm_meshes_parametric_study_tool(self) -> 'List[_3642.WormGearMeshParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.WormMeshesParametricStudyTool, constructor.new(_3642.WormGearMeshParametricStudyTool))
        return value
