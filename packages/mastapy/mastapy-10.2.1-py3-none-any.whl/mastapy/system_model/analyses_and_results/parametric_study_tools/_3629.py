...
from mastapy.system_model.analyses_and_results.parametric_study_tools import _3628, _3627, _3526
...
class StraightBevelGearSetParametricStudyTool(_3526.BevelGearSetParametricStudyTool):
    '''StraightBevelGearSetParametricStudyTool
    ...
    @property
    def straight_bevel_gears_parametric_study_tool(self) -> 'List[_3628.StraightBevelGearParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StraightBevelGearsParametricStudyTool, constructor.new(_3628.StraightBevelGearParametricStudyTool))
        return value

    @property
    def straight_bevel_meshes_parametric_study_tool(self) -> 'List[_3627.StraightBevelGearMeshParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StraightBevelMeshesParametricStudyTool, constructor.new(_3627.StraightBevelGearMeshParametricStudyTool))
        return value
