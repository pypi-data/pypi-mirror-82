...
from mastapy.system_model.analyses_and_results.parametric_study_tools import _3591, _3588
...
class ParametricStudyVariable(_2223.AnalysisCaseVariable):
    '''ParametricStudyVariable
    ...
    @property
    def dimension(self) -> '_3591.ParametricStudyDimension':
        ...
        return constructor.new(_3591.ParametricStudyDimension)(value) if value else None

    @dimension.setter
    def dimension(self, value: '_3591.ParametricStudyDimension'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.Dimension = value

    @property
    def distribution(self) -> '_3588.MonteCarloDistribution':
        ...
        return constructor.new(_3588.MonteCarloDistribution)(value) if value else None

    @distribution.setter
    def distribution(self, value: '_3588.MonteCarloDistribution'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
