...
class BevelDifferentialGearMeshParametricStudyTool(_3524.BevelGearMeshParametricStudyTool):
    '''BevelDifferentialGearMeshParametricStudyTool
    ...
    @property
    def connection_system_deflection_results(self) -> 'List[_2262.BevelDifferentialGearMeshSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionSystemDeflectionResults, constructor.new(_2262.BevelDifferentialGearMeshSystemDeflection))
        return value
