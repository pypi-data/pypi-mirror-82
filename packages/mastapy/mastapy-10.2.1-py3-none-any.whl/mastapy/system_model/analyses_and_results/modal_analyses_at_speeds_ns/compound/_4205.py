...
from mastapy.system_model.analyses_and_results.modal_analyses_at_speeds_ns.compound import _4199
...
class KlingelnbergCycloPalloidSpiralBevelGearCompoundModalAnalysesAtSpeeds(_4199.KlingelnbergCycloPalloidConicalGearCompoundModalAnalysesAtSpeeds):
    '''KlingelnbergCycloPalloidSpiralBevelGearCompoundModalAnalysesAtSpeeds
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_4082.KlingelnbergCycloPalloidSpiralBevelGearModalAnalysesAtSpeeds]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_4082.KlingelnbergCycloPalloidSpiralBevelGearModalAnalysesAtSpeeds))
        return value

    @property
    def component_modal_analyses_at_speeds_load_cases(self) -> 'List[_4082.KlingelnbergCycloPalloidSpiralBevelGearModalAnalysesAtSpeeds]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentModalAnalysesAtSpeedsLoadCases, constructor.new(_4082.KlingelnbergCycloPalloidSpiralBevelGearModalAnalysesAtSpeeds))
        return value
