...
from mastapy.system_model.analyses_and_results.modal_analyses_at_speeds_ns import _4134, _4133, _4068
...
class WormGearSetModalAnalysesAtSpeeds(_4068.GearSetModalAnalysesAtSpeeds):
    '''WormGearSetModalAnalysesAtSpeeds
    ...
    @property
    def worm_gears_modal_analyses_at_speeds(self) -> 'List[_4134.WormGearModalAnalysesAtSpeeds]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.WormGearsModalAnalysesAtSpeeds, constructor.new(_4134.WormGearModalAnalysesAtSpeeds))
        return value

    @property
    def worm_meshes_modal_analyses_at_speeds(self) -> 'List[_4133.WormGearMeshModalAnalysesAtSpeeds]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.WormMeshesModalAnalysesAtSpeeds, constructor.new(_4133.WormGearMeshModalAnalysesAtSpeeds))
        return value
