...
from mastapy.system_model.analyses_and_results.dynamic_analyses import _5949, _5950, _5863
...
class StraightBevelGearSetDynamicAnalysis(_5863.BevelGearSetDynamicAnalysis):
    '''StraightBevelGearSetDynamicAnalysis
    ...
    @property
    def straight_bevel_gears_dynamic_analysis(self) -> 'List[_5949.StraightBevelGearDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StraightBevelGearsDynamicAnalysis, constructor.new(_5949.StraightBevelGearDynamicAnalysis))
        return value

    @property
    def straight_bevel_meshes_dynamic_analysis(self) -> 'List[_5950.StraightBevelGearMeshDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StraightBevelMeshesDynamicAnalysis, constructor.new(_5950.StraightBevelGearMeshDynamicAnalysis))
        return value
