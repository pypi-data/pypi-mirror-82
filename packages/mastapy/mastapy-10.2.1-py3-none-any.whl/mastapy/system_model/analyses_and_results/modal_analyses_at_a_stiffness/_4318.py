...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_stiffness import _4317, _4316, _4264
...
class HypoidGearSetModalAnalysisAtAStiffness(_4264.AGMAGleasonConicalGearSetModalAnalysisAtAStiffness):
    '''HypoidGearSetModalAnalysisAtAStiffness
    ...
    @property
    def hypoid_gears_modal_analysis_at_a_stiffness(self) -> 'List[_4317.HypoidGearModalAnalysisAtAStiffness]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.HypoidGearsModalAnalysisAtAStiffness, constructor.new(_4317.HypoidGearModalAnalysisAtAStiffness))
        return value

    @property
    def hypoid_meshes_modal_analysis_at_a_stiffness(self) -> 'List[_4316.HypoidGearMeshModalAnalysisAtAStiffness]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.HypoidMeshesModalAnalysisAtAStiffness, constructor.new(_4316.HypoidGearMeshModalAnalysisAtAStiffness))
        return value
