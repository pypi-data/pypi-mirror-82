...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_stiffness import _4309, _4308, _4314
...
class FaceGearSetModalAnalysisAtAStiffness(_4314.GearSetModalAnalysisAtAStiffness):
    '''FaceGearSetModalAnalysisAtAStiffness
    ...
    @property
    def face_gears_modal_analysis_at_a_stiffness(self) -> 'List[_4309.FaceGearModalAnalysisAtAStiffness]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.FaceGearsModalAnalysisAtAStiffness, constructor.new(_4309.FaceGearModalAnalysisAtAStiffness))
        return value

    @property
    def face_meshes_modal_analysis_at_a_stiffness(self) -> 'List[_4308.FaceGearMeshModalAnalysisAtAStiffness]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.FaceMeshesModalAnalysisAtAStiffness, constructor.new(_4308.FaceGearMeshModalAnalysisAtAStiffness))
        return value
