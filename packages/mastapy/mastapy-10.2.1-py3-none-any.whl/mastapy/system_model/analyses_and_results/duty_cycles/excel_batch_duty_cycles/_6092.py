...
class ExcelBatchDutyCycleSpectraCreatorDetails(_0.APIBase):
    ...
    @property
    def working_folder(self) -> '_1163.SelectableFolder':
        ...
        return constructor.new(_1163.SelectableFolder)(self.wrapped.WorkingFolder) if self.wrapped.WorkingFolder else None
