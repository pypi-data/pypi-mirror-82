...
class BevelDifferentialGearSetModalAnalysis(_4763.BevelGearSetModalAnalysis):
    ...
    @property
    def system_deflection_results(self) -> '_2263.BevelDifferentialGearSetSystemDeflection':
        ...
        return constructor.new(_2263.BevelDifferentialGearSetSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
