...
from mastapy.system_model.analyses_and_results.modal_analyses import _4816, _4815, _4811
...
class KlingelnbergCycloPalloidSpiralBevelGearSetModalAnalysis(_4811.KlingelnbergCycloPalloidConicalGearSetModalAnalysis):
    '''KlingelnbergCycloPalloidSpiralBevelGearSetModalAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2329.KlingelnbergCycloPalloidSpiralBevelGearSetSystemDeflection':
        ...
        return constructor.new(_2329.KlingelnbergCycloPalloidSpiralBevelGearSetSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None

    @property
    def klingelnberg_cyclo_palloid_spiral_bevel_gears_modal_analysis(self) -> 'List[_4816.KlingelnbergCycloPalloidSpiralBevelGearModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.KlingelnbergCycloPalloidSpiralBevelGearsModalAnalysis, constructor.new(_4816.KlingelnbergCycloPalloidSpiralBevelGearModalAnalysis))
        return value

    @property
    def klingelnberg_cyclo_palloid_spiral_bevel_meshes_modal_analysis(self) -> 'List[_4815.KlingelnbergCycloPalloidSpiralBevelGearMeshModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.KlingelnbergCycloPalloidSpiralBevelMeshesModalAnalysis, constructor.new(_4815.KlingelnbergCycloPalloidSpiralBevelGearMeshModalAnalysis))
        return value
