...
class SpringDamperConnectionModalAnalysis(_4783.CouplingConnectionModalAnalysis):
    '''SpringDamperConnectionModalAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2361.SpringDamperConnectionSystemDeflection':
        ...
        return constructor.new(_2361.SpringDamperConnectionSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
