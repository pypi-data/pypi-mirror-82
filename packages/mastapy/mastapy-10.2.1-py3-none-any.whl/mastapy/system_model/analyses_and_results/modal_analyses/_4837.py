...
class RollingRingAssemblyModalAnalysis(_4845.SpecialisedAssemblyModalAnalysis):
    '''RollingRingAssemblyModalAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2348.RollingRingAssemblySystemDeflection':
        ...
        return constructor.new(_2348.RollingRingAssemblySystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
