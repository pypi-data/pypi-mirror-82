...
class ConicalGearMeshModalAnalysis(_4800.GearMeshModalAnalysis):
    '''ConicalGearMeshModalAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2285.ConicalGearMeshSystemDeflection':
