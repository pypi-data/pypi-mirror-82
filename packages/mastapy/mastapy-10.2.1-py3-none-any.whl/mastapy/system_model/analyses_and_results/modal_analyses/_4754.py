...
from mastapy.system_model.analyses_and_results.system_deflections import _2260, _2293
...
class BeltConnectionModalAnalysis(_4808.InterMountableComponentConnectionModalAnalysis):
    ...
    @property
    def system_deflection_results(self) -> '_2260.BeltConnectionSystemDeflection':
