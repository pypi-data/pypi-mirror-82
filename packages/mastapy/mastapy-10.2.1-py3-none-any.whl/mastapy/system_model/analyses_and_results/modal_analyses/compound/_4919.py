...
class ConceptCouplingHalfCompoundModalAnalysis(_4930.CouplingHalfCompoundModalAnalysis):
    '''ConceptCouplingHalfCompoundModalAnalysis
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_4772.ConceptCouplingHalfModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_4772.ConceptCouplingHalfModalAnalysis))
        return value

    @property
    def component_modal_analysis_load_cases(self) -> 'List[_4772.ConceptCouplingHalfModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentModalAnalysisLoadCases, constructor.new(_4772.ConceptCouplingHalfModalAnalysis))
        return value
