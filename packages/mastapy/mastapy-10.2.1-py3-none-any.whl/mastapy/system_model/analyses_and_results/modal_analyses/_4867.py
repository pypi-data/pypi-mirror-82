...
class TorqueConverterTurbineModalAnalysis(_4784.CouplingHalfModalAnalysis):
    '''TorqueConverterTurbineModalAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2382.TorqueConverterTurbineSystemDeflection':
        ...
        return constructor.new(_2382.TorqueConverterTurbineSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
