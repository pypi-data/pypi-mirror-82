...
TMeasurement = TypeVar('TMeasurement', bound='_1169.MeasurementBase')


class WhineWaterfallReferenceValues(_4873.WhineWaterfallReferenceValuesBase, Generic[TMeasurement]):
    '''WhineWaterfallReferenceValues
