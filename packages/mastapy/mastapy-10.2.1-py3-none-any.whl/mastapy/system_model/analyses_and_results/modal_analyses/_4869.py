...
class VirtualComponentModalAnalysis(_4824.MountableComponentModalAnalysis):
    '''VirtualComponentModalAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2386.VirtualComponentSystemDeflection':
