...
from mastapy.utility.modal_analysis import _1335
...
class RigidlyConnectedDesignEntityGroupModalAnalysis(_2227.DesignEntityGroupAnalysis):
    '''RigidlyConnectedDesignEntityGroupModalAnalysis
    ...
    @property
    def excitation_frequencies_at_reference_speed(self) -> 'List[_1335.DesignEntityExcitationDescription]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ExcitationFrequenciesAtReferenceSpeed, constructor.new(_1335.DesignEntityExcitationDescription))
        return value
