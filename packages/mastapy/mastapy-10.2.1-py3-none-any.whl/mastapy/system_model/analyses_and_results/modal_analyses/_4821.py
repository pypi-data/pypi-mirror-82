...
from mastapy.nodal_analysis import _1382, _1381
...
class ModalAnalysisBarModelFEExportOptions(_0.APIBase):
    ...
    @property
    def analysis_type(self) -> '_1381.BarModelAnalysisType':
        ...
        return constructor.new(_1381.BarModelAnalysisType)(value) if value else None

    @analysis_type.setter
    def analysis_type(self, value: '_1381.BarModelAnalysisType'):
    ...
    @property
    def mode_options(self) -> '_1477.EigenvalueOptions':
        ...
        return constructor.new(_1477.EigenvalueOptions)(self.wrapped.ModeOptions) if self.wrapped.ModeOptions else None
