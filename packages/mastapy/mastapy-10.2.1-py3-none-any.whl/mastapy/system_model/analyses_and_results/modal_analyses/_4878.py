...
class ZerolBevelGearMeshModalAnalysis(_4761.BevelGearMeshModalAnalysis):
    '''ZerolBevelGearMeshModalAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2390.ZerolBevelGearMeshSystemDeflection':
        ...
        return constructor.new(_2390.ZerolBevelGearMeshSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
