...
from mastapy.system_model.analyses_and_results.modal_analyses import _4853, _4852, _4763
...
class StraightBevelDiffGearSetModalAnalysis(_4763.BevelGearSetModalAnalysis):
    '''StraightBevelDiffGearSetModalAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2365.StraightBevelDiffGearSetSystemDeflection':
        ...
        return constructor.new(_2365.StraightBevelDiffGearSetSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None

    @property
    def straight_bevel_diff_gears_modal_analysis(self) -> 'List[_4853.StraightBevelDiffGearModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StraightBevelDiffGearsModalAnalysis, constructor.new(_4853.StraightBevelDiffGearModalAnalysis))
        return value

    @property
    def straight_bevel_diff_meshes_modal_analysis(self) -> 'List[_4852.StraightBevelDiffGearMeshModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StraightBevelDiffMeshesModalAnalysis, constructor.new(_4852.StraightBevelDiffGearMeshModalAnalysis))
        return value
