...
class RollingRingConnectionModalAnalysis(_4808.InterMountableComponentConnectionModalAnalysis):
    '''RollingRingConnectionModalAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2349.RollingRingConnectionSystemDeflection':
        ...
        return constructor.new(_2349.RollingRingConnectionSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
