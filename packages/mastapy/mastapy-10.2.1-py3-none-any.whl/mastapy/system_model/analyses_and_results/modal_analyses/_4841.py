...
class ShaftHubConnectionModalAnalysis(_4781.ConnectorModalAnalysis):
    '''ShaftHubConnectionModalAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2352.ShaftHubConnectionSystemDeflection':
        ...
        return constructor.new(_2352.ShaftHubConnectionSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
