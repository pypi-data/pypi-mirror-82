...
from mastapy.system_model.analyses_and_results.static_loads import _6165, _6166, _6175
...
class FaceGearSetLoadCase(_6175.GearSetLoadCase):
    '''FaceGearSetLoadCase
    ...
    @property
    def face_gears_load_case(self) -> 'List[_6165.FaceGearLoadCase]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.FaceGearsLoadCase, constructor.new(_6165.FaceGearLoadCase))
        return value

    @property
    def face_meshes_load_case(self) -> 'List[_6166.FaceGearMeshLoadCase]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.FaceMeshesLoadCase, constructor.new(_6166.FaceGearMeshLoadCase))
        return value
