...
from mastapy.system_model.analyses_and_results.static_loads import _6155, _6161
...
T = TypeVar('T', bound='_6161.ElectricMachineHarmonicLoadImportOptionsBase')


class ElectricMachineHarmonicLoadDataFromMotorPackages(_6155.ElectricMachineHarmonicLoadData, Generic[T]):
    '''ElectricMachineHarmonicLoadDataFromMotorPackages
