...
from mastapy.system_model.imported_fes import _1954, _1978
...
class ImportedFEComponentLoadCase(_6099.AbstractShaftOrHousingLoadCase):
    '''ImportedFEComponentLoadCase
    ...
    @property
    def angle_source(self) -> '_1954.AngleSource':
        ...
        return constructor.new(_1954.AngleSource)(value) if value else None
