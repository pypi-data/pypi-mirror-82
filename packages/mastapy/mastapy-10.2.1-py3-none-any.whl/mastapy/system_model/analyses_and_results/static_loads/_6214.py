...
from mastapy.system_model.analyses_and_results.static_loads import _6213, _6203
...
class PlanetCarrierLoadCase(_6203.MountableComponentLoadCase):
    '''PlanetCarrierLoadCase
    ...
    @property
    def planet_manufacture_errors(self) -> 'List[_6213.PlanetarySocketManufactureError]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.PlanetManufactureErrors, constructor.new(_6213.PlanetarySocketManufactureError))
        return value
