...
from mastapy.system_model.analyses_and_results.static_loads import _6256, _6155, _6260
...
class PowerLoadLoadCase(_6260.VirtualComponentLoadCase):
    '''PowerLoadLoadCase
    ...
    @property
    def wheel_slip_model(self) -> '_5146.WheelSlipType':
        ...
        return constructor.new(_5146.WheelSlipType)(value) if value else None

    @wheel_slip_model.setter
    def wheel_slip_model(self, value: '_5146.WheelSlipType'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def engine_idle_speed_control_pid_settings(self) -> '_1144.PIDControlSettings':
        ...
        return constructor.new(_1144.PIDControlSettings)(self.wrapped.EngineIdleSpeedControlPIDSettings) if self.wrapped.EngineIdleSpeedControlPIDSettings else None

    @property
    def coefficient_of_friction_with_ground(self) -> '_1420.NonDimensionalInputComponent':
        ...
        return constructor.new(_1420.NonDimensionalInputComponent)(self.wrapped.CoefficientOfFrictionWithGround) if self.wrapped.CoefficientOfFrictionWithGround else None

    @property
    def pid_control_settings(self) -> '_1144.PIDControlSettings':
        ...
        return constructor.new(_1144.PIDControlSettings)(self.wrapped.PIDControlSettings) if self.wrapped.PIDControlSettings else None

    def get_harmonic_load_data_for_import(self) -> '_6155.ElectricMachineHarmonicLoadData':
