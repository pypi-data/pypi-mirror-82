...
class ConceptCouplingLoadCase(_6139.CouplingLoadCase):
    '''ConceptCouplingLoadCase
    ...
    @property
    def speed_ratio_pid_control(self) -> '_1144.PIDControlSettings':
        ...
        return constructor.new(_1144.PIDControlSettings)(self.wrapped.SpeedRatioPIDControl) if self.wrapped.SpeedRatioPIDControl else None
