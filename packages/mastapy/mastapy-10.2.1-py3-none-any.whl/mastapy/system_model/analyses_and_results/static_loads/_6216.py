...
from mastapy.math_utility import _1079, _1087
...
class PointLoadHarmonicLoadData(_6229.SpeedDependentHarmonicLoadData):
    '''PointLoadHarmonicLoadData
    ...
    @property
    def degree_of_freedom(self) -> '_1079.DegreesOfFreedom':
        ...
        return constructor.new(_1079.DegreesOfFreedom)(value) if value else None

    @degree_of_freedom.setter
    def degree_of_freedom(self, value: '_1079.DegreesOfFreedom'):
