...
from mastapy.system_model.analyses_and_results import _2252
from mastapy.system_model.analyses_and_results.gear_whine_analyses import _5374
from mastapy.system_model.analyses_and_results.load_case_groups import _5283, _5284, _5285
...
class StaticLoadCase(_6097.LoadCase):
    '''StaticLoadCase
    ...
    @property
    def te_set_up_for_dynamic_analyses_options(self) -> '_2252.TESetUpForDynamicAnalysisOptions':
        ...
        return constructor.new(_2252.TESetUpForDynamicAnalysisOptions)(self.wrapped.TESetUpForDynamicAnalysesOptions) if self.wrapped.TESetUpForDynamicAnalysesOptions else None

    @property
    def gear_whine_harmonic_excitation_analysis_options(self) -> '_5374.GearWhineAnalysisOptions':
        ...
        return constructor.new(_5374.GearWhineAnalysisOptions)(self.wrapped.GearWhineHarmonicExcitationAnalysisOptions) if self.wrapped.GearWhineHarmonicExcitationAnalysisOptions else None

    @property
    def clutch_engagements(self) -> 'List[_5283.ClutchEngagementStatus]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ClutchEngagements, constructor.new(_5283.ClutchEngagementStatus))
        return value

    @property
    def concept_clutch_engagements(self) -> 'List[_5284.ConceptSynchroGearEngagementStatus]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConceptClutchEngagements, constructor.new(_5284.ConceptSynchroGearEngagementStatus))
        return value

    def duplicate(self, new_design_state_group: '_5285.DesignState', name: Optional['str'] = 'None') -> 'StaticLoadCase':
