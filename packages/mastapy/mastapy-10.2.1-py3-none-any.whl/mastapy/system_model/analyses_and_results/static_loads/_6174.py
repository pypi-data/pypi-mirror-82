...
from mastapy.system_model.analyses_and_results.static_loads import _6173, _6178
...
class GearSetHarmonicLoadData(_6178.HarmonicLoadDataBase):
    '''GearSetHarmonicLoadData
    ...
    @property
    def gear_mesh_te_order_type(self) -> '_6173.GearMeshTEOrderType':
        ...
        return constructor.new(_6173.GearMeshTEOrderType)(value) if value else None

    @gear_mesh_te_order_type.setter
    def gear_mesh_te_order_type(self, value: '_6173.GearMeshTEOrderType'):
