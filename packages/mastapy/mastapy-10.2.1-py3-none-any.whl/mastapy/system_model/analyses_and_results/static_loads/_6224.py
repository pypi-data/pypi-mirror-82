...
from mastapy.nodal_analysis.varying_input_components import _1418, _1417, _1422
from mastapy.math_utility.control import _1144
from mastapy.system_model.analyses_and_results.static_loads import _6236, _6147, _6105
...
class RootAssemblyLoadCase(_6105.AssemblyLoadCase):
    '''RootAssemblyLoadCase
    ...
    @property
    def brake_force_input_values(self) -> '_1418.ForceInputComponent':
        ...
        return constructor.new(_1418.ForceInputComponent)(self.wrapped.BrakeForceInputValues) if self.wrapped.BrakeForceInputValues else None

    @property
    def road_incline_input_values(self) -> '_1417.AngleInputComponent':
        ...
        return constructor.new(_1417.AngleInputComponent)(self.wrapped.RoadInclineInputValues) if self.wrapped.RoadInclineInputValues else None

    @property
    def drive_cycle_pid_control_settings(self) -> '_1144.PIDControlSettings':
        ...
        return constructor.new(_1144.PIDControlSettings)(self.wrapped.DriveCyclePIDControlSettings) if self.wrapped.DriveCyclePIDControlSettings else None

    @property
    def target_vehicle_speed(self) -> '_1422.VelocityInputComponent':
        ...
        return constructor.new(_1422.VelocityInputComponent)(self.wrapped.TargetVehicleSpeed) if self.wrapped.TargetVehicleSpeed else None
    ...
    @property
    def supercharger_rotor_sets(self) -> 'List[_6147.CylindricalGearSetLoadCase]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.SuperchargerRotorSets, constructor.new(_6147.CylindricalGearSetLoadCase))
        return value
