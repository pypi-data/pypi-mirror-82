...
from mastapy.system_model.analyses_and_results.static_loads import _6185, _6186, _6103
...
class HypoidGearSetLoadCase(_6103.AGMAGleasonConicalGearSetLoadCase):
    '''HypoidGearSetLoadCase
    ...
    @property
    def hypoid_gears_load_case(self) -> 'List[_6185.HypoidGearLoadCase]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.HypoidGearsLoadCase, constructor.new(_6185.HypoidGearLoadCase))
        return value

    @property
    def hypoid_meshes_load_case(self) -> 'List[_6186.HypoidGearMeshLoadCase]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.HypoidMeshesLoadCase, constructor.new(_6186.HypoidGearMeshLoadCase))
        return value
