...
class ClutchCompoundModalAnalysisAtASpeed(_4661.CouplingCompoundModalAnalysisAtASpeed):
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_4525.ClutchModalAnalysisAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_4525.ClutchModalAnalysisAtASpeed))
        return value

    @property
    def assembly_modal_analysis_at_a_speed_load_cases(self) -> 'List[_4525.ClutchModalAnalysisAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyModalAnalysisAtASpeedLoadCases, constructor.new(_4525.ClutchModalAnalysisAtASpeed))
        return value
