...
class FlexiblePinAssemblyCompoundModalAnalysisAtASpeed(_4716.SpecialisedAssemblyCompoundModalAnalysisAtASpeed):
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_4554.FlexiblePinAssemblyModalAnalysisAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_4554.FlexiblePinAssemblyModalAnalysisAtASpeed))
        return value

    @property
    def assembly_modal_analysis_at_a_speed_load_cases(self) -> 'List[_4554.FlexiblePinAssemblyModalAnalysisAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyModalAnalysisAtASpeedLoadCases, constructor.new(_4554.FlexiblePinAssemblyModalAnalysisAtASpeed))
        return value
