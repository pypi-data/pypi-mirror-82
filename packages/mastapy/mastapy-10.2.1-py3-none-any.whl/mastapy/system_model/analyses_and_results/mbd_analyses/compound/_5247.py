...
class ShaftHubConnectionCompoundMultiBodyDynamicsAnalysis(_5193.ConnectorCompoundMultiBodyDynamicsAnalysis):
    '''ShaftHubConnectionCompoundMultiBodyDynamicsAnalysis
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_5115.ShaftHubConnectionMultiBodyDynamicsAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_5115.ShaftHubConnectionMultiBodyDynamicsAnalysis))
        return value

    @property
    def component_multi_body_dynamics_analysis_load_cases(self) -> 'List[_5115.ShaftHubConnectionMultiBodyDynamicsAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentMultiBodyDynamicsAnalysisLoadCases, constructor.new(_5115.ShaftHubConnectionMultiBodyDynamicsAnalysis))
        return value
