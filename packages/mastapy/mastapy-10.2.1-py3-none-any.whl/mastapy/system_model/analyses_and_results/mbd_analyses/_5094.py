...
from mastapy.system_model.analyses_and_results.mbd_analyses import _5080, _5118, _5113
...
class MBDRunUpAnalysisOptions(_6535.AbstractAnalysisOptions['_6250.TimeSeriesLoadCase']):
    '''MBDRunUpAnalysisOptions
    ...
    @property
    def input_velocity_processing_type(self) -> '_5080.InputVelocityForRunUpProcessingType':
        ...
        return constructor.new(_5080.InputVelocityForRunUpProcessingType)(value) if value else None

    @input_velocity_processing_type.setter
    def input_velocity_processing_type(self, value: '_5080.InputVelocityForRunUpProcessingType'):
    ...
    @property
    def shape_of_initial_acceleration_period(self) -> '_5118.ShapeOfInitialAccelerationPeriodForRunUp':
        ...
        return constructor.new(_5118.ShapeOfInitialAccelerationPeriodForRunUp)(value) if value else None

    @shape_of_initial_acceleration_period.setter
    def shape_of_initial_acceleration_period(self, value: '_5118.ShapeOfInitialAccelerationPeriodForRunUp'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.ShapeOfInitialAccelerationPeriod = value

    @property
    def run_up_driving_mode(self) -> '_5113.RunUpDrivingMode':
        ...
        return constructor.new(_5113.RunUpDrivingMode)(value) if value else None

    @run_up_driving_mode.setter
    def run_up_driving_mode(self, value: '_5113.RunUpDrivingMode'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
