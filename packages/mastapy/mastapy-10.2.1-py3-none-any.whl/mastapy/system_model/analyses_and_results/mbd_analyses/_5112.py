...
from mastapy.system_model.analyses_and_results.mbd_analyses import _5097, _5020
...
class RootAssemblyMultiBodyDynamicsAnalysis(_5020.AssemblyMultiBodyDynamicsAnalysis):
    '''RootAssemblyMultiBodyDynamicsAnalysis
    ...
    @property
    def multi_body_dynamics_analysis_inputs(self) -> '_5097.MultiBodyDynamicsAnalysis':
        ...
        return constructor.new(_5097.MultiBodyDynamicsAnalysis)(self.wrapped.MultiBodyDynamicsAnalysisInputs) if self.wrapped.MultiBodyDynamicsAnalysisInputs else None
