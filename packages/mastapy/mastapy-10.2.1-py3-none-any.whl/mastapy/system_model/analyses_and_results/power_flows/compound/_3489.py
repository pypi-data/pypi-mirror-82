...
class StraightBevelGearCompoundPowerFlow(_3403.BevelGearCompoundPowerFlow):
    '''StraightBevelGearCompoundPowerFlow
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_3368.StraightBevelGearPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_3368.StraightBevelGearPowerFlow))
        return value

    @property
    def component_power_flow_load_cases(self) -> 'List[_3368.StraightBevelGearPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentPowerFlowLoadCases, constructor.new(_3368.StraightBevelGearPowerFlow))
        return value
