...
class PlanetaryConnectionCompoundPowerFlow(_3478.ShaftToMountableComponentConnectionCompoundPowerFlow):
    '''PlanetaryConnectionCompoundPowerFlow
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_3342.PlanetaryConnectionPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_3342.PlanetaryConnectionPowerFlow))
        return value

    @property
    def connection_power_flow_load_cases(self) -> 'List[_3342.PlanetaryConnectionPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionPowerFlowLoadCases, constructor.new(_3342.PlanetaryConnectionPowerFlow))
        return value
