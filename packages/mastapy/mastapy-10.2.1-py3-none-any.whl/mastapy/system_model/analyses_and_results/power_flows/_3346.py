...
class PowerFlow(_6549.StaticLoadAnalysisCase):
    '''PowerFlow
    ...
    @property
    def torsional_system_deflection(self) -> '_2383.TorsionalSystemDeflection':
        ...
        return constructor.new(_2383.TorsionalSystemDeflection)(self.wrapped.TorsionalSystemDeflection) if self.wrapped.TorsionalSystemDeflection else None
