...
from mastapy.system_model.analyses_and_results.power_flows import _3313, _3312, _3318
...
class FaceGearSetPowerFlow(_3318.GearSetPowerFlow):
    '''FaceGearSetPowerFlow
    ...
    @property
    def gears_power_flow(self) -> 'List[_3313.FaceGearPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.GearsPowerFlow, constructor.new(_3313.FaceGearPowerFlow))
        return value

    @property
    def face_gears_power_flow(self) -> 'List[_3313.FaceGearPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.FaceGearsPowerFlow, constructor.new(_3313.FaceGearPowerFlow))
        return value

    @property
    def meshes_power_flow(self) -> 'List[_3312.FaceGearMeshPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.MeshesPowerFlow, constructor.new(_3312.FaceGearMeshPowerFlow))
        return value

    @property
    def face_meshes_power_flow(self) -> 'List[_3312.FaceGearMeshPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.FaceMeshesPowerFlow, constructor.new(_3312.FaceGearMeshPowerFlow))
        return value
