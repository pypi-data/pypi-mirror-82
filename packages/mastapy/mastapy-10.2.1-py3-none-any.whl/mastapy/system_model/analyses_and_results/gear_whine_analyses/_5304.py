...
class AGMAGleasonConicalGearMeshGearWhineAnalysis(_5333.ConicalGearMeshGearWhineAnalysis):
    ...
    @property
    def connection_design(self) -> '_1902.AGMAGleasonConicalGearMesh':
    ...
    @property
    def system_deflection_results(self) -> '_2255.AGMAGleasonConicalGearMeshSystemDeflection':
