...
class FlexiblePinAssemblyGearWhineAnalysis(_5415.SpecialisedAssemblyGearWhineAnalysis):
    '''FlexiblePinAssemblyGearWhineAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2312.FlexiblePinAssemblySystemDeflection':
        ...
        return constructor.new(_2312.FlexiblePinAssemblySystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
