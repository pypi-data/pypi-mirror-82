...
class StraightBevelSunGearGearWhineAnalysis(_5423.StraightBevelDiffGearGearWhineAnalysis):
    '''StraightBevelSunGearGearWhineAnalysis
    ...
    @property
    def component_design(self) -> '_2134.StraightBevelSunGear':
        ...
        return constructor.new(_2134.StraightBevelSunGear)(self.wrapped.ComponentDesign) if self.wrapped.ComponentDesign else None

    @property
    def system_deflection_results(self) -> '_2371.StraightBevelSunGearSystemDeflection':
        ...
        return constructor.new(_2371.StraightBevelSunGearSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
