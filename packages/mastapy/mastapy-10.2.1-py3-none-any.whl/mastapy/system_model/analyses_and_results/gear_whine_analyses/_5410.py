...
from mastapy.system_model.analyses_and_results.gear_whine_analyses import _5372, _5306
...
class RootAssemblyGearWhineAnalysis(_5306.AssemblyGearWhineAnalysis):
    '''RootAssemblyGearWhineAnalysis
    ...
    @property
    def gear_whine_analysis_inputs(self) -> '_5372.GearWhineAnalysis':
        ...
        return constructor.new(_5372.GearWhineAnalysis)(self.wrapped.GearWhineAnalysisInputs) if self.wrapped.GearWhineAnalysisInputs else None

    @property
    def system_deflection_results(self) -> '_2351.RootAssemblySystemDeflection':
        ...
        return constructor.new(_2351.RootAssemblySystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
