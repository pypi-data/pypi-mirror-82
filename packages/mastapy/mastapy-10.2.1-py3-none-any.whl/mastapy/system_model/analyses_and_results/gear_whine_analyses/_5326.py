...
class ConceptCouplingConnectionGearWhineAnalysis(_5337.CouplingConnectionGearWhineAnalysis):
    '''ConceptCouplingConnectionGearWhineAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2278.ConceptCouplingConnectionSystemDeflection':
        ...
        return constructor.new(_2278.ConceptCouplingConnectionSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
