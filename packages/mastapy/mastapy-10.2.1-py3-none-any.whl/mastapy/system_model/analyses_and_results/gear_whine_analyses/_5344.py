...
from mastapy.system_model.analyses_and_results.system_deflections import _2296, _2297, _2298
...
class CylindricalGearMeshGearWhineAnalysis(_5368.GearMeshGearWhineAnalysis):
    '''CylindricalGearMeshGearWhineAnalysis
    ...
    @property
    def advanced_system_deflection_results(self) -> '_6330.CylindricalGearMeshAdvancedSystemDeflection':
        ...
        return constructor.new(_6330.CylindricalGearMeshAdvancedSystemDeflection)(self.wrapped.AdvancedSystemDeflectionResults) if self.wrapped.AdvancedSystemDeflectionResults else None
    ...
    @property
    def system_deflection_results(self) -> '_2296.CylindricalGearMeshSystemDeflection':
