...
from mastapy.system_model.analyses_and_results.gear_whine_analyses import (
    _5301, _5349, _5350, _5351,
    _5352, _5353, _5354, _5355,
    _5356, _5357, _5358, _5359,
    _5367, _5369, _5370, _5375,
    _5400, _5414, _5439
)
from mastapy._internal import constructor
from mastapy._internal.cast_exception import CastException
from mastapy.system_model.analyses_and_results.analysis_cases import _6549
...
class SingleMeshWhineAnalysis(_6549.StaticLoadAnalysisCase):
    '''SingleMeshWhineAnalysis
    ...
    @property
    def excitation_detail(self) -> '_5301.AbstractPeriodicExcitationDetail':
        ...
        if _5301.AbstractPeriodicExcitationDetail.TYPE not in self.wrapped.ExcitationDetail.__class__.__mro__:
    ...
    @property
    def excitation_detail_of_type_electric_machine_periodic_excitation_detail(self) -> '_5349.ElectricMachinePeriodicExcitationDetail':
        ...
        if _5349.ElectricMachinePeriodicExcitationDetail.TYPE not in self.wrapped.ExcitationDetail.__class__.__mro__:
    ...
    @property
    def excitation_detail_of_type_electric_machine_rotor_x_force_periodic_excitation_detail(self) -> '_5350.ElectricMachineRotorXForcePeriodicExcitationDetail':
        ...
        if _5350.ElectricMachineRotorXForcePeriodicExcitationDetail.TYPE not in self.wrapped.ExcitationDetail.__class__.__mro__:
    ...
    @property
    def excitation_detail_of_type_electric_machine_rotor_x_moment_periodic_excitation_detail(self) -> '_5351.ElectricMachineRotorXMomentPeriodicExcitationDetail':
        ...
        if _5351.ElectricMachineRotorXMomentPeriodicExcitationDetail.TYPE not in self.wrapped.ExcitationDetail.__class__.__mro__:
    ...
    @property
    def excitation_detail_of_type_electric_machine_rotor_y_force_periodic_excitation_detail(self) -> '_5352.ElectricMachineRotorYForcePeriodicExcitationDetail':
        ...
        if _5352.ElectricMachineRotorYForcePeriodicExcitationDetail.TYPE not in self.wrapped.ExcitationDetail.__class__.__mro__:
    ...
    @property
    def excitation_detail_of_type_electric_machine_rotor_y_moment_periodic_excitation_detail(self) -> '_5353.ElectricMachineRotorYMomentPeriodicExcitationDetail':
        ...
        if _5353.ElectricMachineRotorYMomentPeriodicExcitationDetail.TYPE not in self.wrapped.ExcitationDetail.__class__.__mro__:
    ...
    @property
    def excitation_detail_of_type_electric_machine_rotor_z_force_periodic_excitation_detail(self) -> '_5354.ElectricMachineRotorZForcePeriodicExcitationDetail':
        ...
        if _5354.ElectricMachineRotorZForcePeriodicExcitationDetail.TYPE not in self.wrapped.ExcitationDetail.__class__.__mro__:
    ...
    @property
    def excitation_detail_of_type_electric_machine_stator_tooth_axial_loads_excitation_detail(self) -> '_5355.ElectricMachineStatorToothAxialLoadsExcitationDetail':
        ...
        if _5355.ElectricMachineStatorToothAxialLoadsExcitationDetail.TYPE not in self.wrapped.ExcitationDetail.__class__.__mro__:
    ...
    @property
    def excitation_detail_of_type_electric_machine_stator_tooth_loads_excitation_detail(self) -> '_5356.ElectricMachineStatorToothLoadsExcitationDetail':
        ...
        if _5356.ElectricMachineStatorToothLoadsExcitationDetail.TYPE not in self.wrapped.ExcitationDetail.__class__.__mro__:
    ...
    @property
    def excitation_detail_of_type_electric_machine_stator_tooth_radial_loads_excitation_detail(self) -> '_5357.ElectricMachineStatorToothRadialLoadsExcitationDetail':
        ...
        if _5357.ElectricMachineStatorToothRadialLoadsExcitationDetail.TYPE not in self.wrapped.ExcitationDetail.__class__.__mro__:
    ...
    @property
    def excitation_detail_of_type_electric_machine_stator_tooth_tangential_loads_excitation_detail(self) -> '_5358.ElectricMachineStatorToothTangentialLoadsExcitationDetail':
        ...
        if _5358.ElectricMachineStatorToothTangentialLoadsExcitationDetail.TYPE not in self.wrapped.ExcitationDetail.__class__.__mro__:
    ...
    @property
    def excitation_detail_of_type_electric_machine_torque_ripple_periodic_excitation_detail(self) -> '_5359.ElectricMachineTorqueRipplePeriodicExcitationDetail':
        ...
        if _5359.ElectricMachineTorqueRipplePeriodicExcitationDetail.TYPE not in self.wrapped.ExcitationDetail.__class__.__mro__:
    ...
    @property
    def excitation_detail_of_type_gear_mesh_excitation_detail(self) -> '_5367.GearMeshExcitationDetail':
        ...
        if _5367.GearMeshExcitationDetail.TYPE not in self.wrapped.ExcitationDetail.__class__.__mro__:
    ...
    @property
    def excitation_detail_of_type_gear_mesh_misalignment_excitation_detail(self) -> '_5369.GearMeshMisalignmentExcitationDetail':
        ...
        if _5369.GearMeshMisalignmentExcitationDetail.TYPE not in self.wrapped.ExcitationDetail.__class__.__mro__:
    ...
    @property
    def excitation_detail_of_type_gear_mesh_te_excitation_detail(self) -> '_5370.GearMeshTEExcitationDetail':
        ...
        if _5370.GearMeshTEExcitationDetail.TYPE not in self.wrapped.ExcitationDetail.__class__.__mro__:
    ...
    @property
    def excitation_detail_of_type_general_periodic_excitation_detail(self) -> '_5375.GeneralPeriodicExcitationDetail':
        ...
        if _5375.GeneralPeriodicExcitationDetail.TYPE not in self.wrapped.ExcitationDetail.__class__.__mro__:
    ...
    @property
    def excitation_detail_of_type_periodic_excitation_with_reference_shaft(self) -> '_5400.PeriodicExcitationWithReferenceShaft':
        ...
        if _5400.PeriodicExcitationWithReferenceShaft.TYPE not in self.wrapped.ExcitationDetail.__class__.__mro__:
    ...
    @property
    def excitation_detail_of_type_single_node_periodic_excitation_with_reference_shaft(self) -> '_5414.SingleNodePeriodicExcitationWithReferenceShaft':
        ...
        if _5414.SingleNodePeriodicExcitationWithReferenceShaft.TYPE not in self.wrapped.ExcitationDetail.__class__.__mro__:
    ...
    @property
    def excitation_detail_of_type_unbalanced_mass_excitation_detail(self) -> '_5439.UnbalancedMassExcitationDetail':
        ...
        if _5439.UnbalancedMassExcitationDetail.TYPE not in self.wrapped.ExcitationDetail.__class__.__mro__:
