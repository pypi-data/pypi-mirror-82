...
from mastapy.system_model.analyses_and_results.gear_whine_analyses.single_mesh_whine_analyses.compound import _5683, _5684, _5599
...
class StraightBevelGearSetCompoundSingleMeshWhineAnalysis(_5599.BevelGearSetCompoundSingleMeshWhineAnalysis):
    '''StraightBevelGearSetCompoundSingleMeshWhineAnalysis
    ...
    @property
    def straight_bevel_gears_compound_single_mesh_whine_analysis(self) -> 'List[_5683.StraightBevelGearCompoundSingleMeshWhineAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StraightBevelGearsCompoundSingleMeshWhineAnalysis, constructor.new(_5683.StraightBevelGearCompoundSingleMeshWhineAnalysis))
        return value

    @property
    def straight_bevel_meshes_compound_single_mesh_whine_analysis(self) -> 'List[_5684.StraightBevelGearMeshCompoundSingleMeshWhineAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StraightBevelMeshesCompoundSingleMeshWhineAnalysis, constructor.new(_5684.StraightBevelGearMeshCompoundSingleMeshWhineAnalysis))
        return value

    @property
    def load_case_analyses_ready(self) -> 'List[_5563.StraightBevelGearSetSingleMeshWhineAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_5563.StraightBevelGearSetSingleMeshWhineAnalysis))
        return value

    @property
    def assembly_single_mesh_whine_analysis_load_cases(self) -> 'List[_5563.StraightBevelGearSetSingleMeshWhineAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblySingleMeshWhineAnalysisLoadCases, constructor.new(_5563.StraightBevelGearSetSingleMeshWhineAnalysis))
        return value
