...
class CVTGearWhineAnalysis(_5309.BeltDriveGearWhineAnalysis):
    '''CVTGearWhineAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2295.CVTSystemDeflection':
        ...
        return constructor.new(_2295.CVTSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
