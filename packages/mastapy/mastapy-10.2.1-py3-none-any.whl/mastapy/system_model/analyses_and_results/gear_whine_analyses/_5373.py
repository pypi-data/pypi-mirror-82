...
class GearWhineAnalysisFEExportOptions(_0.APIBase):
    ...
    @property
    def analysis_options(self) -> '_5374.GearWhineAnalysisOptions':
        ...
        return constructor.new(_5374.GearWhineAnalysisOptions)(self.wrapped.AnalysisOptions) if self.wrapped.AnalysisOptions else None
    ...
    @property
    def eigenvalue_options(self) -> '_1477.EigenvalueOptions':
        ...
        return constructor.new(_1477.EigenvalueOptions)(self.wrapped.EigenvalueOptions) if self.wrapped.EigenvalueOptions else None
