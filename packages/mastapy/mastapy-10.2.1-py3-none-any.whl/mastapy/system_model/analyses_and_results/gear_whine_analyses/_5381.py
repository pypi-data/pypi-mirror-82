...
from mastapy.system_model.analyses_and_results.gear_whine_analyses import _5373, _5302
...
class ImportedFEComponentGearWhineAnalysis(_5302.AbstractShaftOrHousingGearWhineAnalysis):
    '''ImportedFEComponentGearWhineAnalysis
    ...
    @property
    def coupled_modal_analysis(self) -> '_4807.ImportedFEComponentModalAnalysis':
        ...
        return constructor.new(_4807.ImportedFEComponentModalAnalysis)(self.wrapped.CoupledModalAnalysis) if self.wrapped.CoupledModalAnalysis else None

    @property
    def export(self) -> '_5373.GearWhineAnalysisFEExportOptions':
        ...
        return constructor.new(_5373.GearWhineAnalysisFEExportOptions)(self.wrapped.Export) if self.wrapped.Export else None
    ...
    @property
    def system_deflection_results(self) -> '_2320.ImportedFEComponentSystemDeflection':
        ...
        return constructor.new(_2320.ImportedFEComponentSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
