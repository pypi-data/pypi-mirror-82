...
from mastapy.system_model.analyses_and_results.static_loads import _6219, _6142
from mastapy.system_model.analyses_and_results.system_deflections import _2347, _2294
...
class PulleyGearWhineAnalysis(_5339.CouplingHalfGearWhineAnalysis):
    '''PulleyGearWhineAnalysis
    ...
    @property
    def component_load_case(self) -> '_6219.PulleyLoadCase':
        ...
        if _6219.PulleyLoadCase.TYPE not in self.wrapped.ComponentLoadCase.__class__.__mro__:
    ...
    @property
    def system_deflection_results(self) -> '_2347.PulleySystemDeflection':
