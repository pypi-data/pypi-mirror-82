...
class ConceptGearGearWhineAnalysis(_5366.GearGearWhineAnalysis):
    '''ConceptGearGearWhineAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2283.ConceptGearSystemDeflection':
        ...
        return constructor.new(_2283.ConceptGearSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
