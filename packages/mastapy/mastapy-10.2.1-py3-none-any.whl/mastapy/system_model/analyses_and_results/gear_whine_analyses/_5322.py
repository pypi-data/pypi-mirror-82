...
class ClutchHalfGearWhineAnalysis(_5339.CouplingHalfGearWhineAnalysis):
    '''ClutchHalfGearWhineAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2273.ClutchHalfSystemDeflection':
        ...
        return constructor.new(_2273.ClutchHalfSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
