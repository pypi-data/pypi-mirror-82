...
from mastapy.utility.units_and_measurements.measurements import _1226, _1179
...
class ShaftForcedComplexShape(_3259.ShaftComplexShape['_1226.LengthVeryShort', '_1179.AngleSmall']):
    '''ShaftForcedComplexShape
