...
from mastapy.system_model.analyses_and_results.steady_state_synchronous_responses import _3062, _3060, _3065
...
class FaceGearSetSteadyStateSynchronousResponse(_3065.GearSetSteadyStateSynchronousResponse):
    '''FaceGearSetSteadyStateSynchronousResponse
    ...
    @property
    def face_gears_steady_state_synchronous_response(self) -> 'List[_3062.FaceGearSteadyStateSynchronousResponse]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.FaceGearsSteadyStateSynchronousResponse, constructor.new(_3062.FaceGearSteadyStateSynchronousResponse))
        return value

    @property
    def face_meshes_steady_state_synchronous_response(self) -> 'List[_3060.FaceGearMeshSteadyStateSynchronousResponse]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.FaceMeshesSteadyStateSynchronousResponse, constructor.new(_3060.FaceGearMeshSteadyStateSynchronousResponse))
        return value
