...
from mastapy.system_model.analyses_and_results.steady_state_synchronous_responses import _3133, _3131, _3065
...
class WormGearSetSteadyStateSynchronousResponse(_3065.GearSetSteadyStateSynchronousResponse):
    '''WormGearSetSteadyStateSynchronousResponse
    ...
    @property
    def worm_gears_steady_state_synchronous_response(self) -> 'List[_3133.WormGearSteadyStateSynchronousResponse]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.WormGearsSteadyStateSynchronousResponse, constructor.new(_3133.WormGearSteadyStateSynchronousResponse))
        return value

    @property
    def worm_meshes_steady_state_synchronous_response(self) -> 'List[_3131.WormGearMeshSteadyStateSynchronousResponse]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.WormMeshesSteadyStateSynchronousResponse, constructor.new(_3131.WormGearMeshSteadyStateSynchronousResponse))
        return value
