...
class GuideDxfModelCompoundSteadyStateSynchronousResponse(_3160.ComponentCompoundSteadyStateSynchronousResponse):
    '''GuideDxfModelCompoundSteadyStateSynchronousResponse
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_3067.GuideDxfModelSteadyStateSynchronousResponse]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_3067.GuideDxfModelSteadyStateSynchronousResponse))
        return value

    @property
    def component_steady_state_synchronous_response_load_cases(self) -> 'List[_3067.GuideDxfModelSteadyStateSynchronousResponse]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentSteadyStateSynchronousResponseLoadCases, constructor.new(_3067.GuideDxfModelSteadyStateSynchronousResponse))
        return value
