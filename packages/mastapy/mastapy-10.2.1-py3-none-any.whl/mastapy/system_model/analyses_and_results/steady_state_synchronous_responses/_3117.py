...
from mastapy.system_model.analyses_and_results.steady_state_synchronous_responses import _3118, _3116, _3027
...
class StraightBevelGearSetSteadyStateSynchronousResponse(_3027.BevelGearSetSteadyStateSynchronousResponse):
    '''StraightBevelGearSetSteadyStateSynchronousResponse
    ...
    @property
    def straight_bevel_gears_steady_state_synchronous_response(self) -> 'List[_3118.StraightBevelGearSteadyStateSynchronousResponse]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StraightBevelGearsSteadyStateSynchronousResponse, constructor.new(_3118.StraightBevelGearSteadyStateSynchronousResponse))
        return value

    @property
    def straight_bevel_meshes_steady_state_synchronous_response(self) -> 'List[_3116.StraightBevelGearMeshSteadyStateSynchronousResponse]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StraightBevelMeshesSteadyStateSynchronousResponse, constructor.new(_3116.StraightBevelGearMeshSteadyStateSynchronousResponse))
        return value
