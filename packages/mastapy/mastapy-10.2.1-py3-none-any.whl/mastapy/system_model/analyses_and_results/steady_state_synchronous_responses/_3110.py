...
class SteadyStateSynchronousResponse(_6536.CompoundAnalysisCase):
    '''SteadyStateSynchronousResponse
    ...
    @property
    def steady_state_analysis_options(self) -> '_3112.SteadyStateSynchronousResponseOptions':
        ...
        return constructor.new(_3112.SteadyStateSynchronousResponseOptions)(self.wrapped.SteadyStateAnalysisOptions) if self.wrapped.SteadyStateAnalysisOptions else None
