...
from mastapy.system_model.analyses_and_results.steady_state_synchronous_responses import _3078, _3076, _3074
...
class KlingelnbergCycloPalloidHypoidGearSetSteadyStateSynchronousResponse(_3074.KlingelnbergCycloPalloidConicalGearSetSteadyStateSynchronousResponse):
    '''KlingelnbergCycloPalloidHypoidGearSetSteadyStateSynchronousResponse
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_gears_steady_state_synchronous_response(self) -> 'List[_3078.KlingelnbergCycloPalloidHypoidGearSteadyStateSynchronousResponse]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.KlingelnbergCycloPalloidHypoidGearsSteadyStateSynchronousResponse, constructor.new(_3078.KlingelnbergCycloPalloidHypoidGearSteadyStateSynchronousResponse))
        return value

    @property
    def klingelnberg_cyclo_palloid_hypoid_meshes_steady_state_synchronous_response(self) -> 'List[_3076.KlingelnbergCycloPalloidHypoidGearMeshSteadyStateSynchronousResponse]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.KlingelnbergCycloPalloidHypoidMeshesSteadyStateSynchronousResponse, constructor.new(_3076.KlingelnbergCycloPalloidHypoidGearMeshSteadyStateSynchronousResponse))
        return value
