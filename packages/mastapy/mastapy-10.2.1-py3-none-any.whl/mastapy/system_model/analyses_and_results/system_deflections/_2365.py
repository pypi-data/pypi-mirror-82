...
from mastapy.system_model.analyses_and_results.system_deflections import _2366, _2364, _2268
...
class StraightBevelDiffGearSetSystemDeflection(_2268.BevelGearSetSystemDeflection):
    '''StraightBevelDiffGearSetSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3366.StraightBevelDiffGearSetPowerFlow':
        ...
        return constructor.new(_3366.StraightBevelDiffGearSetPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
    ...
    @property
    def straight_bevel_diff_meshes_system_deflection(self) -> 'List[_2364.StraightBevelDiffGearMeshSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StraightBevelDiffMeshesSystemDeflection, constructor.new(_2364.StraightBevelDiffGearMeshSystemDeflection))
        return value
