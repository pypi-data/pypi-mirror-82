...
from mastapy.system_model.analyses_and_results.system_deflections import _2331, _2378
...
class SystemDeflection(_6543.FEAnalysis):
    '''SystemDeflection
    ...
    @property
    def overall_efficiency_results(self) -> '_2331.LoadCaseOverallEfficiencyResult':
        ...
        return constructor.new(_2331.LoadCaseOverallEfficiencyResult)(self.wrapped.OverallEfficiencyResults) if self.wrapped.OverallEfficiencyResults else None

    @property
    def analysis_options(self) -> '_2378.SystemDeflectionOptions':
        ...
        return constructor.new(_2378.SystemDeflectionOptions)(self.wrapped.AnalysisOptions) if self.wrapped.AnalysisOptions else None
