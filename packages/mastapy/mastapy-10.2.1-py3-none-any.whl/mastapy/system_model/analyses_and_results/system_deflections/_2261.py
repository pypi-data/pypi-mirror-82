...
from mastapy.system_model.analyses_and_results.power_flows import _3272, _3303
from mastapy.system_model.analyses_and_results.system_deflections import _2260, _2357
...
class BeltDriveSystemDeflection(_2357.SpecialisedAssemblySystemDeflection):
    '''BeltDriveSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3272.BeltDrivePowerFlow':
    ...
    @property
    def belts(self) -> 'List[_2260.BeltConnectionSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Belts, constructor.new(_2260.BeltConnectionSystemDeflection))
        return value
