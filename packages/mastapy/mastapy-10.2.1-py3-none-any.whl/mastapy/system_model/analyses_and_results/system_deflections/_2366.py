...
from mastapy.system_model.analyses_and_results.static_loads import _6237, _6243, _6244
from mastapy.system_model.analyses_and_results.power_flows import _3365, _3370, _3371
...
class StraightBevelDiffGearSystemDeflection(_2269.BevelGearSystemDeflection):
    '''StraightBevelDiffGearSystemDeflection
    ...
    @property
    def component_load_case(self) -> '_6237.StraightBevelDiffGearLoadCase':
        ...
        if _6237.StraightBevelDiffGearLoadCase.TYPE not in self.wrapped.ComponentLoadCase.__class__.__mro__:
    ...
    @property
    def power_flow_results(self) -> '_3365.StraightBevelDiffGearPowerFlow':
