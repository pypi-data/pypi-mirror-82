...
from mastapy.system_model.analyses_and_results.power_flows import _3307, _3309
...
class CylindricalGearSystemDeflection(_2315.GearSystemDeflection):
    '''CylindricalGearSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3307.CylindricalGearPowerFlow':
