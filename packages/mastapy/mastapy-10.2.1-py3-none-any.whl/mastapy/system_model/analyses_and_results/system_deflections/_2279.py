...
class ConceptCouplingHalfSystemDeflection(_2291.CouplingHalfSystemDeflection):
    '''ConceptCouplingHalfSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3289.ConceptCouplingHalfPowerFlow':
        ...
        return constructor.new(_3289.ConceptCouplingHalfPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
