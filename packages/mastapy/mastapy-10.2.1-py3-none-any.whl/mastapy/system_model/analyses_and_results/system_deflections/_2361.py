...
class SpringDamperConnectionSystemDeflection(_2290.CouplingConnectionSystemDeflection):
    '''SpringDamperConnectionSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3361.SpringDamperConnectionPowerFlow':
        ...
        return constructor.new(_3361.SpringDamperConnectionPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
