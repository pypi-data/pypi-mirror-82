...
class SpiralBevelGearMeshSystemDeflection(_2267.BevelGearMeshSystemDeflection):
    '''SpiralBevelGearMeshSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3358.SpiralBevelGearMeshPowerFlow':
        ...
        return constructor.new(_3358.SpiralBevelGearMeshPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
