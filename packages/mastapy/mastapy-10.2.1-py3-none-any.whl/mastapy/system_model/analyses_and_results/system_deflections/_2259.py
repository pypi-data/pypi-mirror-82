...
from mastapy.system_model.part_model import _2028, _2029
...
from mastapy.math_utility.measured_vectors import _1138, _1134
from mastapy.bearings.bearing_results import (
    _1601, _1606, _1608, _1609,
    _1610, _1611, _1612, _1614
)
from mastapy._internal.cast_exception import CastException
from mastapy.bearings.bearing_results.rolling import (
    _1633, _1636, _1639, _1644,
    _1647, _1652, _1655, _1659,
    _1662, _1667, _1671, _1674,
    _1679, _1683, _1686, _1690,
    _1693, _1699, _1702, _1705,
    _1708
)
from mastapy.bearings.bearing_results.fluid_film import (
    _1761, _1762, _1763, _1765,
    _1768, _1769
)
...
class BearingSystemDeflection(_2289.ConnectorSystemDeflection):
    '''BearingSystemDeflection
    ...
    @property
    def component_design(self) -> '_2028.Bearing':
        ...
        return constructor.new(_2028.Bearing)(self.wrapped.ComponentDesign) if self.wrapped.ComponentDesign else None
    ...
    @property
    def power_flow_results(self) -> '_3270.BearingPowerFlow':
        ...
        return constructor.new(_3270.BearingPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None

    @property
    def relative_displacement_in_wcs(self) -> '_1138.VectorWithLinearAndAngularComponents':
        ...
        return constructor.new(_1138.VectorWithLinearAndAngularComponents)(self.wrapped.RelativeDisplacementInWCS) if self.wrapped.RelativeDisplacementInWCS else None

    @property
    def relative_displacement_in_lcs(self) -> '_1138.VectorWithLinearAndAngularComponents':
        ...
        return constructor.new(_1138.VectorWithLinearAndAngularComponents)(self.wrapped.RelativeDisplacementInLCS) if self.wrapped.RelativeDisplacementInLCS else None

    @property
    def stiffness_between_rings(self) -> '_1601.BearingStiffnessMatrixReporter':
        ...
        return constructor.new(_1601.BearingStiffnessMatrixReporter)(self.wrapped.StiffnessBetweenRings) if self.wrapped.StiffnessBetweenRings else None

    @property
    def stiffness_matrix(self) -> '_1601.BearingStiffnessMatrixReporter':
        ...
        return constructor.new(_1601.BearingStiffnessMatrixReporter)(self.wrapped.StiffnessMatrix) if self.wrapped.StiffnessMatrix else None

    @property
    def outer_left_mounting_stiffness(self) -> '_1601.BearingStiffnessMatrixReporter':
        ...
        return constructor.new(_1601.BearingStiffnessMatrixReporter)(self.wrapped.OuterLeftMountingStiffness) if self.wrapped.OuterLeftMountingStiffness else None

    @property
    def outer_right_mounting_stiffness(self) -> '_1601.BearingStiffnessMatrixReporter':
        ...
        return constructor.new(_1601.BearingStiffnessMatrixReporter)(self.wrapped.OuterRightMountingStiffness) if self.wrapped.OuterRightMountingStiffness else None

    @property
    def inner_left_mounting_stiffness(self) -> '_1601.BearingStiffnessMatrixReporter':
        ...
        return constructor.new(_1601.BearingStiffnessMatrixReporter)(self.wrapped.InnerLeftMountingStiffness) if self.wrapped.InnerLeftMountingStiffness else None

    @property
    def inner_right_mounting_stiffness(self) -> '_1601.BearingStiffnessMatrixReporter':
        ...
        return constructor.new(_1601.BearingStiffnessMatrixReporter)(self.wrapped.InnerRightMountingStiffness) if self.wrapped.InnerRightMountingStiffness else None

    @property
    def inner_radial_mounting_stiffness(self) -> '_1601.BearingStiffnessMatrixReporter':
        ...
        return constructor.new(_1601.BearingStiffnessMatrixReporter)(self.wrapped.InnerRadialMountingStiffness) if self.wrapped.InnerRadialMountingStiffness else None

    @property
    def outer_radial_mounting_stiffness(self) -> '_1601.BearingStiffnessMatrixReporter':
        ...
        return constructor.new(_1601.BearingStiffnessMatrixReporter)(self.wrapped.OuterRadialMountingStiffness) if self.wrapped.OuterRadialMountingStiffness else None

    @property
    def preload_spring_stiffness(self) -> '_1601.BearingStiffnessMatrixReporter':
        ...
        return constructor.new(_1601.BearingStiffnessMatrixReporter)(self.wrapped.PreloadSpringStiffness) if self.wrapped.PreloadSpringStiffness else None

    @property
    def component_detailed_analysis(self) -> '_1606.LoadedBearingResults':
        ...
        if _1606.LoadedBearingResults.TYPE not in self.wrapped.ComponentDetailedAnalysis.__class__.__mro__:
    ...
    @property
    def component_detailed_analysis_of_type_loaded_concept_axial_clearance_bearing_results(self) -> '_1608.LoadedConceptAxialClearanceBearingResults':
        ...
        if _1608.LoadedConceptAxialClearanceBearingResults.TYPE not in self.wrapped.ComponentDetailedAnalysis.__class__.__mro__:
    ...
    @property
    def component_detailed_analysis_of_type_loaded_concept_clearance_bearing_results(self) -> '_1609.LoadedConceptClearanceBearingResults':
        ...
        if _1609.LoadedConceptClearanceBearingResults.TYPE not in self.wrapped.ComponentDetailedAnalysis.__class__.__mro__:
    ...
    @property
    def component_detailed_analysis_of_type_loaded_concept_radial_clearance_bearing_results(self) -> '_1610.LoadedConceptRadialClearanceBearingResults':
        ...
        if _1610.LoadedConceptRadialClearanceBearingResults.TYPE not in self.wrapped.ComponentDetailedAnalysis.__class__.__mro__:
    ...
    @property
    def component_detailed_analysis_of_type_loaded_detailed_bearing_results(self) -> '_1611.LoadedDetailedBearingResults':
        ...
        if _1611.LoadedDetailedBearingResults.TYPE not in self.wrapped.ComponentDetailedAnalysis.__class__.__mro__:
    ...
    @property
    def component_detailed_analysis_of_type_loaded_linear_bearing_results(self) -> '_1612.LoadedLinearBearingResults':
        ...
        if _1612.LoadedLinearBearingResults.TYPE not in self.wrapped.ComponentDetailedAnalysis.__class__.__mro__:
    ...
    @property
    def component_detailed_analysis_of_type_loaded_non_linear_bearing_results(self) -> '_1614.LoadedNonLinearBearingResults':
        ...
        if _1614.LoadedNonLinearBearingResults.TYPE not in self.wrapped.ComponentDetailedAnalysis.__class__.__mro__:
    ...
    @property
    def component_detailed_analysis_of_type_loaded_angular_contact_ball_bearing_results(self) -> '_1633.LoadedAngularContactBallBearingResults':
        ...
        if _1633.LoadedAngularContactBallBearingResults.TYPE not in self.wrapped.ComponentDetailedAnalysis.__class__.__mro__:
    ...
    @property
    def component_detailed_analysis_of_type_loaded_angular_contact_thrust_ball_bearing_results(self) -> '_1636.LoadedAngularContactThrustBallBearingResults':
        ...
        if _1636.LoadedAngularContactThrustBallBearingResults.TYPE not in self.wrapped.ComponentDetailedAnalysis.__class__.__mro__:
    ...
    @property
    def component_detailed_analysis_of_type_loaded_asymmetric_spherical_roller_bearing_results(self) -> '_1639.LoadedAsymmetricSphericalRollerBearingResults':
        ...
        if _1639.LoadedAsymmetricSphericalRollerBearingResults.TYPE not in self.wrapped.ComponentDetailedAnalysis.__class__.__mro__:
    ...
    @property
    def component_detailed_analysis_of_type_loaded_axial_thrust_cylindrical_roller_bearing_results(self) -> '_1644.LoadedAxialThrustCylindricalRollerBearingResults':
        ...
        if _1644.LoadedAxialThrustCylindricalRollerBearingResults.TYPE not in self.wrapped.ComponentDetailedAnalysis.__class__.__mro__:
    ...
    @property
    def component_detailed_analysis_of_type_loaded_axial_thrust_needle_roller_bearing_results(self) -> '_1647.LoadedAxialThrustNeedleRollerBearingResults':
        ...
        if _1647.LoadedAxialThrustNeedleRollerBearingResults.TYPE not in self.wrapped.ComponentDetailedAnalysis.__class__.__mro__:
    ...
    @property
    def component_detailed_analysis_of_type_loaded_ball_bearing_results(self) -> '_1652.LoadedBallBearingResults':
        ...
        if _1652.LoadedBallBearingResults.TYPE not in self.wrapped.ComponentDetailedAnalysis.__class__.__mro__:
    ...
    @property
    def component_detailed_analysis_of_type_loaded_crossed_roller_bearing_results(self) -> '_1655.LoadedCrossedRollerBearingResults':
        ...
        if _1655.LoadedCrossedRollerBearingResults.TYPE not in self.wrapped.ComponentDetailedAnalysis.__class__.__mro__:
    ...
    @property
    def component_detailed_analysis_of_type_loaded_cylindrical_roller_bearing_results(self) -> '_1659.LoadedCylindricalRollerBearingResults':
        ...
        if _1659.LoadedCylindricalRollerBearingResults.TYPE not in self.wrapped.ComponentDetailedAnalysis.__class__.__mro__:
    ...
    @property
    def component_detailed_analysis_of_type_loaded_deep_groove_ball_bearing_results(self) -> '_1662.LoadedDeepGrooveBallBearingResults':
        ...
        if _1662.LoadedDeepGrooveBallBearingResults.TYPE not in self.wrapped.ComponentDetailedAnalysis.__class__.__mro__:
    ...
    @property
    def component_detailed_analysis_of_type_loaded_four_point_contact_ball_bearing_results(self) -> '_1667.LoadedFourPointContactBallBearingResults':
        ...
        if _1667.LoadedFourPointContactBallBearingResults.TYPE not in self.wrapped.ComponentDetailedAnalysis.__class__.__mro__:
    ...
    @property
    def component_detailed_analysis_of_type_loaded_needle_roller_bearing_results(self) -> '_1671.LoadedNeedleRollerBearingResults':
        ...
        if _1671.LoadedNeedleRollerBearingResults.TYPE not in self.wrapped.ComponentDetailedAnalysis.__class__.__mro__:
    ...
    @property
    def component_detailed_analysis_of_type_loaded_non_barrel_roller_bearing_results(self) -> '_1674.LoadedNonBarrelRollerBearingResults':
        ...
        if _1674.LoadedNonBarrelRollerBearingResults.TYPE not in self.wrapped.ComponentDetailedAnalysis.__class__.__mro__:
    ...
    @property
    def component_detailed_analysis_of_type_loaded_roller_bearing_results(self) -> '_1679.LoadedRollerBearingResults':
        ...
        if _1679.LoadedRollerBearingResults.TYPE not in self.wrapped.ComponentDetailedAnalysis.__class__.__mro__:
    ...
    @property
    def component_detailed_analysis_of_type_loaded_rolling_bearing_results(self) -> '_1683.LoadedRollingBearingResults':
        ...
        if _1683.LoadedRollingBearingResults.TYPE not in self.wrapped.ComponentDetailedAnalysis.__class__.__mro__:
    ...
    @property
    def component_detailed_analysis_of_type_loaded_self_aligning_ball_bearing_results(self) -> '_1686.LoadedSelfAligningBallBearingResults':
        ...
        if _1686.LoadedSelfAligningBallBearingResults.TYPE not in self.wrapped.ComponentDetailedAnalysis.__class__.__mro__:
    ...
    @property
    def component_detailed_analysis_of_type_loaded_spherical_roller_radial_bearing_results(self) -> '_1690.LoadedSphericalRollerRadialBearingResults':
        ...
        if _1690.LoadedSphericalRollerRadialBearingResults.TYPE not in self.wrapped.ComponentDetailedAnalysis.__class__.__mro__:
    ...
    @property
    def component_detailed_analysis_of_type_loaded_spherical_roller_thrust_bearing_results(self) -> '_1693.LoadedSphericalRollerThrustBearingResults':
        ...
        if _1693.LoadedSphericalRollerThrustBearingResults.TYPE not in self.wrapped.ComponentDetailedAnalysis.__class__.__mro__:
    ...
    @property
    def component_detailed_analysis_of_type_loaded_taper_roller_bearing_results(self) -> '_1699.LoadedTaperRollerBearingResults':
        ...
        if _1699.LoadedTaperRollerBearingResults.TYPE not in self.wrapped.ComponentDetailedAnalysis.__class__.__mro__:
    ...
    @property
    def component_detailed_analysis_of_type_loaded_three_point_contact_ball_bearing_results(self) -> '_1702.LoadedThreePointContactBallBearingResults':
        ...
        if _1702.LoadedThreePointContactBallBearingResults.TYPE not in self.wrapped.ComponentDetailedAnalysis.__class__.__mro__:
    ...
    @property
    def component_detailed_analysis_of_type_loaded_thrust_ball_bearing_results(self) -> '_1705.LoadedThrustBallBearingResults':
        ...
        if _1705.LoadedThrustBallBearingResults.TYPE not in self.wrapped.ComponentDetailedAnalysis.__class__.__mro__:
    ...
    @property
    def component_detailed_analysis_of_type_loaded_toroidal_roller_bearing_results(self) -> '_1708.LoadedToroidalRollerBearingResults':
        ...
        if _1708.LoadedToroidalRollerBearingResults.TYPE not in self.wrapped.ComponentDetailedAnalysis.__class__.__mro__:
    ...
    @property
    def component_detailed_analysis_of_type_loaded_grease_filled_journal_bearing_results(self) -> '_1761.LoadedGreaseFilledJournalBearingResults':
        ...
        if _1761.LoadedGreaseFilledJournalBearingResults.TYPE not in self.wrapped.ComponentDetailedAnalysis.__class__.__mro__:
    ...
    @property
    def component_detailed_analysis_of_type_loaded_pad_fluid_film_bearing_results(self) -> '_1762.LoadedPadFluidFilmBearingResults':
        ...
        if _1762.LoadedPadFluidFilmBearingResults.TYPE not in self.wrapped.ComponentDetailedAnalysis.__class__.__mro__:
    ...
    @property
    def component_detailed_analysis_of_type_loaded_plain_journal_bearing_results(self) -> '_1763.LoadedPlainJournalBearingResults':
        ...
        if _1763.LoadedPlainJournalBearingResults.TYPE not in self.wrapped.ComponentDetailedAnalysis.__class__.__mro__:
    ...
    @property
    def component_detailed_analysis_of_type_loaded_plain_oil_fed_journal_bearing(self) -> '_1765.LoadedPlainOilFedJournalBearing':
        ...
        if _1765.LoadedPlainOilFedJournalBearing.TYPE not in self.wrapped.ComponentDetailedAnalysis.__class__.__mro__:
    ...
    @property
    def component_detailed_analysis_of_type_loaded_tilting_pad_journal_bearing_results(self) -> '_1768.LoadedTiltingPadJournalBearingResults':
        ...
        if _1768.LoadedTiltingPadJournalBearingResults.TYPE not in self.wrapped.ComponentDetailedAnalysis.__class__.__mro__:
    ...
    @property
    def component_detailed_analysis_of_type_loaded_tilting_pad_thrust_bearing_results(self) -> '_1769.LoadedTiltingPadThrustBearingResults':
        ...
        if _1769.LoadedTiltingPadThrustBearingResults.TYPE not in self.wrapped.ComponentDetailedAnalysis.__class__.__mro__:
    ...
    @property
    def race_mounting_options_for_analysis(self) -> 'List[_2029.BearingRaceMountingOptions]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.RaceMountingOptionsForAnalysis, constructor.new(_2029.BearingRaceMountingOptions))
        return value
