...
class WormGearSystemDeflection(_2315.GearSystemDeflection):
    '''WormGearSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3384.WormGearPowerFlow':
        ...
        return constructor.new(_3384.WormGearPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
