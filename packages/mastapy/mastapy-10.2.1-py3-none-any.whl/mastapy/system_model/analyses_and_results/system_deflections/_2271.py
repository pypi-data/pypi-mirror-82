...
class BoltSystemDeflection(_2276.ComponentSystemDeflection):
    '''BoltSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3282.BoltPowerFlow':
        ...
        return constructor.new(_3282.BoltPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
