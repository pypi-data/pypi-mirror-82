...
class PlanetaryConnectionSystemDeflection(_2356.ShaftToMountableComponentConnectionSystemDeflection):
    '''PlanetaryConnectionSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3342.PlanetaryConnectionPowerFlow':
        ...
        return constructor.new(_3342.PlanetaryConnectionPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
