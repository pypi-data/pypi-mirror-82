...
from mastapy.nodal_analysis.nodal_entities import _1449
...
class ShaftSectionSystemDeflection(_1449.Bar):
    '''ShaftSectionSystemDeflection
    ...
    @property
    def left_end(self) -> '_2353.ShaftSectionEndResultsSystemDeflection':
        ...
        return constructor.new(_2353.ShaftSectionEndResultsSystemDeflection)(self.wrapped.LeftEnd) if self.wrapped.LeftEnd else None

    @property
    def right_end(self) -> '_2353.ShaftSectionEndResultsSystemDeflection':
        ...
        return constructor.new(_2353.ShaftSectionEndResultsSystemDeflection)(self.wrapped.RightEnd) if self.wrapped.RightEnd else None
