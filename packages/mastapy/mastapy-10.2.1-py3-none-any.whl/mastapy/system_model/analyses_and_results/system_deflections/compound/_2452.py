...
from mastapy.system_model.analyses_and_results.system_deflections.compound import _2450, _2451, _2456
...
class FaceGearSetCompoundSystemDeflection(_2456.GearSetCompoundSystemDeflection):
    '''FaceGearSetCompoundSystemDeflection
    ...
    @property
    def face_gears_compound_system_deflection(self) -> 'List[_2450.FaceGearCompoundSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.FaceGearsCompoundSystemDeflection, constructor.new(_2450.FaceGearCompoundSystemDeflection))
        return value

    @property
    def face_meshes_compound_system_deflection(self) -> 'List[_2451.FaceGearMeshCompoundSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.FaceMeshesCompoundSystemDeflection, constructor.new(_2451.FaceGearMeshCompoundSystemDeflection))
        return value

    @property
    def load_case_analyses_ready(self) -> 'List[_2310.FaceGearSetSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_2310.FaceGearSetSystemDeflection))
        return value

    @property
    def assembly_system_deflection_load_cases(self) -> 'List[_2310.FaceGearSetSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblySystemDeflectionLoadCases, constructor.new(_2310.FaceGearSetSystemDeflection))
        return value
