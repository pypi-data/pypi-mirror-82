...
from mastapy.system_model.analyses_and_results.system_deflections.compound import _2476
...
class AbstractAssemblyCompoundSystemDeflection(_2476.PartCompoundSystemDeflection):
    '''AbstractAssemblyCompoundSystemDeflection
