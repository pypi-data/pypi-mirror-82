...
from mastapy.system_model.analyses_and_results.power_flows import _3349, _3304
...
class PulleySystemDeflection(_2291.CouplingHalfSystemDeflection):
    '''PulleySystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3349.PulleyPowerFlow':
        ...
        if _3349.PulleyPowerFlow.TYPE not in self.wrapped.PowerFlowResults.__class__.__mro__:
