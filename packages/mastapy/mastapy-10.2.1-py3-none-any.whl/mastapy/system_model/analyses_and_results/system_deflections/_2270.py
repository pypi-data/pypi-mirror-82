...
class BoltedJointSystemDeflection(_2357.SpecialisedAssemblySystemDeflection):
    '''BoltedJointSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3281.BoltedJointPowerFlow':
        ...
        return constructor.new(_3281.BoltedJointPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
