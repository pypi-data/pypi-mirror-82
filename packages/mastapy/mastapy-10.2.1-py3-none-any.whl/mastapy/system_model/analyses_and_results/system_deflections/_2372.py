...
from mastapy.system_model.analyses_and_results.system_deflections import _2272, _2373
...
class SynchroniserHalfSystemDeflection(_2373.SynchroniserPartSystemDeflection):
    '''SynchroniserHalfSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3372.SynchroniserHalfPowerFlow':
        ...
        return constructor.new(_3372.SynchroniserHalfPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
