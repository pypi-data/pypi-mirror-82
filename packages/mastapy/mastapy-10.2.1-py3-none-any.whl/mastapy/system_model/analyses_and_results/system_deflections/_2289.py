...
class ConnectorSystemDeflection(_2336.MountableComponentSystemDeflection):
    '''ConnectorSystemDeflection
    ...
    @property
    def outer_imported_fe(self) -> '_2320.ImportedFEComponentSystemDeflection':
        ...
        return constructor.new(_2320.ImportedFEComponentSystemDeflection)(self.wrapped.OuterImportedFE) if self.wrapped.OuterImportedFE else None

    @property
    def force_on_outer_support_in_wcs(self) -> '_1138.VectorWithLinearAndAngularComponents':
        ...
        return constructor.new(_1138.VectorWithLinearAndAngularComponents)(self.wrapped.ForceOnOuterSupportInWCS) if self.wrapped.ForceOnOuterSupportInWCS else None

    @property
    def force_on_outer_support_in_lcs(self) -> '_1138.VectorWithLinearAndAngularComponents':
        ...
        return constructor.new(_1138.VectorWithLinearAndAngularComponents)(self.wrapped.ForceOnOuterSupportInLCS) if self.wrapped.ForceOnOuterSupportInLCS else None

    @property
    def outer_imported_fe_nodes(self) -> 'List[_1990.ImportedFEStiffnessNode]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.OuterImportedFENodes, constructor.new(_1990.ImportedFEStiffnessNode))
        return value

    @property
    def power_flow_results(self) -> '_3298.ConnectorPowerFlow':
        ...
        if _3298.ConnectorPowerFlow.TYPE not in self.wrapped.PowerFlowResults.__class__.__mro__:
    ...
    @property
    def power_flow_results_of_type_bearing_power_flow(self) -> '_3270.BearingPowerFlow':
        ...
        if _3270.BearingPowerFlow.TYPE not in self.wrapped.PowerFlowResults.__class__.__mro__:
    ...
    @property
    def power_flow_results_of_type_oil_seal_power_flow(self) -> '_3337.OilSealPowerFlow':
        ...
        if _3337.OilSealPowerFlow.TYPE not in self.wrapped.PowerFlowResults.__class__.__mro__:
    ...
    @property
    def power_flow_results_of_type_shaft_hub_connection_power_flow(self) -> '_3354.ShaftHubConnectionPowerFlow':
        ...
        if _3354.ShaftHubConnectionPowerFlow.TYPE not in self.wrapped.PowerFlowResults.__class__.__mro__:
