...
class CVTBeltConnectionSystemDeflection(_2260.BeltConnectionSystemDeflection):
    '''CVTBeltConnectionSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3302.CVTBeltConnectionPowerFlow':
        ...
        return constructor.new(_3302.CVTBeltConnectionPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
