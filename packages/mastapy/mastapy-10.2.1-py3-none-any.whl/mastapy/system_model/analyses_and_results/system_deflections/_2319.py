...
class HypoidGearSystemDeflection(_2257.AGMAGleasonConicalGearSystemDeflection):
    '''HypoidGearSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3321.HypoidGearPowerFlow':
        ...
        return constructor.new(_3321.HypoidGearPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
