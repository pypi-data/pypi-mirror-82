...
class AGMAGleasonConicalGearSetSystemDeflection(_2286.ConicalGearSetSystemDeflection):
    '''AGMAGleasonConicalGearSetSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3268.AGMAGleasonConicalGearSetPowerFlow':
