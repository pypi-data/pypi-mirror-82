...
class CylindricalGearMeshCompoundSteadyStateSynchronousResponseAtASpeed(_2943.GearMeshCompoundSteadyStateSynchronousResponseAtASpeed):
    '''CylindricalGearMeshCompoundSteadyStateSynchronousResponseAtASpeed
    ...
    @property
    def component_design(self) -> '_1912.CylindricalGearMesh':
        ...
        return constructor.new(_1912.CylindricalGearMesh)(self.wrapped.ComponentDesign) if self.wrapped.ComponentDesign else None
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_2810.CylindricalGearMeshSteadyStateSynchronousResponseAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_2810.CylindricalGearMeshSteadyStateSynchronousResponseAtASpeed))
        return value

    @property
    def connection_steady_state_synchronous_response_at_a_speed_load_cases(self) -> 'List[_2810.CylindricalGearMeshSteadyStateSynchronousResponseAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionSteadyStateSynchronousResponseAtASpeedLoadCases, constructor.new(_2810.CylindricalGearMeshSteadyStateSynchronousResponseAtASpeed))
        return value
