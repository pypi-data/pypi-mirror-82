...
class FlexiblePinAssemblyCompoundSteadyStateSynchronousResponseAtASpeed(_2981.SpecialisedAssemblyCompoundSteadyStateSynchronousResponseAtASpeed):
    '''FlexiblePinAssemblyCompoundSteadyStateSynchronousResponseAtASpeed
    ...
    @property
    def component_design(self) -> '_2040.FlexiblePinAssembly':
        ...
        return constructor.new(_2040.FlexiblePinAssembly)(self.wrapped.ComponentDesign) if self.wrapped.ComponentDesign else None
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_2819.FlexiblePinAssemblySteadyStateSynchronousResponseAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_2819.FlexiblePinAssemblySteadyStateSynchronousResponseAtASpeed))
        return value

    @property
    def assembly_steady_state_synchronous_response_at_a_speed_load_cases(self) -> 'List[_2819.FlexiblePinAssemblySteadyStateSynchronousResponseAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblySteadyStateSynchronousResponseAtASpeedLoadCases, constructor.new(_2819.FlexiblePinAssemblySteadyStateSynchronousResponseAtASpeed))
        return value
