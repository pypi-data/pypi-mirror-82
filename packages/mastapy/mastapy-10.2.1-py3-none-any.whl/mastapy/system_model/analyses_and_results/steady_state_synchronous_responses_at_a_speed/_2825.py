...
from mastapy.system_model.analyses_and_results.steady_state_synchronous_responses_at_a_speed import _2826, _2824, _2772
...
class HypoidGearSetSteadyStateSynchronousResponseAtASpeed(_2772.AGMAGleasonConicalGearSetSteadyStateSynchronousResponseAtASpeed):
    '''HypoidGearSetSteadyStateSynchronousResponseAtASpeed
    ...
    @property
    def hypoid_gears_steady_state_synchronous_response_at_a_speed(self) -> 'List[_2826.HypoidGearSteadyStateSynchronousResponseAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.HypoidGearsSteadyStateSynchronousResponseAtASpeed, constructor.new(_2826.HypoidGearSteadyStateSynchronousResponseAtASpeed))
        return value

    @property
    def hypoid_meshes_steady_state_synchronous_response_at_a_speed(self) -> 'List[_2824.HypoidGearMeshSteadyStateSynchronousResponseAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.HypoidMeshesSteadyStateSynchronousResponseAtASpeed, constructor.new(_2824.HypoidGearMeshSteadyStateSynchronousResponseAtASpeed))
        return value
