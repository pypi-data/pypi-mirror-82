...
class FlexiblePinAnalysisManufactureLevel(_5839.FlexiblePinAnalysis):
    ...
    @property
    def planetary_mesh_analysis(self) -> '_3551.CylindricalGearMeshParametricStudyTool':
        ...
        return constructor.new(_3551.CylindricalGearMeshParametricStudyTool)(self.wrapped.PlanetaryMeshAnalysis) if self.wrapped.PlanetaryMeshAnalysis else None
