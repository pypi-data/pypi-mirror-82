...
from mastapy.system_model.analyses_and_results.system_deflections.compound import _2445, _2481, _2408
...
class FlexiblePinAnalysisGearAndBearingRating(_5839.FlexiblePinAnalysis):
    ...
    @property
    def gear_set_analysis(self) -> '_2445.CylindricalGearSetCompoundSystemDeflection':
        ...
        if _2445.CylindricalGearSetCompoundSystemDeflection.TYPE not in self.wrapped.GearSetAnalysis.__class__.__mro__:
    ...
    @property
    def bearing_analyses(self) -> 'List[_2408.BearingCompoundSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.BearingAnalyses, constructor.new(_2408.BearingCompoundSystemDeflection))
        return value
