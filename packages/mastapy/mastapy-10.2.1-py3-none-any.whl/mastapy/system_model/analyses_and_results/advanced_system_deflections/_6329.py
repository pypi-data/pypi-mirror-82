...
from mastapy.system_model.part_model.gears import _2109, _2111
from mastapy.system_model.analyses_and_results.static_loads import _6143, _6148
from mastapy.gears.rating.cylindrical import _257
from mastapy.system_model.analyses_and_results.advanced_system_deflections import _6330, _6332, _6340
...
class CylindricalGearAdvancedSystemDeflection(_6340.GearAdvancedSystemDeflection):
    '''CylindricalGearAdvancedSystemDeflection
    ...
    @property
    def component_design(self) -> '_2109.CylindricalGear':
    ...
    @property
    def component_load_case(self) -> '_6143.CylindricalGearLoadCase':
        ...
        if _6143.CylindricalGearLoadCase.TYPE not in self.wrapped.ComponentLoadCase.__class__.__mro__:
    ...
    @property
    def cylindrical_gear_advanced_system_deflection_meshes(self) -> 'List[_6330.CylindricalGearMeshAdvancedSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CylindricalGearAdvancedSystemDeflectionMeshes, constructor.new(_6330.CylindricalGearMeshAdvancedSystemDeflection))
        return value

    @property
    def cylindrical_meshed_gear_advanced_system_deflections(self) -> 'List[_6332.CylindricalMeshedGearAdvancedSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CylindricalMeshedGearAdvancedSystemDeflections, constructor.new(_6332.CylindricalMeshedGearAdvancedSystemDeflection))
        return value

    @property
    def cylindrical_gear_advanced_system_deflections_in_meshes(self) -> 'List[_6332.CylindricalMeshedGearAdvancedSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CylindricalGearAdvancedSystemDeflectionsInMeshes, constructor.new(_6332.CylindricalMeshedGearAdvancedSystemDeflection))
        return value
