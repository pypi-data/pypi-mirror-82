...
from mastapy.system_model.analyses_and_results.advanced_system_deflections import _6329, _6330, _6342
...
class CylindricalGearSetAdvancedSystemDeflection(_6342.GearSetAdvancedSystemDeflection):
    '''CylindricalGearSetAdvancedSystemDeflection
    ...
    @property
    def cylindrical_gears_advanced_system_deflection(self) -> 'List[_6329.CylindricalGearAdvancedSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CylindricalGearsAdvancedSystemDeflection, constructor.new(_6329.CylindricalGearAdvancedSystemDeflection))
        return value

    @property
    def cylindrical_meshes_advanced_system_deflection(self) -> 'List[_6330.CylindricalGearMeshAdvancedSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CylindricalMeshesAdvancedSystemDeflection, constructor.new(_6330.CylindricalGearMeshAdvancedSystemDeflection))
        return value
