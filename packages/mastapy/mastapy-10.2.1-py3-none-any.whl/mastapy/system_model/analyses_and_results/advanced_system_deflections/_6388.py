...
class StraightBevelDiffGearMeshAdvancedSystemDeflection(_6302.BevelGearMeshAdvancedSystemDeflection):
    '''StraightBevelDiffGearMeshAdvancedSystemDeflection
    ...
    @property
    def connection_load_case(self) -> '_6238.StraightBevelDiffGearMeshLoadCase':
        ...
        return constructor.new(_6238.StraightBevelDiffGearMeshLoadCase)(self.wrapped.ConnectionLoadCase) if self.wrapped.ConnectionLoadCase else None
    ...
    @property
    def connection_system_deflection_results(self) -> 'List[_2364.StraightBevelDiffGearMeshSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionSystemDeflectionResults, constructor.new(_2364.StraightBevelDiffGearMeshSystemDeflection))
        return value
