...
class OilSealAdvancedSystemDeflection(_6321.ConnectorAdvancedSystemDeflection):
    '''OilSealAdvancedSystemDeflection
    ...
    @property
    def component_system_deflection_results(self) -> 'List[_2338.OilSealSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentSystemDeflectionResults, constructor.new(_2338.OilSealSystemDeflection))
        return value
