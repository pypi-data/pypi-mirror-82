...
class TransmissionErrorToOtherPowerLoad(_0.APIBase):
    ...
    @property
    def fourier_series_of_te(self) -> '_1087.FourierSeries':
        ...
        return constructor.new(_1087.FourierSeries)(self.wrapped.FourierSeriesOfTE) if self.wrapped.FourierSeriesOfTE else None
