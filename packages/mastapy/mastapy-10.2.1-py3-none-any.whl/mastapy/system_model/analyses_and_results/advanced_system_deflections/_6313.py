...
class ConceptCouplingHalfAdvancedSystemDeflection(_6325.CouplingHalfAdvancedSystemDeflection):
    '''ConceptCouplingHalfAdvancedSystemDeflection
    ...
    @property
    def component_system_deflection_results(self) -> 'List[_2279.ConceptCouplingHalfSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentSystemDeflectionResults, constructor.new(_2279.ConceptCouplingHalfSystemDeflection))
        return value
