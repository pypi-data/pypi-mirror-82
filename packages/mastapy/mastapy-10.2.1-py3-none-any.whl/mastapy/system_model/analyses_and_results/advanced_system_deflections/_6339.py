...
from mastapy.system_model.analyses_and_results.advanced_system_deflections import _6329, _6377, _6380
from mastapy.system_model.analyses_and_results.system_deflections import _2352, _2332, _2312
...
class FlexiblePinAssemblyAdvancedSystemDeflection(_6380.SpecialisedAssemblyAdvancedSystemDeflection):
    '''FlexiblePinAssemblyAdvancedSystemDeflection
    ...
    @property
    def planet_gear_analyses(self) -> 'List[_6329.CylindricalGearAdvancedSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.PlanetGearAnalyses, constructor.new(_6329.CylindricalGearAdvancedSystemDeflection))
        return value

    @property
    def pin_advanced_analyses(self) -> 'List[_6377.ShaftAdvancedSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.PinAdvancedAnalyses, constructor.new(_6377.ShaftAdvancedSystemDeflection))
        return value

    @property
    def spindle_advanced_analyses(self) -> 'List[_6377.ShaftAdvancedSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.SpindleAdvancedAnalyses, constructor.new(_6377.ShaftAdvancedSystemDeflection))
        return value

    @property
    def pin_spindle_fit_advanced_analyses(self) -> 'List[_2352.ShaftHubConnectionSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.PinSpindleFitAdvancedAnalyses, constructor.new(_2352.ShaftHubConnectionSystemDeflection))
        return value
    ...
    @property
    def assembly_system_deflection_results(self) -> 'List[_2312.FlexiblePinAssemblySystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblySystemDeflectionResults, constructor.new(_2312.FlexiblePinAssemblySystemDeflection))
        return value
