...
class ImportedFEComponentAdvancedSystemDeflection(_6285.AbstractShaftOrHousingAdvancedSystemDeflection):
    '''ImportedFEComponentAdvancedSystemDeflection
    ...
    @property
    def component_system_deflection_results(self) -> 'List[_2320.ImportedFEComponentSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentSystemDeflectionResults, constructor.new(_2320.ImportedFEComponentSystemDeflection))
        return value
