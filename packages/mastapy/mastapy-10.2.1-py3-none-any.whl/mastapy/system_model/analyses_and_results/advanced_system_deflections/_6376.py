...
from mastapy.system_model.analyses_and_results.advanced_system_deflections import _6286, _6292
...
class RootAssemblyAdvancedSystemDeflection(_6292.AssemblyAdvancedSystemDeflection):
    '''RootAssemblyAdvancedSystemDeflection
    ...
    @property
    def advanced_system_deflection_inputs(self) -> '_6286.AdvancedSystemDeflection':
        ...
        return constructor.new(_6286.AdvancedSystemDeflection)(self.wrapped.AdvancedSystemDeflectionInputs) if self.wrapped.AdvancedSystemDeflectionInputs else None
