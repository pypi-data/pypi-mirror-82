...
from mastapy.system_model.analyses_and_results.advanced_system_deflections import _6387, _6388, _6303
...
class StraightBevelDiffGearSetAdvancedSystemDeflection(_6303.BevelGearSetAdvancedSystemDeflection):
    '''StraightBevelDiffGearSetAdvancedSystemDeflection
    ...
    @property
    def straight_bevel_diff_gears_advanced_system_deflection(self) -> 'List[_6387.StraightBevelDiffGearAdvancedSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StraightBevelDiffGearsAdvancedSystemDeflection, constructor.new(_6387.StraightBevelDiffGearAdvancedSystemDeflection))
        return value

    @property
    def straight_bevel_diff_meshes_advanced_system_deflection(self) -> 'List[_6388.StraightBevelDiffGearMeshAdvancedSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StraightBevelDiffMeshesAdvancedSystemDeflection, constructor.new(_6388.StraightBevelDiffGearMeshAdvancedSystemDeflection))
        return value

    @property
    def assembly_system_deflection_results(self) -> 'List[_2365.StraightBevelDiffGearSetSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblySystemDeflectionResults, constructor.new(_2365.StraightBevelDiffGearSetSystemDeflection))
        return value
