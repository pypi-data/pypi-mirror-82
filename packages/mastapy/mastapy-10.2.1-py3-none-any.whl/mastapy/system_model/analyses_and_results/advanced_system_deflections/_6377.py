...
class ShaftAdvancedSystemDeflection(_6285.AbstractShaftOrHousingAdvancedSystemDeflection):
    '''ShaftAdvancedSystemDeflection
    ...
    @property
    def component_system_deflection_results(self) -> 'List[_2355.ShaftSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentSystemDeflectionResults, constructor.new(_2355.ShaftSystemDeflection))
        return value
