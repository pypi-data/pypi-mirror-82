...
from mastapy.system_model.analyses_and_results.advanced_system_deflections import _6407, _6408, _6342
...
class WormGearSetAdvancedSystemDeflection(_6342.GearSetAdvancedSystemDeflection):
    '''WormGearSetAdvancedSystemDeflection
    ...
    @property
    def worm_gears_advanced_system_deflection(self) -> 'List[_6407.WormGearAdvancedSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.WormGearsAdvancedSystemDeflection, constructor.new(_6407.WormGearAdvancedSystemDeflection))
        return value

    @property
    def worm_meshes_advanced_system_deflection(self) -> 'List[_6408.WormGearMeshAdvancedSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.WormMeshesAdvancedSystemDeflection, constructor.new(_6408.WormGearMeshAdvancedSystemDeflection))
        return value

    @property
    def assembly_system_deflection_results(self) -> 'List[_2388.WormGearSetSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblySystemDeflectionResults, constructor.new(_2388.WormGearSetSystemDeflection))
        return value
