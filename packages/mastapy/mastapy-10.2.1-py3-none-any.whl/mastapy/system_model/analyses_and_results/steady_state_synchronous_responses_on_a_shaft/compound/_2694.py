...
class ExternalCADModelCompoundSteadyStateSynchronousResponseOnAShaft(_2671.ComponentCompoundSteadyStateSynchronousResponseOnAShaft):
    '''ExternalCADModelCompoundSteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def component_design(self) -> '_2039.ExternalCADModel':
        ...
        return constructor.new(_2039.ExternalCADModel)(self.wrapped.ComponentDesign) if self.wrapped.ComponentDesign else None

    @property
    def load_case_analyses_ready(self) -> 'List[_2572.ExternalCADModelSteadyStateSynchronousResponseOnAShaft]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_2572.ExternalCADModelSteadyStateSynchronousResponseOnAShaft))
        return value

    @property
    def component_steady_state_synchronous_response_on_a_shaft_load_cases(self) -> 'List[_2572.ExternalCADModelSteadyStateSynchronousResponseOnAShaft]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentSteadyStateSynchronousResponseOnAShaftLoadCases, constructor.new(_2572.ExternalCADModelSteadyStateSynchronousResponseOnAShaft))
        return value
