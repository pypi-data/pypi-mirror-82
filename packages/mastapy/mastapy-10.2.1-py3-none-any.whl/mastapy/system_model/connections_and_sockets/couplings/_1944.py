...
class SpringDamperConnection(_1940.CouplingConnection):
    '''SpringDamperConnection
    ...
    @property
    def damping(self) -> '_1398.LinearDampingConnectionProperties':
        ...
        return constructor.new(_1398.LinearDampingConnectionProperties)(self.wrapped.Damping) if self.wrapped.Damping else None
