...
from mastapy.system_model.part_model.gears import _2110, _2126, _2109
...
class CylindricalGearMesh(_1916.GearMesh):
    '''CylindricalGearMesh
    ...
    @property
    def cylindrical_gear_set(self) -> '_2110.CylindricalGearSet':
        ...
        if _2110.CylindricalGearSet.TYPE not in self.wrapped.CylindricalGearSet.__class__.__mro__:
    ...
    @property
    def centre_distance_range(self) -> '_1139.ShortLengthRange':
        ...
        return constructor.new(_1139.ShortLengthRange)(self.wrapped.CentreDistanceRange) if self.wrapped.CentreDistanceRange else None
