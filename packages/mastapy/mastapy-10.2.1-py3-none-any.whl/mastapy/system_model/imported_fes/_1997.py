...
class IndependentMastaCreatedCondensationNode(_0.APIBase):
    ...
    @property
    def rigid_coupling_type(self) -> '_1498.RigidCouplingType':
        ...
        return constructor.new(_1498.RigidCouplingType)(value) if value else None

    @rigid_coupling_type.setter
    def rigid_coupling_type(self, value: '_1498.RigidCouplingType'):
    ...
    @property
    def imported_fe_node(self) -> '_1990.ImportedFEStiffnessNode':
        ...
        return constructor.new(_1990.ImportedFEStiffnessNode)(self.wrapped.ImportedFENode) if self.wrapped.ImportedFENode else None
