...
class ContactPairWithSelection(_0.APIBase):
    ...
    @property
    def contact_pair(self) -> '_1499.ContactPairReporting':
        ...
        return constructor.new(_1499.ContactPairReporting)(self.wrapped.ContactPair) if self.wrapped.ContactPair else None
