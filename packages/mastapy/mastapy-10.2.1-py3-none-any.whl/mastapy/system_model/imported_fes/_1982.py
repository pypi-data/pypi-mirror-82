...
class ImportedFeLinkWithSelection(_0.APIBase):
    ...
    @property
    def link(self) -> '_1949.ImportedFELink':
        ...
        if _1949.ImportedFELink.TYPE not in self.wrapped.Link.__class__.__mro__:
    ...
    @property
    def link_of_type_imported_fe_electric_machine_stator_link(self) -> '_1979.ImportedFEElectricMachineStatorLink':
        ...
        if _1979.ImportedFEElectricMachineStatorLink.TYPE not in self.wrapped.Link.__class__.__mro__:
    ...
    @property
    def link_of_type_imported_fe_gear_mesh_link(self) -> '_1980.ImportedFEGearMeshLink':
        ...
        if _1980.ImportedFEGearMeshLink.TYPE not in self.wrapped.Link.__class__.__mro__:
    ...
    @property
    def link_of_type_imported_fe_gear_with_duplicated_meshes_link(self) -> '_1981.ImportedFEGearWithDuplicatedMeshesLink':
        ...
        if _1981.ImportedFEGearWithDuplicatedMeshesLink.TYPE not in self.wrapped.Link.__class__.__mro__:
    ...
    @property
    def link_of_type_imported_fe_multi_node_connector_link(self) -> '_1983.ImportedFEMultiNodeConnectorLink':
        ...
        if _1983.ImportedFEMultiNodeConnectorLink.TYPE not in self.wrapped.Link.__class__.__mro__:
    ...
    @property
    def link_of_type_imported_fe_multi_node_link(self) -> '_1984.ImportedFEMultiNodeLink':
        ...
        if _1984.ImportedFEMultiNodeLink.TYPE not in self.wrapped.Link.__class__.__mro__:
    ...
    @property
    def link_of_type_imported_fe_node_link(self) -> '_1985.ImportedFENodeLink':
        ...
        if _1985.ImportedFENodeLink.TYPE not in self.wrapped.Link.__class__.__mro__:
            raise CastException('Failed to cast link to ImportedFENodeLink. Expected: {}.'.format(self.wrapped.Link.__class__.__qualname__))

        return constructor.new_override(self.wrapped.Link.__class__)(self.wrapped.Link) if self.wrapped.Link else None

    @property
    def link_of_type_imported_fe_planetary_connector_multi_node_link(self) -> '_1986.ImportedFEPlanetaryConnectorMultiNodeLink':
        ...
        if _1986.ImportedFEPlanetaryConnectorMultiNodeLink.TYPE not in self.wrapped.Link.__class__.__mro__:
    ...
    @property
    def link_of_type_imported_fe_planet_based_link(self) -> '_1987.ImportedFEPlanetBasedLink':
        ...
        if _1987.ImportedFEPlanetBasedLink.TYPE not in self.wrapped.Link.__class__.__mro__:
    ...
    @property
    def link_of_type_imported_fe_planet_carrier_link(self) -> '_1988.ImportedFEPlanetCarrierLink':
        ...
        if _1988.ImportedFEPlanetCarrierLink.TYPE not in self.wrapped.Link.__class__.__mro__:
    ...
    @property
    def link_of_type_imported_fe_point_load_link(self) -> '_1989.ImportedFEPointLoadLink':
        ...
        if _1989.ImportedFEPointLoadLink.TYPE not in self.wrapped.Link.__class__.__mro__:
    ...
    @property
    def link_of_type_multi_angle_connection_link(self) -> '_2001.MultiAngleConnectionLink':
        ...
        if _2001.MultiAngleConnectionLink.TYPE not in self.wrapped.Link.__class__.__mro__:
    ...
    @property
    def link_of_type_rolling_ring_connection_link(self) -> '_2012.RollingRingConnectionLink':
        ...
        if _2012.RollingRingConnectionLink.TYPE not in self.wrapped.Link.__class__.__mro__:
    ...
    @property
    def link_of_type_shaft_hub_connection_fe_link(self) -> '_2013.ShaftHubConnectionFELink':
        ...
        if _2013.ShaftHubConnectionFELink.TYPE not in self.wrapped.Link.__class__.__mro__:
