...
from mastapy.system_model.imported_fes import _1952, _1958
...
class RaceBearingFE(_0.APIBase):
    ...
    @property
    def alignment_method(self) -> '_1952.AlignmentMethodForRaceBearing':
        ...
        return constructor.new(_1952.AlignmentMethodForRaceBearing)(value) if value else None

    @alignment_method.setter
    def alignment_method(self, value: '_1952.AlignmentMethodForRaceBearing'):
    ...
    @property
    def links(self) -> 'List[_1958.BearingRaceNodeLink]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Links, constructor.new(_1958.BearingRaceNodeLink))
        return value
