...
class CylindricalGearMeshFEModel(_935.GearMeshFEModel):
    ...
    def stiffness_wrt_contacts_for(self, gear: '_934.GearFEModel', flank: '_126.GearFlanks') -> 'List[_612.GearContactStiffness]':
        ...
        return conversion.pn_to_mp_objects_in_list(self.wrapped.StiffnessWrtContactsFor.Overloads[_GEAR_FE_MODEL, _GEAR_FLANKS](gear.wrapped if gear else None, flank), constructor.new(_612.GearContactStiffness))

    def stiffness_wrt_contacts_for_with_progress(self, gear: '_934.GearFEModel', flank: '_126.GearFlanks', progress: '_6554.TaskProgress') -> 'List[_612.GearContactStiffness]':
        ''' 'StiffnessWrtContactsFor' is the original name of this method.
        ...
        flank = conversion.mp_to_pn_enum(flank)
        return conversion.pn_to_mp_objects_in_list(self.wrapped.StiffnessWrtContactsFor.Overloads[_GEAR_FE_MODEL, _GEAR_FLANKS, _TASK_PROGRESS](gear.wrapped if gear else None, flank, progress.wrapped if progress else None), constructor.new(_612.GearContactStiffness))
