...
class FindleyCriticalPlaneAnalysis(_0.APIBase):
    ...
    @property
    def maximum_findley_critical_plane_angle(self) -> 'List[_1065.Vector2D]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.MaximumFindleyCriticalPlaneAngle, constructor.new(_1065.Vector2D))
        return value
