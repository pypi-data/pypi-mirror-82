...
from mastapy.nodal_analysis.states import _1447
...
class CylindricalGearTwoDimensionalFEAnalysis(_0.APIBase):
    ...
    @property
    def findley_critical_plane_analysis(self) -> '_670.FindleyCriticalPlaneAnalysis':
        ...
        return constructor.new(_670.FindleyCriticalPlaneAnalysis)(self.wrapped.FindleyCriticalPlaneAnalysis) if self.wrapped.FindleyCriticalPlaneAnalysis else None

    def get_stress_states(self, index: 'int') -> '_1447.NodeVectorState':
