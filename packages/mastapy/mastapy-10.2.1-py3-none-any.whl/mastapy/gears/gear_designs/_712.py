...
class DesignConstraintsCollection(_1362.NamedDatabaseItem):
    '''DesignConstraintsCollection
    ...
    @property
    def design_constraints(self) -> 'List[_1367.DeletableCollectionMember[_710.DesignConstraint]]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.DesignConstraints, constructor.new(_1367.DeletableCollectionMember)[_710.DesignConstraint])
        return value
