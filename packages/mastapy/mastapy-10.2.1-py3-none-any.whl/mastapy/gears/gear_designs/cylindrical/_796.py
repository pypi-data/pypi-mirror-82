...
class CylindricalPlanetaryGearSetDesign(_787.CylindricalGearSetDesign):
    ...
    @property
    def planetary_sideband_fourier_series_for_rotating_planet_carrier(self) -> '_1087.FourierSeries':
        ...
        return constructor.new(_1087.FourierSeries)(self.wrapped.PlanetarySidebandFourierSeriesForRotatingPlanetCarrier) if self.wrapped.PlanetarySidebandFourierSeriesForRotatingPlanetCarrier else None
