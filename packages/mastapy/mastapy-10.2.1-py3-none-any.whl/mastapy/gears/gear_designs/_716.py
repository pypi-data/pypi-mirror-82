...
class GearSetDesign(_714.GearDesignComponent):
    ...
    @property
    def gear_set_drawing(self) -> '_6557.SMTBitmap':
        ...
        return constructor.new(_6557.SMTBitmap)(self.wrapped.GearSetDrawing) if self.wrapped.GearSetDrawing else None
    ...
    @property
    def active_ltcafe_model(self) -> '_937.GearSetFEModel':
        ...
        if _937.GearSetFEModel.TYPE not in self.wrapped.ActiveLTCAFEModel.__class__.__mro__:
    ...
    @property
    def active_ltcafe_model_of_type_cylindrical_gear_set_fe_model(self) -> '_940.CylindricalGearSetFEModel':
        ...
        if _940.CylindricalGearSetFEModel.TYPE not in self.wrapped.ActiveLTCAFEModel.__class__.__mro__:
    ...
    @property
    def active_ltcafe_model_of_type_conical_set_fe_model(self) -> '_943.ConicalSetFEModel':
        ...
        if _943.ConicalSetFEModel.TYPE not in self.wrapped.ActiveLTCAFEModel.__class__.__mro__:
    ...
    @property
    def tifffe_model(self) -> '_937.GearSetFEModel':
        ...
        if _937.GearSetFEModel.TYPE not in self.wrapped.TIFFFEModel.__class__.__mro__:
    ...
    @property
    def tifffe_model_of_type_cylindrical_gear_set_fe_model(self) -> '_940.CylindricalGearSetFEModel':
        ...
        if _940.CylindricalGearSetFEModel.TYPE not in self.wrapped.TIFFFEModel.__class__.__mro__:
    ...
    @property
    def tifffe_model_of_type_conical_set_fe_model(self) -> '_943.ConicalSetFEModel':
        ...
        if _943.ConicalSetFEModel.TYPE not in self.wrapped.TIFFFEModel.__class__.__mro__:
    ...
    @property
    def ltcafe_models(self) -> 'List[_937.GearSetFEModel]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LTCAFEModels, constructor.new(_937.GearSetFEModel))
        return value
