...
class CylindricalGearMeshLoadDistributionAnalysis(_615.GearMeshLoadDistributionAnalysis):
    ...
    @property
    def transmission_error_against_rotation(self) -> 'List[_1065.Vector2D]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.TransmissionErrorAgainstRotation, constructor.new(_1065.Vector2D))
        return value
