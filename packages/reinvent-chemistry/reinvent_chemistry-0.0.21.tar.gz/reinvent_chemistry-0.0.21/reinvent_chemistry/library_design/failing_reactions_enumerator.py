...
class FailingReactionsEnumerator:
        ...
        for reaction in self._chemical_reactions:
            ...
            for pair in dto.reaction_outcomes:
                ...
                for indx, _ in enumerate(pair):
                    ...
                    if not self._validate(scaffold, labeled_decoration, original_smiles):
    ...
    def _validate(self, scaffold: Mol, labeled_decoration: OrderedDict, original_smiles: str) -> bool:
        if scaffold:
