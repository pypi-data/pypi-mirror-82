...
with io.open(os.path.join(here, 'visionui', '__about__.py'), encoding='utf-8') as f:
    exec(f.read(), about)
...
class UploadCommand(Command):
    ...
    def run(self):
        try:
            ...
            rmtree(os.path.join(here, 'visionui/dist'))
        except OSError:
            pass
...
setup(
    ...
    package_data={
        '': ["README.md"],
        'visionui': ['dbnet_crnn/model/det/model', 'dbnet_crnn/model/det/params', 'dbnet_crnn/model/rec/model',
