    ...
    def model(self,*args, **kwargs):
        ...
        with pyro.plate('data', N, batch):
            ...
            for i in pyro.plate('segments2', I):
                pyro.sample('obs_{}'.format(i), dist.Normal(Vindex(cc)[assignment,i], norm_sd[assignment,i]
    ...
    def init_fn(self):
        def init_function(site):
            ...
            if site["name"] == "norm_sd":
                return self._params['init_sd'] * torch.ones(self._params['K'], self._data['data'].shape[0])
