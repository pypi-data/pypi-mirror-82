...
class ObjectsCommand(Command):
    ...
    def handle(self):
        ...
        if self.option("create"):
            ...
            asyncio.run(
                client.objects.update_metadata(
                    container_name, object_name, headers=headers
                )
            )
            ...
            asyncio.run(
                client.objects.delete(container_name, object_name, headers=headers)
            )
            self.line(
