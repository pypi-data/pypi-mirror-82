...
def test_host_port():
    """Check if Mod9 ASR Engine is online. Loop until get server_ready response. Print stats."""
...
def place_reformatted_mod9_response_in_operation_results(
    ...
    """Get and format response from Mod9 ASR Engine. Place response in proper operation_result."""
...
class Recognize(Resource):
    """Implement synchronous speech-to-text."""
...
class GetOperationByName(Resource):
    """Implement operation result fetching for /operations/<operation_name> endpoint."""
...
class LongRunningRecognize(Resource):
    """Implement long-running speech-to-text for /longrunningrecognize endpoint."""
