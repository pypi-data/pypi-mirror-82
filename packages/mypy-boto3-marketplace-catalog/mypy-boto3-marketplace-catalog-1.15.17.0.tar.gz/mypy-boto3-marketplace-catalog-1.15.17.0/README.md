...
[boto3.MarketplaceCatalog 1.15.17](https://boto3.amazonaws.com/v1/documentation/api/1.15.17/reference/services/marketplace-catalog.html#MarketplaceCatalog) service
compatible with
