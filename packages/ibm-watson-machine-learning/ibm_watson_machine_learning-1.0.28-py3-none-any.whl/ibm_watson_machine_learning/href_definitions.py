...
class HrefDefinitions:
    ...
    def volume_href(self,volume_id):
        return VOLUME_ID.format(self._wml_credentials['url'] + self.prepend,volume_id)

    def volume_service_href(self,volume_name):
        return VOLUME_SERVICE.format(self._wml_credentials['url'] + self.prepend,volume_name)

    def volume_upload_href(self, name):
        return  VOLUME_SERVICE_FILE_UPLOAD.format(self._wml_credentials['url'] + self.prepend,volume_name)
