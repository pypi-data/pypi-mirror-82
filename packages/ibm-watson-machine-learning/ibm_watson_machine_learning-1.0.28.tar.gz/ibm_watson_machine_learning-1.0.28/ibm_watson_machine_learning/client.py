       ...
       # if not self.ICP and not self.ICP_30 and not self.WSD:
        ...
        if self.CLOUD_PLATFORM_SPACES or self.ICP_PLATFORM_SPACES:
            ...
            if (3 == sys.version_info.major) and (6 == sys.version_info.minor):
                print(
                    "DEPRECATED!!! Python 3.6 framework is deprecated and will be removed on Jan 20, 2021. Use Python 3.7 "
                    "instead. For details, see https://dataplatform.cloud.ibm.com/docs/content/wsj/analyze-data/pm_service_supported_frameworks.html")
