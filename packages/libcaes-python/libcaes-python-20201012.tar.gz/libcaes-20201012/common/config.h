...
#define HAVE_AES_CBC_ENCRYPT 1

/* Define to 1 if you have the `AES_ecb_encrypt' function". */
#define HAVE_AES_ECB_ENCRYPT 1
...
#define PACKAGE_STRING "libcaes 20201012"
...
#define PACKAGE_VERSION "20201012"
