...
_CROSSZONEPOLICYFILTERSFLOWSASSERTIONRESULT = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='violator_descriptions', full_name='com.intentionet.bfe.assertions.CrossZonePolicyFiltersFlowsAssertionResult.violator_descriptions', index=3,
