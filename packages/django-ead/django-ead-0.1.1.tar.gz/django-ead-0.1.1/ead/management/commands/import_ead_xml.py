...
from ...constants import (
    ...
    ACQINFO_ATTRS, AGENCYCODE_ATTRS, AGENCYNAME_ATTRS, AGENT_ATTRS,
    AGENTTYPE_ATTRS, ALTFORMAVAIL_ATTRS, APPRAISAL_ATTRS, ARCHDESC_ATTRS,
    ARRANGEMENT_ATTRS, AUTHOR_ATTRS, BIBLIOGRAPHY_ATTRS, BIOGHIST_ATTRS,
    CITATION_ATTRS, CONTAINER_ATTRS, CONTROL_ATTRS, CONTROLACCESS_ATTRS,
    CONTROLNOTE_ATTRS, CONVENTIONDECLARATION_ATTRS, CUSTODHIST_ATTRS,
    DAO_ATTRS, DAOSET_ATTRS, DATERANGE_ATTRS, DATESET_ATTRS, DATESINGLE_ATTRS,
    DESCRIPTIVENOTE_ATTRS, DID_ATTRS, DIDNOTE_ATTRS, DIMENSIONS_ATTRS,
    EAD_ATTRS, EAD_NS, EDITIONSTMT_ATTRS, EVENTDATETIME_ATTRS,
    ...
    LANGUAGESET_ATTRS, LEGALSTATUS_ATTRS, LOCALTYPEDECLARATION_ATTRS,
    ...
    PUBLICATIONSTMT_ATTRS, QUANTITY_ATTRS, RELATEDMATERIAL_ATTRS,
    RELATION_ATTRS, RELATIONENTRY_ATTRS, RELATIONS_ATTRS, REPOSITORY_ATTRS,
    REPRESENTATION_ATTRS, RIGHTSDECLARATION_ATTRS, SCOPECONTENT_ATTRS,
    SCRIPT_ATTRS, SEPARATEDMATERIAL_ATTRS, SERIESSTMT_ATTRS, SOURCE_ATTRS,
    SOURCEENTRY_ATTRS, SOURCES_ATTRS, SPONSOR_ATTRS, SUBTITLE_ATTRS,
...
from ...models import (
    ...
    LanguageSetLanguage, LanguageSetScript, LegalStatus, LocalTypeDeclaration,
    MaintenanceEvent, MaterialSpec, Name, NamePart, ODD, OriginalsLoc,
    Origination, OtherAgencyCode, OtherFindAid, OtherRecordID, PersName,
    PersNamePart, PhysDesc, PhysDescSet, PhysDescSetPhysDescStructured,
    ...
    RelationDateSingle, RelationEntry, Repository, Representation,
...
class Command(BaseCommand):
    ...
    def _import_abbr(self, abbr, parent_obj):
        ...
        for abbr as a child of elements where it may occur only
        once."""
    ...
    def _import_ead(self, ead):
        ...
        try:
            ...
            pass
        ead_obj = EAD(recordid=recordid)
        ead_obj.save()
        self._record_ids[recordid] = self._path
        import_attrs(ead, EAD_ATTRS, ead_obj)
        control = ead[0]
        self._import_control(control, ead_obj)
        archdesc = ead[1]
        self._import_archdesc(archdesc, ead_obj)
        ead_obj.save()
        return ead_obj
    ...
    def _import_language(self, language, parent_obj, language_model):
        ...
        language_obj.langcode = langcode
