...
from .constants import (
    ...
    EAD_ATTRS, EAD_NAMESPACE, EAD_NS as EAD, EDITIONSTMT_ATTRS,
    EVENTDATETIME_ATTRS, EVENTDESCRIPTION_ATTRS, EVENTTYPE_ATTRS,
    FILEDESC_ATTRS, FILEPLAN_ATTRS, FROMTODATE_ATTRS, GEOGNAME_ATTRS,
    HEAD_ATTRS, INDEX_ATTRS, LANGMATERIAL_ATTRS, LANGUAGE_ATTRS,
    LANGUAGEDECLARATION_ATTRS, LANGUAGESET_ATTRS, LEGALSTATUS_ATTRS,
    ...
    SOURCES_ATTRS, SPONSOR_ATTRS, SUBTITLE_ATTRS, TITLEPROPER_ATTRS,
    TITLESTMT_ATTRS, UNITDATE_ATTRS, UNITDATESTRUCTURED_ATTRS, UNITID_ATTRS,
    UNITTITLE_ATTRS, UNITTYPE_ATTRS, USERESTRICT_ATTRS)
...
def append_xml(parent, xml):
    if xml:
        root = etree.fromstring('<wrapper>{}</wrapper>'.format(escape(xml)))
...
class EADSerialiser:
    ...
    def serialise(self, ead_obj):
        ...
        return etree.tostring(ead, encoding='utf-8', pretty_print=True)
    ...
    def _serialise_daterange(self, daterange_obj, parent):
        daterange = etree.SubElement(parent, EAD + 'daterange')
        serialise_attrs(daterange_obj, DATERANGE_ATTRS, daterange)
    ...
    def _serialise_datesingle(self, datesingle_obj, parent):
        datesingle = etree.SubElement(parent, EAD + 'datesingle')
        serialise_attrs(datesingle_obj, DATESINGLE_ATTRS, datesingle)
