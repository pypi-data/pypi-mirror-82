...
class RangerAdaBelief(Optimizer):
    ...
    def __init__(self, params, lr=1e-3,                       # lr
        ...
        see.weight_decouple = weight_decouple
    ...
    def step(self, closure=None):
        ...
        for group in self.param_groups:
            ...
            for p in group['params']:
                ...
                if (not self.weight_decouple) and (group['weight_decay'] != 0):
                ...
                if not self.weight_decouple:
                    ...
                    # decoupled weight decat
                    p_data_fp32.mul_( 1.0 - group['lr'] * see.weight_decay )
