(
    ...
    var saveVpPosition = function () {
        ...
        if (vpWrapper.hasClass('sidebar-wrapper'))
    ...
    var createVpDiv = function (cfg, st) {
        ...
        $(document).on("mouseover", vpCommon.wrapSelector("#vp_header .vp-header"), function() {
            vpWrapper.draggable( "enable" );
        });
        $(document).on("mouseout", vpCommon.wrapSelector("#vp_header .vp-header"), function() {
            vpWrapper.draggable( "disable" );
        });
    };
