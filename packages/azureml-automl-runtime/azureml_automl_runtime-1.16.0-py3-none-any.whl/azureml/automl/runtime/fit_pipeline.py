                                ...
                                try:
                                    with dataset.open_dataset():
                                        from azureml.train.automl.runtime._automl_model_explain import \
                                            _automl_auto_mode_explain_model, AutoMLModelExplainDriverFactory

                                        # Get the model explain driver class for explaining this model
                                        automl_model_explain_driver = \
                                            AutoMLModelExplainDriverFactory._get_model_explain_driver(
                                                automl_child_run=run,
                                                dataset=dataset, automl_settings=automl_settings,
                                                model_exp_workspace_config=cast(
                                                    Dict[str, Any], feature_configs).get('model_explainability'))
