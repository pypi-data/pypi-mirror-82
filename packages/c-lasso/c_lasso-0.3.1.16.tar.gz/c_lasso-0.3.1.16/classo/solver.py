...
class solution_CV:
    ...
    def __repr__(self):
        ...
        plt.bar(range(sum(self.selected_param])), self.refit[self.selected_param]), plt.title(CV_beta["title"]), plt.xlabel(CV_beta["xlabel"]),plt.ylabel(CV_beta["ylabel"])
        plt.xticks(range(sum(self.selected_param])),self.label[self.selected_param], rotation=30)
