...
class solution_StabSel:
    ...
    def __init__(self, matrices, param, formulation, numerical_method, label):
        ...
        self.selected_param, _ = selected_param(self.distribution, param.threshold,param.threshold_label)
    ...
    def __repr__(self):
        ...
        _, self.to_label = selected_param(self.distribution, param.threshold,self.threshold_label)
