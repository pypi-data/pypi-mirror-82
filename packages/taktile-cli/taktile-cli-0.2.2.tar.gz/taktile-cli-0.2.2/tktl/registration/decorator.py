...
class Endpoint(ABC):
    ...
    @abstractmethod
    def get_x_and_y_for_profiling(self) -> Tuple[pandas.DataFrame, pandas.Series]:
...
class TabularEndpoint(Endpoint):
    ...
    def _profiling_supported(self):
        ...
        try:
            ...
            logger.error(f"Unable to produce predictions from given values: {e}")
            return False
        return predictions
...
class CustomEndpoint(Endpoint):
    ...
    def __init__(self, func, payload_model=None, response_model=None):
        ...
        try:
            ...
            logger.error("Endpoint function is not a callable")
