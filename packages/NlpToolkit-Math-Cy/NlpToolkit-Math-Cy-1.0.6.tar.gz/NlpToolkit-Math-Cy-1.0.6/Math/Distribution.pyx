...
cdef class Distribution(object):
    ...
    @staticmethod
    def chiSquare(x: double, freedom: int) -> double:
        """
    ...
    @staticmethod
    def chiSquareInverse(p: double, freedom: int) -> double:
        """
    ...
    @staticmethod
    def fDistribution(F: double, freedom1: int, freedom2: int) -> double:
        """
    ...
    @staticmethod
    def fDistributionInverse(p: double, freedom1: int, freedom2: int) -> double:
        """
    ...
    @staticmethod
    def tDistribution(T: double, freedom: int) -> double:
        """
    ...
    @staticmethod
    def tDistributionInverse(p: double, freedom: int) -> double:
        """
