...
def get(endpoint, **kwargs):
    ...
    return requests.get(_full_url(endpoint), **kwargs)


def post(endpoint, **kwargs):
    kwargs = _kwargs(kwargs)
    return requests.post(_full_url(endpoint), **kwargs)


def patch(endpoint, **kwargs):
    kwargs = _kwargs(kwargs)
    return requests.patch(_full_url(endpoint), **kwargs)


def put(endpoint, **kwargs):
    kwargs = _kwargs(kwargs)
    return requests.put(_full_url(endpoint), **kwargs)


def delete(endpoint, **kwargs):
    kwargs = _kwargs(kwargs)
    return requests.delete(_full_url(endpoint), **kwargs)


def options(endpoint, **kwargs):
    kwargs = _kwargs(kwargs)
    return requests.options(_full_url(endpoint), **kwargs)


def head(endpoint, **kwargs):
    kwargs = _kwargs(kwargs)
    return requests.head(_full_url(endpoint), **kwargs)
