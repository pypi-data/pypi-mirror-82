...
def fetch_all_necessary_data_b40lux(public_key = None, private_key= None, start_time= None, end_time= None, me_month=None, save_to_dropbox = False, dropbox_token = None, local_root_directory = './', trade_only_granularity = False, recompute_all=False):
...
#            os.remove(full_path)
    ...
    return filtered_binance_df, filteredWallet[valo_columns], converted_history_balance, actualPositions
