...
class MergeModal extends React.Component<MergeModalProps, MergeModalState> {
    ...
    completeMerge = (): void => {
        ...
        this.props.setModal(ModalEnum.None);
    }
    ...
    render()  {
        ...
        if (this.props.dfNames.length === 0) {
            return (
                <DefaultModal
                    ...
                    buttons = {
                        <Fragment>
                            <div className='modal-close-button' onClick={() => {this.props.setModal(ModalEnum.None)}}> Close </div>
                        </Fragment>
                    }
                />
            )
        ...
        return (
            <DefaultModal
                ...
                buttons = {
                    <Fragment>
                        <div className='modal-close-button modal-dual-button-left' onClick={() => {this.props.setModal(ModalEnum.None)}}> Close </div>
