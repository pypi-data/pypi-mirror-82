...
@as_types('string_series', 'number_series', num_optional=1)
...
@as_types('string_series', 'number_series', 'number_series')
...
@as_types('string_series', 'string_series', 'string_series', 'number_series', num_optional=1)
