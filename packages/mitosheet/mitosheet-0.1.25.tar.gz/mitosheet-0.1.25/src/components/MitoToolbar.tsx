...
const MitoToolbar = (
    ...
    const repeatAnalysis = () => {
        // We log the opening of the repeat analysis modal
        window.logger?.track({
            userId: window.user_id,
        ...
        props.setModal(ModalEnum.RepeatAnalysis);
    }
    ...
    return (
        <div className='mito-toolbar-container'>
            ...
            <button className='mito-toolbar-item vertical-align-content' onClick={repeatAnalysis}>
