...
class AddIODialogFFR(QtWidgets.QDialog):
    ...
    def __init__(self, parent=None, io_dict=None):
        ...
        super(AddIODialogFFR, self).__init__(parent)
    ...
    def restoreParams(self):
        ...
        # Restore state for combo box for chamber
        self.params["chamber"] = self.io_dict["chamber"]
        if self.params["chamber"] == "top":
            self.combo_chamber.setCurrentIndex(0)
        elif self.params["chamber"] == "bottom":
            self.combo_chamber.setCurrentIndex(1)
    ...
    def readForm(self):
        ...
        self.params["chamber"] = self.combo_chamber.currentText().lower()
    ...
    def initUI(self):
        ...
        self.combo_chamber = QtWidgets.QComboBox(self)
        self.combo_chamber.addItems(["Top", "Bottom"])
        ...
        fbox.addRow("Chamber: ", self.combo_chamber)
