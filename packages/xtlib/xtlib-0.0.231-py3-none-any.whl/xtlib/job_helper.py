...
def set_job_tags(store, db, name_list, tag_list, ws_name, tag_dict, clear):
    ...
    if job_list:
        ...
        #     all_ws_jobs = db.get_info_for_jobs(workspace, {"ws_name": workspace}, {"_id": 1})
        ...
        # matched_count = db.update_job_stats_from_list(workspace, job_list, fd, clear=clear, upsert=False)
