...
class Runner():
    ...
    def write_node_info_data(self, _id, ws_name, job_id, node_index, total_run_count, node_count, 
        box_name, run_name, secret, service_info, args):

        target = args["target"]
        str_now = utils.get_time()
        ...
        dd = {"_id": _id, "ws_name": ws_name, "job_id": job_id, 
    ...
    def write_node_stats_data(self, _id, ws_name):
        ...
        dd = {"_id": _id, "node_status": "created", 
            ...
            "create_time": str_now, "start_time": None, "end_time": None,
            "queue_duration": None, "run_duration": None, 
            "restarts": 0, "db_retries": 0, "storage_retries": 0}
    ...
    def log_run_and_node(self, workspace, box_name, runs_by_box, job_id, total_run_count, secrets_by_node, 
        ...
        self.write_node_info_data(id_for_node, ws_name, job_id, node_index, total_run_count, node_count, 
            box_name, run_name, box_secret, service_info, args)
    ...
    def log_runs_queued(self, runs_by_box, workspace, job_id, total_run_count, secrets_by_node, 
        service_info_by_node, args):
        ...
        utils.run_on_threads(thread_worker, box_name_list, max_workers, [workspace])
