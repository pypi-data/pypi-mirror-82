...
class MongoDB2(implements(DbInterface)):
    ...
    def get_collection(self, ws_name, collection_name, filter, fields=None, sort_col=None, 
        ...
        records = self.mongo_with_retries("get_collection_records", dbx, \
    ...
    def update_run_stats_from_list(self, ws_name, id_list, dd, clear=False, upsert=True):
        ...
        for id in id_list:
            ...
            result = self.mongo_with_retries("update_run_stats_from_list", dbx, \
    ...
    def update_job_stats_from_list(self, ws_name, id_list, dd, clear=False, upsert=True):
        ...
        for id in id_list:
            ...
            result = self.mongo_with_retries("update_job_stats_from_list", dbx, \
