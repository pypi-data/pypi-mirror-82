...
Your local config file should only contain the XT properties that you change. It is typically much smaller then the default config file.
...
|                               | to the corporate login name of the user. It is   |
|                               | sed for logging for new runs/jobs.               |
+-------------------------------+--------------------------------------------------+
