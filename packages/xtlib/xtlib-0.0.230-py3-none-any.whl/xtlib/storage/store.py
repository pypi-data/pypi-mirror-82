...
class StoreV2():
    ...
    def __init__(self, storage_creds=None, config=None, max_retries=25, run_cache_dir=None, feedback_enabled=True,  db_creds=None, 
        ...
        if self.db_type == "database":
            self.db = mongo_v2.databaseDB2(self.db_conn_str, run_cache_dir=run_cache_dir, store=self, 
    ...
    def get_props_dict(self):
        pd = {"storage_creds": self.storage_creds, "db_conn_str": self.db_conn_str, 
    ...
    def log_run_event(self, ws_name, run_name, event_name, data_dict=None, event_time=None):
    ...
    def wrapup_run(self, ws_name, run_name, aggregate_dest, dest_name, status, exit_code, primary_metric, maximize_metric, 
        ...
        if self.db:
            ...
            self.db.run_exit(ws_name, run_name, db_retries, storage_retries, 
                status, exit_code, start_time)
