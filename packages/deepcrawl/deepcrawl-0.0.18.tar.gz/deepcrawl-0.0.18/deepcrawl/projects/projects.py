...
class DeepCrawlProject(ImmutableAttributesMixin):
    ...
    def save(self, connection: 'deepcrawl.DeepCrawlConnection' = None) -> DeepCrawlProject:
    ...
    def refresh(self, connection: 'deepcrawl.DeepCrawlConnection' = None) -> DeepCrawlProject:
    ...
    def add_extractions(
            self, extractions: dict, connection: 'deepcrawl.DeepCrawlConnection' = None
    ) -> DeepCrawlProject:
