...
class DeepCrawlAccount(ImmutableAttributesMixin):
    ...
    def save(self, connection: 'deepcrawl.DeepCrawlConnection' = None) -> DeepCrawlAccount:
    ...
    def refresh(self, connection: 'deepcrawl.DeepCrawlConnection' = None) -> DeepCrawlAccount:
    ...
    def update(self, account_settings, connection: 'deepcrawl.DeepCrawlConnection' = None) -> DeepCrawlAccount:
    ...
    def get_projects(
            ...
            connection: 'deepcrawl.DeepCrawlConnection' = None, filters: Optional[dict] = None
    ) -> List[DeepCrawlProject]:
        """Get projects
