...
def bump_version_inf(curr_version, file_name, line_pattern='app_version'):
    new_ver = version_inc_inf(curr_version)
    replace_line(file_name, line_pattern, 'app_version = "' + new_ver + '"')
    return new_ver


def bump_version_upto10(curr_version, file_name, line_pattern='app_version'):
    new_ver = version_inc_upto10(curr_version)
    replace_line(file_name, line_pattern, 'app_version = "' + new_ver + '"')
    return new_ver


def bump_version_upto100(curr_version, file_name, line_pattern='app_version'):
