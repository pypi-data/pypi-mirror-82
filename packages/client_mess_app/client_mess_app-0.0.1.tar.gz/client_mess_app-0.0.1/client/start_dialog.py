...
class UserNameDialog(QDialog):
   ...
   """
    ...
    def __init__(self):
        ...
        self.client_name.setFixedSize(240, 20)
        self.client_name.move(5, 40)

        self.btn_ok = QPushButton('Начать', self)
        self.btn_ok.move(5, 110)
        self.btn_ok.clicked.connect(self.click)

        self.btn_cancel = QPushButton('Выход', self)
        self.btn_cancel.move(133, 110)
        self.btn_cancel.clicked.connect(qApp.exit)

        self.label_passwd = QLabel('Введите пароль:', self)
        self.label_passwd.move(25, 65)
        self.label_passwd.setFixedSize(150, 15)

        self.client_passwd = QLineEdit(self)
        self.client_passwd.setFixedSize(240, 20)
        self.client_passwd.move(5, 85)
