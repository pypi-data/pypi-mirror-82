...
class AidlabSDK:
    ...
    def setup_user_callback(self):
        ...
        self.lib.initUserServiceCallback(self.ecg_c_callback, self.respiration_c_callback, self.temperature_c_callback,
                                         ...
                                         self.exercise_c_callback, self.receive_command_c_callback, self.aidlab_sdk_ptr)

    def setup_synchronization_callback(self):

        self.past_ecg_c_callback = self.sample_time_callback_type(self.did_receive_past_ecg)
        self.past_respiration_c_callback = self.sample_time_callback_type(self.did_receive_past_respiration)
    ...
    def did_receive_past_ecg(self, context, timestamp, value):
        self.delegate.did_receive_past_ecg(self.aidlab, timestamp, value)

    def did_receive_past_respiration(self, context, timestamp, value):
        self.delegate.did_receive_past_respiration(self.aidlab, timestamp, value)
