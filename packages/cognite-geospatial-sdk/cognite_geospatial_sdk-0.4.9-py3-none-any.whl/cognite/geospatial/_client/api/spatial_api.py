...
class SpatialApi(object):
    ...
    def add_spatial_item_attributes_with_http_info(self, project, item_attributes_dto, **kwargs):  # noqa: E501
        ...
        all_params = ["project", "item_attributes_dto"]
        all_params.extend(
        ...
        for key, val in six.iteritems(local_var_params["kwargs"]):
            if key not in all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'" " to method add_spatial_item_attributes" % key
                )
        ...
        if self.api_client.client_side_validation and (
            ...
            raise ApiValueError(
                "Missing the required parameter `project` when calling `add_spatial_item_attributes`"
            )  # noqa: E501
        # verify the required parameter 'item_attributes_dto' is set
        if self.api_client.client_side_validation and (
            "item_attributes_dto" not in local_var_params
            or local_var_params["item_attributes_dto"] is None  # noqa: E501
        ):  # noqa: E501
            raise ApiValueError(
                "Missing the required parameter `item_attributes_dto` when calling `add_spatial_item_attributes`"
            )  # noqa: E501
    ...
    def find_intersection_with_http_info(self, project, intersection_query_dto, **kwargs):  # noqa: E501
        ...
        all_params = ["project", "intersection_query_dto", "geometry"]
        all_params.extend(
            ["async_req", "_return_http_data_only", "_preload_content", "_request_timeout", "_request_auth"]
        )
    ...
    def get_spatial_coverage_with_http_info(self, project, spatial_coverage_request_dto, **kwargs):  # noqa: E501
        ...
        all_params = ["project", "spatial_coverage_request_dto", "geometry"]
        all_params.extend(
            ["async_req", "_return_http_data_only", "_preload_content", "_request_timeout", "_request_auth"]
        )
    ...
    def get_spatial_item_attributes(self, project, spatial_data_request_dto, **kwargs):  # noqa: E501
        ...
        """
        kwargs["_return_http_data_only"] = True
        return self.get_spatial_item_attributes_with_http_info(
            project, spatial_data_request_dto, **kwargs
        )  # noqa: E501
    ...
    def get_spatial_item_attributes_with_http_info(self, project, spatial_data_request_dto, **kwargs):  # noqa: E501
        ...
        for key, val in six.iteritems(local_var_params["kwargs"]):
            if key not in all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'" " to method get_spatial_item_attributes" % key
                )
            local_var_params[key] = val
        del local_var_params["kwargs"]
        # verify the required parameter 'project' is set
        if self.api_client.client_side_validation and (
            ...
            raise ApiValueError(
                "Missing the required parameter `project` when calling `get_spatial_item_attributes`"
            )  # noqa: E501
        ...
        if self.api_client.client_side_validation and (
            ...
            raise ApiValueError(
                "Missing the required parameter `spatial_data_request_dto` when calling `get_spatial_item_attributes`"
            )  # noqa: E501
    ...
    def grid_coverage_with_http_info(self, project, grid_coverage_request_dto, **kwargs):  # noqa: E501
        ...
        all_params = ["project", "grid_coverage_request_dto"]
        all_params.extend(
            ["async_req", "_return_http_data_only", "_preload_content", "_request_timeout", "_request_auth"]
        )
        ...
        for key, val in six.iteritems(local_var_params["kwargs"]):
            if key not in all_params:
                raise ApiTypeError("Got an unexpected keyword argument '%s'" " to method grid_coverage" % key)
            local_var_params[key] = val
        del local_var_params["kwargs"]
        # verify the required parameter 'project' is set
        if self.api_client.client_side_validation and (
        ...
        if self.api_client.client_side_validation and (
            "grid_coverage_request_dto" not in local_var_params
            or local_var_params["grid_coverage_request_dto"] is None  # noqa: E501
        ):  # noqa: E501
            raise ApiValueError(
                "Missing the required parameter `grid_coverage_request_dto` when calling `grid_coverage`"
            )  # noqa: E501
        ...
        return self.api_client.call_api(
            "/api/playground/projects/{project}/spatial/grid-coverage/get",
            "POST",
            path_params,
            query_params,
            header_params,
    ...
    def operation_union_with_http_info(self, project, geometry_items_dto, **kwargs):  # noqa: E501
        ...
        all_params = ["project", "geometry_items_dto", "geometry"]
        all_params.extend(
            ["async_req", "_return_http_data_only", "_preload_content", "_request_timeout", "_request_auth"]
        )
        ...
        for key, val in six.iteritems(local_var_params["kwargs"]):
            if key not in all_params:
                raise ApiTypeError("Got an unexpected keyword argument '%s'" " to method operation_union" % key)
            local_var_params[key] = val
        del local_var_params["kwargs"]
        # verify the required parameter 'project' is set
        if self.api_client.client_side_validation and (
        ...
        if self.api_client.client_side_validation and (
            "geometry_items_dto" not in local_var_params or local_var_params["geometry_items_dto"] is None  # noqa: E501
        ):  # noqa: E501
            raise ApiValueError(
                "Missing the required parameter `geometry_items_dto` when calling `operation_union`"
            )  # noqa: E501
        ...
        return self.api_client.call_api(
            "/api/playground/projects/{project}/spatial/operation/union",
            "POST",
            path_params,
            query_params,
            header_params,
