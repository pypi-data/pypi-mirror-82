...
class SpatialObject(FullSpatialItemDTO, Geometry):
    ...
    def plot(self, attributes=None, label=None, title=None, xlabel="x", ylabel="y"):
        plot = None
    ...
    def plot_bounding(self):
        ...
        if layer.name == "seismic":
            return self.plot(
                ...
                title="Grid in UTML-coordinates",
            )
        ...
        if geometry is not None:
            ...
            return plot_geometry(box_geometry, title="Grid in UTML-coordinates")
