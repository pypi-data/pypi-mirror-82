...
class GridCoverageRequestDTO(object):
    ...
    """
    openapi_types = {"spatial_id": "EitherIdDTO", "geometry": "TextBasedGeometryDTO", "distance": "float"}

    attribute_map = {"spatial_id": "spatialId", "geometry": "geometry", "distance": "distance"}
