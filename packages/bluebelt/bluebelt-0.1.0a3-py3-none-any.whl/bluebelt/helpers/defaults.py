...
light_blue = tuple(ti/255 for ti in (57, 94, 168))
blue = tuple(ti/255 for ti in (22, 51, 107))
...
plt.rc('lines', linewidth=3) # line width in points
...
plt.rc('lines', markersize=9)# markersize, in points
...
plt.rc('lines', dashed_pattern=(5, 2))
plt.rc('lines', dashdot_pattern=(5, 2, 1, 2,))
plt.rc('lines', dotted_pattern=(1, 2))
...
#plt.rc('patch', edgecolor='none')# if forced, or patch is not filled
...
### HATCHES
#plt.rc('hatch', color='red')
#plt.rc('hatch', linewidth=1)

### Boxplot
plt.rc('boxplot', notch=True)
...
plt.rc('axes', edgecolor=light_grey)# axes edge color
plt.rc('axes', linewidth=1)# edge linewidth
plt.rc('axes', grid=True)# display grid or not
plt.rc('axes.grid', axis='both')# which axis (x, y, both, none)
plt.rc('axes.grid', which='major')# major, minor or both

plt.rc('axes', titlesize=medium)# fontsize of the axes title
#plt.rc('axes', titlepad=5)# pad between title and axis in points
...
#blauw, donkerbl, lichtbl, rood, geel, blauw, donkerbl, lichtbl, rood, geel
...
#plt.rc('axes', ymargin='.05')# y margin. See `axes.Axes.margins`
...
plt.rc('xtick', top=False)# draw ticks on the top side
plt.rc('xtick', bottom=True)# draw ticks on the bottom side
plt.rc('xtick', color=dark_grey)# color of the tick labels
plt.rc('xtick', labelsize=small)# fontsize of the tick labels
plt.rc('xtick', direction='out')# direction: in, out, or inout
...
#plt.rc('xtick.major', top=False)# draw x axis top major ticks
...
plt.rc('ytick', right=False)# draw ticks on the right side
plt.rc('ytick', color=dark_grey)# color of the tick labels
plt.rc('ytick', labelsize=small)# fontsize of the tick labels
#plt.rc('ytick', direction='out')# direction: in, out, or inout
...
plt.rc('grid', alpha=1)# transparency, between 0.0 and 1.0
