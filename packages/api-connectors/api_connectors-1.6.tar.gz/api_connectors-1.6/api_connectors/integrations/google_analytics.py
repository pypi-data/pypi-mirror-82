...
class GoogleAnalyticsAPI:
    ...
    def __init__(self, credentials: dict):
        # Made for different versions compatibility
        signature = inspect.signature(OAuth2Credentials.__init__)

        self.oauth_creds = OAuth2Credentials(
            **{param: credentials.get(param, None)
    ...
    def data_request(self,
        ...
        if total_results > first_response['itemsPerPage']:
