...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'azure', '3.25.0-alpha.1602603610+aca0203f'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource azure 3.25.0-alpha.1602603610+aca0203f`
                """)
            else:
                raise
