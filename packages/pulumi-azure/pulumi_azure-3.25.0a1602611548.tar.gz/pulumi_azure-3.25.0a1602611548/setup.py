...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'azure', '3.25.0-alpha.1602611548+26d534d2'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource azure 3.25.0-alpha.1602611548+26d534d2`
                """)
            else:
                raise
