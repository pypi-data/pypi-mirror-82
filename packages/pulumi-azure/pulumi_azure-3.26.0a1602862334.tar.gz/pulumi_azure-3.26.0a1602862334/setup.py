...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'azure', '3.26.0-alpha.1602862334+eda3193e'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource azure 3.26.0-alpha.1602862334+eda3193e`
                """)
            else:
                raise
