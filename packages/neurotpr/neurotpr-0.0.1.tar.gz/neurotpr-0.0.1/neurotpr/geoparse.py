...
package_path = os.path.dirname(neurotpr.__file__)
model_path = package_path+"/pretrained/"
wordembedding_path = package_path+"/pretrained/word2Idx.npy"
labelset_path = package_path+"/pretrained/idx2Label.npy"
charembedding_path = package_path+"/pretrained/char2Idx.npy"
charembedding_path2 = package_path+"/pretrained/char2Idx_caseless.npy"
posembedding_path = package_path+"/pretrained/pos2Idx.npy"
...
#print("Loading the pretrained NeuroTPR model weights...")
tpr_model = load_keras_model(model_path)
