...
from Stackml.Drawio.Link import Link
from Stackml.Drawio.Node import Node
from Stackml.Drawio.Tier import Tier
...
class DrawIO:
    ...
    def from_stackml(self, stackml: Stackml) -> str or None:
