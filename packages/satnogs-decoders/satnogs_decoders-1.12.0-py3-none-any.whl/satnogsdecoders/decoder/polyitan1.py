...
class Polyitan1(KaitaiStruct):
    ...
    class UiFrame(KaitaiStruct):
        ...
        def _read(self):
            ...
            if _on == u"EM0UKP":
                ...
                self.ax25_info = self._root.Ax25Info(io, self, self._root)
            else:
    ...
    class Ax25Info(KaitaiStruct):
        ...
        def _read(self):
            ...
            if _on == 0:
                self.data = self._root.Beacon0(self._io, self, self._root)
            elif _on == 1:
                self.data = self._root.Beacon1(self._io, self, self._root)
            elif _on == 2:
                self.data = self._root.Beacon2(self._io, self, self._root)
