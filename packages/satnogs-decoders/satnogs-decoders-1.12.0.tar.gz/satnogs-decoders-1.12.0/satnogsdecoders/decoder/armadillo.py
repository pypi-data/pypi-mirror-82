...
class Armadillo(KaitaiStruct):
    ...
    class ArmadilloPayload(KaitaiStruct):
        ...
        def _read(self):
            ...
            self.pwr_states_reserved = self._io.read_bits_int(3)
            self.gps_power = self._io.read_bits_int(1) != 0
            self.adc_power = self._io.read_bits_int(1) != 0
            self.antenna_power = self._io.read_bits_int(1) != 0
            self.pdd_power = self._io.read_bits_int(1) != 0
            self.spacecraft_mode = self._io.read_bits_int(1) != 0
