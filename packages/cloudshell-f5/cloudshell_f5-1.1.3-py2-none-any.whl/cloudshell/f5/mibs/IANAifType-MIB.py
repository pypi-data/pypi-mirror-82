...
# Produced by pysmi-0.0.6 at Fri Nov 06 12:46:41 2015
...
(
    ...
    ObjectIdentifier,
    OctetString,
) = mibBuilder.importSymbols("ASN1", "Integer", "ObjectIdentifier", "OctetString")
...
(
    NotificationGroup,
    ModuleCompliance,
) = mibBuilder.importSymbols("SNMPv2-CONF", "NotificationGroup", "ModuleCompliance")
(
    Integer32,
    MibScalar,
    MibTable,
...
(
    DisplayString,
    TextualConvention,
) = mibBuilder.importSymbols("SNMPv2-TC", "DisplayString", "TextualConvention")
ianaifType = ModuleIdentity((1, 3, 6, 1, 2, 1, 30)).setRevisions(
    (
        "2011-10-26 00:00",
        "2011-09-07 00:00",
        "2011-07-22 00:00",
